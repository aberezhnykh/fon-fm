...
__c.LogImpl("988473603",("Page with this id already exists: "+__c.SmartStringFormatter("",(Object)(_idtolower))+"!"),0);
...
__c.LogImpl("988342549","#SupportedOrientations attribute must be set to landscape or portrait.",_xui.Color_Red);
 };
 };
 }
};
...
__c.LogImpl("988735748","Only top page can be closed",0);
...
__c.LogImpl("988735751","First page cannot be closed",0);
...
__c.LogImpl("989391107","Error: page id not found: "+_id,0);
 //BA.debugLineNum = 402;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
__c.LogImpl("989391108","Ids: "+BA.ObjectToString(_idtob4xpage._getkeys /*anywheresoftware.b4a.objects.collections.List*/ ()),0);
 };
...
__c.LogImpl("988277019","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
 };
...
__c.LogImpl("989980942","Too many parameters",0);
 break; }
}
;
...
__c.LogImpl("990046478","Too many parameters",0);
 break; }
}
;
