...
try {
		Debug.PushSubsStack("ClearHistoryStage (playbackmetastate) ","playbackmetastate",12,__ref.getField(false, "ba"),__ref,30);
...
try {
		Debug.PushSubsStack("CloneStateMap (playbackmetastate) ","playbackmetastate",12,__ref.getField(false, "ba"),__ref,35);
...
try {
		Debug.PushSubsStack("Initialize (playbackmetastate) ","playbackmetastate",12,__ref.getField(false, "ba"),__ref,9);
...
try {
		Debug.PushSubsStack("Reset (playbackmetastate) ","playbackmetastate",12,__ref.getField(false, "ba"),__ref,13);
...
try {
		Debug.PushSubsStack("SetCurrentMedia (playbackmetastate) ","playbackmetastate",12,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("StageHistoryItem (playbackmetastate) ","playbackmetastate",12,__ref.getField(false, "ba"),__ref,25);
