...
try {
		Debug.PushSubsStack("ClearHistoryStage (playbackmetastate) ","playbackmetastate",17,__ref.getField(false, "ba"),__ref,41);
...
try {
		Debug.PushSubsStack("CloneStateMap (playbackmetastate) ","playbackmetastate",17,__ref.getField(false, "ba"),__ref,46);
...
try {
		Debug.PushSubsStack("Initialize (playbackmetastate) ","playbackmetastate",17,__ref.getField(false, "ba"),__ref,13);
...
try {
		Debug.PushSubsStack("Reset (playbackmetastate) ","playbackmetastate",17,__ref.getField(false, "ba"),__ref,18);
...
try {
		Debug.PushSubsStack("SetCurrentMedia (playbackmetastate) ","playbackmetastate",17,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("SetCurrentTrack (playbackmetastate) ","playbackmetastate",17,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("StageHistoryItem (playbackmetastate) ","playbackmetastate",17,__ref.getField(false, "ba"),__ref,36);
