...
playbackmetastate._currentmediatype = RemoteObject.createImmutable("");__ref.setField("_currentmediatype",playbackmetastate._currentmediatype);
 //BA.debugLineNum = 8;BA.debugLine="Public PendingHistoryItem As Map";
playbackmetastate._pendinghistoryitem = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");__ref.setField("_pendinghistoryitem",playbackmetastate._pendinghistoryitem);
 //BA.debugLineNum = 9;BA.debugLine="Public HistoryStartedAtTicks As Long";
...
Debug.ShouldStop(4);
 BA.debugLineNum = 36;BA.debugLine="PendingHistoryItem.Initialize";
Debug.ShouldStop(8);
__ref.getField(false,"_pendinghistoryitem" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 37;BA.debugLine="HistoryStartedAtTicks = 0";
Debug.ShouldStop(16);
...
Debug.locals.put("source", _source);
 BA.debugLineNum = 40;BA.debugLine="Private Sub CloneStateMap(source As Map) As Map";
Debug.ShouldStop(128);
 BA.debugLineNum = 41;BA.debugLine="Dim cloned As Map";
Debug.ShouldStop(256);
_cloned = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("cloned", _cloned);
 BA.debugLineNum = 42;BA.debugLine="cloned.Initialize";
Debug.ShouldStop(512);
_cloned.runVoidMethod ("Initialize");
 BA.debugLineNum = 43;BA.debugLine="If source.IsInitialized = False Then Return clone";
...
if (true) return _cloned;};
 BA.debugLineNum = 44;BA.debugLine="For Each key As Object In source.Keys";
...
Debug.locals.put("key", _key);
 BA.debugLineNum = 45;BA.debugLine="cloned.Put(key, source.Get(key))";
Debug.ShouldStop(4096);
_cloned.runVoidMethod ("Put",(Object)(_key),(Object)(_source.runMethod(false,"Get",(Object)(_key))));
 }
}Debug.locals.put("key", _key);
;
 BA.debugLineNum = 47;BA.debugLine="Return cloned";
...
Debug.ShouldStop(65536);
 BA.debugLineNum = 18;BA.debugLine="CurrentMediaUrl = \"\"";
Debug.ShouldStop(131072);
__ref.setField ("_currentmediaurl" /*RemoteObject*/ ,BA.ObjectToString(""));
 BA.debugLineNum = 19;BA.debugLine="CurrentMediaType = \"\"";
Debug.ShouldStop(262144);
__ref.setField ("_currentmediatype" /*RemoteObject*/ ,BA.ObjectToString(""));
 BA.debugLineNum = 20;BA.debugLine="HistoryStartedAtTicks = 0";
Debug.ShouldStop(524288);
__ref.setField ("_historystartedatticks" /*RemoteObject*/ ,BA.numberCast(long.class, 0));
 BA.debugLineNum = 21;BA.debugLine="PendingHistoryItem.Initialize";
...
Debug.locals.put("mediaType", _mediatype);
 BA.debugLineNum = 24;BA.debugLine="Public Sub SetCurrentMedia(mediaUrl As String, med";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 25;BA.debugLine="CurrentMediaUrl = mediaUrl";
Debug.ShouldStop(16777216);
__ref.setField ("_currentmediaurl" /*RemoteObject*/ ,_mediaurl);
 BA.debugLineNum = 26;BA.debugLine="CurrentMediaType = mediaType";
...
Debug.locals.put("startedAtTicks", _startedatticks);
 BA.debugLineNum = 30;BA.debugLine="Public Sub StageHistoryItem(item As Map, startedAt";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 31;BA.debugLine="PendingHistoryItem = CloneStateMap(item)";
...
__ref.setField ("_pendinghistoryitem" /*RemoteObject*/ ,__ref.runClassMethod (b4j.example.playbackmetastate.class, "_clonestatemap" /*RemoteObject*/ ,(Object)(_item)));
 BA.debugLineNum = 32;BA.debugLine="HistoryStartedAtTicks = startedAtTicks";
