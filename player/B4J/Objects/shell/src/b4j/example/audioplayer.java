...
public static RemoteObject _check_timer_interval_ms = RemoteObject.createImmutable(0);
public static RemoteObject _silence_stall_threshold = RemoteObject.createImmutable(0);
...
public static RemoteObject _targetpage = RemoteObject.declareNull("b4j.example.b4xmainpage");
...
public static RemoteObject _stalledcheckcount = RemoteObject.createImmutable(0);
public static RemoteObject _currentloadtoken = RemoteObject.createImmutable(0L);
public static RemoteObject _activeeventloadtoken = RemoteObject.createImmutable(0L);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"activeEventLoadToken",_ref.getField(false, "_activeeventloadtoken"),"audioKey",_ref.getField(false, "_audiokey"),"CHECK_TIMER_INTERVAL_MS",_ref.getField(false, "_check_timer_interval_ms"),"checkTimer",_ref.getField(false, "_checktimer"),"currentLoadToken",_ref.getField(false, "_currentloadtoken"),"currentVolume",_ref.getField(false, "_currentvolume"),"eventName",_ref.getField(false, "_eventname"),"FADE_IN",_ref.getField(false, "_fade_in"),"FADE_NONE",_ref.getField(false, "_fade_none"),"FADE_OUT",_ref.getField(false, "_fade_out"),"fadeMode",_ref.getField(false, "_fademode"),"fadeStepVolume",_ref.getField(false, "_fadestepvolume"),"fadeTargetVolume",_ref.getField(false, "_fadetargetvolume"),"fadeTimer",_ref.getField(false, "_fadetimer"),"jo",_ref.getField(false, "_jo"),"lastPosition",_ref.getField(false, "_lastposition"),"loadTimer",_ref.getField(false, "_loadtimer"),"maxVolume",_ref.getField(false, "_maxvolume"),"player",_ref.getField(false, "_player"),"playerState",_ref.getField(false, "_playerstate"),"SILENCE_STALL_THRESHOLD",_ref.getField(false, "_silence_stall_threshold"),"stalledCheckCount",_ref.getField(false, "_stalledcheckcount"),"STATE_LOADING",_ref.getField(false, "_state_loading"),"STATE_PLAYING",_ref.getField(false, "_state_playing"),"STATE_READY",_ref.getField(false, "_state_ready"),"STATE_STOPPED",_ref.getField(false, "_state_stopped"),"targetPage",_ref.getField(false, "_targetpage"),"timeUpdateTimer",_ref.getField(false, "_timeupdatetimer")};
}
}