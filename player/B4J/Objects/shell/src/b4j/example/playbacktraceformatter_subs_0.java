...
try {
		Debug.PushSubsStack("AddCountPart (playbacktraceformatter) ","playbacktraceformatter",7,__ref.getField(false, "ba"),__ref,319);
...
Debug.locals.put("label", _label);
 BA.debugLineNum = 319;BA.debugLine="Private Sub AddCountPart(parts As List, details As";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 320;BA.debugLine="Dim value As String = ExtractDetailValue(details,";
...
_value = __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(_key));Debug.locals.put("value", _value);Debug.locals.put("value", _value);
 BA.debugLineNum = 321;BA.debugLine="If value = \"\" Then Return";
Debug.ShouldStop(1);
if (RemoteObject.solveBoolean("=",_value,BA.ObjectToString(""))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 322;BA.debugLine="parts.Add(label & \" \" & value)";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("BuildAudioSettingsText (playbacktraceformatter) ","playbacktraceformatter",7,__ref.getField(false, "ba"),__ref,252);
...
Debug.locals.put("details", _details);
 BA.debugLineNum = 252;BA.debugLine="Private Sub BuildAudioSettingsText(details As Stri";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 253;BA.debugLine="Dim volumeText As String = ExtractDetailValue(det";
...
_volumetext = __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("volume")));Debug.locals.put("volumeText", _volumetext);Debug.locals.put("volumeText", _volumetext);
 BA.debugLineNum = 254;BA.debugLine="Dim gainText As String = ExtractDetailValue(detai";
...
_gaintext = __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("gainDb")));Debug.locals.put("gainText", _gaintext);Debug.locals.put("gainText", _gaintext);
 BA.debugLineNum = 255;BA.debugLine="Dim gainState As String = ExtractDetailValue(deta";
Debug.ShouldStop(1073741824);
_gainstate = __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("gainApplied")));Debug.locals.put("gainState", _gainstate);Debug.locals.put("gainState", _gainstate);
 BA.debugLineNum = 256;BA.debugLine="Dim parts As List";
Debug.ShouldStop(-2147483648);
_parts = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("parts", _parts);
 BA.debugLineNum = 257;BA.debugLine="parts.Initialize";
Debug.ShouldStop(1);
_parts.runVoidMethod ("Initialize");
 BA.debugLineNum = 258;BA.debugLine="If volumeText <> \"\" Then parts.Add(\"громкость \" &";
Debug.ShouldStop(2);
...
_parts.runVoidMethod ("Add",(Object)((RemoteObject.concat(RemoteObject.createImmutable("громкость "),_volumetext))));};
 BA.debugLineNum = 259;BA.debugLine="If gainText <> \"\" Then";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("!",_gaintext,BA.ObjectToString(""))) { 
 BA.debugLineNum = 260;BA.debugLine="If gainState = \"yes\" Then";
Debug.ShouldStop(8);
if (RemoteObject.solveBoolean("=",_gainstate,BA.ObjectToString("yes"))) { 
 BA.debugLineNum = 261;BA.debugLine="parts.Add(\"gain \" & gainText & \" дБ\")";
Debug.ShouldStop(16);
_parts.runVoidMethod ("Add",(Object)((RemoteObject.concat(RemoteObject.createImmutable("gain "),_gaintext,RemoteObject.createImmutable(" дБ")))));
 ...
 BA.debugLineNum = 263;BA.debugLine="parts.Add(\"gain по умолчанию \" & gainText & \" д";
Debug.ShouldStop(64);
_parts.runVoidMethod ("Add",(Object)((RemoteObject.concat(RemoteObject.createImmutable("gain по умолчанию "),_gaintext,RemoteObject.createImmutable(" дБ")))));
 ...
 BA.debugLineNum = 266;BA.debugLine="If parts.Size = 0 Then Return \"\"";
Debug.ShouldStop(512);
if (RemoteObject.solveBoolean("=",_parts.runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
if (true) return BA.ObjectToString("");};
 BA.debugLineNum = 267;BA.debugLine="Return \". \" & JoinWords(parts)";
...
try {
		Debug.PushSubsStack("BuildCountsText (playbacktraceformatter) ","playbacktraceformatter",7,__ref.getField(false, "ba"),__ref,303);
...
RemoteObject _parts = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
Debug.locals.put("details", _details);
 BA.debugLineNum = 303;BA.debugLine="Private Sub BuildCountsText(details As String) As";
Debug.ShouldStop(16384);
 BA.debugLineNum = 304;BA.debugLine="Dim parts As List";
Debug.ShouldStop(32768);
_parts = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("parts", _parts);
 BA.debugLineNum = 305;BA.debugLine="parts.Initialize";
Debug.ShouldStop(65536);
_parts.runVoidMethod ("Initialize");
 BA.debugLineNum = 306;BA.debugLine="AddCountPart(parts, details, \"downloaded\", \"загру";
...
__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_addcountpart" /*RemoteObject*/ ,(Object)(_parts),(Object)(_details),(Object)(BA.ObjectToString("downloaded")),(Object)(RemoteObject.createImmutable("загружено")));
 BA.debugLineNum = 307;BA.debugLine="AddCountPart(parts, details, \"updated\", \"обновлен";
...
__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_addcountpart" /*RemoteObject*/ ,(Object)(_parts),(Object)(_details),(Object)(BA.ObjectToString("updated")),(Object)(RemoteObject.createImmutable("обновлено")));
 BA.debugLineNum = 308;BA.debugLine="AddCountPart(parts, details, \"failed\", \"ошибок\")";
...
__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_addcountpart" /*RemoteObject*/ ,(Object)(_parts),(Object)(_details),(Object)(BA.ObjectToString("failed")),(Object)(RemoteObject.createImmutable("ошибок")));
 BA.debugLineNum = 309;BA.debugLine="AddCountPart(parts, details, \"removed\", \"удалено\"";
...
__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_addcountpart" /*RemoteObject*/ ,(Object)(_parts),(Object)(_details),(Object)(BA.ObjectToString("removed")),(Object)(RemoteObject.createImmutable("удалено")));
 BA.debugLineNum = 310;BA.debugLine="AddCountPart(parts, details, \"actual\", \"осталось\"";
...
__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_addcountpart" /*RemoteObject*/ ,(Object)(_parts),(Object)(_details),(Object)(BA.ObjectToString("actual")),(Object)(RemoteObject.createImmutable("осталось")));
 BA.debugLineNum = 311;BA.debugLine="AddCountPart(parts, details, \"added\", \"добавлено\"";
...
__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_addcountpart" /*RemoteObject*/ ,(Object)(_parts),(Object)(_details),(Object)(BA.ObjectToString("added")),(Object)(RemoteObject.createImmutable("добавлено")));
 BA.debugLineNum = 312;BA.debugLine="AddCountPart(parts, details, \"tempDeleted\", \"врем";
...
__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_addcountpart" /*RemoteObject*/ ,(Object)(_parts),(Object)(_details),(Object)(BA.ObjectToString("tempDeleted")),(Object)(RemoteObject.createImmutable("временных удалено")));
 BA.debugLineNum = 313;BA.debugLine="AddCountPart(parts, details, \"ads\", \"рекламы\")";
...
__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_addcountpart" /*RemoteObject*/ ,(Object)(_parts),(Object)(_details),(Object)(BA.ObjectToString("ads")),(Object)(RemoteObject.createImmutable("рекламы")));
 BA.debugLineNum = 314;BA.debugLine="AddCountPart(parts, details, \"tracks\", \"треков\")";
...
__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_addcountpart" /*RemoteObject*/ ,(Object)(_parts),(Object)(_details),(Object)(BA.ObjectToString("tracks")),(Object)(RemoteObject.createImmutable("треков")));
 BA.debugLineNum = 315;BA.debugLine="If parts.Size = 0 Then Return BuildReasonText(det";
...
if (true) return __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_buildreasontext" /*RemoteObject*/ ,(Object)(_details));};
 BA.debugLineNum = 316;BA.debugLine="Return JoinWords(parts)";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("BuildHealthAudioSettingsText (playbacktraceformatter) ","playbacktraceformatter",7,__ref.getField(false, "ba"),__ref,270);
...
RemoteObject _parts = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
Debug.locals.put("details", _details);
 BA.debugLineNum = 270;BA.debugLine="Private Sub BuildHealthAudioSettingsText(details A";
Debug.ShouldStop(8192);
 BA.debugLineNum = 271;BA.debugLine="Dim volumeText As String = ExtractDetailValue(det";
Debug.ShouldStop(16384);
_volumetext = __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("volume")));Debug.locals.put("volumeText", _volumetext);Debug.locals.put("volumeText", _volumetext);
 BA.debugLineNum = 272;BA.debugLine="Dim gainText As String = ExtractDetailValue(detai";
Debug.ShouldStop(32768);
_gaintext = __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("gainDb")));Debug.locals.put("gainText", _gaintext);Debug.locals.put("gainText", _gaintext);
 BA.debugLineNum = 273;BA.debugLine="Dim gainState As String = ExtractDetailValue(deta";
Debug.ShouldStop(65536);
_gainstate = __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("gainApplied")));Debug.locals.put("gainState", _gainstate);Debug.locals.put("gainState", _gainstate);
 BA.debugLineNum = 274;BA.debugLine="Dim parts As List";
Debug.ShouldStop(131072);
_parts = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("parts", _parts);
 BA.debugLineNum = 275;BA.debugLine="parts.Initialize";
Debug.ShouldStop(262144);
_parts.runVoidMethod ("Initialize");
 BA.debugLineNum = 276;BA.debugLine="If volumeText <> \"\" Then parts.Add(\"громкость=\" &";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean("!",_volumetext,BA.ObjectToString(""))) { 
_parts.runVoidMethod ("Add",(Object)((RemoteObject.concat(RemoteObject.createImmutable("громкость="),_volumetext))));};
 BA.debugLineNum = 277;BA.debugLine="If gainText <> \"\" Then";
Debug.ShouldStop(1048576);
if (RemoteObject.solveBoolean("!",_gaintext,BA.ObjectToString(""))) { 
 BA.debugLineNum = 278;BA.debugLine="If gainState = \"yes\" Then";
Debug.ShouldStop(2097152);
if (RemoteObject.solveBoolean("=",_gainstate,BA.ObjectToString("yes"))) { 
 BA.debugLineNum = 279;BA.debugLine="parts.Add(\"gain=\" & gainText & \" дБ\")";
Debug.ShouldStop(4194304);
_parts.runVoidMethod ("Add",(Object)((RemoteObject.concat(RemoteObject.createImmutable("gain="),_gaintext,RemoteObject.createImmutable(" дБ")))));
 }else {
 BA.debugLineNum = 281;BA.debugLine="parts.Add(\"gain=\" & gainText & \" дБ по умолчани";
Debug.ShouldStop(16777216);
_parts.runVoidMethod ("Add",(Object)((RemoteObject.concat(RemoteObject.createImmutable("gain="),_gaintext,RemoteObject.createImmutable(" дБ по умолчанию")))));
 ...
 BA.debugLineNum = 284;BA.debugLine="If parts.Size = 0 Then Return \"\"";
Debug.ShouldStop(134217728);
if (RemoteObject.solveBoolean("=",_parts.runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
if (true) return BA.ObjectToString("");};
 BA.debugLineNum = 285;BA.debugLine="Return \", \" & JoinWords(parts)";
Debug.ShouldStop(268435456);
if (true) return RemoteObject.concat(RemoteObject.createImmutable(", "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_joinwords" /*RemoteObject*/ ,(Object)(_parts)));
...
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Не удалось подготовить очередь. "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_buildreasontext" /*RemoteObject*/ ,(Object)(_details)));
 break; }
case 4: {
 BA.debugLineNum = 83;BA.debugLine="Return \"Следующий элемент очереди: \" & TraceI";
Debug.ShouldStop(262144);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Следующий элемент очереди: "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_traceitemlabelfromdetails" /*RemoteObject*/ ,(Object)(_details)));
 break; }
case 5: {
...
if (true) return BA.ObjectToString("Начата обработка break.");
 break; }
case 6: {
 BA.debugLineNum = 87;BA.debugLine="Return \"Запущен заранее подготовленный элемен";
Debug.ShouldStop(4194304);
if (true) return BA.ObjectToString("Запущен заранее подготовленный элемент.");
 break; }
case 7: {
...
if (true) return BA.ObjectToString("Переход к следующему элементу.");
 break; }
case 8: {
 BA.debugLineNum = 91;BA.debugLine="Return \"Начата подготовка следующего элемента";
Debug.ShouldStop(67108864);
if (true) return BA.ObjectToString("Начата подготовка следующего элемента.");
 break; }
case 9: {
 BA.debugLineNum = 93;BA.debugLine="Return \"Следующий элемент подготовлен заранее";
Debug.ShouldStop(268435456);
if (true) return BA.ObjectToString("Следующий элемент подготовлен заранее.");
 break; }
case 10: {
 BA.debugLineNum = 95;BA.debugLine="Return \"Не удалось заранее подготовить следую";
Debug.ShouldStop(1073741824);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Не удалось заранее подготовить следующий элемент. "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_buildreasontext" /*RemoteObject*/ ,(Object)(_details)));
 break; }
case 11: {
...
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Кэш: Не удалось загрузить трек. "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_buildreasontext" /*RemoteObject*/ ,(Object)(_details)));
 break; }
case 2: {
 BA.debugLineNum = 151;BA.debugLine="Return \"Кэш треков проверен. \" & BuildCountsT";
Debug.ShouldStop(4194304);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Кэш треков проверен. "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_buildcountstext" /*RemoteObject*/ ,(Object)(_details)));
 break; }
case 3: {
 BA.debugLineNum = 153;BA.debugLine="Return \"Кэш рекламы проверен. \" & BuildCounts";
Debug.ShouldStop(16777216);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Кэш рекламы проверен. "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_buildcountstext" /*RemoteObject*/ ,(Object)(_details)));
 break; }
case 4: {
 BA.debugLineNum = 155;BA.debugLine="Return \"Кэш проверен. \" & BuildCountsText(det";
Debug.ShouldStop(67108864);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Кэш проверен. "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_buildcountstext" /*RemoteObject*/ ,(Object)(_details)));
 break; }
case 5: {
 BA.debugLineNum = 157;BA.debugLine="Return \"Очистка кэша завершена. \" & BuildCoun";
Debug.ShouldStop(268435456);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Очистка кэша завершена. "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_buildcountstext" /*RemoteObject*/ ,(Object)(_details)));
 break; }
case 6: {
...
case 0: {
 BA.debugLineNum = 181;BA.debugLine="Return \"Состояние воспроизведения: этап=\" & E";
Debug.ShouldStop(1048576);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Состояние воспроизведения: этап="),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("stage"))),RemoteObject.createImmutable(", играет="),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("playing"))),RemoteObject.createImmutable(", трек="),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("currentTrackId"))),RemoteObject.createImmutable(", очередь="),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("queue"))),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_buildhealthaudiosettingstext" /*RemoteObject*/ ,(Object)(_details)));
 break; }
case 1: {
 BA.debugLineNum = 187;BA.debugLine="Return \"Состояние кэша: треков=\" & ExtractDet";
Debug.ShouldStop(67108864);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Состояние кэша: треков="),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("trackCache"))),RemoteObject.createImmutable(", рекламы="),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("adCache"))),RemoteObject.createImmutable(", индекс треков="),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("trackIndex"))),RemoteObject.createImmutable(", индекс рекламы="),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("adIndex"))));
 break; }
case 2: {
 BA.debugLineNum = 192;BA.debugLine="Return \"Состояние устройства: \" & ExtractDeta";
Debug.ShouldStop(-2147483648);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Состояние устройства: "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("device"))),RemoteObject.createImmutable(", id="),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("deviceId"))),RemoteObject.createImmutable(", ОС="),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailtail" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("os"))));
 break; }
case 3: {
 BA.debugLineNum = 196;BA.debugLine="Return \"Состояние ресурсов: RAM=\" & ExtractDe";
Debug.ShouldStop(8);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Состояние ресурсов: RAM="),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("ramFreeMb"))),RemoteObject.createImmutable(" МБ"),RemoteObject.createImmutable(", диск="),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("diskFreeMb"))),RemoteObject.createImmutable("/"),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("diskTotalMb"))),RemoteObject.createImmutable(" МБ"));
 break; }
case 4: {
 BA.debugLineNum = 199;BA.debugLine="Return \"Состояние сети: ошибок=\" & ExtractDet";
Debug.ShouldStop(64);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Состояние сети: ошибок="),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("netErrors"))),RemoteObject.createImmutable(", данные ок "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("lastDataOkAgoSec"))),RemoteObject.createImmutable(" сек назад"),RemoteObject.createImmutable(", история ок "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("lastHistoryOkAgoSec"))),RemoteObject.createImmutable(" сек назад"));
 break; }
}
;
 break; }
case 8: {
 BA.debugLineNum = 204;BA.debugLine="Select message";
Debug.ShouldStop(2048);
...
case 0: {
 BA.debugLineNum = 206;BA.debugLine="Return \"Системный снимок. Источник: \" & detai";
Debug.ShouldStop(8192);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Системный снимок. Источник: "),_details);
 break; }
case 1: {
 BA.debugLineNum = 208;BA.debugLine="Return \"Устройство: \" & ExtractDetailValue(de";
Debug.ShouldStop(32768);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Устройство: "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("name"))),RemoteObject.createImmutable(", id="),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("id"))));
 break; }
case 2: {
 BA.debugLineNum = 210;BA.debugLine="Return \"Платформа: \" & ExtractDetailTail(deta";
Debug.ShouldStop(131072);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Платформа: "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailtail" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("os"))));
 break; }
case 3: {
 BA.debugLineNum = 212;BA.debugLine="Return \"Память: свободно \" & ExtractDetailVal";
Debug.ShouldStop(524288);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Память: свободно "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("ramFreeMb"))),RemoteObject.createImmutable(" МБ"));
 break; }
case 4: {
 BA.debugLineNum = 214;BA.debugLine="Return \"Память: доступно приложению \" & Extra";
Debug.ShouldStop(2097152);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Память: доступно приложению "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("ramTotalMb"))),RemoteObject.createImmutable(" МБ"));
 break; }
case 5: {
 BA.debugLineNum = 216;BA.debugLine="Return \"Диск: свободно \" & ExtractDetailValue";
Debug.ShouldStop(8388608);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Диск: свободно "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("diskFreeMb"))),RemoteObject.createImmutable(" МБ из "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("diskTotalMb"))),RemoteObject.createImmutable(" МБ"));
 break; }
case 6: {
 BA.debugLineNum = 218;BA.debugLine="Return \"Кэш треков: \" & ExtractDetailValue(de";
Debug.ShouldStop(33554432);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Кэш треков: "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("trackCount"))),RemoteObject.createImmutable(" файлов, "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("trackMb"))),RemoteObject.createImmutable(" МБ, в индексе "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("trackIndex"))));
 break; }
case 7: {
 BA.debugLineNum = 220;BA.debugLine="Return \"Кэш рекламы: \" & ExtractDetailValue(d";
Debug.ShouldStop(134217728);
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Кэш рекламы: "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("adCount"))),RemoteObject.createImmutable(" файлов, "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("adMb"))),RemoteObject.createImmutable(" МБ, в индексе "),__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("adIndex"))));
 break; }
case 8: {
 BA.debugLineNum = 222;BA.debugLine="Return \"История: ожидает отправки \" & Extract";
Debug.ShouldStop(536870912);
...
;
 BA.debugLineNum = 225;BA.debugLine="Dim genericText As String = message";
Debug.ShouldStop(1);
_generictext = _message;Debug.locals.put("genericText", _generictext);Debug.locals.put("genericText", _generictext);
 BA.debugLineNum = 226;BA.debugLine="If details <> \"\" Then genericText = genericText &";
Debug.ShouldStop(2);
...
_generictext = RemoteObject.concat(_generictext,RemoteObject.createImmutable(". "),_details);Debug.locals.put("genericText", _generictext);};
 BA.debugLineNum = 227;BA.debugLine="Return genericText";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("BuildReasonText (playbacktraceformatter) ","playbacktraceformatter",7,__ref.getField(false, "ba"),__ref,288);
...
Debug.locals.put("details", _details);
 BA.debugLineNum = 288;BA.debugLine="Private Sub BuildReasonText(details As String) As";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 289;BA.debugLine="If details = \"\" Then Return \"\"";
Debug.ShouldStop(1);
if (RemoteObject.solveBoolean("=",_details,BA.ObjectToString(""))) { 
if (true) return BA.ObjectToString("");};
 BA.debugLineNum = 290;BA.debugLine="Dim messageText As String = ExtractDetailTail(det";
Debug.ShouldStop(2);
_messagetext = __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailtail" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("message")));Debug.locals.put("messageText", _messagetext);Debug.locals.put("messageText", _messagetext);
 BA.debugLineNum = 291;BA.debugLine="If messageText <> \"\" Then Return messageText";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("!",_messagetext,BA.ObjectToString(""))) { 
if (true) return _messagetext;};
 BA.debugLineNum = 292;BA.debugLine="Dim reasonText As String = ExtractDetailTail(deta";
Debug.ShouldStop(8);
_reasontext = __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailtail" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("reason")));Debug.locals.put("reasonText", _reasontext);Debug.locals.put("reasonText", _reasontext);
 BA.debugLineNum = 293;BA.debugLine="If reasonText <> \"\" Then Return \"Причина: \" & rea";
Debug.ShouldStop(16);
...
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Причина: "),_reasontext);};
 BA.debugLineNum = 294;BA.debugLine="Dim kindText As String = ExtractDetailValue(detai";
Debug.ShouldStop(32);
_kindtext = __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("kind")));Debug.locals.put("kindText", _kindtext);Debug.locals.put("kindText", _kindtext);
 BA.debugLineNum = 295;BA.debugLine="If kindText <> \"\" Then Return \"Причина: \" & kindT";
Debug.ShouldStop(64);
...
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Причина: "),_kindtext);};
 BA.debugLineNum = 296;BA.debugLine="Dim stepText As String = ExtractDetailValue(detai";
Debug.ShouldStop(128);
_steptext = __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("step")));Debug.locals.put("stepText", _steptext);Debug.locals.put("stepText", _steptext);
 BA.debugLineNum = 297;BA.debugLine="If stepText <> \"\" Then Return \"Шаг: \" & stepText";
Debug.ShouldStop(256);
...
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Шаг: "),_steptext);};
 BA.debugLineNum = 298;BA.debugLine="Dim resultText As String = ExtractDetailValue(det";
Debug.ShouldStop(512);
_resulttext = __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("result")));Debug.locals.put("resultText", _resulttext);Debug.locals.put("resultText", _resulttext);
 BA.debugLineNum = 299;BA.debugLine="If resultText <> \"\" Then Return \"Результат: \" & r";
Debug.ShouldStop(1024);
...
if (true) return RemoteObject.concat(RemoteObject.createImmutable("Результат: "),_resulttext);};
 BA.debugLineNum = 300;BA.debugLine="Return details";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("BuildVersionPlayerText (playbacktraceformatter) ","playbacktraceformatter",7,__ref.getField(false, "ba"),__ref,230);
...
RemoteObject _parts = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
Debug.locals.put("details", _details);
 BA.debugLineNum = 230;BA.debugLine="Private Sub BuildVersionPlayerText(details As Stri";
Debug.ShouldStop(32);
 BA.debugLineNum = 231;BA.debugLine="Dim versionText As String = ExtractDetailValue(de";
Debug.ShouldStop(64);
_versiontext = __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("version")));Debug.locals.put("versionText", _versiontext);Debug.locals.put("versionText", _versiontext);
 BA.debugLineNum = 232;BA.debugLine="Dim playerText As String = ExtractDetailValue(det";
Debug.ShouldStop(128);
_playertext = __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("player")));Debug.locals.put("playerText", _playertext);Debug.locals.put("playerText", _playertext);
 BA.debugLineNum = 233;BA.debugLine="Dim parts As List";
Debug.ShouldStop(256);
_parts = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("parts", _parts);
 BA.debugLineNum = 234;BA.debugLine="parts.Initialize";
Debug.ShouldStop(512);
_parts.runVoidMethod ("Initialize");
 BA.debugLineNum = 235;BA.debugLine="If versionText <> \"\" Then parts.Add(\"Версия \" & v";
Debug.ShouldStop(1024);
...
_parts.runVoidMethod ("Add",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Версия "),_versiontext))));};
 BA.debugLineNum = 236;BA.debugLine="If playerText <> \"\" Then parts.Add(\"Плеер \" & pla";
Debug.ShouldStop(2048);
...
_parts.runVoidMethod ("Add",(Object)((RemoteObject.concat(RemoteObject.createImmutable("Плеер "),_playertext))));};
 BA.debugLineNum = 237;BA.debugLine="If parts.Size = 0 Then Return \"Запуск\"";
Debug.ShouldStop(4096);
if (RemoteObject.solveBoolean("=",_parts.runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
if (true) return BA.ObjectToString("Запуск");};
 BA.debugLineNum = 238;BA.debugLine="Return JoinWords(parts)";
Debug.ShouldStop(8192);
if (true) return __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_joinwords" /*RemoteObject*/ ,(Object)(_parts));
...
try {
		Debug.PushSubsStack("DefaultIfEmpty (playbacktraceformatter) ","playbacktraceformatter",7,__ref.getField(false, "ba"),__ref,335);
...
Debug.locals.put("fallback", _fallback);
 BA.debugLineNum = 335;BA.debugLine="Private Sub DefaultIfEmpty(value As String, fallba";
Debug.ShouldStop(16384);
 BA.debugLineNum = 336;BA.debugLine="If value = \"\" Then Return fallback";
Debug.ShouldStop(32768);
if (RemoteObject.solveBoolean("=",_value,BA.ObjectToString(""))) { 
if (true) return _fallback;};
 BA.debugLineNum = 337;BA.debugLine="Return value";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("ExtractDetailTail (playbacktraceformatter) ","playbacktraceformatter",7,__ref.getField(false, "ba"),__ref,350);
...
Debug.locals.put("details", _details);
Debug.locals.put("key", _key);
 BA.debugLineNum = 350;BA.debugLine="Private Sub ExtractDetailTail(details As String, k";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 351;BA.debugLine="Dim marker As String = key & \"=\"";
Debug.ShouldStop(1073741824);
_marker = RemoteObject.concat(_key,RemoteObject.createImmutable("="));Debug.locals.put("marker", _marker);Debug.locals.put("marker", _marker);
 BA.debugLineNum = 352;BA.debugLine="Dim startIndex As Int = details.IndexOf(marker)";
Debug.ShouldStop(-2147483648);
_startindex = _details.runMethod(true,"indexOf",(Object)(_marker));Debug.locals.put("startIndex", _startindex);Debug.locals.put("startIndex", _startindex);
 BA.debugLineNum = 353;BA.debugLine="If startIndex < 0 Then Return \"\"";
Debug.ShouldStop(1);
if (RemoteObject.solveBoolean("<",_startindex,BA.numberCast(double.class, 0))) { 
if (true) return BA.ObjectToString("");};
 BA.debugLineNum = 354;BA.debugLine="Return details.SubString(startIndex + marker.Leng";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("ExtractDetailValue (playbacktraceformatter) ","playbacktraceformatter",7,__ref.getField(false, "ba"),__ref,340);
...
Debug.locals.put("details", _details);
Debug.locals.put("key", _key);
 BA.debugLineNum = 340;BA.debugLine="Private Sub ExtractDetailValue(details As String,";
Debug.ShouldStop(524288);
 BA.debugLineNum = 341;BA.debugLine="Dim marker As String = key & \"=\"";
Debug.ShouldStop(1048576);
_marker = RemoteObject.concat(_key,RemoteObject.createImmutable("="));Debug.locals.put("marker", _marker);Debug.locals.put("marker", _marker);
 BA.debugLineNum = 342;BA.debugLine="Dim startIndex As Int = details.IndexOf(marker)";
Debug.ShouldStop(2097152);
_startindex = _details.runMethod(true,"indexOf",(Object)(_marker));Debug.locals.put("startIndex", _startindex);Debug.locals.put("startIndex", _startindex);
 BA.debugLineNum = 343;BA.debugLine="If startIndex < 0 Then Return \"\"";
Debug.ShouldStop(4194304);
if (RemoteObject.solveBoolean("<",_startindex,BA.numberCast(double.class, 0))) { 
if (true) return BA.ObjectToString("");};
 BA.debugLineNum = 344;BA.debugLine="Dim value As String = details.SubString(startInde";
Debug.ShouldStop(8388608);
_value = _details.runMethod(true,"substring",(Object)(RemoteObject.solve(new RemoteObject[] {_startindex,_marker.runMethod(true,"length")}, "+",1, 1))).runMethod(true,"trim");Debug.locals.put("value", _value);Debug.locals.put("value", _value);
 BA.debugLineNum = 345;BA.debugLine="Dim nextSpace As Int = value.IndexOf(\" \")";
Debug.ShouldStop(16777216);
_nextspace = _value.runMethod(true,"indexOf",(Object)(RemoteObject.createImmutable(" ")));Debug.locals.put("nextSpace", _nextspace);Debug.locals.put("nextSpace", _nextspace);
 BA.debugLineNum = 346;BA.debugLine="If nextSpace >= 0 Then value = value.SubString2(0";
Debug.ShouldStop(33554432);
...
_value = _value.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(_nextspace));Debug.locals.put("value", _value);};
 BA.debugLineNum = 347;BA.debugLine="Return value.Trim";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("JoinWords (playbacktraceformatter) ","playbacktraceformatter",7,__ref.getField(false, "ba"),__ref,325);
...
int _i = 0;
Debug.locals.put("parts", _parts);
 BA.debugLineNum = 325;BA.debugLine="Private Sub JoinWords(parts As List) As String";
Debug.ShouldStop(16);
...
_sb.runVoidMethod ("Initialize");
 BA.debugLineNum = 328;BA.debugLine="For i = 0 To parts.Size - 1";
Debug.ShouldStop(128);
{
final int step3 = 1;
...
try {
		Debug.PushSubsStack("TraceItemLabelFromDetails (playbacktraceformatter) ","playbacktraceformatter",7,__ref.getField(false, "ba"),__ref,241);
...
Debug.locals.put("details", _details);
 BA.debugLineNum = 241;BA.debugLine="Private Sub TraceItemLabelFromDetails(details As S";
Debug.ShouldStop(65536);
 BA.debugLineNum = 242;BA.debugLine="Dim itemType As String = ExtractDetailValue(detai";
Debug.ShouldStop(131072);
_itemtype = __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("type")));Debug.locals.put("itemType", _itemtype);Debug.locals.put("itemType", _itemtype);
 BA.debugLineNum = 243;BA.debugLine="Dim itemId As String = DefaultIfEmpty(ExtractDeta";
Debug.ShouldStop(262144);
_itemid = __ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_defaultifempty" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("id")))),(Object)(__ref.runClassMethod (b4j.example.playbacktraceformatter.class, "_extractdetailvalue" /*RemoteObject*/ ,(Object)(_details),(Object)(RemoteObject.createImmutable("trackId")))));Debug.locals.put("itemId", _itemid);Debug.locals.put("itemId", _itemid);
 BA.debugLineNum = 244;BA.debugLine="If itemType = \"ad\" Then";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean("=",_itemtype,BA.ObjectToString("ad"))) { 
 BA.debugLineNum = 245;BA.debugLine="If itemId <> \"\" Then Return \"рекламу \" & itemId";
Debug.ShouldStop(1048576);
...
if (true) return RemoteObject.concat(RemoteObject.createImmutable("рекламу "),_itemid);};
 BA.debugLineNum = 246;BA.debugLine="Return \"рекламу\"";
Debug.ShouldStop(2097152);
if (true) return BA.ObjectToString("рекламу");
 };
 BA.debugLineNum = 248;BA.debugLine="If itemId <> \"\" Then Return \"трек \" & itemId";
Debug.ShouldStop(8388608);
if (RemoteObject.solveBoolean("!",_itemid,BA.ObjectToString(""))) { 
if (true) return RemoteObject.concat(RemoteObject.createImmutable("трек "),_itemid);};
 BA.debugLineNum = 249;BA.debugLine="Return \"трек\"";
Debug.ShouldStop(16777216);
