...
try {
		Debug.PushSubsStack("CreateB4XPageParent (b4xpagesmanager) ","b4xpagesmanager",32,__ref.getField(false, "ba"),__ref,600);
...
try {
		Debug.PushSubsStack("Initialize (b4xpagesmanager) ","b4xpagesmanager",32,__ref.getField(false, "ba"),__ref,57);
...
try {
		Debug.PushSubsStack("MainForm_Closed (b4xpagesmanager) ","b4xpagesmanager",32,__ref.getField(false, "ba"),__ref,440);
...
try {
		Debug.PushSubsStack("MainForm_CloseRequest (b4xpagesmanager) ","b4xpagesmanager",32,__ref.getField(false, "ba"),__ref,457);
...
try {
		Debug.PushSubsStack("MainForm_FocusChanged (b4xpagesmanager) ","b4xpagesmanager",32,__ref.getField(false, "ba"),__ref,431);
...
try {
		Debug.PushSubsStack("MainForm_IconifiedChanged (b4xpagesmanager) ","b4xpagesmanager",32,__ref.getField(false, "ba"),__ref,451);
...
try {
		Debug.PushSubsStack("MovePageToTop (b4xpagesmanager) ","b4xpagesmanager",32,__ref.getField(false, "ba"),__ref,413);
