...
Debug.JustUpdateDeviceLine();
b4xpagesmanager.__c.runVoidMethod ("LogImpl","915925251",(RemoteObject.concat(RemoteObject.createImmutable("Page with this id already exists: "),b4xpagesmanager.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_idtolower))),RemoteObject.createImmutable("!"))),0);
...
Debug.JustUpdateDeviceLine();
b4xpagesmanager.__c.runVoidMethod ("LogImpl","916187396",RemoteObject.createImmutable("Only top page can be closed"),0);
...
Debug.JustUpdateDeviceLine();
b4xpagesmanager.__c.runVoidMethod ("LogImpl","916187399",RemoteObject.createImmutable("First page cannot be closed"),0);
...
try {
		Debug.PushSubsStack("CreateB4XPageParent (b4xpagesmanager) ","b4xpagesmanager",14,__ref.getField(false, "ba"),__ref,600);
...
Debug.JustUpdateDeviceLine();
b4xpagesmanager.__c.runVoidMethod ("LogImpl","916842755",RemoteObject.concat(RemoteObject.createImmutable("Error: page id not found: "),_id),0);
 BA.debugLineNum = 402;BA.debugLine="Log(\"Ids: \" & IdToB4XPage.Keys) 'ignore";
Debug.JustUpdateDeviceLine();
b4xpagesmanager.__c.runVoidMethod ("LogImpl","916842756",RemoteObject.concat(RemoteObject.createImmutable("Ids: "),__ref.getField(false,"_idtob4xpage" /*RemoteObject*/ ).runClassMethod (b4j.example.b4xorderedmap.class, "_getkeys" /*RemoteObject*/ )),0);
 };
...
try {
		Debug.PushSubsStack("Initialize (b4xpagesmanager) ","b4xpagesmanager",14,__ref.getField(false, "ba"),__ref,57);
...
Debug.JustUpdateDeviceLine();
b4xpagesmanager.__c.runVoidMethod ("LogImpl","915859741",RemoteObject.createImmutable("Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events."),0);
 };
...
Debug.JustUpdateDeviceLine();
b4xpagesmanager.__c.runVoidMethod ("LogImpl","918022403",_msg,0);
 };
...
try {
		Debug.PushSubsStack("MainForm_Closed (b4xpagesmanager) ","b4xpagesmanager",14,__ref.getField(false, "ba"),__ref,440);
...
try {
		Debug.PushSubsStack("MainForm_CloseRequest (b4xpagesmanager) ","b4xpagesmanager",14,__ref.getField(false, "ba"),__ref,457);
...
try {
		Debug.PushSubsStack("MainForm_FocusChanged (b4xpagesmanager) ","b4xpagesmanager",14,__ref.getField(false, "ba"),__ref,431);
...
try {
		Debug.PushSubsStack("MainForm_IconifiedChanged (b4xpagesmanager) ","b4xpagesmanager",14,__ref.getField(false, "ba"),__ref,451);
...
try {
		Debug.PushSubsStack("MovePageToTop (b4xpagesmanager) ","b4xpagesmanager",14,__ref.getField(false, "ba"),__ref,413);
...
Debug.JustUpdateDeviceLine();
b4xpagesmanager.__c.runVoidMethod ("LogImpl","917498126",RemoteObject.createImmutable("Too many parameters"),0);
 break; }
}
;
...
Debug.JustUpdateDeviceLine();
b4xpagesmanager.__c.runVoidMethod ("LogImpl","917563662",RemoteObject.createImmutable("Too many parameters"),0);
 break; }
}
;
