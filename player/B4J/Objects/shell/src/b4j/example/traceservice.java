...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"debugResponsesDir",_ref.getField(false, "_debugresponsesdir"),"pendingTraceBatch",_ref.getField(false, "_pendingtracebatch"),"serverSnapshotLimit",_ref.getField(false, "_serversnapshotlimit"),"serverSnapshots",_ref.getField(false, "_serversnapshots"),"storageDir",_ref.getField(false, "_storagedir"),"traceLogLimit",_ref.getField(false, "_traceloglimit"),"traceLogs",_ref.getField(false, "_tracelogs")};
}
}