...
try {
		Debug.PushSubsStack("Initialize (playbackresponseadapter) ","playbackresponseadapter",17,__ref.getField(false, "ba"),__ref,7);
...
try {
		Debug.PushSubsStack("NormalizeQueueResponse (playbackresponseadapter) ","playbackresponseadapter",17,__ref.getField(false, "ba"),__ref,11);
...
try {
		Debug.PushSubsStack("NormalizeRetryAfter (playbackresponseadapter) ","playbackresponseadapter",17,__ref.getField(false, "ba"),__ref,27);
