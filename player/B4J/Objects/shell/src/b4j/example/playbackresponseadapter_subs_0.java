...
try {
		Debug.PushSubsStack("Initialize (playbackresponseadapter) ","playbackresponseadapter",13,__ref.getField(false, "ba"),__ref,7);
...
try {
		Debug.PushSubsStack("NormalizeQueueResponse (playbackresponseadapter) ","playbackresponseadapter",13,__ref.getField(false, "ba"),__ref,11);
...
Debug.locals.put("data", _data);
 BA.debugLineNum = 11;BA.debugLine="Public Sub NormalizeQueueResponse(data As Object)";
Debug.ShouldStop(1024);
 BA.debugLineNum = 12;BA.debugLine="If data Is Map Then";
Debug.ShouldStop(2048);
if (RemoteObject.solveBoolean("i",_data, RemoteObject.createImmutable("java.util.Map"))) { 
 BA.debugLineNum = 13;BA.debugLine="Dim m As Map = data";
...
_m = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _data);Debug.locals.put("m", _m);Debug.locals.put("m", _m);
 BA.debugLineNum = 14;BA.debugLine="Dim items As List = m.GetDefault(\"queue\", Null)";
...
_items = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _m.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("queue"))),(Object)(playbackresponseadapter.__c.getField(false,"Null"))));Debug.locals.put("items", _items);Debug.locals.put("items", _items);
 BA.debugLineNum = 15;BA.debugLine="If items.IsInitialized = False Then Return Null";
...
if (true) return RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), playbackresponseadapter.__c.getField(false,"Null"));};
 BA.debugLineNum = 16;BA.debugLine="Dim normalized As List";
...
_normalized = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("normalized", _normalized);
 BA.debugLineNum = 17;BA.debugLine="normalized.Initialize";
Debug.ShouldStop(65536);
_normalized.runVoidMethod ("Initialize");
 BA.debugLineNum = 18;BA.debugLine="For Each item As Object In items";
...
Debug.locals.put("item", _item);
 BA.debugLineNum = 19;BA.debugLine="If item Is Map Then normalized.Add(item)";
...
;
 BA.debugLineNum = 21;BA.debugLine="Return normalized";
...
try {
		Debug.PushSubsStack("NormalizeRetryAfter (playbackresponseadapter) ","playbackresponseadapter",13,__ref.getField(false, "ba"),__ref,27);
...
Debug.locals.put("data", _data);
 BA.debugLineNum = 27;BA.debugLine="Public Sub NormalizeRetryAfter(data As Object) As";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 28;BA.debugLine="If data Is Map Then";
Debug.ShouldStop(134217728);
if (RemoteObject.solveBoolean("i",_data, RemoteObject.createImmutable("java.util.Map"))) { 
 BA.debugLineNum = 29;BA.debugLine="Dim m As Map = data";
Debug.ShouldStop(268435456);
_m = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_m = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _data);Debug.locals.put("m", _m);Debug.locals.put("m", _m);
 BA.debugLineNum = 30;BA.debugLine="If m.ContainsKey(\"retry_after\") = False Then Ret";
...
if (true) return BA.numberCast(int.class, 0);};
 BA.debugLineNum = 31;BA.debugLine="Dim value As Int = m.Get(\"retry_after\")";
...
_value = BA.numberCast(int.class, _m.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("retry_after")))));Debug.locals.put("value", _value);Debug.locals.put("value", _value);
 BA.debugLineNum = 32;BA.debugLine="If value <= 0 Then Return 0";
Debug.ShouldStop(-2147483648);
if (RemoteObject.solveBoolean("k",_value,BA.numberCast(double.class, 0))) { 
if (true) return BA.numberCast(int.class, 0);};
 BA.debugLineNum = 33;BA.debugLine="Return value";
Debug.ShouldStop(1);
