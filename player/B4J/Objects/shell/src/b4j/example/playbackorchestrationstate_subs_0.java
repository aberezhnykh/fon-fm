...
try {
		Debug.PushSubsStack("BeginDispatch (playbackorchestrationstate) ","playbackorchestrationstate",17,__ref.getField(false, "ba"),__ref,87);
...
try {
		Debug.PushSubsStack("BeginQueueBackfill (playbackorchestrationstate) ","playbackorchestrationstate",17,__ref.getField(false, "ba"),__ref,76);
...
try {
		Debug.PushSubsStack("ClearTrackTransitionFlags (playbackorchestrationstate) ","playbackorchestrationstate",17,__ref.getField(false, "ba"),__ref,40);
...
try {
		Debug.PushSubsStack("EndDispatch (playbackorchestrationstate) ","playbackorchestrationstate",17,__ref.getField(false, "ba"),__ref,94);
...
try {
		Debug.PushSubsStack("EndQueueBackfill (playbackorchestrationstate) ","playbackorchestrationstate",17,__ref.getField(false, "ba"),__ref,82);
...
try {
		Debug.PushSubsStack("EnterInternalStoppingState (playbackorchestrationstate) ","playbackorchestrationstate",17,__ref.getField(false, "ba"),__ref,57);
...
try {
		Debug.PushSubsStack("EnterPolicyPausedState (playbackorchestrationstate) ","playbackorchestrationstate",17,__ref.getField(false, "ba"),__ref,62);
...
try {
		Debug.PushSubsStack("EnterStartedState (playbackorchestrationstate) ","playbackorchestrationstate",17,__ref.getField(false, "ba"),__ref,45);
...
try {
		Debug.PushSubsStack("EnterUserStoppedState (playbackorchestrationstate) ","playbackorchestrationstate",17,__ref.getField(false, "ba"),__ref,51);
...
try {
		Debug.PushSubsStack("ExitStoppingState (playbackorchestrationstate) ","playbackorchestrationstate",17,__ref.getField(false, "ba"),__ref,68);
...
try {
		Debug.PushSubsStack("Initialize (playbackorchestrationstate) ","playbackorchestrationstate",17,__ref.getField(false, "ba"),__ref,16);
...
try {
		Debug.PushSubsStack("IsPlaybackActive (playbackorchestrationstate) ","playbackorchestrationstate",17,__ref.getField(false, "ba"),__ref,72);
...
try {
		Debug.PushSubsStack("ResetToStopped (playbackorchestrationstate) ","playbackorchestrationstate",17,__ref.getField(false, "ba"),__ref,21);
...
try {
		Debug.PushSubsStack("ResetTransientFlags (playbackorchestrationstate) ","playbackorchestrationstate",17,__ref.getField(false, "ba"),__ref,32);
