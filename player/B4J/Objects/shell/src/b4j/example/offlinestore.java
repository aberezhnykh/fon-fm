...
public static RemoteObject _playerdatafilename = RemoteObject.createImmutable("");
public static RemoteObject _playlistrequirementsfilename = RemoteObject.createImmutable("");
public static RemoteObject _playlistsdirname = RemoteObject.createImmutable("");
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"playerDataFileName",_ref.getField(false, "_playerdatafilename"),"playlistCdnBaseUrl",_ref.getField(false, "_playlistcdnbaseurl"),"playlistRequirementsFileName",_ref.getField(false, "_playlistrequirementsfilename"),"playlistsDirName",_ref.getField(false, "_playlistsdirname"),"storage",_ref.getField(false, "_storage"),"storageDir",_ref.getField(false, "_storagedir"),"targetModule",_ref.getField(false, "_targetmodule"),"traceSubName",_ref.getField(false, "_tracesubname")};
}
}