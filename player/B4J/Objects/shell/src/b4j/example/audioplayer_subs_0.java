...
try {
		Debug.PushSubsStack("CallIfExists (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,180);
...
Debug.locals.put("subName", _subname);
 BA.debugLineNum = 180;BA.debugLine="Private Sub CallIfExists(subName As String)";
Debug.ShouldStop(524288);
 BA.debugLineNum = 181;BA.debugLine="If SubExists(targetModule, subName) Then";
...
if (audioplayer.__c.runMethod(true,"SubExists",__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_targetmodule" /*RemoteObject*/ )),(Object)(_subname)).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 182;BA.debugLine="CallSubDelayed(targetModule, subName)";
...
try {
		Debug.PushSubsStack("CheckTimer_Tick (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,191);
...
RemoteObject _positionnow = RemoteObject.createImmutable(0L);
 BA.debugLineNum = 191;BA.debugLine="Private Sub CheckTimer_Tick";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 192;BA.debugLine="If playerState <> STATE_PLAYING Then Return";
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 193;BA.debugLine="Dim positionNow As Long = Position";
Debug.ShouldStop(1);
_positionnow = __ref.runClassMethod (b4j.example.audioplayer.class, "_position" /*RemoteObject*/ );Debug.locals.put("positionNow", _positionnow);Debug.locals.put("positionNow", _positionnow);
 BA.debugLineNum = 194;BA.debugLine="If positionNow = lastPosition Then";
Debug.ShouldStop(2);
if (RemoteObject.solveBoolean("=",_positionnow,__ref.getField(true,"_lastposition" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 195;BA.debugLine="NotifyError(\"Silence detected 1\")";
Debug.ShouldStop(4);
__ref.runClassMethod (b4j.example.audioplayer.class, "_notifyerror" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("Silence detected 1")));
 ...
 BA.debugLineNum = 197;BA.debugLine="lastPosition = positionNow";
Debug.ShouldStop(16);
...
audioplayer._playerstate = RemoteObject.createImmutable(0);__ref.setField("_playerstate",audioplayer._playerstate);
 //BA.debugLineNum = 16;BA.debugLine="Private maxVolume As Int";
...
try {
		Debug.PushSubsStack("Duration (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,135);
if (RapidSub.canDelegate("duration")) { return __ref.runUserSub(false, "audioplayer","duration", __ref);}
 BA.debugLineNum = 135;BA.debugLine="Public Sub Duration As Long";
Debug.ShouldStop(64);
 BA.debugLineNum = 136;BA.debugLine="If player.IsInitialized = False Then Return 0";
...
try { BA.debugLineNum = 138;BA.debugLine="Return player.Duration";
...
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(long.class, __ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"getDuration"));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e5.toString()); BA.debugLineNum = 140;BA.debugLine="Return 0";
...
try {
		Debug.PushSubsStack("Error_Event (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,150);
...
Debug.locals.put("args", _args);
 BA.debugLineNum = 150;BA.debugLine="Private Sub Error_Event(methodName As String, args";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 151;BA.debugLine="Dim msg As String = \"\"";
Debug.ShouldStop(4194304);
_msg = BA.ObjectToString("");Debug.locals.put("msg", _msg);Debug.locals.put("msg", _msg);
 BA.debugLineNum = 152;BA.debugLine="Try";
Debug.ShouldStop(8388608);
try { BA.debugLineNum = 153;BA.debugLine="msg = jo.RunMethod(\"getError\", Null)";
...
_msg = BA.ObjectToString(__ref.getField(false,"_jo" /*RemoteObject*/ ).runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getError")),(Object)((audioplayer.__c.getField(false,"Null")))));Debug.locals.put("msg", _msg);
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e5.toString()); BA.debugLineNum = 155;BA.debugLine="msg = LastException.Message";
...
_msg = audioplayer.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage");Debug.locals.put("msg", _msg);
 ...
 BA.debugLineNum = 157;BA.debugLine="NotifyError(msg)";
...
try {
		Debug.PushSubsStack("FadeTimer_Tick (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,206);
...
RemoteObject _nextvolume = RemoteObject.createImmutable(0);
 BA.debugLineNum = 206;BA.debugLine="Private Sub FadeTimer_Tick";
Debug.ShouldStop(8192);
 BA.debugLineNum = 207;BA.debugLine="If player.IsInitialized = False Then";
Debug.ShouldStop(16384);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
 BA.debugLineNum = 208;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(32768);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 209;BA.debugLine="fadeMode = FADE_NONE";
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 212;BA.debugLine="Dim nextVolume As Double = currentVolume + fadeSt";
Debug.ShouldStop(524288);
_nextvolume = RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_currentvolume" /*RemoteObject*/ ),__ref.getField(true,"_fadestepvolume" /*RemoteObject*/ )}, "+",1, 0);Debug.locals.put("nextVolume", _nextvolume);Debug.locals.put("nextVolume", _nextvolume);
 BA.debugLineNum = 213;BA.debugLine="If fadeMode = FADE_IN Then";
Debug.ShouldStop(1048576);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_fademode" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_fade_in" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 214;BA.debugLine="If nextVolume >= fadeTargetVolume Then";
Debug.ShouldStop(2097152);
if (RemoteObject.solveBoolean("g",_nextvolume,__ref.getField(true,"_fadetargetvolume" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 215;BA.debugLine="nextVolume = fadeTargetVolume";
Debug.ShouldStop(4194304);
_nextvolume = __ref.getField(true,"_fadetargetvolume" /*RemoteObject*/ );Debug.locals.put("nextVolume", _nextvolume);
 BA.debugLineNum = 216;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(8388608);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 217;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(16777216);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 };
 }else 
{ BA.debugLineNum = 219;BA.debugLine="Else If fadeMode = FADE_OUT Then";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_fademode" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_fade_out" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 220;BA.debugLine="If nextVolume <= fadeTargetVolume Then";
Debug.ShouldStop(134217728);
if (RemoteObject.solveBoolean("k",_nextvolume,__ref.getField(true,"_fadetargetvolume" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 221;BA.debugLine="nextVolume = fadeTargetVolume";
Debug.ShouldStop(268435456);
_nextvolume = __ref.getField(true,"_fadetargetvolume" /*RemoteObject*/ );Debug.locals.put("nextVolume", _nextvolume);
 BA.debugLineNum = 222;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(536870912);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 223;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(1073741824);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 };
 }}
;
 BA.debugLineNum = 226;BA.debugLine="SetPlayerVolume(nextVolume)";
Debug.ShouldStop(2);
__ref.runClassMethod (b4j.example.audioplayer.class, "_setplayervolume" /*RemoteObject*/ ,(Object)(_nextvolume));
 BA.debugLineNum = 227;BA.debugLine="If fadeMode = FADE_NONE And nextVolume <= 0 Then";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_fademode" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_fade_none" /*RemoteObject*/ ))) && RemoteObject.solveBoolean("k",_nextvolume,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 228;BA.debugLine="StopImmediately";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("IsLoading (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,114);
if (RapidSub.canDelegate("isloading")) { return __ref.runUserSub(false, "audioplayer","isloading", __ref);}
 BA.debugLineNum = 114;BA.debugLine="Public Sub IsLoading As Boolean";
Debug.ShouldStop(131072);
 BA.debugLineNum = 115;BA.debugLine="Return playerState = STATE_LOADING";
...
try {
		Debug.PushSubsStack("IsPlaying (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,122);
if (RapidSub.canDelegate("isplaying")) { return __ref.runUserSub(false, "audioplayer","isplaying", __ref);}
 BA.debugLineNum = 122;BA.debugLine="Public Sub IsPlaying As Boolean";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 123;BA.debugLine="Return playerState = STATE_PLAYING";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("IsReady (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,118);
if (RapidSub.canDelegate("isready")) { return __ref.runUserSub(false, "audioplayer","isready", __ref);}
 BA.debugLineNum = 118;BA.debugLine="Public Sub IsReady As Boolean";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 119;BA.debugLine="Return playerState = STATE_READY";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("IsStopped (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,110);
if (RapidSub.canDelegate("isstopped")) { return __ref.runUserSub(false, "audioplayer","isstopped", __ref);}
 BA.debugLineNum = 110;BA.debugLine="Public Sub IsStopped As Boolean";
Debug.ShouldStop(8192);
 BA.debugLineNum = 111;BA.debugLine="Return playerState = STATE_STOPPED";
Debug.ShouldStop(16384);
...
try {
		Debug.PushSubsStack("LoadTimer_Tick (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,201);
if (RapidSub.canDelegate("loadtimer_tick")) { return __ref.runUserSub(false, "audioplayer","loadtimer_tick", __ref);}
 BA.debugLineNum = 201;BA.debugLine="Private Sub LoadTimer_Tick";
Debug.ShouldStop(256);
 BA.debugLineNum = 202;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(512);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 203;BA.debugLine="NotifyError(\"Track loading timeout expired\")";
...
try {
		Debug.PushSubsStack("LoadUrl (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,32);
...
Debug.locals.put("volume", _volume);
 BA.debugLineNum = 32;BA.debugLine="Public Sub LoadUrl(url As String, volume As Int)";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 33;BA.debugLine="Reset";
Debug.ShouldStop(1);
__ref.runClassMethod (b4j.example.audioplayer.class, "_reset" /*RemoteObject*/ );
 BA.debugLineNum = 34;BA.debugLine="loadTimer.Interval = 10 * DateTime.TicksPerSecond";
Debug.ShouldStop(2);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setInterval",RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(10),audioplayer.__c.getField(false,"DateTime").getField(true,"TicksPerSecond")}, "*",0, 2));
 BA.debugLineNum = 35;BA.debugLine="loadTimer.Enabled = True";
Debug.ShouldStop(4);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"True"));
 BA.debugLineNum = 36;BA.debugLine="playerState = STATE_LOADING";
Debug.ShouldStop(8);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_loading" /*RemoteObject*/ ));
 BA.debugLineNum = 37;BA.debugLine="maxVolume = Max(0, Min(100, volume))";
Debug.ShouldStop(16);
__ref.setField ("_maxvolume" /*RemoteObject*/ ,BA.numberCast(int.class, audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(audioplayer.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, 100)),(Object)(BA.numberCast(double.class, _volume)))))));
 BA.debugLineNum = 38;BA.debugLine="Try";
Debug.ShouldStop(32);
try { BA.debugLineNum = 39;BA.debugLine="player.Initialize(\"Player\", url)";
Debug.ShouldStop(64);
__ref.getField(false,"_player" /*RemoteObject*/ ).runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("Player")),(Object)(_url));
 BA.debugLineNum = 40;BA.debugLine="jo = player";
Debug.ShouldStop(128);
__ref.getField(false,"_jo" /*RemoteObject*/ ).setObject (__ref.getField(false,"_player" /*RemoteObject*/ ).getObject());
 BA.debugLineNum = 41;BA.debugLine="jo.RunMethod(\"setOnError\", Array As Object(jo.Cr";
Debug.ShouldStop(256);
__ref.getField(false,"_jo" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setOnError")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.getField(false,"_jo" /*RemoteObject*/ ).runMethod(false,"CreateEventFromUI",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("java.lang.Runnable")),(Object)(BA.ObjectToString("Error")),(Object)((audioplayer.__c.getField(true,"False"))))})));
 BA.debugLineNum = 42;BA.debugLine="jo.RunMethod(\"setOnReady\", Array As Object(jo.Cr";
Debug.ShouldStop(512);
__ref.getField(false,"_jo" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setOnReady")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.getField(false,"_jo" /*RemoteObject*/ ).runMethod(false,"CreateEventFromUI",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("java.lang.Runnable")),(Object)(BA.ObjectToString("Ready")),(Object)((audioplayer.__c.getField(true,"False"))))})));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e12.toString()); BA.debugLineNum = 44;BA.debugLine="NotifyError(LastException.Message)";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("NotifyError (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,172);
...
Debug.locals.put("message", _message);
 BA.debugLineNum = 172;BA.debugLine="Private Sub NotifyError(message As String)";
Debug.ShouldStop(2048);
 BA.debugLineNum = 173;BA.debugLine="Reset";
Debug.ShouldStop(4096);
__ref.runClassMethod (b4j.example.audioplayer.class, "_reset" /*RemoteObject*/ );
 BA.debugLineNum = 174;BA.debugLine="Dim subName As String = eventName & \"_Error\"";
Debug.ShouldStop(8192);
_subname = RemoteObject.concat(__ref.getField(true,"_eventname" /*RemoteObject*/ ),RemoteObject.createImmutable("_Error"));Debug.locals.put("subName", _subname);Debug.locals.put("subName", _subname);
 BA.debugLineNum = 175;BA.debugLine="If SubExists(targetModule, subName) Then";
Debug.ShouldStop(16384);
if (audioplayer.__c.runMethod(true,"SubExists",__ref.getField(false, "ba"),(Object)(__ref.getField(false,"_targetmodule" /*RemoteObject*/ )),(Object)(_subname)).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 176;BA.debugLine="CallSubDelayed2(targetModule, subName, message)";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("Play (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,48);
if (RapidSub.canDelegate("play")) { return __ref.runUserSub(false, "audioplayer","play", __ref);}
 BA.debugLineNum = 48;BA.debugLine="Public Sub Play";
Debug.ShouldStop(32768);
 BA.debugLineNum = 49;BA.debugLine="PlayWithFade(0)";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("Player_Complete (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,160);
if (RapidSub.canDelegate("player_complete")) { return __ref.runUserSub(false, "audioplayer","player_complete", __ref);}
 BA.debugLineNum = 160;BA.debugLine="Private Sub Player_Complete";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 161;BA.debugLine="If playerState = STATE_STOPPED Then Return";
Debug.ShouldStop(1);
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 162;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(2);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 163;BA.debugLine="checkTimer.Enabled = False";
Debug.ShouldStop(4);
__ref.getField(false,"_checktimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 164;BA.debugLine="timeUpdateTimer.Enabled = False";
Debug.ShouldStop(8);
__ref.getField(false,"_timeupdatetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 165;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(16);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 166;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(32);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 BA.debugLineNum = 167;BA.debugLine="currentVolume = 0";
Debug.ShouldStop(64);
__ref.setField ("_currentvolume" /*RemoteObject*/ ,BA.numberCast(double.class, 0));
 BA.debugLineNum = 168;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(128);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 169;BA.debugLine="CallIfExists(eventName & \"_Complete\")";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("PlayWithFade (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,52);
...
Debug.locals.put("fadeTimeMs", _fadetimems);
 BA.debugLineNum = 52;BA.debugLine="Public Sub PlayWithFade(fadeTimeMs As Int)";
Debug.ShouldStop(524288);
 BA.debugLineNum = 53;BA.debugLine="If playerState <> STATE_READY Then Return";
Debug.ShouldStop(1048576);
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 54;BA.debugLine="playerState = STATE_PLAYING";
Debug.ShouldStop(2097152);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_playing" /*RemoteObject*/ ));
 BA.debugLineNum = 55;BA.debugLine="lastPosition = 0";
Debug.ShouldStop(4194304);
__ref.setField ("_lastposition" /*RemoteObject*/ ,BA.numberCast(long.class, 0));
 BA.debugLineNum = 56;BA.debugLine="checkTimer.Enabled = True";
Debug.ShouldStop(8388608);
__ref.getField(false,"_checktimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"True"));
 BA.debugLineNum = 57;BA.debugLine="timeUpdateTimer.Enabled = True";
Debug.ShouldStop(16777216);
__ref.getField(false,"_timeupdatetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"True"));
 BA.debugLineNum = 58;BA.debugLine="player.Play";
Debug.ShouldStop(33554432);
__ref.getField(false,"_player" /*RemoteObject*/ ).runVoidMethod ("Play");
 BA.debugLineNum = 59;BA.debugLine="If fadeTimeMs > 0 Then";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean(">",_fadetimems,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 60;BA.debugLine="SetPlayerVolume(0)";
Debug.ShouldStop(134217728);
__ref.runClassMethod (b4j.example.audioplayer.class, "_setplayervolume" /*RemoteObject*/ ,(Object)(BA.numberCast(double.class, 0)));
 BA.debugLineNum = 61;BA.debugLine="StartFade(FADE_IN, maxVolume / 100, fadeTimeMs)";
Debug.ShouldStop(268435456);
__ref.runClassMethod (b4j.example.audioplayer.class, "_startfade" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_fade_in" /*RemoteObject*/ )),(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_maxvolume" /*RemoteObject*/ ),RemoteObject.createImmutable(100)}, "/",0, 0)),(Object)(_fadetimems));
 }else {
 BA.debugLineNum = 63;BA.debugLine="SetPlayerVolume(maxVolume / 100)";
Debug.ShouldStop(1073741824);
__ref.runClassMethod (b4j.example.audioplayer.class, "_setplayervolume" /*RemoteObject*/ ,(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_maxvolume" /*RemoteObject*/ ),RemoteObject.createImmutable(100)}, "/",0, 0)));
 };
...
try {
		Debug.PushSubsStack("Position (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,126);
if (RapidSub.canDelegate("position")) { return __ref.runUserSub(false, "audioplayer","position", __ref);}
 BA.debugLineNum = 126;BA.debugLine="Public Sub Position As Long";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 127;BA.debugLine="If player.IsInitialized = False Then Return 0";
Debug.ShouldStop(1073741824);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
if (true) return BA.numberCast(long.class, 0);};
 BA.debugLineNum = 128;BA.debugLine="Try";
Debug.ShouldStop(-2147483648);
try { BA.debugLineNum = 129;BA.debugLine="Return player.Position";
Debug.ShouldStop(1);
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(long.class, __ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"getPosition"));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e5.toString()); BA.debugLineNum = 131;BA.debugLine="Return 0";
Debug.ShouldStop(4);
if (true) return BA.numberCast(long.class, 0);
 };
...
try {
		Debug.PushSubsStack("Ready_Event (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,144);
if (RapidSub.canDelegate("ready_event")) { return __ref.runUserSub(false, "audioplayer","ready_event", __ref, _methodname, _args);}
Debug.locals.put("methodName", _methodname);
Debug.locals.put("args", _args);
 BA.debugLineNum = 144;BA.debugLine="Private Sub Ready_Event(methodName As String, args";
Debug.ShouldStop(32768);
 BA.debugLineNum = 145;BA.debugLine="playerState = STATE_READY";
Debug.ShouldStop(65536);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_ready" /*RemoteObject*/ ));
 BA.debugLineNum = 146;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(131072);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 147;BA.debugLine="CallIfExists(eventName & \"_Ready\")";
Debug.ShouldStop(262144);
...
try {
		Debug.PushSubsStack("Reset (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,84);
if (RapidSub.canDelegate("reset")) { return __ref.runUserSub(false, "audioplayer","reset", __ref);}
 BA.debugLineNum = 84;BA.debugLine="Public Sub Reset";
Debug.ShouldStop(524288);
 BA.debugLineNum = 85;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(1048576);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 86;BA.debugLine="checkTimer.Enabled = False";
Debug.ShouldStop(2097152);
__ref.getField(false,"_checktimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 87;BA.debugLine="timeUpdateTimer.Enabled = False";
Debug.ShouldStop(4194304);
__ref.getField(false,"_timeupdatetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 88;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(8388608);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 89;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(16777216);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 BA.debugLineNum = 90;BA.debugLine="lastPosition = 0";
Debug.ShouldStop(33554432);
__ref.setField ("_lastposition" /*RemoteObject*/ ,BA.numberCast(long.class, 0));
 BA.debugLineNum = 91;BA.debugLine="currentVolume = 0";
Debug.ShouldStop(67108864);
__ref.setField ("_currentvolume" /*RemoteObject*/ ,BA.numberCast(double.class, 0));
 BA.debugLineNum = 92;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(134217728);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 93;BA.debugLine="If player.IsInitialized Then";
Debug.ShouldStop(268435456);
...
Debug.ShouldStop(536870912);
try { BA.debugLineNum = 95;BA.debugLine="player.Volume = 0";
Debug.ShouldStop(1073741824);
__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"setVolume",BA.numberCast(double.class, 0));
 BA.debugLineNum = 96;BA.debugLine="player.Stop";
Debug.ShouldStop(-2147483648);
__ref.getField(false,"_player" /*RemoteObject*/ ).runVoidMethod ("Stop");
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e14) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e14.toString()); BA.debugLineNum = 98;BA.debugLine="Log(LastException.Message)";
Debug.ShouldStop(2);
audioplayer.__c.runVoidMethod ("LogImpl","720905998",audioplayer.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage"),0);
 };
 BA.debugLineNum = 100;BA.debugLine="If jo.IsInitialized Then";
Debug.ShouldStop(8);
...
Debug.ShouldStop(16);
try { BA.debugLineNum = 102;BA.debugLine="jo.RunMethod(\"dispose\", Null)";
Debug.ShouldStop(32);
__ref.getField(false,"_jo" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("dispose")),(Object)((audioplayer.__c.getField(false,"Null"))));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e20.toString()); BA.debugLineNum = 104;BA.debugLine="Log(LastException.Message)";
Debug.ShouldStop(128);
audioplayer.__c.runVoidMethod ("LogImpl","720906004",audioplayer.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage"),0);
 };
 };
 };
...
try {
		Debug.PushSubsStack("SetPlayerVolume (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,249);
...
Debug.locals.put("volumeValue", _volumevalue);
 BA.debugLineNum = 249;BA.debugLine="Private Sub SetPlayerVolume(volumeValue As Double)";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 250;BA.debugLine="currentVolume = Max(0, Min(1, volumeValue))";
Debug.ShouldStop(33554432);
__ref.setField ("_currentvolume" /*RemoteObject*/ ,audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(audioplayer.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, 1)),(Object)(_volumevalue)))));
 BA.debugLineNum = 251;BA.debugLine="If player.IsInitialized = False Then Return";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 252;BA.debugLine="Try";
Debug.ShouldStop(134217728);
try { BA.debugLineNum = 253;BA.debugLine="player.Volume = currentVolume";
Debug.ShouldStop(268435456);
__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"setVolume",__ref.getField(true,"_currentvolume" /*RemoteObject*/ ));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e6.toString()); BA.debugLineNum = 255;BA.debugLine="Log(LastException.Message)";
Debug.ShouldStop(1073741824);
audioplayer.__c.runVoidMethod ("LogImpl","722413318",audioplayer.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage"),0);
 };
...
try {
		Debug.PushSubsStack("StartFade (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,232);
...
Debug.locals.put("fadeTimeMs", _fadetimems);
 BA.debugLineNum = 232;BA.debugLine="Private Sub StartFade(mode As Int, targetVolume As";
Debug.ShouldStop(128);
 BA.debugLineNum = 233;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(256);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 234;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(512);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 BA.debugLineNum = 235;BA.debugLine="If player.IsInitialized = False Then Return";
Debug.ShouldStop(1024);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 236;BA.debugLine="If fadeTimeMs <= 0 Then";
Debug.ShouldStop(2048);
if (RemoteObject.solveBoolean("k",_fadetimems,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 237;BA.debugLine="SetPlayerVolume(targetVolume)";
Debug.ShouldStop(4096);
__ref.runClassMethod (b4j.example.audioplayer.class, "_setplayervolume" /*RemoteObject*/ ,(Object)(_targetvolume));
 BA.debugLineNum = 238;BA.debugLine="If targetVolume <= 0 Then StopImmediately";
Debug.ShouldStop(8192);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 241;BA.debugLine="Dim intervalMs As Int = Max(20, fadeTimer.Interva";
Debug.ShouldStop(65536);
_intervalms = BA.numberCast(int.class, audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 20)),(Object)(BA.numberCast(double.class, __ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"getInterval")))));Debug.locals.put("intervalMs", _intervalms);Debug.locals.put("intervalMs", _intervalms);
 BA.debugLineNum = 242;BA.debugLine="Dim steps As Int = Max(1, Ceil(fadeTimeMs / inter";
Debug.ShouldStop(131072);
_steps = BA.numberCast(int.class, audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 1)),(Object)(audioplayer.__c.runMethod(true,"Ceil",(Object)(RemoteObject.solve(new RemoteObject[] {_fadetimems,_intervalms}, "/",0, 0))))));Debug.locals.put("steps", _steps);Debug.locals.put("steps", _steps);
 BA.debugLineNum = 243;BA.debugLine="fadeMode = mode";
Debug.ShouldStop(262144);
__ref.setField ("_fademode" /*RemoteObject*/ ,_mode);
 BA.debugLineNum = 244;BA.debugLine="fadeTargetVolume = targetVolume";
Debug.ShouldStop(524288);
__ref.setField ("_fadetargetvolume" /*RemoteObject*/ ,_targetvolume);
 BA.debugLineNum = 245;BA.debugLine="fadeStepVolume = (targetVolume - currentVolume) /";
Debug.ShouldStop(1048576);
__ref.setField ("_fadestepvolume" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_targetvolume,__ref.getField(true,"_currentvolume" /*RemoteObject*/ )}, "-",1, 0)),_steps}, "/",0, 0));
 BA.debugLineNum = 246;BA.debugLine="fadeTimer.Enabled = True";
Debug.ShouldStop(2097152);
...
try {
		Debug.PushSubsStack("Stop (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,67);
if (RapidSub.canDelegate("stop")) { return __ref.runUserSub(false, "audioplayer","stop", __ref, _fadetimems);}
Debug.locals.put("fadeTimeMs", _fadetimems);
 BA.debugLineNum = 67;BA.debugLine="Public Sub Stop(fadeTimeMs As Int)";
Debug.ShouldStop(4);
 BA.debugLineNum = 68;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(8);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 69;BA.debugLine="checkTimer.Enabled = False";
Debug.ShouldStop(16);
__ref.getField(false,"_checktimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 70;BA.debugLine="timeUpdateTimer.Enabled = False";
Debug.ShouldStop(32);
__ref.getField(false,"_timeupdatetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 71;BA.debugLine="lastPosition = 0";
Debug.ShouldStop(64);
__ref.setField ("_lastposition" /*RemoteObject*/ ,BA.numberCast(long.class, 0));
 BA.debugLineNum = 72;BA.debugLine="If player.IsInitialized = False Then";
Debug.ShouldStop(128);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
 BA.debugLineNum = 73;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(256);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 76;BA.debugLine="If fadeTimeMs > 0 And currentVolume > 0 Then";
Debug.ShouldStop(2048);
if (RemoteObject.solveBoolean(">",_fadetimems,BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean(">",__ref.getField(true,"_currentvolume" /*RemoteObject*/ ),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 77;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(4096);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 78;BA.debugLine="StartFade(FADE_OUT, 0, fadeTimeMs)";
Debug.ShouldStop(8192);
__ref.runClassMethod (b4j.example.audioplayer.class, "_startfade" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_fade_out" /*RemoteObject*/ )),(Object)(BA.numberCast(double.class, 0)),(Object)(_fadetimems));
 ...
 BA.debugLineNum = 80;BA.debugLine="StopImmediately";
Debug.ShouldStop(32768);
__ref.runClassMethod (b4j.example.audioplayer.class, "_stopimmediately" /*RemoteObject*/ );
 };
...
try {
		Debug.PushSubsStack("StopImmediately (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,259);
if (RapidSub.canDelegate("stopimmediately")) { return __ref.runUserSub(false, "audioplayer","stopimmediately", __ref);}
 BA.debugLineNum = 259;BA.debugLine="Private Sub StopImmediately";
Debug.ShouldStop(4);
 BA.debugLineNum = 260;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(8);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 261;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(16);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 BA.debugLineNum = 262;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(32);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 263;BA.debugLine="currentVolume = 0";
Debug.ShouldStop(64);
__ref.setField ("_currentvolume" /*RemoteObject*/ ,BA.numberCast(double.class, 0));
 BA.debugLineNum = 264;BA.debugLine="If player.IsInitialized = False Then Return";
Debug.ShouldStop(128);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 265;BA.debugLine="Try";
Debug.ShouldStop(256);
try { BA.debugLineNum = 266;BA.debugLine="player.Volume = 0";
Debug.ShouldStop(512);
__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"setVolume",BA.numberCast(double.class, 0));
 BA.debugLineNum = 267;BA.debugLine="player.Stop";
Debug.ShouldStop(1024);
__ref.getField(false,"_player" /*RemoteObject*/ ).runVoidMethod ("Stop");
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e10) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e10.toString()); BA.debugLineNum = 269;BA.debugLine="Log(LastException.Message)";
Debug.ShouldStop(4096);
audioplayer.__c.runVoidMethod ("LogImpl","722478858",audioplayer.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage"),0);
 };
...
try {
		Debug.PushSubsStack("TimeUpdateTimer_Tick (audioplayer) ","audioplayer",2,__ref.getField(false, "ba"),__ref,186);
if (RapidSub.canDelegate("timeupdatetimer_tick")) { return __ref.runUserSub(false, "audioplayer","timeupdatetimer_tick", __ref);}
 BA.debugLineNum = 186;BA.debugLine="Private Sub TimeUpdateTimer_Tick";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 187;BA.debugLine="If playerState <> STATE_PLAYING Then Return";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_playerstate" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_playing" /*RemoteObject*/ )))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 188;BA.debugLine="CallIfExists(eventName & \"_Timeupdate\")";
Debug.ShouldStop(134217728);
