...
try {
		Debug.PushSubsStack("CheckTimer_Tick (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,241);
...
RemoteObject _remainms = RemoteObject.createImmutable(0L);
 BA.debugLineNum = 241;BA.debugLine="Private Sub CheckTimer_Tick";
Debug.ShouldStop(65536);
 BA.debugLineNum = 242;BA.debugLine="If playerState <> STATE_PLAYING Then Return";
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 243;BA.debugLine="Dim positionNow As Long = Position";
...
_positionnow = __ref.runClassMethod (b4j.example.audioplayer.class, "_position" /*RemoteObject*/ );Debug.locals.put("positionNow", _positionnow);Debug.locals.put("positionNow", _positionnow);
 BA.debugLineNum = 244;BA.debugLine="If positionNow > lastPosition Then";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean(">",_positionnow,__ref.getField(true,"_lastposition" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 245;BA.debugLine="lastPosition = positionNow";
Debug.ShouldStop(1048576);
__ref.setField ("_lastposition" /*RemoteObject*/ ,_positionnow);
 BA.debugLineNum = 246;BA.debugLine="stalledCheckCount = 0";
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 249;BA.debugLine="Dim durationNow As Long = Duration";
...
_durationnow = __ref.runClassMethod (b4j.example.audioplayer.class, "_duration" /*RemoteObject*/ );Debug.locals.put("durationNow", _durationnow);Debug.locals.put("durationNow", _durationnow);
 BA.debugLineNum = 250;BA.debugLine="Dim remainMs As Long = -1";
...
_remainms = BA.numberCast(long.class, -(double) (0 + 1));Debug.locals.put("remainMs", _remainms);Debug.locals.put("remainMs", _remainms);
 BA.debugLineNum = 251;BA.debugLine="If durationNow > 0 Then remainMs = Max(0, duratio";
...
_remainms = BA.numberCast(long.class, audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {_durationnow,_positionnow}, "-",1, 2)))));Debug.locals.put("remainMs", _remainms);};
 BA.debugLineNum = 252;BA.debugLine="If durationNow > 0 And positionNow >= Max(0, dura";
...
if (RemoteObject.solveBoolean(">",_durationnow,BA.numberCast(long.class, 0)) && RemoteObject.solveBoolean("g",_positionnow,BA.numberCast(long.class, audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {_durationnow,RemoteObject.createImmutable(2000)}, "-",1, 2))))))) { 
 BA.debugLineNum = 253;BA.debugLine="TraceDiagnostic(\"хвост audio=\" & eventName & \" p";
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 256;BA.debugLine="stalledCheckCount = stalledCheckCount + 1";
...
__ref.setField ("_stalledcheckcount" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_stalledcheckcount" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1));
 BA.debugLineNum = 257;BA.debugLine="If stalledCheckCount = 1 Or stalledCheckCount = 3";
Debug.ShouldStop(1);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_stalledcheckcount" /*RemoteObject*/ ),BA.numberCast(double.class, 1)) || RemoteObject.solveBoolean("=",__ref.getField(true,"_stalledcheckcount" /*RemoteObject*/ ),BA.numberCast(double.class, 3))) { 
 BA.debugLineNum = 258;BA.debugLine="TraceDiagnostic(\"задержка audio=\" & eventName &";
Debug.ShouldStop(2);
__ref.runClassMethod (b4j.example.audioplayer.class, "_tracediagnostic" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("задержка audio="),__ref.getField(true,"_eventname" /*RemoteObject*/ ),RemoteObject.createImmutable(" positionMs="),_positionnow,RemoteObject.createImmutable(" durationMs="),_durationnow,RemoteObject.createImmutable(" remainMs="),_remainms,RemoteObject.createImmutable(" stalled="),__ref.getField(true,"_stalledcheckcount" /*RemoteObject*/ ))));
 ...
 BA.debugLineNum = 260;BA.debugLine="If stalledCheckCount < SILENCE_STALL_THRESHOLD Th";
Debug.ShouldStop(8);
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 261;BA.debugLine="NotifyError(\"Silence detected \" & SILENCE_STALL_T";
Debug.ShouldStop(16);
...
public static RemoteObject  _class_globals(RemoteObject __ref) throws Exception{
 ...
 //BA.debugLineNum = 8;BA.debugLine="Private Const STATE_STOPPED = 0, STATE_LOADING =";
...
audioplayer._state_playing = BA.numberCast(int.class, 3);__ref.setField("_state_playing",audioplayer._state_playing);
 //BA.debugLineNum = 9;BA.debugLine="Private Const FADE_NONE = 0, FADE_IN = 1, FADE_OU";
...
audioplayer._fade_out = BA.numberCast(int.class, 2);__ref.setField("_fade_out",audioplayer._fade_out);
 //BA.debugLineNum = 10;BA.debugLine="Private Const CHECK_TIMER_INTERVAL_MS As Int = 20";
audioplayer._check_timer_interval_ms = BA.numberCast(int.class, 2000);__ref.setField("_check_timer_interval_ms",audioplayer._check_timer_interval_ms);
 //BA.debugLineNum = 11;BA.debugLine="Private Const SILENCE_STALL_THRESHOLD As Int = 3";
audioplayer._silence_stall_threshold = BA.numberCast(int.class, 3);__ref.setField("_silence_stall_threshold",audioplayer._silence_stall_threshold);
 //BA.debugLineNum = 13;BA.debugLine="Private player As MediaPlayer";
audioplayer._player = RemoteObject.createNew ("anywheresoftware.b4j.objects.MediaPlayerWrapper");__ref.setField("_player",audioplayer._player);
 //BA.debugLineNum = 14;BA.debugLine="Private jo As JavaObject";
...
audioplayer._eventname = RemoteObject.createImmutable("");__ref.setField("_eventname",audioplayer._eventname);
 //BA.debugLineNum = 16;BA.debugLine="Private targetPage As B4XMainPage";
audioplayer._targetpage = RemoteObject.createNew ("b4j.example.b4xmainpage");__ref.setField("_targetpage",audioplayer._targetpage);
 //BA.debugLineNum = 17;BA.debugLine="Private timeUpdateTimer As Timer";
audioplayer._timeupdatetimer = RemoteObject.createNew ("anywheresoftware.b4a.objects.Timer");__ref.setField("_timeupdatetimer",audioplayer._timeupdatetimer);
 //BA.debugLineNum = 18;BA.debugLine="Private lastPosition As Long";
audioplayer._lastposition = RemoteObject.createImmutable(0L);__ref.setField("_lastposition",audioplayer._lastposition);
 //BA.debugLineNum = 19;BA.debugLine="Private checkTimer As Timer";
audioplayer._checktimer = RemoteObject.createNew ("anywheresoftware.b4a.objects.Timer");__ref.setField("_checktimer",audioplayer._checktimer);
 //BA.debugLineNum = 20;BA.debugLine="Private loadTimer As Timer";
audioplayer._loadtimer = RemoteObject.createNew ("anywheresoftware.b4a.objects.Timer");__ref.setField("_loadtimer",audioplayer._loadtimer);
 //BA.debugLineNum = 21;BA.debugLine="Private fadeTimer As Timer";
...
audioplayer._stalledcheckcount = RemoteObject.createImmutable(0);__ref.setField("_stalledcheckcount",audioplayer._stalledcheckcount);
 //BA.debugLineNum = 29;BA.debugLine="Private currentLoadToken As Long";
audioplayer._currentloadtoken = RemoteObject.createImmutable(0L);__ref.setField("_currentloadtoken",audioplayer._currentloadtoken);
 //BA.debugLineNum = 30;BA.debugLine="Private activeEventLoadToken As Long";
audioplayer._activeeventloadtoken = RemoteObject.createImmutable(0L);__ref.setField("_activeeventloadtoken",audioplayer._activeeventloadtoken);
 //BA.debugLineNum = 31;BA.debugLine="Private audioKey As String";
...
try {
		Debug.PushSubsStack("Duration (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,173);
if (RapidSub.canDelegate("duration")) { return __ref.runUserSub(false, "audioplayer","duration", __ref);}
 BA.debugLineNum = 173;BA.debugLine="Public Sub Duration As Long";
Debug.ShouldStop(4096);
 BA.debugLineNum = 174;BA.debugLine="If player.IsInitialized = False Then Return 0";
...
try { BA.debugLineNum = 176;BA.debugLine="Return player.Duration";
...
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(long.class, __ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"getDuration"));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e5.toString()); BA.debugLineNum = 178;BA.debugLine="Return 0";
Debug.ShouldStop(131072);
if (true) return BA.numberCast(long.class, 0);
 };
...
try {
		Debug.PushSubsStack("Error_Event (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,194);
...
Debug.locals.put("args", _args);
 BA.debugLineNum = 194;BA.debugLine="Private Sub Error_Event(methodName As String, args";
Debug.ShouldStop(2);
 BA.debugLineNum = 195;BA.debugLine="If activeEventLoadToken <> currentLoadToken Then";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_activeeventloadtoken" /*RemoteObject*/ ),__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 196;BA.debugLine="TraceAudio(\"Error ignored. stale_token=\" & activ";
Debug.ShouldStop(8);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 199;BA.debugLine="Dim msg As String = \"\"";
Debug.ShouldStop(64);
_msg = BA.ObjectToString("");Debug.locals.put("msg", _msg);Debug.locals.put("msg", _msg);
 BA.debugLineNum = 200;BA.debugLine="Try";
Debug.ShouldStop(128);
try { BA.debugLineNum = 201;BA.debugLine="msg = jo.RunMethod(\"getError\", Null)";
...
_msg = BA.ObjectToString(__ref.getField(false,"_jo" /*RemoteObject*/ ).runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getError")),(Object)((audioplayer.__c.getField(false,"Null")))));Debug.locals.put("msg", _msg);
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e9.toString()); BA.debugLineNum = 203;BA.debugLine="msg = LastException.Message";
...
_msg = audioplayer.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage");Debug.locals.put("msg", _msg);
 ...
 BA.debugLineNum = 205;BA.debugLine="TraceAudio(\"Error_Event. message=\" & msg)";
Debug.ShouldStop(4096);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Error_Event. message="),_msg)));
 BA.debugLineNum = 206;BA.debugLine="NotifyError(msg)";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("FadeTimer_Tick (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,270);
...
RemoteObject _nextvolume = RemoteObject.createImmutable(0);
 BA.debugLineNum = 270;BA.debugLine="Private Sub FadeTimer_Tick";
Debug.ShouldStop(8192);
 BA.debugLineNum = 271;BA.debugLine="If player.IsInitialized = False Then";
Debug.ShouldStop(16384);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
 BA.debugLineNum = 272;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(32768);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 273;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(65536);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 276;BA.debugLine="Dim nextVolume As Double = currentVolume + fadeSt";
Debug.ShouldStop(524288);
_nextvolume = RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_currentvolume" /*RemoteObject*/ ),__ref.getField(true,"_fadestepvolume" /*RemoteObject*/ )}, "+",1, 0);Debug.locals.put("nextVolume", _nextvolume);Debug.locals.put("nextVolume", _nextvolume);
 BA.debugLineNum = 277;BA.debugLine="If fadeMode = FADE_IN Then";
Debug.ShouldStop(1048576);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_fademode" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_fade_in" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 278;BA.debugLine="If nextVolume >= fadeTargetVolume Then";
Debug.ShouldStop(2097152);
if (RemoteObject.solveBoolean("g",_nextvolume,__ref.getField(true,"_fadetargetvolume" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 279;BA.debugLine="nextVolume = fadeTargetVolume";
Debug.ShouldStop(4194304);
_nextvolume = __ref.getField(true,"_fadetargetvolume" /*RemoteObject*/ );Debug.locals.put("nextVolume", _nextvolume);
 BA.debugLineNum = 280;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(8388608);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 281;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(16777216);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 };
 }else 
{ BA.debugLineNum = 283;BA.debugLine="Else If fadeMode = FADE_OUT Then";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_fademode" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_fade_out" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 284;BA.debugLine="If nextVolume <= fadeTargetVolume Then";
Debug.ShouldStop(134217728);
if (RemoteObject.solveBoolean("k",_nextvolume,__ref.getField(true,"_fadetargetvolume" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 285;BA.debugLine="nextVolume = fadeTargetVolume";
Debug.ShouldStop(268435456);
_nextvolume = __ref.getField(true,"_fadetargetvolume" /*RemoteObject*/ );Debug.locals.put("nextVolume", _nextvolume);
 BA.debugLineNum = 286;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(536870912);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 287;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(1073741824);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 };
 }}
;
 BA.debugLineNum = 290;BA.debugLine="SetPlayerVolume(nextVolume)";
Debug.ShouldStop(2);
__ref.runClassMethod (b4j.example.audioplayer.class, "_setplayervolume" /*RemoteObject*/ ,(Object)(_nextvolume));
 BA.debugLineNum = 291;BA.debugLine="If fadeMode = FADE_NONE And nextVolume <= 0 Then";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_fademode" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_fade_none" /*RemoteObject*/ ))) && RemoteObject.solveBoolean("k",_nextvolume,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 292;BA.debugLine="StopImmediately";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("Initialize (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,34);
...
Debug.locals.put("targetPageValue", _targetpagevalue);
 BA.debugLineNum = 34;BA.debugLine="Public Sub Initialize (eventNameValue As String, t";
Debug.ShouldStop(2);
 BA.debugLineNum = 35;BA.debugLine="eventName = eventNameValue";
Debug.ShouldStop(4);
__ref.setField ("_eventname" /*RemoteObject*/ ,_eventnamevalue);
 BA.debugLineNum = 36;BA.debugLine="targetPage = targetPageValue";
Debug.ShouldStop(8);
__ref.setField ("_targetpage" /*RemoteObject*/ ,_targetpagevalue);
 BA.debugLineNum = 37;BA.debugLine="audioKey = ResolveAudioKey(eventName)";
Debug.ShouldStop(16);
__ref.setField ("_audiokey" /*RemoteObject*/ ,__ref.runClassMethod (b4j.example.audioplayer.class, "_resolveaudiokey" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_eventname" /*RemoteObject*/ ))));
 BA.debugLineNum = 38;BA.debugLine="loadTimer.Initialize(\"LoadTimer\", 10 * DateTime.T";
Debug.ShouldStop(32);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("LoadTimer")),(Object)(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(10),audioplayer.__c.getField(false,"DateTime").getField(true,"TicksPerSecond")}, "*",0, 2)));
 BA.debugLineNum = 39;BA.debugLine="checkTimer.Initialize(\"CheckTimer\", CHECK_TIMER_I";
Debug.ShouldStop(64);
__ref.getField(false,"_checktimer" /*RemoteObject*/ ).runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("CheckTimer")),(Object)(BA.numberCast(long.class, __ref.getField(true,"_check_timer_interval_ms" /*RemoteObject*/ ))));
 BA.debugLineNum = 40;BA.debugLine="timeUpdateTimer.Initialize(\"TimeUpdateTimer\", 250";
Debug.ShouldStop(128);
__ref.getField(false,"_timeupdatetimer" /*RemoteObject*/ ).runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("TimeUpdateTimer")),(Object)(BA.numberCast(long.class, 250)));
 BA.debugLineNum = 41;BA.debugLine="fadeTimer.Initialize(\"FadeTimer\", 40)";
Debug.ShouldStop(256);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("FadeTimer")),(Object)(BA.numberCast(long.class, 40)));
 BA.debugLineNum = 42;BA.debugLine="TraceAudio(\"Initialize\")";
...
try {
		Debug.PushSubsStack("IsLoading (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,152);
if (RapidSub.canDelegate("isloading")) { return __ref.runUserSub(false, "audioplayer","isloading", __ref);}
 BA.debugLineNum = 152;BA.debugLine="Public Sub IsLoading As Boolean";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 153;BA.debugLine="Return playerState = STATE_LOADING";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("IsPlaying (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,160);
if (RapidSub.canDelegate("isplaying")) { return __ref.runUserSub(false, "audioplayer","isplaying", __ref);}
 BA.debugLineNum = 160;BA.debugLine="Public Sub IsPlaying As Boolean";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 161;BA.debugLine="Return playerState = STATE_PLAYING";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("IsReady (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,156);
if (RapidSub.canDelegate("isready")) { return __ref.runUserSub(false, "audioplayer","isready", __ref);}
 BA.debugLineNum = 156;BA.debugLine="Public Sub IsReady As Boolean";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 157;BA.debugLine="Return playerState = STATE_READY";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("IsStopped (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,148);
if (RapidSub.canDelegate("isstopped")) { return __ref.runUserSub(false, "audioplayer","isstopped", __ref);}
 BA.debugLineNum = 148;BA.debugLine="Public Sub IsStopped As Boolean";
Debug.ShouldStop(524288);
 BA.debugLineNum = 149;BA.debugLine="Return playerState = STATE_STOPPED";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("LoadTimer_Tick (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,264);
if (RapidSub.canDelegate("loadtimer_tick")) { return __ref.runUserSub(false, "audioplayer","loadtimer_tick", __ref);}
 BA.debugLineNum = 264;BA.debugLine="Private Sub LoadTimer_Tick";
Debug.ShouldStop(128);
 BA.debugLineNum = 265;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(256);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 266;BA.debugLine="TraceAudio(\"Load timeout\")";
Debug.ShouldStop(512);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("Load timeout")));
 BA.debugLineNum = 267;BA.debugLine="NotifyError(\"Track loading timeout expired\")";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("LoadUrl (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,46);
...
Debug.locals.put("volume", _volume);
 BA.debugLineNum = 46;BA.debugLine="Public Sub LoadUrl(url As String, volume As Double";
Debug.ShouldStop(8192);
 BA.debugLineNum = 47;BA.debugLine="Dim startedAt As Long = DateTime.Now";
Debug.ShouldStop(16384);
_startedat = audioplayer.__c.getField(false,"DateTime").runMethod(true,"getNow");Debug.locals.put("startedAt", _startedat);Debug.locals.put("startedAt", _startedat);
 BA.debugLineNum = 48;BA.debugLine="Reset";
Debug.ShouldStop(32768);
__ref.runClassMethod (b4j.example.audioplayer.class, "_reset" /*RemoteObject*/ );
 BA.debugLineNum = 49;BA.debugLine="currentLoadToken = currentLoadToken + 1";
Debug.ShouldStop(65536);
__ref.setField ("_currentloadtoken" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 2));
 BA.debugLineNum = 50;BA.debugLine="activeEventLoadToken = currentLoadToken";
Debug.ShouldStop(131072);
__ref.setField ("_activeeventloadtoken" /*RemoteObject*/ ,__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ));
 BA.debugLineNum = 51;BA.debugLine="loadTimer.Interval = 10 * DateTime.TicksPerSecond";
Debug.ShouldStop(262144);
...
__ref.setField ("_maxvolume" /*RemoteObject*/ ,audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(audioplayer.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, 1)),(Object)(_volume)))));
 BA.debugLineNum = 55;BA.debugLine="TraceAudio(\"LoadUrl. volume=\" & NumberFormat2(max";
Debug.ShouldStop(4194304);
...
Debug.ShouldStop(8388608);
try { BA.debugLineNum = 57;BA.debugLine="player.Initialize(\"Player\", url)";
Debug.ShouldStop(16777216);
__ref.getField(false,"_player" /*RemoteObject*/ ).runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("Player")),(Object)(_url));
 BA.debugLineNum = 58;BA.debugLine="jo = player";
Debug.ShouldStop(33554432);
__ref.getField(false,"_jo" /*RemoteObject*/ ).setObject (__ref.getField(false,"_player" /*RemoteObject*/ ).getObject());
 BA.debugLineNum = 59;BA.debugLine="jo.RunMethod(\"setOnError\", Array As Object(jo.Cr";
Debug.ShouldStop(67108864);
__ref.getField(false,"_jo" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setOnError")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.getField(false,"_jo" /*RemoteObject*/ ).runMethod(false,"CreateEventFromUI",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("java.lang.Runnable")),(Object)(BA.ObjectToString("Error")),(Object)((audioplayer.__c.getField(true,"False"))))})));
 BA.debugLineNum = 60;BA.debugLine="jo.RunMethod(\"setOnReady\", Array As Object(jo.Cr";
Debug.ShouldStop(134217728);
__ref.getField(false,"_jo" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setOnReady")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.getField(false,"_jo" /*RemoteObject*/ ).runMethod(false,"CreateEventFromUI",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("java.lang.Runnable")),(Object)(BA.ObjectToString("Ready")),(Object)((audioplayer.__c.getField(true,"False"))))})));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e16.toString()); BA.debugLineNum = 62;BA.debugLine="NotifyError(LastException.Message)";
Debug.ShouldStop(536870912);
__ref.runClassMethod (b4j.example.audioplayer.class, "_notifyerror" /*RemoteObject*/ ,(Object)(audioplayer.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage")));
 ...
 BA.debugLineNum = 64;BA.debugLine="LogSlowOperation(\"LoadUrl\", startedAt)";
Debug.ShouldStop(-2147483648);
...
try {
		Debug.PushSubsStack("LogSlowOperation (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,340);
...
Debug.locals.put("startedAt", _startedat);
 BA.debugLineNum = 340;BA.debugLine="Private Sub LogSlowOperation(operationName As Stri";
Debug.ShouldStop(524288);
 BA.debugLineNum = 341;BA.debugLine="Dim elapsed As Long = DateTime.Now - startedAt";
Debug.ShouldStop(1048576);
_elapsed = RemoteObject.solve(new RemoteObject[] {audioplayer.__c.getField(false,"DateTime").runMethod(true,"getNow"),_startedat}, "-",1, 2);Debug.locals.put("elapsed", _elapsed);Debug.locals.put("elapsed", _elapsed);
 BA.debugLineNum = 342;BA.debugLine="If elapsed < 50 Then Return";
Debug.ShouldStop(2097152);
if (RemoteObject.solveBoolean("<",_elapsed,BA.numberCast(long.class, 50))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 343;BA.debugLine="TraceDiagnostic(\"audio slow op=\" & eventName & \".";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("NotifyError (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,228);
if (RapidSub.canDelegate("notifyerror")) { return __ref.runUserSub(false, "audioplayer","notifyerror", __ref, _message);}
Debug.locals.put("message", _message);
 BA.debugLineNum = 228;BA.debugLine="Private Sub NotifyError(message As String)";
Debug.ShouldStop(8);
 BA.debugLineNum = 229;BA.debugLine="TraceAudio(\"NotifyError. message=\" & message)";
Debug.ShouldStop(16);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("NotifyError. message="),_message)));
 BA.debugLineNum = 230;BA.debugLine="Reset";
Debug.ShouldStop(32);
__ref.runClassMethod (b4j.example.audioplayer.class, "_reset" /*RemoteObject*/ );
 BA.debugLineNum = 231;BA.debugLine="targetPage.AudioPlayer_Error(audioKey, message)";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("Play (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,67);
if (RapidSub.canDelegate("play")) { return __ref.runUserSub(false, "audioplayer","play", __ref);}
 BA.debugLineNum = 67;BA.debugLine="Public Sub Play";
Debug.ShouldStop(4);
 BA.debugLineNum = 68;BA.debugLine="PlayWithFade(0)";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("Player_Complete (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,210);
if (RapidSub.canDelegate("player_complete")) { return __ref.runUserSub(false, "audioplayer","player_complete", __ref);}
 BA.debugLineNum = 210;BA.debugLine="Private Sub Player_Complete";
Debug.ShouldStop(131072);
 BA.debugLineNum = 211;BA.debugLine="If activeEventLoadToken <> currentLoadToken Then";
Debug.ShouldStop(262144);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_activeeventloadtoken" /*RemoteObject*/ ),__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 212;BA.debugLine="TraceAudio(\"Complete ignored. stale_token=\" & ac";
Debug.ShouldStop(524288);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 215;BA.debugLine="If playerState = STATE_STOPPED Then Return";
Debug.ShouldStop(4194304);
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 216;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(8388608);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 217;BA.debugLine="checkTimer.Enabled = False";
Debug.ShouldStop(16777216);
__ref.getField(false,"_checktimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 218;BA.debugLine="timeUpdateTimer.Enabled = False";
Debug.ShouldStop(33554432);
__ref.getField(false,"_timeupdatetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 219;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(67108864);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 220;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(134217728);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 BA.debugLineNum = 221;BA.debugLine="currentVolume = 0";
Debug.ShouldStop(268435456);
__ref.setField ("_currentvolume" /*RemoteObject*/ ,BA.numberCast(double.class, 0));
 BA.debugLineNum = 222;BA.debugLine="stalledCheckCount = 0";
Debug.ShouldStop(536870912);
__ref.setField ("_stalledcheckcount" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 223;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(1073741824);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 224;BA.debugLine="TraceAudio(\"Complete\")";
Debug.ShouldStop(-2147483648);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("Complete")));
 BA.debugLineNum = 225;BA.debugLine="targetPage.AudioPlayer_Complete(audioKey)";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("PlayWithFade (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,72);
...
Debug.locals.put("fadeTimeMs", _fadetimems);
 BA.debugLineNum = 72;BA.debugLine="Public Sub PlayWithFade(fadeTimeMs As Int)";
Debug.ShouldStop(128);
 BA.debugLineNum = 73;BA.debugLine="If playerState <> STATE_READY Then";
Debug.ShouldStop(256);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_playerstate" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_ready" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 74;BA.debugLine="TraceInternalError(\"play_with_fade_not_ready sta";
Debug.ShouldStop(512);
...
__ref.runClassMethod (b4j.example.audioplayer.class, "_setplayervolume" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_maxvolume" /*RemoteObject*/ )));
 ...
 BA.debugLineNum = 87;BA.debugLine="player.Play";
Debug.ShouldStop(4194304);
__ref.getField(false,"_player" /*RemoteObject*/ ).runVoidMethod ("Play");
 BA.debugLineNum = 88;BA.debugLine="TraceAudio(\"PlayWithFade. fadeTimeMs=\" & fadeTime";
Debug.ShouldStop(8388608);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("PlayWithFade. fadeTimeMs="),_fadetimems,RemoteObject.createImmutable(", maxVolume="),audioplayer.__c.runMethod(true,"NumberFormat2",(Object)(__ref.getField(true,"_maxvolume" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, 1)),(Object)(BA.numberCast(int.class, 3)),(Object)(BA.numberCast(int.class, 3)),(Object)(audioplayer.__c.getField(true,"False"))))));
 BA.debugLineNum = 89;BA.debugLine="If fadeTimeMs > 0 Then";
Debug.ShouldStop(16777216);
if (RemoteObject.solveBoolean(">",_fadetimems,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 90;BA.debugLine="StartFade(FADE_IN, maxVolume, fadeTimeMs)";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("Position (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,164);
if (RapidSub.canDelegate("position")) { return __ref.runUserSub(false, "audioplayer","position", __ref);}
 BA.debugLineNum = 164;BA.debugLine="Public Sub Position As Long";
Debug.ShouldStop(8);
 BA.debugLineNum = 165;BA.debugLine="If player.IsInitialized = False Then Return 0";
Debug.ShouldStop(16);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
if (true) return BA.numberCast(long.class, 0);};
 BA.debugLineNum = 166;BA.debugLine="Try";
Debug.ShouldStop(32);
try { BA.debugLineNum = 167;BA.debugLine="Return player.Position";
Debug.ShouldStop(64);
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(long.class, __ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"getPosition"));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e5.toString()); BA.debugLineNum = 169;BA.debugLine="Return 0";
Debug.ShouldStop(256);
if (true) return BA.numberCast(long.class, 0);
 };
...
try {
		Debug.PushSubsStack("Ready_Event (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,183);
if (RapidSub.canDelegate("ready_event")) { return __ref.runUserSub(false, "audioplayer","ready_event", __ref, _methodname, _args);}
Debug.locals.put("methodName", _methodname);
Debug.locals.put("args", _args);
 BA.debugLineNum = 183;BA.debugLine="Private Sub Ready_Event(methodName As String, args";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 184;BA.debugLine="If activeEventLoadToken <> currentLoadToken Then";
Debug.ShouldStop(8388608);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_activeeventloadtoken" /*RemoteObject*/ ),__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 185;BA.debugLine="TraceAudio(\"Ready ignored. stale_token=\" & activ";
Debug.ShouldStop(16777216);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 188;BA.debugLine="playerState = STATE_READY";
Debug.ShouldStop(134217728);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_ready" /*RemoteObject*/ ));
 BA.debugLineNum = 189;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(268435456);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 190;BA.debugLine="TraceAudio(\"Ready\")";
Debug.ShouldStop(536870912);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("Ready")));
 BA.debugLineNum = 191;BA.debugLine="targetPage.AudioPlayer_Ready(audioKey)";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("Reset (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,118);
...
Debug.ShouldStop(1073741824);
__ref.setField ("_currentvolume" /*RemoteObject*/ ,BA.numberCast(double.class, 0));
 BA.debugLineNum = 128;BA.debugLine="activeEventLoadToken = 0";
Debug.ShouldStop(-2147483648);
__ref.setField ("_activeeventloadtoken" /*RemoteObject*/ ,BA.numberCast(long.class, 0));
 BA.debugLineNum = 129;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(1);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 130;BA.debugLine="If player.IsInitialized Then";
Debug.ShouldStop(2);
...
Debug.ShouldStop(4);
try { BA.debugLineNum = 132;BA.debugLine="player.Volume = 0";
Debug.ShouldStop(8);
__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"setVolume",BA.numberCast(double.class, 0));
 BA.debugLineNum = 133;BA.debugLine="player.Stop";
Debug.ShouldStop(16);
__ref.getField(false,"_player" /*RemoteObject*/ ).runVoidMethod ("Stop");
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e17) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e17.toString()); BA.debugLineNum = 135;BA.debugLine="TraceInternalError(\"reset_stop\")";
Debug.ShouldStop(64);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceinternalerror" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("reset_stop")));
 ...
 BA.debugLineNum = 137;BA.debugLine="If jo.IsInitialized Then";
Debug.ShouldStop(256);
...
Debug.ShouldStop(512);
try { BA.debugLineNum = 139;BA.debugLine="jo.RunMethod(\"dispose\", Null)";
Debug.ShouldStop(1024);
__ref.getField(false,"_jo" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("dispose")),(Object)((audioplayer.__c.getField(false,"Null"))));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e23.toString()); BA.debugLineNum = 141;BA.debugLine="TraceInternalError(\"reset_dispose\")";
Debug.ShouldStop(4096);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceinternalerror" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("reset_dispose")));
 ...
 BA.debugLineNum = 145;BA.debugLine="LogSlowOperation(\"Reset\", startedAt)";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("ResolveAudioKey (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,358);
...
Debug.locals.put("nameValue", _namevalue);
 BA.debugLineNum = 358;BA.debugLine="Private Sub ResolveAudioKey(nameValue As String) A";
Debug.ShouldStop(32);
 BA.debugLineNum = 359;BA.debugLine="If nameValue.ToLowerCase.Contains(\"secondary\") Th";
Debug.ShouldStop(64);
...
if (true) return BA.ObjectToString("secondary");};
 BA.debugLineNum = 360;BA.debugLine="Return \"primary\"";
Debug.ShouldStop(128);
...
try {
		Debug.PushSubsStack("SetPlayerVolume (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,313);
...
Debug.locals.put("volumeValue", _volumevalue);
 BA.debugLineNum = 313;BA.debugLine="Private Sub SetPlayerVolume(volumeValue As Double)";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 314;BA.debugLine="currentVolume = Max(0, Min(1, volumeValue))";
Debug.ShouldStop(33554432);
__ref.setField ("_currentvolume" /*RemoteObject*/ ,audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(audioplayer.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, 1)),(Object)(_volumevalue)))));
 BA.debugLineNum = 315;BA.debugLine="If player.IsInitialized = False Then Return";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 316;BA.debugLine="Try";
Debug.ShouldStop(134217728);
try { BA.debugLineNum = 317;BA.debugLine="player.Volume = currentVolume";
Debug.ShouldStop(268435456);
__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"setVolume",__ref.getField(true,"_currentvolume" /*RemoteObject*/ ));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e6.toString()); BA.debugLineNum = 319;BA.debugLine="TraceInternalError(\"set_volume\")";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("StartFade (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,296);
...
Debug.locals.put("fadeTimeMs", _fadetimems);
 BA.debugLineNum = 296;BA.debugLine="Private Sub StartFade(mode As Int, targetVolume As";
Debug.ShouldStop(128);
 BA.debugLineNum = 297;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(256);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 298;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(512);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 BA.debugLineNum = 299;BA.debugLine="If player.IsInitialized = False Then Return";
Debug.ShouldStop(1024);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 300;BA.debugLine="If fadeTimeMs <= 0 Then";
Debug.ShouldStop(2048);
if (RemoteObject.solveBoolean("k",_fadetimems,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 301;BA.debugLine="SetPlayerVolume(targetVolume)";
Debug.ShouldStop(4096);
__ref.runClassMethod (b4j.example.audioplayer.class, "_setplayervolume" /*RemoteObject*/ ,(Object)(_targetvolume));
 BA.debugLineNum = 302;BA.debugLine="If targetVolume <= 0 Then StopImmediately";
Debug.ShouldStop(8192);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 305;BA.debugLine="Dim intervalMs As Int = Max(20, fadeTimer.Interva";
Debug.ShouldStop(65536);
_intervalms = BA.numberCast(int.class, audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 20)),(Object)(BA.numberCast(double.class, __ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"getInterval")))));Debug.locals.put("intervalMs", _intervalms);Debug.locals.put("intervalMs", _intervalms);
 BA.debugLineNum = 306;BA.debugLine="Dim steps As Int = Max(1, Ceil(fadeTimeMs / inter";
Debug.ShouldStop(131072);
_steps = BA.numberCast(int.class, audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 1)),(Object)(audioplayer.__c.runMethod(true,"Ceil",(Object)(RemoteObject.solve(new RemoteObject[] {_fadetimems,_intervalms}, "/",0, 0))))));Debug.locals.put("steps", _steps);Debug.locals.put("steps", _steps);
 BA.debugLineNum = 307;BA.debugLine="fadeMode = mode";
Debug.ShouldStop(262144);
__ref.setField ("_fademode" /*RemoteObject*/ ,_mode);
 BA.debugLineNum = 308;BA.debugLine="fadeTargetVolume = targetVolume";
Debug.ShouldStop(524288);
__ref.setField ("_fadetargetvolume" /*RemoteObject*/ ,_targetvolume);
 BA.debugLineNum = 309;BA.debugLine="fadeStepVolume = (targetVolume - currentVolume) /";
Debug.ShouldStop(1048576);
__ref.setField ("_fadestepvolume" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_targetvolume,__ref.getField(true,"_currentvolume" /*RemoteObject*/ )}, "-",1, 0)),_steps}, "/",0, 0));
 BA.debugLineNum = 310;BA.debugLine="fadeTimer.Enabled = True";
Debug.ShouldStop(2097152);
...
try {
		Debug.PushSubsStack("Stop (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,95);
if (RapidSub.canDelegate("stop")) { return __ref.runUserSub(false, "audioplayer","stop", __ref, _fadetimems);}
RemoteObject _startedat = RemoteObject.createImmutable(0L);
Debug.locals.put("fadeTimeMs", _fadetimems);
 BA.debugLineNum = 95;BA.debugLine="Public Sub Stop(fadeTimeMs As Int)";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 96;BA.debugLine="Dim startedAt As Long = DateTime.Now";
Debug.ShouldStop(-2147483648);
_startedat = audioplayer.__c.getField(false,"DateTime").runMethod(true,"getNow");Debug.locals.put("startedAt", _startedat);Debug.locals.put("startedAt", _startedat);
 BA.debugLineNum = 97;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(1);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 98;BA.debugLine="checkTimer.Enabled = False";
Debug.ShouldStop(2);
__ref.getField(false,"_checktimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 99;BA.debugLine="timeUpdateTimer.Enabled = False";
Debug.ShouldStop(4);
__ref.getField(false,"_timeupdatetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 100;BA.debugLine="lastPosition = 0";
Debug.ShouldStop(8);
__ref.setField ("_lastposition" /*RemoteObject*/ ,BA.numberCast(long.class, 0));
 BA.debugLineNum = 101;BA.debugLine="stalledCheckCount = 0";
Debug.ShouldStop(16);
__ref.setField ("_stalledcheckcount" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 102;BA.debugLine="If player.IsInitialized = False Then";
Debug.ShouldStop(32);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
 BA.debugLineNum = 103;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(64);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 104;BA.debugLine="TraceAudio(\"Stop ignored. player not initialized";
Debug.ShouldStop(128);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 107;BA.debugLine="TraceAudio(\"Stop. fadeTimeMs=\" & fadeTimeMs & \",";
Debug.ShouldStop(1024);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Stop. fadeTimeMs="),_fadetimems,RemoteObject.createImmutable(", currentVolume="),audioplayer.__c.runMethod(true,"NumberFormat2",(Object)(__ref.getField(true,"_currentvolume" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, 1)),(Object)(BA.numberCast(int.class, 3)),(Object)(BA.numberCast(int.class, 3)),(Object)(audioplayer.__c.getField(true,"False"))))));
 BA.debugLineNum = 108;BA.debugLine="If fadeTimeMs > 0 And currentVolume > 0 Then";
Debug.ShouldStop(2048);
if (RemoteObject.solveBoolean(">",_fadetimems,BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean(">",__ref.getField(true,"_currentvolume" /*RemoteObject*/ ),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 109;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(4096);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 110;BA.debugLine="StartFade(FADE_OUT, 0, fadeTimeMs)";
Debug.ShouldStop(8192);
__ref.runClassMethod (b4j.example.audioplayer.class, "_startfade" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_fade_out" /*RemoteObject*/ )),(Object)(BA.numberCast(double.class, 0)),(Object)(_fadetimems));
 ...
 BA.debugLineNum = 112;BA.debugLine="StopImmediately";
Debug.ShouldStop(32768);
__ref.runClassMethod (b4j.example.audioplayer.class, "_stopimmediately" /*RemoteObject*/ );
 };
 BA.debugLineNum = 114;BA.debugLine="LogSlowOperation(\"Stop\", startedAt)";
Debug.ShouldStop(131072);
...
try {
		Debug.PushSubsStack("StopImmediately (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,323);
if (RapidSub.canDelegate("stopimmediately")) { return __ref.runUserSub(false, "audioplayer","stopimmediately", __ref);}
RemoteObject _startedat = RemoteObject.createImmutable(0L);
 BA.debugLineNum = 323;BA.debugLine="Private Sub StopImmediately";
Debug.ShouldStop(4);
 BA.debugLineNum = 324;BA.debugLine="Dim startedAt As Long = DateTime.Now";
Debug.ShouldStop(8);
_startedat = audioplayer.__c.getField(false,"DateTime").runMethod(true,"getNow");Debug.locals.put("startedAt", _startedat);Debug.locals.put("startedAt", _startedat);
 BA.debugLineNum = 325;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(16);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 326;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(32);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 BA.debugLineNum = 327;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(64);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 328;BA.debugLine="currentVolume = 0";
Debug.ShouldStop(128);
__ref.setField ("_currentvolume" /*RemoteObject*/ ,BA.numberCast(double.class, 0));
 BA.debugLineNum = 329;BA.debugLine="TraceAudio(\"StopImmediately\")";
Debug.ShouldStop(256);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("StopImmediately")));
 BA.debugLineNum = 330;BA.debugLine="If player.IsInitialized = False Then Return";
Debug.ShouldStop(512);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 331;BA.debugLine="Try";
Debug.ShouldStop(1024);
try { BA.debugLineNum = 332;BA.debugLine="player.Volume = 0";
Debug.ShouldStop(2048);
__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"setVolume",BA.numberCast(double.class, 0));
 BA.debugLineNum = 333;BA.debugLine="player.Stop";
Debug.ShouldStop(4096);
__ref.getField(false,"_player" /*RemoteObject*/ ).runVoidMethod ("Stop");
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e12) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e12.toString()); BA.debugLineNum = 335;BA.debugLine="TraceInternalError(\"stop_immediately\")";
Debug.ShouldStop(16384);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceinternalerror" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("stop_immediately")));
 ...
 BA.debugLineNum = 337;BA.debugLine="LogSlowOperation(\"StopImmediately\", startedAt)";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("TimeUpdateTimer_Tick (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,234);
if (RapidSub.canDelegate("timeupdatetimer_tick")) { return __ref.runUserSub(false, "audioplayer","timeupdatetimer_tick", __ref);}
 BA.debugLineNum = 234;BA.debugLine="Private Sub TimeUpdateTimer_Tick";
Debug.ShouldStop(512);
 BA.debugLineNum = 235;BA.debugLine="If playerState <> STATE_PLAYING Then Return";
Debug.ShouldStop(1024);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_playerstate" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_playing" /*RemoteObject*/ )))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 236;BA.debugLine="If activeEventLoadToken <> currentLoadToken Then";
Debug.ShouldStop(2048);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_activeeventloadtoken" /*RemoteObject*/ ),__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 237;BA.debugLine="targetPage.AudioPlayer_Timeupdate(audioKey)";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("TraceAudio (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,354);
if (RapidSub.canDelegate("traceaudio")) { return __ref.runUserSub(false, "audioplayer","traceaudio", __ref, _message);}
Debug.locals.put("message", _message);
 BA.debugLineNum = 354;BA.debugLine="Private Sub TraceAudio(message As String)";
Debug.ShouldStop(2);
 BA.debugLineNum = 355;BA.debugLine="targetPage.TraceLog(\"[\" & eventName & \"] \" & mess";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("TraceDiagnostic (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,350);
if (RapidSub.canDelegate("tracediagnostic")) { return __ref.runUserSub(false, "audioplayer","tracediagnostic", __ref, _message);}
Debug.locals.put("message", _message);
 BA.debugLineNum = 350;BA.debugLine="Private Sub TraceDiagnostic(message As String)";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 351;BA.debugLine="targetPage.TraceLog(message)";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("TraceInternalError (audioplayer) ","audioplayer",1,__ref.getField(false, "ba"),__ref,346);
...
Debug.locals.put("context", _context);
 BA.debugLineNum = 346;BA.debugLine="Private Sub TraceInternalError(context As String)";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 347;BA.debugLine="targetPage.TraceLog(\"ошибка аудио internal contex";
Debug.ShouldStop(67108864);
