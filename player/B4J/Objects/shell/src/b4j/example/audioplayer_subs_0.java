...
try {
		Debug.PushSubsStack("CheckTimer_Tick (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,233);
...
RemoteObject _remainms = RemoteObject.createImmutable(0L);
 BA.debugLineNum = 233;BA.debugLine="Private Sub CheckTimer_Tick";
Debug.ShouldStop(256);
 BA.debugLineNum = 234;BA.debugLine="If playerState <> STATE_PLAYING Then Return";
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 235;BA.debugLine="Dim positionNow As Long = Position";
...
_positionnow = __ref.runClassMethod (b4j.example.audioplayer.class, "_position" /*RemoteObject*/ );Debug.locals.put("positionNow", _positionnow);Debug.locals.put("positionNow", _positionnow);
 BA.debugLineNum = 236;BA.debugLine="If positionNow > lastPosition Then";
Debug.ShouldStop(2048);
if (RemoteObject.solveBoolean(">",_positionnow,__ref.getField(true,"_lastposition" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 237;BA.debugLine="lastPosition = positionNow";
Debug.ShouldStop(4096);
__ref.setField ("_lastposition" /*RemoteObject*/ ,_positionnow);
 BA.debugLineNum = 238;BA.debugLine="stalledCheckCount = 0";
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 241;BA.debugLine="Dim durationNow As Long = Duration";
...
_durationnow = __ref.runClassMethod (b4j.example.audioplayer.class, "_duration" /*RemoteObject*/ );Debug.locals.put("durationNow", _durationnow);Debug.locals.put("durationNow", _durationnow);
 BA.debugLineNum = 242;BA.debugLine="Dim remainMs As Long = -1";
...
_remainms = BA.numberCast(long.class, -(double) (0 + 1));Debug.locals.put("remainMs", _remainms);Debug.locals.put("remainMs", _remainms);
 BA.debugLineNum = 243;BA.debugLine="If durationNow > 0 Then remainMs = Max(0, duratio";
...
_remainms = BA.numberCast(long.class, audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {_durationnow,_positionnow}, "-",1, 2)))));Debug.locals.put("remainMs", _remainms);};
 BA.debugLineNum = 244;BA.debugLine="If durationNow > 0 And positionNow >= Max(0, dura";
...
if (RemoteObject.solveBoolean(">",_durationnow,BA.numberCast(long.class, 0)) && RemoteObject.solveBoolean("g",_positionnow,BA.numberCast(long.class, audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {_durationnow,RemoteObject.createImmutable(2000)}, "-",1, 2))))))) { 
 BA.debugLineNum = 245;BA.debugLine="TraceDiagnostic(\"хвост audio=\" & eventName & \" p";
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 248;BA.debugLine="stalledCheckCount = stalledCheckCount + 1";
...
__ref.setField ("_stalledcheckcount" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_stalledcheckcount" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1));
 BA.debugLineNum = 249;BA.debugLine="If stalledCheckCount = 1 Or stalledCheckCount = 3";
...
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_stalledcheckcount" /*RemoteObject*/ ),BA.numberCast(double.class, 1)) || RemoteObject.solveBoolean("=",__ref.getField(true,"_stalledcheckcount" /*RemoteObject*/ ),BA.numberCast(double.class, 3))) { 
 BA.debugLineNum = 250;BA.debugLine="TraceDiagnostic(\"задержка audio=\" & eventName &";
...
__ref.runClassMethod (b4j.example.audioplayer.class, "_tracediagnostic" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("задержка audio="),__ref.getField(true,"_eventname" /*RemoteObject*/ ),RemoteObject.createImmutable(" positionMs="),_positionnow,RemoteObject.createImmutable(" durationMs="),_durationnow,RemoteObject.createImmutable(" remainMs="),_remainms,RemoteObject.createImmutable(" stalled="),__ref.getField(true,"_stalledcheckcount" /*RemoteObject*/ ))));
 ...
 BA.debugLineNum = 252;BA.debugLine="If stalledCheckCount < SILENCE_STALL_THRESHOLD Th";
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 253;BA.debugLine="NotifyError(\"Silence detected \" & SILENCE_STALL_T";
...
try {
		Debug.PushSubsStack("Duration (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,165);
if (RapidSub.canDelegate("duration")) { return __ref.runUserSub(false, "audioplayer","duration", __ref);}
 BA.debugLineNum = 165;BA.debugLine="Public Sub Duration As Long";
Debug.ShouldStop(16);
 BA.debugLineNum = 166;BA.debugLine="If player.IsInitialized = False Then Return 0";
Debug.ShouldStop(32);
...
Debug.ShouldStop(64);
try { BA.debugLineNum = 168;BA.debugLine="Return player.Duration";
...
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(long.class, __ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"getDuration"));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e5.toString()); BA.debugLineNum = 170;BA.debugLine="Return 0";
Debug.ShouldStop(512);
if (true) return BA.numberCast(long.class, 0);
 };
...
try {
		Debug.PushSubsStack("Error_Event (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,186);
...
Debug.locals.put("args", _args);
 BA.debugLineNum = 186;BA.debugLine="Private Sub Error_Event(methodName As String, args";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 187;BA.debugLine="If activeEventLoadToken <> currentLoadToken Then";
...
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_activeeventloadtoken" /*RemoteObject*/ ),__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 188;BA.debugLine="TraceAudio(\"Error ignored. stale_token=\" & activ";
Debug.ShouldStop(134217728);
...
_msg = BA.ObjectToString(__ref.getField(false,"_jo" /*RemoteObject*/ ).runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getError")),(Object)((audioplayer.__c.getField(false,"Null")))));Debug.locals.put("msg", _msg);
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e9.toString()); BA.debugLineNum = 195;BA.debugLine="msg = LastException.Message";
Debug.ShouldStop(4);
_msg = audioplayer.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage");Debug.locals.put("msg", _msg);
 ...
 BA.debugLineNum = 197;BA.debugLine="TraceAudio(\"Error_Event. message=\" & msg)";
Debug.ShouldStop(16);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Error_Event. message="),_msg)));
 BA.debugLineNum = 198;BA.debugLine="NotifyError(msg)";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("FadeTimer_Tick (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,262);
...
RemoteObject _nextvolume = RemoteObject.createImmutable(0);
 BA.debugLineNum = 262;BA.debugLine="Private Sub FadeTimer_Tick";
Debug.ShouldStop(32);
 BA.debugLineNum = 263;BA.debugLine="If player.IsInitialized = False Then";
Debug.ShouldStop(64);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 268;BA.debugLine="Dim nextVolume As Double = currentVolume + fadeSt";
Debug.ShouldStop(2048);
_nextvolume = RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_currentvolume" /*RemoteObject*/ ),__ref.getField(true,"_fadestepvolume" /*RemoteObject*/ )}, "+",1, 0);Debug.locals.put("nextVolume", _nextvolume);Debug.locals.put("nextVolume", _nextvolume);
 BA.debugLineNum = 269;BA.debugLine="If fadeMode = FADE_IN Then";
Debug.ShouldStop(4096);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_fademode" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_fade_in" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 270;BA.debugLine="If nextVolume >= fadeTargetVolume Then";
Debug.ShouldStop(8192);
if (RemoteObject.solveBoolean("g",_nextvolume,__ref.getField(true,"_fadetargetvolume" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 271;BA.debugLine="nextVolume = fadeTargetVolume";
Debug.ShouldStop(16384);
...
{ BA.debugLineNum = 275;BA.debugLine="Else If fadeMode = FADE_OUT Then";
Debug.ShouldStop(262144);
...
;
 BA.debugLineNum = 282;BA.debugLine="SetPlayerVolume(nextVolume)";
Debug.ShouldStop(33554432);
__ref.runClassMethod (b4j.example.audioplayer.class, "_setplayervolume" /*RemoteObject*/ ,(Object)(_nextvolume));
 BA.debugLineNum = 283;BA.debugLine="If fadeMode = FADE_NONE And nextVolume <= 0 Then";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_fademode" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_fade_none" /*RemoteObject*/ ))) && RemoteObject.solveBoolean("k",_nextvolume,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 284;BA.debugLine="StopImmediately";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("Initialize (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,32);
...
try {
		Debug.PushSubsStack("IsLoading (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,144);
if (RapidSub.canDelegate("isloading")) { return __ref.runUserSub(false, "audioplayer","isloading", __ref);}
 BA.debugLineNum = 144;BA.debugLine="Public Sub IsLoading As Boolean";
Debug.ShouldStop(32768);
 BA.debugLineNum = 145;BA.debugLine="Return playerState = STATE_LOADING";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("IsPlaying (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,152);
if (RapidSub.canDelegate("isplaying")) { return __ref.runUserSub(false, "audioplayer","isplaying", __ref);}
 BA.debugLineNum = 152;BA.debugLine="Public Sub IsPlaying As Boolean";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 153;BA.debugLine="Return playerState = STATE_PLAYING";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("IsReady (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,148);
if (RapidSub.canDelegate("isready")) { return __ref.runUserSub(false, "audioplayer","isready", __ref);}
 BA.debugLineNum = 148;BA.debugLine="Public Sub IsReady As Boolean";
Debug.ShouldStop(524288);
 BA.debugLineNum = 149;BA.debugLine="Return playerState = STATE_READY";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("IsStopped (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,140);
if (RapidSub.canDelegate("isstopped")) { return __ref.runUserSub(false, "audioplayer","isstopped", __ref);}
 BA.debugLineNum = 140;BA.debugLine="Public Sub IsStopped As Boolean";
Debug.ShouldStop(2048);
 BA.debugLineNum = 141;BA.debugLine="Return playerState = STATE_STOPPED";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("LoadTimer_Tick (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,256);
if (RapidSub.canDelegate("loadtimer_tick")) { return __ref.runUserSub(false, "audioplayer","loadtimer_tick", __ref);}
 BA.debugLineNum = 256;BA.debugLine="Private Sub LoadTimer_Tick";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 257;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(1);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 258;BA.debugLine="TraceAudio(\"Load timeout\")";
Debug.ShouldStop(2);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("Load timeout")));
 BA.debugLineNum = 259;BA.debugLine="NotifyError(\"Track loading timeout expired\")";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("LoadUrl (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,44);
...
Debug.ShouldStop(2048);
 BA.debugLineNum = 45;BA.debugLine="Reset";
Debug.ShouldStop(4096);
__ref.runClassMethod (b4j.example.audioplayer.class, "_reset" /*RemoteObject*/ );
 BA.debugLineNum = 46;BA.debugLine="currentLoadToken = currentLoadToken + 1";
Debug.ShouldStop(8192);
__ref.setField ("_currentloadtoken" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 2));
 BA.debugLineNum = 47;BA.debugLine="activeEventLoadToken = currentLoadToken";
Debug.ShouldStop(16384);
__ref.setField ("_activeeventloadtoken" /*RemoteObject*/ ,__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ));
 BA.debugLineNum = 48;BA.debugLine="loadTimer.Interval = 10 * DateTime.TicksPerSecond";
Debug.ShouldStop(32768);
...
__ref.setField ("_maxvolume" /*RemoteObject*/ ,audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(audioplayer.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, 1)),(Object)(_volume)))));
 BA.debugLineNum = 52;BA.debugLine="TraceAudio(\"LoadUrl. volume=\" & NumberFormat2(max";
Debug.ShouldStop(524288);
...
Debug.ShouldStop(1048576);
try { BA.debugLineNum = 54;BA.debugLine="player.Initialize(\"Player\", url)";
Debug.ShouldStop(2097152);
__ref.getField(false,"_player" /*RemoteObject*/ ).runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("Player")),(Object)(_url));
 BA.debugLineNum = 55;BA.debugLine="jo = player";
Debug.ShouldStop(4194304);
__ref.getField(false,"_jo" /*RemoteObject*/ ).setObject (__ref.getField(false,"_player" /*RemoteObject*/ ).getObject());
 BA.debugLineNum = 56;BA.debugLine="jo.RunMethod(\"setOnError\", Array As Object(jo.Cr";
Debug.ShouldStop(8388608);
__ref.getField(false,"_jo" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setOnError")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.getField(false,"_jo" /*RemoteObject*/ ).runMethod(false,"CreateEventFromUI",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("java.lang.Runnable")),(Object)(BA.ObjectToString("Error")),(Object)((audioplayer.__c.getField(true,"False"))))})));
 BA.debugLineNum = 57;BA.debugLine="jo.RunMethod(\"setOnReady\", Array As Object(jo.Cr";
Debug.ShouldStop(16777216);
__ref.getField(false,"_jo" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setOnReady")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.getField(false,"_jo" /*RemoteObject*/ ).runMethod(false,"CreateEventFromUI",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("java.lang.Runnable")),(Object)(BA.ObjectToString("Ready")),(Object)((audioplayer.__c.getField(true,"False"))))})));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e15.toString()); BA.debugLineNum = 59;BA.debugLine="NotifyError(LastException.Message)";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("NotifyError (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,220);
if (RapidSub.canDelegate("notifyerror")) { return __ref.runUserSub(false, "audioplayer","notifyerror", __ref, _message);}
Debug.locals.put("message", _message);
 BA.debugLineNum = 220;BA.debugLine="Private Sub NotifyError(message As String)";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 221;BA.debugLine="TraceAudio(\"NotifyError. message=\" & message)";
Debug.ShouldStop(268435456);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("NotifyError. message="),_message)));
 BA.debugLineNum = 222;BA.debugLine="Reset";
Debug.ShouldStop(536870912);
__ref.runClassMethod (b4j.example.audioplayer.class, "_reset" /*RemoteObject*/ );
 BA.debugLineNum = 223;BA.debugLine="targetPage.AudioPlayer_Error(audioKey, message)";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("Play (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,63);
if (RapidSub.canDelegate("play")) { return __ref.runUserSub(false, "audioplayer","play", __ref);}
 BA.debugLineNum = 63;BA.debugLine="Public Sub Play";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 64;BA.debugLine="PlayWithFade(0)";
Debug.ShouldStop(-2147483648);
...
try {
		Debug.PushSubsStack("Player_Complete (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,202);
if (RapidSub.canDelegate("player_complete")) { return __ref.runUserSub(false, "audioplayer","player_complete", __ref);}
 BA.debugLineNum = 202;BA.debugLine="Private Sub Player_Complete";
Debug.ShouldStop(512);
 BA.debugLineNum = 203;BA.debugLine="If activeEventLoadToken <> currentLoadToken Then";
Debug.ShouldStop(1024);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_activeeventloadtoken" /*RemoteObject*/ ),__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 204;BA.debugLine="TraceAudio(\"Complete ignored. stale_token=\" & ac";
Debug.ShouldStop(2048);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 207;BA.debugLine="If playerState = STATE_STOPPED Then Return";
Debug.ShouldStop(16384);
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 208;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(32768);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 209;BA.debugLine="checkTimer.Enabled = False";
Debug.ShouldStop(65536);
__ref.getField(false,"_checktimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 210;BA.debugLine="timeUpdateTimer.Enabled = False";
Debug.ShouldStop(131072);
__ref.getField(false,"_timeupdatetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 211;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(262144);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 212;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(524288);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 BA.debugLineNum = 213;BA.debugLine="currentVolume = 0";
Debug.ShouldStop(1048576);
__ref.setField ("_currentvolume" /*RemoteObject*/ ,BA.numberCast(double.class, 0));
 BA.debugLineNum = 214;BA.debugLine="stalledCheckCount = 0";
Debug.ShouldStop(2097152);
__ref.setField ("_stalledcheckcount" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 215;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(4194304);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 216;BA.debugLine="TraceAudio(\"Complete\")";
Debug.ShouldStop(8388608);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("Complete")));
 BA.debugLineNum = 217;BA.debugLine="targetPage.AudioPlayer_Complete(audioKey)";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("PlayWithFade (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,68);
...
Debug.locals.put("fadeTimeMs", _fadetimems);
 BA.debugLineNum = 68;BA.debugLine="Public Sub PlayWithFade(fadeTimeMs As Int)";
Debug.ShouldStop(8);
 BA.debugLineNum = 69;BA.debugLine="If playerState <> STATE_READY Then";
Debug.ShouldStop(16);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_playerstate" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_ready" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 70;BA.debugLine="TraceInternalError(\"play_with_fade_not_ready sta";
Debug.ShouldStop(32);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 73;BA.debugLine="playerState = STATE_PLAYING";
Debug.ShouldStop(256);
...
__ref.runClassMethod (b4j.example.audioplayer.class, "_setplayervolume" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_maxvolume" /*RemoteObject*/ )));
 ...
 BA.debugLineNum = 83;BA.debugLine="player.Play";
Debug.ShouldStop(262144);
__ref.getField(false,"_player" /*RemoteObject*/ ).runVoidMethod ("Play");
 BA.debugLineNum = 84;BA.debugLine="TraceAudio(\"PlayWithFade. fadeTimeMs=\" & fadeTime";
Debug.ShouldStop(524288);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("PlayWithFade. fadeTimeMs="),_fadetimems,RemoteObject.createImmutable(", maxVolume="),audioplayer.__c.runMethod(true,"NumberFormat2",(Object)(__ref.getField(true,"_maxvolume" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, 1)),(Object)(BA.numberCast(int.class, 3)),(Object)(BA.numberCast(int.class, 3)),(Object)(audioplayer.__c.getField(true,"False"))))));
 BA.debugLineNum = 85;BA.debugLine="If fadeTimeMs > 0 Then";
Debug.ShouldStop(1048576);
if (RemoteObject.solveBoolean(">",_fadetimems,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 86;BA.debugLine="StartFade(FADE_IN, maxVolume, fadeTimeMs)";
Debug.ShouldStop(2097152);
...
try {
		Debug.PushSubsStack("Position (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,156);
if (RapidSub.canDelegate("position")) { return __ref.runUserSub(false, "audioplayer","position", __ref);}
 BA.debugLineNum = 156;BA.debugLine="Public Sub Position As Long";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 157;BA.debugLine="If player.IsInitialized = False Then Return 0";
Debug.ShouldStop(268435456);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
if (true) return BA.numberCast(long.class, 0);};
 BA.debugLineNum = 158;BA.debugLine="Try";
Debug.ShouldStop(536870912);
try { BA.debugLineNum = 159;BA.debugLine="Return player.Position";
Debug.ShouldStop(1073741824);
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(long.class, __ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"getPosition"));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e5.toString()); BA.debugLineNum = 161;BA.debugLine="Return 0";
Debug.ShouldStop(1);
if (true) return BA.numberCast(long.class, 0);
 };
...
try {
		Debug.PushSubsStack("Ready_Event (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,175);
if (RapidSub.canDelegate("ready_event")) { return __ref.runUserSub(false, "audioplayer","ready_event", __ref, _methodname, _args);}
Debug.locals.put("methodName", _methodname);
Debug.locals.put("args", _args);
 BA.debugLineNum = 175;BA.debugLine="Private Sub Ready_Event(methodName As String, args";
Debug.ShouldStop(16384);
 BA.debugLineNum = 176;BA.debugLine="If activeEventLoadToken <> currentLoadToken Then";
Debug.ShouldStop(32768);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_activeeventloadtoken" /*RemoteObject*/ ),__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 177;BA.debugLine="TraceAudio(\"Ready ignored. stale_token=\" & activ";
Debug.ShouldStop(65536);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 180;BA.debugLine="playerState = STATE_READY";
Debug.ShouldStop(524288);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_ready" /*RemoteObject*/ ));
 BA.debugLineNum = 181;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(1048576);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 182;BA.debugLine="TraceAudio(\"Ready\")";
Debug.ShouldStop(2097152);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("Ready")));
 BA.debugLineNum = 183;BA.debugLine="targetPage.AudioPlayer_Ready(audioKey)";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("Reset (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,112);
if (RapidSub.canDelegate("reset")) { return __ref.runUserSub(false, "audioplayer","reset", __ref);}
 BA.debugLineNum = 112;BA.debugLine="Public Sub Reset";
Debug.ShouldStop(32768);
 BA.debugLineNum = 113;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(65536);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 114;BA.debugLine="checkTimer.Enabled = False";
Debug.ShouldStop(131072);
__ref.getField(false,"_checktimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 115;BA.debugLine="timeUpdateTimer.Enabled = False";
Debug.ShouldStop(262144);
__ref.getField(false,"_timeupdatetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 116;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(524288);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 117;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(1048576);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 BA.debugLineNum = 118;BA.debugLine="lastPosition = 0";
Debug.ShouldStop(2097152);
__ref.setField ("_lastposition" /*RemoteObject*/ ,BA.numberCast(long.class, 0));
 BA.debugLineNum = 119;BA.debugLine="stalledCheckCount = 0";
Debug.ShouldStop(4194304);
__ref.setField ("_stalledcheckcount" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 120;BA.debugLine="currentVolume = 0";
Debug.ShouldStop(8388608);
__ref.setField ("_currentvolume" /*RemoteObject*/ ,BA.numberCast(double.class, 0));
 BA.debugLineNum = 121;BA.debugLine="activeEventLoadToken = 0";
Debug.ShouldStop(16777216);
__ref.setField ("_activeeventloadtoken" /*RemoteObject*/ ,BA.numberCast(long.class, 0));
 BA.debugLineNum = 122;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(33554432);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 123;BA.debugLine="If player.IsInitialized Then";
Debug.ShouldStop(67108864);
...
Debug.ShouldStop(134217728);
try { BA.debugLineNum = 125;BA.debugLine="player.Volume = 0";
Debug.ShouldStop(268435456);
__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"setVolume",BA.numberCast(double.class, 0));
 BA.debugLineNum = 126;BA.debugLine="player.Stop";
Debug.ShouldStop(536870912);
__ref.getField(false,"_player" /*RemoteObject*/ ).runVoidMethod ("Stop");
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e16) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e16.toString()); BA.debugLineNum = 128;BA.debugLine="TraceInternalError(\"reset_stop\")";
Debug.ShouldStop(-2147483648);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceinternalerror" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("reset_stop")));
 ...
 BA.debugLineNum = 130;BA.debugLine="If jo.IsInitialized Then";
Debug.ShouldStop(2);
...
Debug.ShouldStop(4);
try { BA.debugLineNum = 132;BA.debugLine="jo.RunMethod(\"dispose\", Null)";
Debug.ShouldStop(8);
__ref.getField(false,"_jo" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("dispose")),(Object)((audioplayer.__c.getField(false,"Null"))));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e22.toString()); BA.debugLineNum = 134;BA.debugLine="TraceInternalError(\"reset_dispose\")";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("ResolveAudioKey (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,342);
...
Debug.locals.put("nameValue", _namevalue);
 BA.debugLineNum = 342;BA.debugLine="Private Sub ResolveAudioKey(nameValue As String) A";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 343;BA.debugLine="If nameValue.ToLowerCase.Contains(\"secondary\") Th";
Debug.ShouldStop(4194304);
...
if (true) return BA.ObjectToString("secondary");};
 BA.debugLineNum = 344;BA.debugLine="Return \"primary\"";
Debug.ShouldStop(8388608);
...
try {
		Debug.PushSubsStack("SetPlayerVolume (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,305);
...
Debug.locals.put("volumeValue", _volumevalue);
 BA.debugLineNum = 305;BA.debugLine="Private Sub SetPlayerVolume(volumeValue As Double)";
Debug.ShouldStop(65536);
 BA.debugLineNum = 306;BA.debugLine="currentVolume = Max(0, Min(1, volumeValue))";
Debug.ShouldStop(131072);
__ref.setField ("_currentvolume" /*RemoteObject*/ ,audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(audioplayer.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, 1)),(Object)(_volumevalue)))));
 BA.debugLineNum = 307;BA.debugLine="If player.IsInitialized = False Then Return";
Debug.ShouldStop(262144);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 308;BA.debugLine="Try";
Debug.ShouldStop(524288);
try { BA.debugLineNum = 309;BA.debugLine="player.Volume = currentVolume";
Debug.ShouldStop(1048576);
__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"setVolume",__ref.getField(true,"_currentvolume" /*RemoteObject*/ ));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e6.toString()); BA.debugLineNum = 311;BA.debugLine="TraceInternalError(\"set_volume\")";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("StartFade (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,288);
...
Debug.locals.put("fadeTimeMs", _fadetimems);
 BA.debugLineNum = 288;BA.debugLine="Private Sub StartFade(mode As Int, targetVolume As";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 289;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(1);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 290;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(2);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 BA.debugLineNum = 291;BA.debugLine="If player.IsInitialized = False Then Return";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 292;BA.debugLine="If fadeTimeMs <= 0 Then";
Debug.ShouldStop(8);
if (RemoteObject.solveBoolean("k",_fadetimems,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 293;BA.debugLine="SetPlayerVolume(targetVolume)";
Debug.ShouldStop(16);
__ref.runClassMethod (b4j.example.audioplayer.class, "_setplayervolume" /*RemoteObject*/ ,(Object)(_targetvolume));
 BA.debugLineNum = 294;BA.debugLine="If targetVolume <= 0 Then StopImmediately";
Debug.ShouldStop(32);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 297;BA.debugLine="Dim intervalMs As Int = Max(20, fadeTimer.Interva";
Debug.ShouldStop(256);
_intervalms = BA.numberCast(int.class, audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 20)),(Object)(BA.numberCast(double.class, __ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"getInterval")))));Debug.locals.put("intervalMs", _intervalms);Debug.locals.put("intervalMs", _intervalms);
 BA.debugLineNum = 298;BA.debugLine="Dim steps As Int = Max(1, Ceil(fadeTimeMs / inter";
Debug.ShouldStop(512);
_steps = BA.numberCast(int.class, audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 1)),(Object)(audioplayer.__c.runMethod(true,"Ceil",(Object)(RemoteObject.solve(new RemoteObject[] {_fadetimems,_intervalms}, "/",0, 0))))));Debug.locals.put("steps", _steps);Debug.locals.put("steps", _steps);
 BA.debugLineNum = 299;BA.debugLine="fadeMode = mode";
Debug.ShouldStop(1024);
__ref.setField ("_fademode" /*RemoteObject*/ ,_mode);
 BA.debugLineNum = 300;BA.debugLine="fadeTargetVolume = targetVolume";
Debug.ShouldStop(2048);
__ref.setField ("_fadetargetvolume" /*RemoteObject*/ ,_targetvolume);
 BA.debugLineNum = 301;BA.debugLine="fadeStepVolume = (targetVolume - currentVolume) /";
Debug.ShouldStop(4096);
__ref.setField ("_fadestepvolume" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_targetvolume,__ref.getField(true,"_currentvolume" /*RemoteObject*/ )}, "-",1, 0)),_steps}, "/",0, 0));
 BA.debugLineNum = 302;BA.debugLine="fadeTimer.Enabled = True";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("Stop (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,91);
if (RapidSub.canDelegate("stop")) { return __ref.runUserSub(false, "audioplayer","stop", __ref, _fadetimems);}
Debug.locals.put("fadeTimeMs", _fadetimems);
 BA.debugLineNum = 91;BA.debugLine="Public Sub Stop(fadeTimeMs As Int)";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 92;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(134217728);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 93;BA.debugLine="checkTimer.Enabled = False";
Debug.ShouldStop(268435456);
__ref.getField(false,"_checktimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 94;BA.debugLine="timeUpdateTimer.Enabled = False";
Debug.ShouldStop(536870912);
__ref.getField(false,"_timeupdatetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 95;BA.debugLine="lastPosition = 0";
Debug.ShouldStop(1073741824);
__ref.setField ("_lastposition" /*RemoteObject*/ ,BA.numberCast(long.class, 0));
 BA.debugLineNum = 96;BA.debugLine="stalledCheckCount = 0";
Debug.ShouldStop(-2147483648);
__ref.setField ("_stalledcheckcount" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 97;BA.debugLine="If player.IsInitialized = False Then";
Debug.ShouldStop(1);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
 BA.debugLineNum = 98;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(2);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 99;BA.debugLine="TraceAudio(\"Stop ignored. player not initialized";
Debug.ShouldStop(4);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 102;BA.debugLine="TraceAudio(\"Stop. fadeTimeMs=\" & fadeTimeMs & \",";
Debug.ShouldStop(32);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Stop. fadeTimeMs="),_fadetimems,RemoteObject.createImmutable(", currentVolume="),audioplayer.__c.runMethod(true,"NumberFormat2",(Object)(__ref.getField(true,"_currentvolume" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, 1)),(Object)(BA.numberCast(int.class, 3)),(Object)(BA.numberCast(int.class, 3)),(Object)(audioplayer.__c.getField(true,"False"))))));
 BA.debugLineNum = 103;BA.debugLine="If fadeTimeMs > 0 And currentVolume > 0 Then";
Debug.ShouldStop(64);
...
Debug.ShouldStop(128);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 105;BA.debugLine="StartFade(FADE_OUT, 0, fadeTimeMs)";
Debug.ShouldStop(256);
__ref.runClassMethod (b4j.example.audioplayer.class, "_startfade" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_fade_out" /*RemoteObject*/ )),(Object)(BA.numberCast(double.class, 0)),(Object)(_fadetimems));
 ...
 BA.debugLineNum = 107;BA.debugLine="StopImmediately";
Debug.ShouldStop(1024);
__ref.runClassMethod (b4j.example.audioplayer.class, "_stopimmediately" /*RemoteObject*/ );
 };
...
try {
		Debug.PushSubsStack("StopImmediately (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,315);
if (RapidSub.canDelegate("stopimmediately")) { return __ref.runUserSub(false, "audioplayer","stopimmediately", __ref);}
 BA.debugLineNum = 315;BA.debugLine="Private Sub StopImmediately";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 316;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(134217728);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 317;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(268435456);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 BA.debugLineNum = 318;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(536870912);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 319;BA.debugLine="currentVolume = 0";
Debug.ShouldStop(1073741824);
__ref.setField ("_currentvolume" /*RemoteObject*/ ,BA.numberCast(double.class, 0));
 BA.debugLineNum = 320;BA.debugLine="TraceAudio(\"StopImmediately\")";
Debug.ShouldStop(-2147483648);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("StopImmediately")));
 BA.debugLineNum = 321;BA.debugLine="If player.IsInitialized = False Then Return";
Debug.ShouldStop(1);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 322;BA.debugLine="Try";
Debug.ShouldStop(2);
try { BA.debugLineNum = 323;BA.debugLine="player.Volume = 0";
Debug.ShouldStop(4);
__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"setVolume",BA.numberCast(double.class, 0));
 BA.debugLineNum = 324;BA.debugLine="player.Stop";
Debug.ShouldStop(8);
__ref.getField(false,"_player" /*RemoteObject*/ ).runVoidMethod ("Stop");
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e11) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e11.toString()); BA.debugLineNum = 326;BA.debugLine="TraceInternalError(\"stop_immediately\")";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("TimeUpdateTimer_Tick (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,226);
if (RapidSub.canDelegate("timeupdatetimer_tick")) { return __ref.runUserSub(false, "audioplayer","timeupdatetimer_tick", __ref);}
 BA.debugLineNum = 226;BA.debugLine="Private Sub TimeUpdateTimer_Tick";
Debug.ShouldStop(2);
 BA.debugLineNum = 227;BA.debugLine="If playerState <> STATE_PLAYING Then Return";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_playerstate" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_playing" /*RemoteObject*/ )))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 228;BA.debugLine="If activeEventLoadToken <> currentLoadToken Then";
Debug.ShouldStop(8);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_activeeventloadtoken" /*RemoteObject*/ ),__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 229;BA.debugLine="targetPage.AudioPlayer_Timeupdate(audioKey)";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("TraceAudio (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,338);
if (RapidSub.canDelegate("traceaudio")) { return __ref.runUserSub(false, "audioplayer","traceaudio", __ref, _message);}
Debug.locals.put("message", _message);
 BA.debugLineNum = 338;BA.debugLine="Private Sub TraceAudio(message As String)";
Debug.ShouldStop(131072);
 BA.debugLineNum = 339;BA.debugLine="targetPage.TraceLog(\"[\" & eventName & \"] \" & mess";
Debug.ShouldStop(262144);
...
try {
		Debug.PushSubsStack("TraceDiagnostic (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,334);
if (RapidSub.canDelegate("tracediagnostic")) { return __ref.runUserSub(false, "audioplayer","tracediagnostic", __ref, _message);}
Debug.locals.put("message", _message);
 BA.debugLineNum = 334;BA.debugLine="Private Sub TraceDiagnostic(message As String)";
Debug.ShouldStop(8192);
 BA.debugLineNum = 335;BA.debugLine="targetPage.TraceLog(message)";
Debug.ShouldStop(16384);
...
try {
		Debug.PushSubsStack("TraceInternalError (audioplayer) ","audioplayer",23,__ref.getField(false, "ba"),__ref,330);
...
Debug.locals.put("context", _context);
 BA.debugLineNum = 330;BA.debugLine="Private Sub TraceInternalError(context As String)";
Debug.ShouldStop(512);
 BA.debugLineNum = 331;BA.debugLine="targetPage.TraceLog(\"ошибка аудио internal contex";
Debug.ShouldStop(1024);
