...
try {
		Debug.PushSubsStack("CheckTimer_Tick (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,223);
...
RemoteObject _remainms = RemoteObject.createImmutable(0L);
 BA.debugLineNum = 223;BA.debugLine="Private Sub CheckTimer_Tick";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 224;BA.debugLine="If playerState <> STATE_PLAYING Then Return";
...
_positionnow = __ref.runClassMethod (b4j.example.audioplayer.class, "_position" /*RemoteObject*/ );Debug.locals.put("positionNow", _positionnow);Debug.locals.put("positionNow", _positionnow);
 BA.debugLineNum = 226;BA.debugLine="If positionNow > lastPosition Then";
Debug.ShouldStop(2);
if (RemoteObject.solveBoolean(">",_positionnow,__ref.getField(true,"_lastposition" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 227;BA.debugLine="lastPosition = positionNow";
Debug.ShouldStop(4);
__ref.setField ("_lastposition" /*RemoteObject*/ ,_positionnow);
 BA.debugLineNum = 228;BA.debugLine="stalledCheckCount = 0";
Debug.ShouldStop(8);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 231;BA.debugLine="Dim durationNow As Long = Duration";
Debug.ShouldStop(64);
_durationnow = __ref.runClassMethod (b4j.example.audioplayer.class, "_duration" /*RemoteObject*/ );Debug.locals.put("durationNow", _durationnow);Debug.locals.put("durationNow", _durationnow);
 BA.debugLineNum = 232;BA.debugLine="Dim remainMs As Long = -1";
...
_remainms = BA.numberCast(long.class, -(double) (0 + 1));Debug.locals.put("remainMs", _remainms);Debug.locals.put("remainMs", _remainms);
 BA.debugLineNum = 233;BA.debugLine="If durationNow > 0 Then remainMs = Max(0, duratio";
...
_remainms = BA.numberCast(long.class, audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {_durationnow,_positionnow}, "-",1, 2)))));Debug.locals.put("remainMs", _remainms);};
 BA.debugLineNum = 234;BA.debugLine="If durationNow > 0 And positionNow >= Max(0, dura";
...
if (RemoteObject.solveBoolean(">",_durationnow,BA.numberCast(long.class, 0)) && RemoteObject.solveBoolean("g",_positionnow,BA.numberCast(long.class, audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {_durationnow,RemoteObject.createImmutable(2000)}, "-",1, 2))))))) { 
 BA.debugLineNum = 235;BA.debugLine="TraceDiagnostic(\"хвост audio=\" & eventName & \" p";
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 238;BA.debugLine="stalledCheckCount = stalledCheckCount + 1";
...
__ref.setField ("_stalledcheckcount" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_stalledcheckcount" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1));
 BA.debugLineNum = 239;BA.debugLine="If stalledCheckCount = 1 Or stalledCheckCount = 3";
...
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_stalledcheckcount" /*RemoteObject*/ ),BA.numberCast(double.class, 1)) || RemoteObject.solveBoolean("=",__ref.getField(true,"_stalledcheckcount" /*RemoteObject*/ ),BA.numberCast(double.class, 3))) { 
 BA.debugLineNum = 240;BA.debugLine="TraceDiagnostic(\"задержка audio=\" & eventName &";
...
__ref.runClassMethod (b4j.example.audioplayer.class, "_tracediagnostic" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("задержка audio="),__ref.getField(true,"_eventname" /*RemoteObject*/ ),RemoteObject.createImmutable(" positionMs="),_positionnow,RemoteObject.createImmutable(" durationMs="),_durationnow,RemoteObject.createImmutable(" remainMs="),_remainms,RemoteObject.createImmutable(" stalled="),__ref.getField(true,"_stalledcheckcount" /*RemoteObject*/ ))));
 ...
 BA.debugLineNum = 242;BA.debugLine="If stalledCheckCount < SILENCE_STALL_THRESHOLD Th";
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 243;BA.debugLine="NotifyError(\"Silence detected \" & SILENCE_STALL_T";
...
audioplayer._fade_out = BA.numberCast(int.class, 2);__ref.setField("_fade_out",audioplayer._fade_out);
 //BA.debugLineNum = 5;BA.debugLine="Private Const CHECK_TIMER_INTERVAL_MS As Int = 20";
audioplayer._check_timer_interval_ms = BA.numberCast(int.class, 2000);__ref.setField("_check_timer_interval_ms",audioplayer._check_timer_interval_ms);
 //BA.debugLineNum = 6;BA.debugLine="Private Const SILENCE_STALL_THRESHOLD As Int = 3";
audioplayer._silence_stall_threshold = BA.numberCast(int.class, 3);__ref.setField("_silence_stall_threshold",audioplayer._silence_stall_threshold);
 //BA.debugLineNum = 8;BA.debugLine="Private player As MediaPlayer";
audioplayer._player = RemoteObject.createNew ("anywheresoftware.b4j.objects.MediaPlayerWrapper");__ref.setField("_player",audioplayer._player);
 //BA.debugLineNum = 9;BA.debugLine="Private jo As JavaObject";
...
audioplayer._eventname = RemoteObject.createImmutable("");__ref.setField("_eventname",audioplayer._eventname);
 //BA.debugLineNum = 11;BA.debugLine="Private targetPage As B4XMainPage";
audioplayer._targetpage = RemoteObject.createNew ("b4j.example.b4xmainpage");__ref.setField("_targetpage",audioplayer._targetpage);
 //BA.debugLineNum = 12;BA.debugLine="Private timeUpdateTimer As Timer";
audioplayer._timeupdatetimer = RemoteObject.createNew ("anywheresoftware.b4a.objects.Timer");__ref.setField("_timeupdatetimer",audioplayer._timeupdatetimer);
 //BA.debugLineNum = 13;BA.debugLine="Private lastPosition As Long";
audioplayer._lastposition = RemoteObject.createImmutable(0L);__ref.setField("_lastposition",audioplayer._lastposition);
 //BA.debugLineNum = 14;BA.debugLine="Private checkTimer As Timer";
audioplayer._checktimer = RemoteObject.createNew ("anywheresoftware.b4a.objects.Timer");__ref.setField("_checktimer",audioplayer._checktimer);
 //BA.debugLineNum = 15;BA.debugLine="Private loadTimer As Timer";
audioplayer._loadtimer = RemoteObject.createNew ("anywheresoftware.b4a.objects.Timer");__ref.setField("_loadtimer",audioplayer._loadtimer);
 //BA.debugLineNum = 16;BA.debugLine="Private fadeTimer As Timer";
...
audioplayer._stalledcheckcount = RemoteObject.createImmutable(0);__ref.setField("_stalledcheckcount",audioplayer._stalledcheckcount);
 //BA.debugLineNum = 24;BA.debugLine="Private currentLoadToken As Long";
audioplayer._currentloadtoken = RemoteObject.createImmutable(0L);__ref.setField("_currentloadtoken",audioplayer._currentloadtoken);
 //BA.debugLineNum = 25;BA.debugLine="Private activeEventLoadToken As Long";
audioplayer._activeeventloadtoken = RemoteObject.createImmutable(0L);__ref.setField("_activeeventloadtoken",audioplayer._activeeventloadtoken);
 //BA.debugLineNum = 26;BA.debugLine="Private audioKey As String";
...
try {
		Debug.PushSubsStack("Duration (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,158);
if (RapidSub.canDelegate("duration")) { return __ref.runUserSub(false, "audioplayer","duration", __ref);}
 BA.debugLineNum = 158;BA.debugLine="Public Sub Duration As Long";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 159;BA.debugLine="If player.IsInitialized = False Then Return 0";
Debug.ShouldStop(1073741824);
...
Debug.ShouldStop(-2147483648);
try { BA.debugLineNum = 161;BA.debugLine="Return player.Duration";
Debug.ShouldStop(1);
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(long.class, __ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"getDuration"));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e5.toString()); BA.debugLineNum = 163;BA.debugLine="Return 0";
Debug.ShouldStop(4);
if (true) return BA.numberCast(long.class, 0);
 };
...
try {
		Debug.PushSubsStack("Error_Event (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,178);
...
Debug.locals.put("args", _args);
 BA.debugLineNum = 178;BA.debugLine="Private Sub Error_Event(methodName As String, args";
Debug.ShouldStop(131072);
 BA.debugLineNum = 179;BA.debugLine="If activeEventLoadToken <> currentLoadToken Then";
Debug.ShouldStop(262144);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_activeeventloadtoken" /*RemoteObject*/ ),__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 180;BA.debugLine="TraceAudio(\"Error ignored. stale_token=\" & activ";
Debug.ShouldStop(524288);
...
try { BA.debugLineNum = 185;BA.debugLine="msg = jo.RunMethod(\"getError\", Null)";
...
_msg = BA.ObjectToString(__ref.getField(false,"_jo" /*RemoteObject*/ ).runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getError")),(Object)((audioplayer.__c.getField(false,"Null")))));Debug.locals.put("msg", _msg);
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e9.toString()); BA.debugLineNum = 187;BA.debugLine="msg = LastException.Message";
...
_msg = audioplayer.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage");Debug.locals.put("msg", _msg);
 ...
 BA.debugLineNum = 189;BA.debugLine="TraceAudio(\"Error_Event. message=\" & msg)";
...
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Error_Event. message="),_msg)));
 BA.debugLineNum = 190;BA.debugLine="NotifyError(msg)";
Debug.ShouldStop(536870912);
...
try {
		Debug.PushSubsStack("FadeTimer_Tick (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,252);
...
RemoteObject _nextvolume = RemoteObject.createImmutable(0);
 BA.debugLineNum = 252;BA.debugLine="Private Sub FadeTimer_Tick";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 253;BA.debugLine="If player.IsInitialized = False Then";
Debug.ShouldStop(268435456);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
 BA.debugLineNum = 254;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(536870912);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 255;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(1073741824);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 258;BA.debugLine="Dim nextVolume As Double = currentVolume + fadeSt";
Debug.ShouldStop(2);
_nextvolume = RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_currentvolume" /*RemoteObject*/ ),__ref.getField(true,"_fadestepvolume" /*RemoteObject*/ )}, "+",1, 0);Debug.locals.put("nextVolume", _nextvolume);Debug.locals.put("nextVolume", _nextvolume);
 BA.debugLineNum = 259;BA.debugLine="If fadeMode = FADE_IN Then";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_fademode" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_fade_in" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 260;BA.debugLine="If nextVolume >= fadeTargetVolume Then";
Debug.ShouldStop(8);
if (RemoteObject.solveBoolean("g",_nextvolume,__ref.getField(true,"_fadetargetvolume" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 261;BA.debugLine="nextVolume = fadeTargetVolume";
Debug.ShouldStop(16);
_nextvolume = __ref.getField(true,"_fadetargetvolume" /*RemoteObject*/ );Debug.locals.put("nextVolume", _nextvolume);
 BA.debugLineNum = 262;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(32);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 263;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(64);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 };
 }else 
{ BA.debugLineNum = 265;BA.debugLine="Else If fadeMode = FADE_OUT Then";
Debug.ShouldStop(256);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_fademode" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_fade_out" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 266;BA.debugLine="If nextVolume <= fadeTargetVolume Then";
Debug.ShouldStop(512);
if (RemoteObject.solveBoolean("k",_nextvolume,__ref.getField(true,"_fadetargetvolume" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 267;BA.debugLine="nextVolume = fadeTargetVolume";
Debug.ShouldStop(1024);
_nextvolume = __ref.getField(true,"_fadetargetvolume" /*RemoteObject*/ );Debug.locals.put("nextVolume", _nextvolume);
 BA.debugLineNum = 268;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(2048);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 269;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(4096);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 };
 }}
;
 BA.debugLineNum = 272;BA.debugLine="SetPlayerVolume(nextVolume)";
Debug.ShouldStop(32768);
__ref.runClassMethod (b4j.example.audioplayer.class, "_setplayervolume" /*RemoteObject*/ ,(Object)(_nextvolume));
 BA.debugLineNum = 273;BA.debugLine="If fadeMode = FADE_NONE And nextVolume <= 0 Then";
...
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_fademode" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_fade_none" /*RemoteObject*/ ))) && RemoteObject.solveBoolean("k",_nextvolume,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 274;BA.debugLine="StopImmediately";
Debug.ShouldStop(131072);
...
try {
		Debug.PushSubsStack("Initialize (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,29);
...
Debug.locals.put("targetPageValue", _targetpagevalue);
 BA.debugLineNum = 29;BA.debugLine="Public Sub Initialize (eventNameValue As String, t";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 30;BA.debugLine="eventName = eventNameValue";
Debug.ShouldStop(536870912);
__ref.setField ("_eventname" /*RemoteObject*/ ,_eventnamevalue);
 BA.debugLineNum = 31;BA.debugLine="targetPage = targetPageValue";
Debug.ShouldStop(1073741824);
__ref.setField ("_targetpage" /*RemoteObject*/ ,_targetpagevalue);
 BA.debugLineNum = 32;BA.debugLine="audioKey = ResolveAudioKey(eventName)";
Debug.ShouldStop(-2147483648);
__ref.setField ("_audiokey" /*RemoteObject*/ ,__ref.runClassMethod (b4j.example.audioplayer.class, "_resolveaudiokey" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_eventname" /*RemoteObject*/ ))));
 BA.debugLineNum = 33;BA.debugLine="loadTimer.Initialize(\"LoadTimer\", 10 * DateTime.T";
Debug.ShouldStop(1);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("LoadTimer")),(Object)(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(10),audioplayer.__c.getField(false,"DateTime").getField(true,"TicksPerSecond")}, "*",0, 2)));
 BA.debugLineNum = 34;BA.debugLine="checkTimer.Initialize(\"CheckTimer\", CHECK_TIMER_I";
Debug.ShouldStop(2);
__ref.getField(false,"_checktimer" /*RemoteObject*/ ).runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("CheckTimer")),(Object)(BA.numberCast(long.class, __ref.getField(true,"_check_timer_interval_ms" /*RemoteObject*/ ))));
 BA.debugLineNum = 35;BA.debugLine="timeUpdateTimer.Initialize(\"TimeUpdateTimer\", 250";
Debug.ShouldStop(4);
__ref.getField(false,"_timeupdatetimer" /*RemoteObject*/ ).runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("TimeUpdateTimer")),(Object)(BA.numberCast(long.class, 250)));
 BA.debugLineNum = 36;BA.debugLine="fadeTimer.Initialize(\"FadeTimer\", 40)";
Debug.ShouldStop(8);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("FadeTimer")),(Object)(BA.numberCast(long.class, 40)));
 BA.debugLineNum = 37;BA.debugLine="TraceAudio(\"Initialize\")";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("IsLoading (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,137);
if (RapidSub.canDelegate("isloading")) { return __ref.runUserSub(false, "audioplayer","isloading", __ref);}
 BA.debugLineNum = 137;BA.debugLine="Public Sub IsLoading As Boolean";
Debug.ShouldStop(256);
 BA.debugLineNum = 138;BA.debugLine="Return playerState = STATE_LOADING";
Debug.ShouldStop(512);
...
try {
		Debug.PushSubsStack("IsPlaying (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,145);
if (RapidSub.canDelegate("isplaying")) { return __ref.runUserSub(false, "audioplayer","isplaying", __ref);}
 BA.debugLineNum = 145;BA.debugLine="Public Sub IsPlaying As Boolean";
Debug.ShouldStop(65536);
 BA.debugLineNum = 146;BA.debugLine="Return playerState = STATE_PLAYING";
Debug.ShouldStop(131072);
...
try {
		Debug.PushSubsStack("IsReady (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,141);
if (RapidSub.canDelegate("isready")) { return __ref.runUserSub(false, "audioplayer","isready", __ref);}
 BA.debugLineNum = 141;BA.debugLine="Public Sub IsReady As Boolean";
Debug.ShouldStop(4096);
 BA.debugLineNum = 142;BA.debugLine="Return playerState = STATE_READY";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("IsStopped (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,133);
if (RapidSub.canDelegate("isstopped")) { return __ref.runUserSub(false, "audioplayer","isstopped", __ref);}
 BA.debugLineNum = 133;BA.debugLine="Public Sub IsStopped As Boolean";
Debug.ShouldStop(16);
 BA.debugLineNum = 134;BA.debugLine="Return playerState = STATE_STOPPED";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("LoadTimer_Tick (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,246);
if (RapidSub.canDelegate("loadtimer_tick")) { return __ref.runUserSub(false, "audioplayer","loadtimer_tick", __ref);}
 BA.debugLineNum = 246;BA.debugLine="Private Sub LoadTimer_Tick";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 247;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(4194304);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 248;BA.debugLine="TraceAudio(\"Load timeout\")";
Debug.ShouldStop(8388608);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("Load timeout")));
 BA.debugLineNum = 249;BA.debugLine="NotifyError(\"Track loading timeout expired\")";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("LoadUrl (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,40);
...
Debug.locals.put("volume", _volume);
 BA.debugLineNum = 40;BA.debugLine="Public Sub LoadUrl(url As String, volume As Double";
Debug.ShouldStop(128);
 BA.debugLineNum = 41;BA.debugLine="Reset";
Debug.ShouldStop(256);
__ref.runClassMethod (b4j.example.audioplayer.class, "_reset" /*RemoteObject*/ );
 BA.debugLineNum = 42;BA.debugLine="currentLoadToken = currentLoadToken + 1";
Debug.ShouldStop(512);
__ref.setField ("_currentloadtoken" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 2));
 BA.debugLineNum = 43;BA.debugLine="activeEventLoadToken = currentLoadToken";
Debug.ShouldStop(1024);
__ref.setField ("_activeeventloadtoken" /*RemoteObject*/ ,__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ));
 BA.debugLineNum = 44;BA.debugLine="loadTimer.Interval = 10 * DateTime.TicksPerSecond";
Debug.ShouldStop(2048);
...
__ref.setField ("_maxvolume" /*RemoteObject*/ ,audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(audioplayer.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, 1)),(Object)(_volume)))));
 BA.debugLineNum = 48;BA.debugLine="TraceAudio(\"LoadUrl. volume=\" & NumberFormat2(max";
Debug.ShouldStop(32768);
...
Debug.ShouldStop(65536);
try { BA.debugLineNum = 50;BA.debugLine="player.Initialize(\"Player\", url)";
Debug.ShouldStop(131072);
__ref.getField(false,"_player" /*RemoteObject*/ ).runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("Player")),(Object)(_url));
 BA.debugLineNum = 51;BA.debugLine="jo = player";
Debug.ShouldStop(262144);
__ref.getField(false,"_jo" /*RemoteObject*/ ).setObject (__ref.getField(false,"_player" /*RemoteObject*/ ).getObject());
 BA.debugLineNum = 52;BA.debugLine="jo.RunMethod(\"setOnError\", Array As Object(jo.Cr";
Debug.ShouldStop(524288);
__ref.getField(false,"_jo" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setOnError")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.getField(false,"_jo" /*RemoteObject*/ ).runMethod(false,"CreateEventFromUI",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("java.lang.Runnable")),(Object)(BA.ObjectToString("Error")),(Object)((audioplayer.__c.getField(true,"False"))))})));
 BA.debugLineNum = 53;BA.debugLine="jo.RunMethod(\"setOnReady\", Array As Object(jo.Cr";
Debug.ShouldStop(1048576);
__ref.getField(false,"_jo" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setOnReady")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {__ref.getField(false,"_jo" /*RemoteObject*/ ).runMethod(false,"CreateEventFromUI",__ref.getField(false, "ba"),(Object)(BA.ObjectToString("java.lang.Runnable")),(Object)(BA.ObjectToString("Ready")),(Object)((audioplayer.__c.getField(true,"False"))))})));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e15.toString()); BA.debugLineNum = 55;BA.debugLine="NotifyError(LastException.Message)";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("NotifyError (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,211);
if (RapidSub.canDelegate("notifyerror")) { return __ref.runUserSub(false, "audioplayer","notifyerror", __ref, _message);}
Debug.locals.put("message", _message);
 BA.debugLineNum = 211;BA.debugLine="Private Sub NotifyError(message As String)";
Debug.ShouldStop(262144);
 BA.debugLineNum = 212;BA.debugLine="TraceAudio(\"NotifyError. message=\" & message)";
Debug.ShouldStop(524288);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("NotifyError. message="),_message)));
 BA.debugLineNum = 213;BA.debugLine="Reset";
Debug.ShouldStop(1048576);
__ref.runClassMethod (b4j.example.audioplayer.class, "_reset" /*RemoteObject*/ );
 BA.debugLineNum = 214;BA.debugLine="targetPage.AudioPlayer_Error(audioKey, message)";
Debug.ShouldStop(2097152);
...
try {
		Debug.PushSubsStack("Play (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,59);
if (RapidSub.canDelegate("play")) { return __ref.runUserSub(false, "audioplayer","play", __ref);}
 BA.debugLineNum = 59;BA.debugLine="Public Sub Play";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 60;BA.debugLine="PlayWithFade(0)";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("Player_Complete (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,193);
if (RapidSub.canDelegate("player_complete")) { return __ref.runUserSub(false, "audioplayer","player_complete", __ref);}
 BA.debugLineNum = 193;BA.debugLine="Private Sub Player_Complete";
Debug.ShouldStop(1);
 BA.debugLineNum = 194;BA.debugLine="If activeEventLoadToken <> currentLoadToken Then";
Debug.ShouldStop(2);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_activeeventloadtoken" /*RemoteObject*/ ),__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 195;BA.debugLine="TraceAudio(\"Complete ignored. stale_token=\" & ac";
Debug.ShouldStop(4);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 198;BA.debugLine="If playerState = STATE_STOPPED Then Return";
Debug.ShouldStop(32);
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 199;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(64);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 200;BA.debugLine="checkTimer.Enabled = False";
Debug.ShouldStop(128);
__ref.getField(false,"_checktimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 201;BA.debugLine="timeUpdateTimer.Enabled = False";
Debug.ShouldStop(256);
__ref.getField(false,"_timeupdatetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 202;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(512);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 203;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(1024);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 BA.debugLineNum = 204;BA.debugLine="currentVolume = 0";
Debug.ShouldStop(2048);
__ref.setField ("_currentvolume" /*RemoteObject*/ ,BA.numberCast(double.class, 0));
 BA.debugLineNum = 205;BA.debugLine="stalledCheckCount = 0";
Debug.ShouldStop(4096);
__ref.setField ("_stalledcheckcount" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 206;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(8192);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 207;BA.debugLine="TraceAudio(\"Complete\")";
Debug.ShouldStop(16384);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("Complete")));
 BA.debugLineNum = 208;BA.debugLine="targetPage.AudioPlayer_Complete(audioKey)";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("PlayWithFade (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,63);
...
Debug.locals.put("fadeTimeMs", _fadetimems);
 BA.debugLineNum = 63;BA.debugLine="Public Sub PlayWithFade(fadeTimeMs As Int)";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 64;BA.debugLine="If playerState <> STATE_READY Then";
Debug.ShouldStop(-2147483648);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_playerstate" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_ready" /*RemoteObject*/ )))) { 
 BA.debugLineNum = 65;BA.debugLine="TraceInternalError(\"play_with_fade_not_ready sta";
Debug.ShouldStop(1);
...
__ref.runClassMethod (b4j.example.audioplayer.class, "_setplayervolume" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_maxvolume" /*RemoteObject*/ )));
 ...
 BA.debugLineNum = 78;BA.debugLine="player.Play";
Debug.ShouldStop(8192);
__ref.getField(false,"_player" /*RemoteObject*/ ).runVoidMethod ("Play");
 BA.debugLineNum = 79;BA.debugLine="TraceAudio(\"PlayWithFade. fadeTimeMs=\" & fadeTime";
Debug.ShouldStop(16384);
...
Debug.ShouldStop(32768);
if (RemoteObject.solveBoolean(">",_fadetimems,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 81;BA.debugLine="StartFade(FADE_IN, maxVolume, fadeTimeMs)";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("Position (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,149);
if (RapidSub.canDelegate("position")) { return __ref.runUserSub(false, "audioplayer","position", __ref);}
 BA.debugLineNum = 149;BA.debugLine="Public Sub Position As Long";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 150;BA.debugLine="If player.IsInitialized = False Then Return 0";
Debug.ShouldStop(2097152);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
if (true) return BA.numberCast(long.class, 0);};
 BA.debugLineNum = 151;BA.debugLine="Try";
Debug.ShouldStop(4194304);
try { BA.debugLineNum = 152;BA.debugLine="Return player.Position";
Debug.ShouldStop(8388608);
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(long.class, __ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"getPosition"));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e5.toString()); BA.debugLineNum = 154;BA.debugLine="Return 0";
Debug.ShouldStop(33554432);
if (true) return BA.numberCast(long.class, 0);
 };
...
try {
		Debug.PushSubsStack("Ready_Event (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,167);
if (RapidSub.canDelegate("ready_event")) { return __ref.runUserSub(false, "audioplayer","ready_event", __ref, _methodname, _args);}
Debug.locals.put("methodName", _methodname);
Debug.locals.put("args", _args);
 BA.debugLineNum = 167;BA.debugLine="Private Sub Ready_Event(methodName As String, args";
Debug.ShouldStop(64);
 BA.debugLineNum = 168;BA.debugLine="If activeEventLoadToken <> currentLoadToken Then";
Debug.ShouldStop(128);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_activeeventloadtoken" /*RemoteObject*/ ),__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 169;BA.debugLine="TraceAudio(\"Ready ignored. stale_token=\" & activ";
Debug.ShouldStop(256);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 172;BA.debugLine="playerState = STATE_READY";
Debug.ShouldStop(2048);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_ready" /*RemoteObject*/ ));
 BA.debugLineNum = 173;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(4096);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 174;BA.debugLine="TraceAudio(\"Ready\")";
Debug.ShouldStop(8192);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("Ready")));
 BA.debugLineNum = 175;BA.debugLine="targetPage.AudioPlayer_Ready(audioKey)";
Debug.ShouldStop(16384);
...
try {
		Debug.PushSubsStack("Reset (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,105);
if (RapidSub.canDelegate("reset")) { return __ref.runUserSub(false, "audioplayer","reset", __ref);}
 BA.debugLineNum = 105;BA.debugLine="Public Sub Reset";
Debug.ShouldStop(256);
 BA.debugLineNum = 106;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(512);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 107;BA.debugLine="checkTimer.Enabled = False";
Debug.ShouldStop(1024);
__ref.getField(false,"_checktimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 108;BA.debugLine="timeUpdateTimer.Enabled = False";
Debug.ShouldStop(2048);
__ref.getField(false,"_timeupdatetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 109;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(4096);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 110;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(8192);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 BA.debugLineNum = 111;BA.debugLine="lastPosition = 0";
Debug.ShouldStop(16384);
__ref.setField ("_lastposition" /*RemoteObject*/ ,BA.numberCast(long.class, 0));
 BA.debugLineNum = 112;BA.debugLine="stalledCheckCount = 0";
Debug.ShouldStop(32768);
__ref.setField ("_stalledcheckcount" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 113;BA.debugLine="currentVolume = 0";
Debug.ShouldStop(65536);
__ref.setField ("_currentvolume" /*RemoteObject*/ ,BA.numberCast(double.class, 0));
 BA.debugLineNum = 114;BA.debugLine="activeEventLoadToken = 0";
Debug.ShouldStop(131072);
__ref.setField ("_activeeventloadtoken" /*RemoteObject*/ ,BA.numberCast(long.class, 0));
 BA.debugLineNum = 115;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(262144);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 116;BA.debugLine="If player.IsInitialized Then";
Debug.ShouldStop(524288);
...
Debug.ShouldStop(1048576);
try { BA.debugLineNum = 118;BA.debugLine="player.Volume = 0";
Debug.ShouldStop(2097152);
__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"setVolume",BA.numberCast(double.class, 0));
 BA.debugLineNum = 119;BA.debugLine="player.Stop";
Debug.ShouldStop(4194304);
__ref.getField(false,"_player" /*RemoteObject*/ ).runVoidMethod ("Stop");
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e16) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e16.toString()); BA.debugLineNum = 121;BA.debugLine="TraceInternalError(\"reset_stop\")";
Debug.ShouldStop(16777216);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceinternalerror" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("reset_stop")));
 ...
 BA.debugLineNum = 123;BA.debugLine="If jo.IsInitialized Then";
Debug.ShouldStop(67108864);
...
Debug.ShouldStop(134217728);
try { BA.debugLineNum = 125;BA.debugLine="jo.RunMethod(\"dispose\", Null)";
Debug.ShouldStop(268435456);
__ref.getField(false,"_jo" /*RemoteObject*/ ).runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("dispose")),(Object)((audioplayer.__c.getField(false,"Null"))));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e22.toString()); BA.debugLineNum = 127;BA.debugLine="TraceInternalError(\"reset_dispose\")";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("ResolveAudioKey (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,332);
...
Debug.locals.put("nameValue", _namevalue);
 BA.debugLineNum = 332;BA.debugLine="Private Sub ResolveAudioKey(nameValue As String) A";
Debug.ShouldStop(2048);
 BA.debugLineNum = 333;BA.debugLine="If nameValue.ToLowerCase.Contains(\"secondary\") Th";
Debug.ShouldStop(4096);
...
if (true) return BA.ObjectToString("secondary");};
 BA.debugLineNum = 334;BA.debugLine="Return \"primary\"";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("SetPlayerVolume (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,295);
...
Debug.locals.put("volumeValue", _volumevalue);
 BA.debugLineNum = 295;BA.debugLine="Private Sub SetPlayerVolume(volumeValue As Double)";
Debug.ShouldStop(64);
 BA.debugLineNum = 296;BA.debugLine="currentVolume = Max(0, Min(1, volumeValue))";
Debug.ShouldStop(128);
...
Debug.ShouldStop(512);
try { BA.debugLineNum = 299;BA.debugLine="player.Volume = currentVolume";
Debug.ShouldStop(1024);
__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"setVolume",__ref.getField(true,"_currentvolume" /*RemoteObject*/ ));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e6) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e6.toString()); BA.debugLineNum = 301;BA.debugLine="TraceInternalError(\"set_volume\")";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("StartFade (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,278);
...
Debug.locals.put("fadeTimeMs", _fadetimems);
 BA.debugLineNum = 278;BA.debugLine="Private Sub StartFade(mode As Int, targetVolume As";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 279;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(4194304);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 280;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(8388608);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 BA.debugLineNum = 281;BA.debugLine="If player.IsInitialized = False Then Return";
Debug.ShouldStop(16777216);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 282;BA.debugLine="If fadeTimeMs <= 0 Then";
Debug.ShouldStop(33554432);
if (RemoteObject.solveBoolean("k",_fadetimems,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 283;BA.debugLine="SetPlayerVolume(targetVolume)";
Debug.ShouldStop(67108864);
__ref.runClassMethod (b4j.example.audioplayer.class, "_setplayervolume" /*RemoteObject*/ ,(Object)(_targetvolume));
 BA.debugLineNum = 284;BA.debugLine="If targetVolume <= 0 Then StopImmediately";
Debug.ShouldStop(134217728);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 287;BA.debugLine="Dim intervalMs As Int = Max(20, fadeTimer.Interva";
Debug.ShouldStop(1073741824);
_intervalms = BA.numberCast(int.class, audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 20)),(Object)(BA.numberCast(double.class, __ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"getInterval")))));Debug.locals.put("intervalMs", _intervalms);Debug.locals.put("intervalMs", _intervalms);
 BA.debugLineNum = 288;BA.debugLine="Dim steps As Int = Max(1, Ceil(fadeTimeMs / inter";
Debug.ShouldStop(-2147483648);
_steps = BA.numberCast(int.class, audioplayer.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 1)),(Object)(audioplayer.__c.runMethod(true,"Ceil",(Object)(RemoteObject.solve(new RemoteObject[] {_fadetimems,_intervalms}, "/",0, 0))))));Debug.locals.put("steps", _steps);Debug.locals.put("steps", _steps);
 BA.debugLineNum = 289;BA.debugLine="fadeMode = mode";
Debug.ShouldStop(1);
__ref.setField ("_fademode" /*RemoteObject*/ ,_mode);
 BA.debugLineNum = 290;BA.debugLine="fadeTargetVolume = targetVolume";
Debug.ShouldStop(2);
__ref.setField ("_fadetargetvolume" /*RemoteObject*/ ,_targetvolume);
 BA.debugLineNum = 291;BA.debugLine="fadeStepVolume = (targetVolume - currentVolume) /";
Debug.ShouldStop(4);
__ref.setField ("_fadestepvolume" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_targetvolume,__ref.getField(true,"_currentvolume" /*RemoteObject*/ )}, "-",1, 0)),_steps}, "/",0, 0));
 BA.debugLineNum = 292;BA.debugLine="fadeTimer.Enabled = True";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("Stop (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,85);
if (RapidSub.canDelegate("stop")) { return __ref.runUserSub(false, "audioplayer","stop", __ref, _fadetimems);}
Debug.locals.put("fadeTimeMs", _fadetimems);
 BA.debugLineNum = 85;BA.debugLine="Public Sub Stop(fadeTimeMs As Int)";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 86;BA.debugLine="loadTimer.Enabled = False";
Debug.ShouldStop(2097152);
__ref.getField(false,"_loadtimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 87;BA.debugLine="checkTimer.Enabled = False";
Debug.ShouldStop(4194304);
__ref.getField(false,"_checktimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 88;BA.debugLine="timeUpdateTimer.Enabled = False";
Debug.ShouldStop(8388608);
__ref.getField(false,"_timeupdatetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 89;BA.debugLine="lastPosition = 0";
Debug.ShouldStop(16777216);
__ref.setField ("_lastposition" /*RemoteObject*/ ,BA.numberCast(long.class, 0));
 BA.debugLineNum = 90;BA.debugLine="stalledCheckCount = 0";
Debug.ShouldStop(33554432);
__ref.setField ("_stalledcheckcount" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 91;BA.debugLine="If player.IsInitialized = False Then";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
 BA.debugLineNum = 92;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(134217728);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 93;BA.debugLine="TraceAudio(\"Stop ignored. player not initialized";
Debug.ShouldStop(268435456);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 96;BA.debugLine="TraceAudio(\"Stop. fadeTimeMs=\" & fadeTimeMs & \",";
Debug.ShouldStop(-2147483648);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Stop. fadeTimeMs="),_fadetimems,RemoteObject.createImmutable(", currentVolume="),audioplayer.__c.runMethod(true,"NumberFormat2",(Object)(__ref.getField(true,"_currentvolume" /*RemoteObject*/ )),(Object)(BA.numberCast(int.class, 1)),(Object)(BA.numberCast(int.class, 3)),(Object)(BA.numberCast(int.class, 3)),(Object)(audioplayer.__c.getField(true,"False"))))));
 BA.debugLineNum = 97;BA.debugLine="If fadeTimeMs > 0 And currentVolume > 0 Then";
Debug.ShouldStop(1);
if (RemoteObject.solveBoolean(">",_fadetimems,BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean(">",__ref.getField(true,"_currentvolume" /*RemoteObject*/ ),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 98;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(2);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 99;BA.debugLine="StartFade(FADE_OUT, 0, fadeTimeMs)";
Debug.ShouldStop(4);
__ref.runClassMethod (b4j.example.audioplayer.class, "_startfade" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_fade_out" /*RemoteObject*/ )),(Object)(BA.numberCast(double.class, 0)),(Object)(_fadetimems));
 ...
 BA.debugLineNum = 101;BA.debugLine="StopImmediately";
Debug.ShouldStop(16);
__ref.runClassMethod (b4j.example.audioplayer.class, "_stopimmediately" /*RemoteObject*/ );
 };
...
try {
		Debug.PushSubsStack("StopImmediately (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,305);
if (RapidSub.canDelegate("stopimmediately")) { return __ref.runUserSub(false, "audioplayer","stopimmediately", __ref);}
 BA.debugLineNum = 305;BA.debugLine="Private Sub StopImmediately";
Debug.ShouldStop(65536);
 BA.debugLineNum = 306;BA.debugLine="fadeTimer.Enabled = False";
Debug.ShouldStop(131072);
__ref.getField(false,"_fadetimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",audioplayer.__c.getField(true,"False"));
 BA.debugLineNum = 307;BA.debugLine="fadeMode = FADE_NONE";
Debug.ShouldStop(262144);
__ref.setField ("_fademode" /*RemoteObject*/ ,__ref.getField(true,"_fade_none" /*RemoteObject*/ ));
 BA.debugLineNum = 308;BA.debugLine="playerState = STATE_STOPPED";
Debug.ShouldStop(524288);
__ref.setField ("_playerstate" /*RemoteObject*/ ,__ref.getField(true,"_state_stopped" /*RemoteObject*/ ));
 BA.debugLineNum = 309;BA.debugLine="currentVolume = 0";
Debug.ShouldStop(1048576);
__ref.setField ("_currentvolume" /*RemoteObject*/ ,BA.numberCast(double.class, 0));
 BA.debugLineNum = 310;BA.debugLine="TraceAudio(\"StopImmediately\")";
Debug.ShouldStop(2097152);
__ref.runClassMethod (b4j.example.audioplayer.class, "_traceaudio" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("StopImmediately")));
 BA.debugLineNum = 311;BA.debugLine="If player.IsInitialized = False Then Return";
Debug.ShouldStop(4194304);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"IsInitialized"),audioplayer.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 312;BA.debugLine="Try";
Debug.ShouldStop(8388608);
try { BA.debugLineNum = 313;BA.debugLine="player.Volume = 0";
Debug.ShouldStop(16777216);
__ref.getField(false,"_player" /*RemoteObject*/ ).runMethod(true,"setVolume",BA.numberCast(double.class, 0));
 BA.debugLineNum = 314;BA.debugLine="player.Stop";
Debug.ShouldStop(33554432);
__ref.getField(false,"_player" /*RemoteObject*/ ).runVoidMethod ("Stop");
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e11) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e11.toString()); BA.debugLineNum = 316;BA.debugLine="TraceInternalError(\"stop_immediately\")";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("TimeUpdateTimer_Tick (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,217);
if (RapidSub.canDelegate("timeupdatetimer_tick")) { return __ref.runUserSub(false, "audioplayer","timeupdatetimer_tick", __ref);}
 BA.debugLineNum = 217;BA.debugLine="Private Sub TimeUpdateTimer_Tick";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 218;BA.debugLine="If playerState <> STATE_PLAYING Then Return";
Debug.ShouldStop(33554432);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_playerstate" /*RemoteObject*/ ),BA.numberCast(double.class, __ref.getField(true,"_state_playing" /*RemoteObject*/ )))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 219;BA.debugLine="If activeEventLoadToken <> currentLoadToken Then";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_activeeventloadtoken" /*RemoteObject*/ ),__ref.getField(true,"_currentloadtoken" /*RemoteObject*/ ))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 220;BA.debugLine="targetPage.AudioPlayer_Timeupdate(audioKey)";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("TraceAudio (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,328);
if (RapidSub.canDelegate("traceaudio")) { return __ref.runUserSub(false, "audioplayer","traceaudio", __ref, _message);}
Debug.locals.put("message", _message);
 BA.debugLineNum = 328;BA.debugLine="Private Sub TraceAudio(message As String)";
Debug.ShouldStop(128);
 BA.debugLineNum = 329;BA.debugLine="targetPage.TraceLog(\"[\" & eventName & \"] \" & mess";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("TraceDiagnostic (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,324);
if (RapidSub.canDelegate("tracediagnostic")) { return __ref.runUserSub(false, "audioplayer","tracediagnostic", __ref, _message);}
Debug.locals.put("message", _message);
 BA.debugLineNum = 324;BA.debugLine="Private Sub TraceDiagnostic(message As String)";
Debug.ShouldStop(8);
 BA.debugLineNum = 325;BA.debugLine="targetPage.TraceLog(message)";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("TraceInternalError (audioplayer) ","audioplayer",17,__ref.getField(false, "ba"),__ref,320);
...
Debug.locals.put("context", _context);
 BA.debugLineNum = 320;BA.debugLine="Private Sub TraceInternalError(context As String)";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 321;BA.debugLine="targetPage.TraceLog(\"ошибка аудио internal contex";
Debug.ShouldStop(1);
