...
try {
		Debug.PushSubsStack("BeginPendingTraceBatch (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,78);
...
try {
		Debug.PushSubsStack("CancelPendingTraceBatch (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,94);
...
try {
		Debug.PushSubsStack("CleanupServerSnapshotFiles (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,157);
...
try {
		Debug.PushSubsStack("CloneList (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,204);
...
try {
		Debug.PushSubsStack("CloneMap (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,194);
...
try {
		Debug.PushSubsStack("ConfirmPendingTraceBatchSent (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,84);
...
try {
		Debug.PushSubsStack("EnsureDirectory (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,178);
...
try {
		Debug.PushSubsStack("GetRecentDebugList (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,66);
...
try {
		Debug.PushSubsStack("GetServerTraceList (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,111);
...
try {
		Debug.PushSubsStack("GetServerTraceText (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,99);
...
try {
		Debug.PushSubsStack("GetTraceList (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,56);
...
try {
		Debug.PushSubsStack("GetTraceText (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,51);
...
try {
		Debug.PushSubsStack("Initialize (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,16);
...
try {
		Debug.PushSubsStack("JoinList (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,184);
...
try {
		Debug.PushSubsStack("SaveServerSnapshot (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,122);
...
try {
		Debug.PushSubsStack("Trace (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,28);
...
Debug.ShouldStop(32);
traceservice.__c.runVoidMethod ("LogImpl","267567626",_entry,0);
...
try {
		Debug.PushSubsStack("TraceDebug (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,42);
...
Debug.ShouldStop(32768);
traceservice.__c.runVoidMethod ("LogImpl","267633158",_entry,0);
...
try {
		Debug.PushSubsStack("WriteServerSnapshotFile (traceservice) ","traceservice",25,__ref.getField(false, "ba"),__ref,143);
