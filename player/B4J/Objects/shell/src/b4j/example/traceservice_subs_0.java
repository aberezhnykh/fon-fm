...
try {
		Debug.PushSubsStack("BeginPendingTraceBatch (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,72);
if (RapidSub.canDelegate("beginpendingtracebatch")) { return __ref.runUserSub(false, "traceservice","beginpendingtracebatch", __ref);}
 BA.debugLineNum = 72;BA.debugLine="Public Sub BeginPendingTraceBatch As List";
Debug.ShouldStop(128);
 BA.debugLineNum = 73;BA.debugLine="pendingTraceBatch = CloneList(traceLogs)";
...
__ref.setField ("_pendingtracebatch" /*RemoteObject*/ ,__ref.runClassMethod (b4j.example.traceservice.class, "_clonelist" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_tracelogs" /*RemoteObject*/ ))));
 BA.debugLineNum = 74;BA.debugLine="Return CloneList(pendingTraceBatch)";
...
try {
		Debug.PushSubsStack("CancelPendingTraceBatch (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,87);
if (RapidSub.canDelegate("cancelpendingtracebatch")) { return __ref.runUserSub(false, "traceservice","cancelpendingtracebatch", __ref);}
 BA.debugLineNum = 87;BA.debugLine="Public Sub CancelPendingTraceBatch";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 88;BA.debugLine="If pendingTraceBatch.IsInitialized = False Then p";
...
__ref.getField(false,"_pendingtracebatch" /*RemoteObject*/ ).runVoidMethod ("Initialize");};
 BA.debugLineNum = 89;BA.debugLine="pendingTraceBatch.Clear";
...
traceservice._tracelogs = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");__ref.setField("_tracelogs",traceservice._tracelogs);
 //BA.debugLineNum = 6;BA.debugLine="Private debugLogs As List";
traceservice._debuglogs = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");__ref.setField("_debuglogs",traceservice._debuglogs);
 //BA.debugLineNum = 7;BA.debugLine="Private pendingTraceBatch As List";
traceservice._pendingtracebatch = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");__ref.setField("_pendingtracebatch",traceservice._pendingtracebatch);
 //BA.debugLineNum = 8;BA.debugLine="Private serverSnapshots As List";
traceservice._serversnapshots = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");__ref.setField("_serversnapshots",traceservice._serversnapshots);
 //BA.debugLineNum = 9;BA.debugLine="Private traceLogLimit As Int";
traceservice._traceloglimit = RemoteObject.createImmutable(0);__ref.setField("_traceloglimit",traceservice._traceloglimit);
 //BA.debugLineNum = 10;BA.debugLine="Private serverSnapshotLimit As Int";
...
try {
		Debug.PushSubsStack("CleanupServerSnapshotFiles (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,149);
...
RemoteObject _filename = RemoteObject.createImmutable("");
 BA.debugLineNum = 149;BA.debugLine="Private Sub CleanupServerSnapshotFiles";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 150;BA.debugLine="Try";
Debug.ShouldStop(2097152);
try { BA.debugLineNum = 151;BA.debugLine="If File.Exists(debugResponsesDir, \"\") = False Th";
Debug.ShouldStop(4194304);
...
Debug.CheckDeviceExceptions();if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 152;BA.debugLine="Dim listedFiles As List = File.ListFiles(debugRe";
Debug.ShouldStop(8388608);
...
_listedfiles = traceservice.__c.getField(false,"File").runMethod(false,"ListFiles",(Object)(__ref.getField(true,"_debugresponsesdir" /*RemoteObject*/ )));Debug.locals.put("listedFiles", _listedfiles);Debug.locals.put("listedFiles", _listedfiles);
 BA.debugLineNum = 153;BA.debugLine="If listedFiles.IsInitialized = False Or listedFi";
Debug.ShouldStop(16777216);
...
Debug.CheckDeviceExceptions();if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 154;BA.debugLine="Dim files As List";
Debug.ShouldStop(33554432);
_files = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("files", _files);
 BA.debugLineNum = 155;BA.debugLine="files.Initialize";
Debug.ShouldStop(67108864);
_files.runVoidMethod ("Initialize");
 BA.debugLineNum = 156;BA.debugLine="For Each fileName As String In listedFiles";
...
Debug.locals.put("fileName", _filename);
 BA.debugLineNum = 157;BA.debugLine="files.Add(fileName)";
Debug.ShouldStop(268435456);
_files.runVoidMethod ("Add",(Object)((_filename)));
 }
}Debug.locals.put("fileName", _filename);
;
 BA.debugLineNum = 159;BA.debugLine="files.Sort(True)";
Debug.ShouldStop(1073741824);
_files.runVoidMethod ("Sort",(Object)(traceservice.__c.getField(true,"True")));
 BA.debugLineNum = 160;BA.debugLine="Do While files.Size > serverSnapshotLimit";
...
while (RemoteObject.solveBoolean(">",_files.runMethod(true,"getSize"),BA.numberCast(double.class, __ref.getField(true,"_serversnapshotlimit" /*RemoteObject*/ )))) {
 BA.debugLineNum = 161;BA.debugLine="Dim fileName As String = files.Get(0)";
Debug.ShouldStop(1);
_filename = BA.ObjectToString(_files.runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("fileName", _filename);Debug.locals.put("fileName", _filename);
 BA.debugLineNum = 162;BA.debugLine="File.Delete(debugResponsesDir, fileName)";
Debug.ShouldStop(2);
traceservice.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(__ref.getField(true,"_debugresponsesdir" /*RemoteObject*/ )),(Object)(_filename));
 BA.debugLineNum = 163;BA.debugLine="files.RemoveAt(0)";
Debug.ShouldStop(4);
...
;
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e17.toString()); BA.debugLineNum = 166;BA.debugLine="Trace(\"Не удалось очистить старые snapshots серв";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("CloneList (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,196);
...
Debug.locals.put("source", _source);
 BA.debugLineNum = 196;BA.debugLine="Private Sub CloneList(source As List) As List";
Debug.ShouldStop(8);
 BA.debugLineNum = 197;BA.debugLine="Dim copy As List";
Debug.ShouldStop(16);
_copy = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("copy", _copy);
 BA.debugLineNum = 198;BA.debugLine="copy.Initialize";
Debug.ShouldStop(32);
_copy.runVoidMethod ("Initialize");
 BA.debugLineNum = 199;BA.debugLine="If source.IsInitialized = False Then Return copy";
Debug.ShouldStop(64);
...
if (true) return _copy;};
 BA.debugLineNum = 200;BA.debugLine="For Each item As Object In source";
Debug.ShouldStop(128);
{
...
Debug.locals.put("item", _item);
 BA.debugLineNum = 201;BA.debugLine="copy.Add(item)";
Debug.ShouldStop(256);
_copy.runVoidMethod ("Add",(Object)(_item));
 }
}Debug.locals.put("item", _item);
;
 BA.debugLineNum = 203;BA.debugLine="Return copy";
Debug.ShouldStop(1024);
if (true) return _copy;
...
try {
		Debug.PushSubsStack("CloneMap (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,186);
...
Debug.locals.put("source", _source);
 BA.debugLineNum = 186;BA.debugLine="Private Sub CloneMap(source As Map) As Map";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 187;BA.debugLine="Dim copy As Map";
Debug.ShouldStop(67108864);
_copy = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("copy", _copy);
 BA.debugLineNum = 188;BA.debugLine="copy.Initialize";
Debug.ShouldStop(134217728);
_copy.runVoidMethod ("Initialize");
 BA.debugLineNum = 189;BA.debugLine="If source.IsInitialized = False Then Return copy";
Debug.ShouldStop(268435456);
if (RemoteObject.solveBoolean("=",_source.runMethod(true,"IsInitialized"),traceservice.__c.getField(true,"False"))) { 
if (true) return _copy;};
 BA.debugLineNum = 190;BA.debugLine="For Each key As Object In source.Keys";
...
Debug.locals.put("key", _key);
 BA.debugLineNum = 191;BA.debugLine="copy.Put(key, source.Get(key))";
Debug.ShouldStop(1073741824);
_copy.runVoidMethod ("Put",(Object)(_key),(Object)(_source.runMethod(false,"Get",(Object)(_key))));
 }
}Debug.locals.put("key", _key);
;
 BA.debugLineNum = 193;BA.debugLine="Return copy";
Debug.ShouldStop(1);
if (true) return _copy;
...
try {
		Debug.PushSubsStack("ConfirmPendingTraceBatchSent (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,77);
if (RapidSub.canDelegate("confirmpendingtracebatchsent")) { return __ref.runUserSub(false, "traceservice","confirmpendingtracebatchsent", __ref);}
 BA.debugLineNum = 77;BA.debugLine="Public Sub ConfirmPendingTraceBatchSent";
Debug.ShouldStop(4096);
 BA.debugLineNum = 78;BA.debugLine="If pendingTraceBatch.IsInitialized = False Or pen";
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 79;BA.debugLine="Do While pendingTraceBatch.Size > 0 And traceLogs";
...
while (RemoteObject.solveBoolean(">",__ref.getField(false,"_pendingtracebatch" /*RemoteObject*/ ).runMethod(true,"getSize"),BA.numberCast(double.class, 0)) && RemoteObject.solveBoolean(">",__ref.getField(false,"_tracelogs" /*RemoteObject*/ ).runMethod(true,"getSize"),BA.numberCast(double.class, 0))) {
 BA.debugLineNum = 80;BA.debugLine="If traceLogs.Get(0) <> pendingTraceBatch.Get(0)";
...
try {
		Debug.PushSubsStack("EnsureDirectory (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,170);
...
Debug.locals.put("path", _path);
 BA.debugLineNum = 170;BA.debugLine="Private Sub EnsureDirectory(path As String)";
Debug.ShouldStop(512);
 BA.debugLineNum = 171;BA.debugLine="Dim joFile As JavaObject";
Debug.ShouldStop(1024);
_jofile = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");Debug.locals.put("joFile", _jofile);
 BA.debugLineNum = 172;BA.debugLine="joFile.InitializeNewInstance(\"java.io.File\", Arra";
Debug.ShouldStop(2048);
_jofile.runVoidMethod ("InitializeNewInstance",(Object)(BA.ObjectToString("java.io.File")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(_path)})));
 BA.debugLineNum = 173;BA.debugLine="joFile.RunMethod(\"mkdirs\", Null)";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("GetRecentDebugList (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,61);
...
Debug.locals.put("maxItems", _maxitems);
 BA.debugLineNum = 61;BA.debugLine="Public Sub GetRecentDebugList(maxItems As Int) As";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 62;BA.debugLine="Dim copy As List";
Debug.ShouldStop(536870912);
_copy = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("copy", _copy);
 BA.debugLineNum = 63;BA.debugLine="copy.Initialize";
Debug.ShouldStop(1073741824);
_copy.runVoidMethod ("Initialize");
 BA.debugLineNum = 64;BA.debugLine="If debugLogs.IsInitialized = False Or debugLogs.S";
Debug.ShouldStop(-2147483648);
...
if (true) return _copy;};
 BA.debugLineNum = 65;BA.debugLine="Dim startIndex As Int = Max(0, debugLogs.Size - M";
Debug.ShouldStop(1);
_startindex = BA.numberCast(int.class, traceservice.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_debuglogs" /*RemoteObject*/ ).runMethod(true,"getSize"),traceservice.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 1)),(Object)(BA.numberCast(double.class, _maxitems)))}, "-",1, 0))));Debug.locals.put("startIndex", _startindex);Debug.locals.put("startIndex", _startindex);
 BA.debugLineNum = 66;BA.debugLine="For i = startIndex To debugLogs.Size - 1";
Debug.ShouldStop(2);
{
final int step5 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 67;BA.debugLine="copy.Add(debugLogs.Get(i))";
Debug.ShouldStop(4);
...
;
 BA.debugLineNum = 69;BA.debugLine="Return copy";
Debug.ShouldStop(16);
if (true) return _copy;
...
try {
		Debug.PushSubsStack("GetServerTraceList (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,104);
...
RemoteObject _entry = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 104;BA.debugLine="Public Sub GetServerTraceList As List";
Debug.ShouldStop(128);
 BA.debugLineNum = 105;BA.debugLine="Dim copy As List";
Debug.ShouldStop(256);
_copy = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("copy", _copy);
 BA.debugLineNum = 106;BA.debugLine="copy.Initialize";
Debug.ShouldStop(512);
_copy.runVoidMethod ("Initialize");
 BA.debugLineNum = 107;BA.debugLine="If serverSnapshots.IsInitialized = False Then Ret";
Debug.ShouldStop(1024);
...
if (true) return _copy;};
 BA.debugLineNum = 108;BA.debugLine="For Each entry As Map In serverSnapshots";
Debug.ShouldStop(2048);
...
Debug.locals.put("entry", _entry);
 BA.debugLineNum = 109;BA.debugLine="copy.Add(CloneMap(entry))";
Debug.ShouldStop(4096);
...
;
 BA.debugLineNum = 111;BA.debugLine="Return copy";
Debug.ShouldStop(16384);
if (true) return _copy;
...
try {
		Debug.PushSubsStack("GetServerTraceText (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,92);
...
RemoteObject _entry = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 92;BA.debugLine="Public Sub GetServerTraceText As String";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 93;BA.debugLine="If serverSnapshots.IsInitialized = False Or serve";
Debug.ShouldStop(268435456);
...
if (true) return BA.ObjectToString("");};
 BA.debugLineNum = 94;BA.debugLine="Dim lines As List";
Debug.ShouldStop(536870912);
_lines = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("lines", _lines);
 BA.debugLineNum = 95;BA.debugLine="lines.Initialize";
Debug.ShouldStop(1073741824);
_lines.runVoidMethod ("Initialize");
 BA.debugLineNum = 96;BA.debugLine="For Each entry As Map In serverSnapshots";
Debug.ShouldStop(-2147483648);
_entry = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
{
final RemoteObject group4 = __ref.getField(false,"_serversnapshots" /*RemoteObject*/ );
...
_entry = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), group4.runMethod(false,"Get",index4));Debug.locals.put("entry", _entry);
Debug.locals.put("entry", _entry);
 BA.debugLineNum = 97;BA.debugLine="lines.Add(entry.GetDefault(\"Header\", \"\"))";
Debug.ShouldStop(1);
_lines.runVoidMethod ("Add",(Object)(_entry.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("Header"))),(Object)((RemoteObject.createImmutable(""))))));
 BA.debugLineNum = 98;BA.debugLine="lines.Add(entry.GetDefault(\"Body\", \"\"))";
Debug.ShouldStop(2);
_lines.runVoidMethod ("Add",(Object)(_entry.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("Body"))),(Object)((RemoteObject.createImmutable(""))))));
 BA.debugLineNum = 99;BA.debugLine="lines.Add(\"\")";
Debug.ShouldStop(4);
_lines.runVoidMethod ("Add",(Object)((RemoteObject.createImmutable(""))));
 }
}Debug.locals.put("entry", _entry);
;
 BA.debugLineNum = 101;BA.debugLine="Return JoinList(lines, CRLF)";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("GetTraceList (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,51);
...
RemoteObject _entry = RemoteObject.createImmutable("");
 BA.debugLineNum = 51;BA.debugLine="Public Sub GetTraceList As List";
Debug.ShouldStop(262144);
 BA.debugLineNum = 52;BA.debugLine="Dim copy As List";
Debug.ShouldStop(524288);
_copy = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("copy", _copy);
 BA.debugLineNum = 53;BA.debugLine="copy.Initialize";
Debug.ShouldStop(1048576);
_copy.runVoidMethod ("Initialize");
 BA.debugLineNum = 54;BA.debugLine="If traceLogs.IsInitialized = False Then Return co";
Debug.ShouldStop(2097152);
...
if (true) return _copy;};
 BA.debugLineNum = 55;BA.debugLine="For Each entry As String In traceLogs";
Debug.ShouldStop(4194304);
{
...
Debug.locals.put("entry", _entry);
 BA.debugLineNum = 56;BA.debugLine="copy.Add(entry)";
Debug.ShouldStop(8388608);
_copy.runVoidMethod ("Add",(Object)((_entry)));
 }
}Debug.locals.put("entry", _entry);
;
 BA.debugLineNum = 58;BA.debugLine="Return copy";
Debug.ShouldStop(33554432);
if (true) return _copy;
...
try {
		Debug.PushSubsStack("GetTraceText (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,46);
if (RapidSub.canDelegate("gettracetext")) { return __ref.runUserSub(false, "traceservice","gettracetext", __ref);}
 BA.debugLineNum = 46;BA.debugLine="Public Sub GetTraceText As String";
Debug.ShouldStop(8192);
 BA.debugLineNum = 47;BA.debugLine="If traceLogs.IsInitialized = False Or traceLogs.S";
Debug.ShouldStop(16384);
...
if (true) return BA.ObjectToString("");};
 BA.debugLineNum = 48;BA.debugLine="Return JoinList(traceLogs, CRLF)";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("Initialize (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,13);
...
Debug.locals.put("serverSnapshotLimitValue", _serversnapshotlimitvalue);
 BA.debugLineNum = 13;BA.debugLine="Public Sub Initialize(storageDirValue As String, d";
Debug.ShouldStop(4096);
 BA.debugLineNum = 14;BA.debugLine="storageDir = storageDirValue";
Debug.ShouldStop(8192);
__ref.setField ("_storagedir" /*RemoteObject*/ ,_storagedirvalue);
 BA.debugLineNum = 15;BA.debugLine="debugResponsesDir = debugResponsesDirValue";
Debug.ShouldStop(16384);
__ref.setField ("_debugresponsesdir" /*RemoteObject*/ ,_debugresponsesdirvalue);
 BA.debugLineNum = 16;BA.debugLine="traceLogLimit = traceLogLimitValue";
Debug.ShouldStop(32768);
__ref.setField ("_traceloglimit" /*RemoteObject*/ ,_traceloglimitvalue);
 BA.debugLineNum = 17;BA.debugLine="serverSnapshotLimit = serverSnapshotLimitValue";
Debug.ShouldStop(65536);
__ref.setField ("_serversnapshotlimit" /*RemoteObject*/ ,_serversnapshotlimitvalue);
 BA.debugLineNum = 18;BA.debugLine="traceLogs.Initialize";
Debug.ShouldStop(131072);
__ref.getField(false,"_tracelogs" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 19;BA.debugLine="debugLogs.Initialize";
Debug.ShouldStop(262144);
__ref.getField(false,"_debuglogs" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 20;BA.debugLine="pendingTraceBatch.Initialize";
Debug.ShouldStop(524288);
__ref.getField(false,"_pendingtracebatch" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 21;BA.debugLine="serverSnapshots.Initialize";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("JoinList (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,176);
...
Debug.locals.put("separator", _separator);
 BA.debugLineNum = 176;BA.debugLine="Private Sub JoinList(items As List, separator As S";
Debug.ShouldStop(32768);
...
_sb.runVoidMethod ("Initialize");
 BA.debugLineNum = 179;BA.debugLine="For i = 0 To items.Size - 1";
Debug.ShouldStop(262144);
{
final int step3 = 1;
...
_sb.runVoidMethod ("Append",(Object)(_separator));};
 BA.debugLineNum = 181;BA.debugLine="sb.Append(items.Get(i))";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("SaveServerSnapshot (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,114);
...
Debug.locals.put("errorMessage", _errormessage);
 BA.debugLineNum = 114;BA.debugLine="Public Sub SaveServerSnapshot(method As String, ur";
Debug.ShouldStop(131072);
 BA.debugLineNum = 115;BA.debugLine="Dim timestamp As String = DateTime.Time(DateTime.";
Debug.ShouldStop(262144);
_timestamp = traceservice.__c.getField(false,"DateTime").runMethod(true,"Time",(Object)(traceservice.__c.getField(false,"DateTime").runMethod(true,"getNow")));Debug.locals.put("timestamp", _timestamp);Debug.locals.put("timestamp", _timestamp);
 BA.debugLineNum = 116;BA.debugLine="Dim header As String = timestamp & \" SNAPSHOT met";
Debug.ShouldStop(524288);
_header = RemoteObject.concat(_timestamp,RemoteObject.createImmutable(" SNAPSHOT method="),_method,RemoteObject.createImmutable(" success="),_success,RemoteObject.createImmutable(" url="),_url);Debug.locals.put("header", _header);Debug.locals.put("header", _header);
 BA.debugLineNum = 117;BA.debugLine="If errorMessage <> \"\" Then header = header & \" er";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("Trace (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,24);
...
Debug.locals.put("message", _message);
 BA.debugLineNum = 24;BA.debugLine="Public Sub Trace(message As String)";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 25;BA.debugLine="Dim entry As String = DateTime.Time(DateTime.Now)";
Debug.ShouldStop(16777216);
_entry = RemoteObject.concat(traceservice.__c.getField(false,"DateTime").runMethod(true,"Time",(Object)(traceservice.__c.getField(false,"DateTime").runMethod(true,"getNow"))),RemoteObject.createImmutable(" "),_message);Debug.locals.put("entry", _entry);Debug.locals.put("entry", _entry);
 BA.debugLineNum = 26;BA.debugLine="traceLogs.Add(entry)";
Debug.ShouldStop(33554432);
__ref.getField(false,"_tracelogs" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((_entry)));
 BA.debugLineNum = 27;BA.debugLine="Do While traceLogs.Size > traceLogLimit";
Debug.ShouldStop(67108864);
while (RemoteObject.solveBoolean(">",__ref.getField(false,"_tracelogs" /*RemoteObject*/ ).runMethod(true,"getSize"),BA.numberCast(double.class, __ref.getField(true,"_traceloglimit" /*RemoteObject*/ )))) {
 BA.debugLineNum = 28;BA.debugLine="Dim removedEntry As String = traceLogs.Get(0)";
Debug.ShouldStop(134217728);
_removedentry = BA.ObjectToString(__ref.getField(false,"_tracelogs" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0))));Debug.locals.put("removedEntry", _removedentry);Debug.locals.put("removedEntry", _removedentry);
 BA.debugLineNum = 29;BA.debugLine="traceLogs.RemoveAt(0)";
Debug.ShouldStop(268435456);
__ref.getField(false,"_tracelogs" /*RemoteObject*/ ).runVoidMethod ("RemoveAt",(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 30;BA.debugLine="If pendingTraceBatch.IsInitialized And pendingTr";
Debug.ShouldStop(536870912);
if (RemoteObject.solveBoolean(".",__ref.getField(false,"_pendingtracebatch" /*RemoteObject*/ ).runMethod(true,"IsInitialized")) && RemoteObject.solveBoolean(">",__ref.getField(false,"_pendingtracebatch" /*RemoteObject*/ ).runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 31;BA.debugLine="If pendingTraceBatch.Get(0) = removedEntry Then";
Debug.ShouldStop(1073741824);
...
;
 BA.debugLineNum = 34;BA.debugLine="Log(entry)";
Debug.ShouldStop(2);
traceservice.__c.runVoidMethod ("LogImpl","730343178",_entry,0);
...
try {
		Debug.PushSubsStack("TraceDebug (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,37);
if (RapidSub.canDelegate("tracedebug")) { return __ref.runUserSub(false, "traceservice","tracedebug", __ref, _message);}
RemoteObject _entry = RemoteObject.createImmutable("");
Debug.locals.put("message", _message);
 BA.debugLineNum = 37;BA.debugLine="Public Sub TraceDebug(message As String)";
Debug.ShouldStop(16);
 BA.debugLineNum = 38;BA.debugLine="Dim entry As String = DateTime.Time(DateTime.Now)";
Debug.ShouldStop(32);
_entry = RemoteObject.concat(traceservice.__c.getField(false,"DateTime").runMethod(true,"Time",(Object)(traceservice.__c.getField(false,"DateTime").runMethod(true,"getNow"))),RemoteObject.createImmutable(" DEBUG "),_message);Debug.locals.put("entry", _entry);Debug.locals.put("entry", _entry);
 BA.debugLineNum = 39;BA.debugLine="debugLogs.Add(entry)";
Debug.ShouldStop(64);
__ref.getField(false,"_debuglogs" /*RemoteObject*/ ).runVoidMethod ("Add",(Object)((_entry)));
 BA.debugLineNum = 40;BA.debugLine="Do While debugLogs.Size > traceLogLimit";
Debug.ShouldStop(128);
while (RemoteObject.solveBoolean(">",__ref.getField(false,"_debuglogs" /*RemoteObject*/ ).runMethod(true,"getSize"),BA.numberCast(double.class, __ref.getField(true,"_traceloglimit" /*RemoteObject*/ )))) {
 BA.debugLineNum = 41;BA.debugLine="debugLogs.RemoveAt(0)";
Debug.ShouldStop(256);
__ref.getField(false,"_debuglogs" /*RemoteObject*/ ).runVoidMethod ("RemoveAt",(Object)(BA.numberCast(int.class, 0)));
 }
;
 BA.debugLineNum = 43;BA.debugLine="Log(entry)";
Debug.ShouldStop(1024);
traceservice.__c.runVoidMethod ("LogImpl","761800454",_entry,0);
...
try {
		Debug.PushSubsStack("WriteServerSnapshotFile (traceservice) ","traceservice",3,__ref.getField(false, "ba"),__ref,135);
...
Debug.locals.put("entry", _entry);
 BA.debugLineNum = 135;BA.debugLine="Private Sub WriteServerSnapshotFile(entry As Map)";
Debug.ShouldStop(64);
 BA.debugLineNum = 136;BA.debugLine="Try";
Debug.ShouldStop(128);
try { BA.debugLineNum = 137;BA.debugLine="EnsureDirectory(storageDir)";
Debug.ShouldStop(256);
__ref.runClassMethod (b4j.example.traceservice.class, "_ensuredirectory" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_storagedir" /*RemoteObject*/ )));
 BA.debugLineNum = 138;BA.debugLine="EnsureDirectory(debugResponsesDir)";
Debug.ShouldStop(512);
__ref.runClassMethod (b4j.example.traceservice.class, "_ensuredirectory" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_debugresponsesdir" /*RemoteObject*/ )));
 BA.debugLineNum = 139;BA.debugLine="Dim stamp As String = Regex.Replace(\"[^0-9]\", en";
Debug.ShouldStop(1024);
_stamp = traceservice.__c.getField(false,"Regex").runMethod(true,"Replace",(Object)(BA.ObjectToString("[^0-9]")),(Object)(BA.ObjectToString(_entry.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("Timestamp"))),(Object)((RemoteObject.createImmutable("")))))),(Object)(RemoteObject.createImmutable("")));Debug.locals.put("stamp", _stamp);Debug.locals.put("stamp", _stamp);
 BA.debugLineNum = 140;BA.debugLine="If stamp = \"\" Then stamp = \"\" & DateTime.Now";
Debug.ShouldStop(2048);
...
_stamp = RemoteObject.concat(RemoteObject.createImmutable(""),traceservice.__c.getField(false,"DateTime").runMethod(true,"getNow"));Debug.locals.put("stamp", _stamp);};
 BA.debugLineNum = 141;BA.debugLine="Dim name As String = stamp & \"_\" & entry.GetDefa";
Debug.ShouldStop(4096);
_name = RemoteObject.concat(_stamp,RemoteObject.createImmutable("_"),_entry.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("Method"))),(Object)((RemoteObject.createImmutable("REQ")))),RemoteObject.createImmutable(".txt"));Debug.locals.put("name", _name);Debug.locals.put("name", _name);
 BA.debugLineNum = 142;BA.debugLine="Dim text As String = entry.GetDefault(\"Header\",";
Debug.ShouldStop(8192);
_text = RemoteObject.concat(_entry.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("Header"))),(Object)((RemoteObject.createImmutable("")))),traceservice.__c.getField(true,"CRLF"),traceservice.__c.getField(true,"CRLF"),_entry.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("Body"))),(Object)((RemoteObject.createImmutable("")))));Debug.locals.put("text", _text);Debug.locals.put("text", _text);
 BA.debugLineNum = 143;BA.debugLine="File.WriteString(debugResponsesDir, name, text)";
Debug.ShouldStop(16384);
traceservice.__c.getField(false,"File").runVoidMethod ("WriteString",(Object)(__ref.getField(true,"_debugresponsesdir" /*RemoteObject*/ )),(Object)(_name),(Object)(_text));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e10.toString()); BA.debugLineNum = 145;BA.debugLine="Trace(\"Не удалось записать snapshot сервера. \" &";
Debug.ShouldStop(65536);
