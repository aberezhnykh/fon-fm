...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"CurrentMediaType",_ref.getField(false, "_currentmediatype"),"CurrentMediaUrl",_ref.getField(false, "_currentmediaurl"),"HistoryStartedAtTicks",_ref.getField(false, "_historystartedatticks"),"PendingHistoryItem",_ref.getField(false, "_pendinghistoryitem")};
}
}