...
Debug.ShouldStop(262144);
_resolveditem = __ref.runClassMethod (b4j.example.playerstatestore.class, "_resolveslotscopedcachedtrackitem" /*RemoteObject*/ ,(Object)(_currentslot),(Object)(_playlists));Debug.locals.put("resolvedItem", _resolveditem);
...
Debug.ShouldStop(65536);
_cachedtrack = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_cachedtrack = __ref.getField(false,"_mediacacheref" /*RemoteObject*/ ).runClassMethod (b4j.example.mediacache.class, "_resolveanycachedtrackfromindex" /*RemoteObject*/ ,(Object)(_playlistid),(Object)(RemoteObject.createImmutable("")));Debug.locals.put("cachedTrack", _cachedtrack);Debug.locals.put("cachedTrack", _cachedtrack);
...
Debug.ShouldStop(8388608);
if (RemoteObject.solveBoolean(".",_queueitem.runMethod(true,"IsInitialized")) && RemoteObject.solveBoolean(">",_queueitem.runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
...
{ BA.debugLineNum = 611;BA.debugLine="Else If networkFailure Then";
Debug.ShouldStop(4);
