...
try {
		Debug.PushSubsStack("ApplyTemporaryMode (playbackdatapolicystate) ","playbackdatapolicystate",15,__ref.getField(false, "ba"),__ref,70);
...
try {
		Debug.PushSubsStack("BeginOfflineDataRefresh (playbackdatapolicystate) ","playbackdatapolicystate",15,__ref.getField(false, "ba"),__ref,27);
...
try {
		Debug.PushSubsStack("BeginTrackCacheRefresh (playbackdatapolicystate) ","playbackdatapolicystate",15,__ref.getField(false, "ba"),__ref,39);
...
try {
		Debug.PushSubsStack("ClearPolicyPause (playbackdatapolicystate) ","playbackdatapolicystate",15,__ref.getField(false, "ba"),__ref,56);
...
try {
		Debug.PushSubsStack("ClearPolicyPauseAndResumeRequest (playbackdatapolicystate) ","playbackdatapolicystate",15,__ref.getField(false, "ba"),__ref,60);
...
try {
		Debug.PushSubsStack("EndOfflineDataRefresh (playbackdatapolicystate) ","playbackdatapolicystate",15,__ref.getField(false, "ba"),__ref,34);
...
try {
		Debug.PushSubsStack("EndTrackCacheRefresh (playbackdatapolicystate) ","playbackdatapolicystate",15,__ref.getField(false, "ba"),__ref,45);
...
try {
		Debug.PushSubsStack("EnterLocalPlayback (playbackdatapolicystate) ","playbackdatapolicystate",15,__ref.getField(false, "ba"),__ref,65);
...
try {
		Debug.PushSubsStack("EnterPolicyPause (playbackdatapolicystate) ","playbackdatapolicystate",15,__ref.getField(false, "ba"),__ref,50);
...
try {
		Debug.PushSubsStack("Initialize (playbackdatapolicystate) ","playbackdatapolicystate",15,__ref.getField(false, "ba"),__ref,13);
...
try {
		Debug.PushSubsStack("Reset (playbackdatapolicystate) ","playbackdatapolicystate",15,__ref.getField(false, "ba"),__ref,18);
...
try {
		Debug.PushSubsStack("SetRemoteDataReady (playbackdatapolicystate) ","playbackdatapolicystate",15,__ref.getField(false, "ba"),__ref,76);
