...
public static RemoteObject _haslocalmediafallback = RemoteObject.createImmutable(false);
...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"HasLocalMediaFallback",_ref.getField(false, "_haslocalmediafallback"),"IsOfflineDataRefreshInProgress",_ref.getField(false, "_isofflinedatarefreshinprogress"),"IsPlaybackPausedByPolicy",_ref.getField(false, "_isplaybackpausedbypolicy"),"IsTrackCacheRefreshInProgress",_ref.getField(false, "_istrackcacherefreshinprogress"),"LastOfflineDataRefreshState",_ref.getField(false, "_lastofflinedatarefreshstate"),"ResumePlaybackWhenServerAllows",_ref.getField(false, "_resumeplaybackwhenserverallows")};
}
}