...
try {
		Debug.PushSubsStack("FlushTraceBuffer (playbacktraceuploader) ","playbacktraceuploader",22,__ref.getField(false, "ba"),__ref,34);
...
try {
		Debug.PushSubsStack("FlushTraceBufferAsync (playbacktraceuploader) ","playbacktraceuploader",22,__ref.getField(false, "ba"),__ref,30);
...
try {
		Debug.PushSubsStack("Initialize (playbacktraceuploader) ","playbacktraceuploader",22,__ref.getField(false, "ba"),__ref,14);
...
try {
		Debug.PushSubsStack("IsTraceUploadEnabled (playbacktraceuploader) ","playbacktraceuploader",22,__ref.getField(false, "ba"),__ref,22);
...
try {
		Debug.PushSubsStack("IsUploadInProgress (playbacktraceuploader) ","playbacktraceuploader",22,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("JoinList (playbacktraceuploader) ","playbacktraceuploader",22,__ref.getField(false, "ba"),__ref,95);
