...
try {
		Debug.PushSubsStack("Close (keyvaluestore) ","keyvaluestore",23,__ref.getField(false, "ba"),__ref,168);
...
try {
		Debug.PushSubsStack("ContainsKey (keyvaluestore) ","keyvaluestore",23,__ref.getField(false, "ba"),__ref,155);
...
try {
		Debug.PushSubsStack("CreateTable (keyvaluestore) ","keyvaluestore",23,__ref.getField(false, "ba"),__ref,174);
...
try {
		Debug.PushSubsStack("DeleteAll (keyvaluestore) ","keyvaluestore",23,__ref.getField(false, "ba"),__ref,161);
...
try {
		Debug.PushSubsStack("Get (keyvaluestore) ","keyvaluestore",23,__ref.getField(false, "ba"),__ref,21);
...
try {
		Debug.PushSubsStack("GetBitmap (keyvaluestore) ","keyvaluestore",23,__ref.getField(false, "ba"),__ref,121);
...
try {
		Debug.PushSubsStack("GetDefault (keyvaluestore) ","keyvaluestore",23,__ref.getField(false, "ba"),__ref,83);
...
try {
		Debug.PushSubsStack("GetMapAsync (keyvaluestore) ","keyvaluestore",23,__ref.getField(false, "ba"),__ref,36);
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","931916055",BA.ObjectToString(parent.__c.runMethod(false,"LastException",__ref.getField(false, "ba"))),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("Initialize (keyvaluestore) ","keyvaluestore",23,__ref.getField(false, "ba"),__ref,7);
...
try {
		Debug.PushSubsStack("ListKeys (keyvaluestore) ","keyvaluestore",23,__ref.getField(false, "ba"),__ref,143);
...
try {
		Debug.PushSubsStack("Put (keyvaluestore) ","keyvaluestore",23,__ref.getField(false, "ba"),__ref,17);
...
try {
		Debug.PushSubsStack("PutBitmap (keyvaluestore) ","keyvaluestore",23,__ref.getField(false, "ba"),__ref,113);
...
try {
		Debug.PushSubsStack("PutMapAsync (keyvaluestore) ","keyvaluestore",23,__ref.getField(false, "ba"),__ref,67);
...
Debug.JustUpdateDeviceLine();
parent.__c.runVoidMethod ("LogImpl","931981576",RemoteObject.concat(RemoteObject.createImmutable("Failed to serialize object: "),_map.runMethod(false,"Get",(Object)((_key)))),0);
 if (true) break;
...
try {
		Debug.PushSubsStack("Remove (keyvaluestore) ","keyvaluestore",23,__ref.getField(false, "ba"),__ref,138);
...
try {
		Debug.PushSubsStack("Vacuum (keyvaluestore) ","keyvaluestore",23,__ref.getField(false, "ba"),__ref,179);
