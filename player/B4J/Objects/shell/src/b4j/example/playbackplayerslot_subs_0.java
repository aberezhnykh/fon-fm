...
try {
		Debug.PushSubsStack("ClearItem (playbackplayerslot) ","playbackplayerslot",18,__ref.getField(false, "ba"),__ref,42);
...
try {
		Debug.PushSubsStack("CloneStateMap (playbackplayerslot) ","playbackplayerslot",18,__ref.getField(false, "ba"),__ref,56);
...
try {
		Debug.PushSubsStack("HasItem (playbackplayerslot) ","playbackplayerslot",18,__ref.getField(false, "ba"),__ref,52);
...
try {
		Debug.PushSubsStack("Initialize (playbackplayerslot) ","playbackplayerslot",18,__ref.getField(false, "ba"),__ref,15);
...
try {
		Debug.PushSubsStack("MarkProgress (playbackplayerslot) ","playbackplayerslot",18,__ref.getField(false, "ba"),__ref,48);
...
try {
		Debug.PushSubsStack("Reset (playbackplayerslot) ","playbackplayerslot",18,__ref.getField(false, "ba"),__ref,22);
...
try {
		Debug.PushSubsStack("SetItem (playbackplayerslot) ","playbackplayerslot",18,__ref.getField(false, "ba"),__ref,37);
...
try {
		Debug.PushSubsStack("SetRoleState (playbackplayerslot) ","playbackplayerslot",18,__ref.getField(false, "ba"),__ref,30);
