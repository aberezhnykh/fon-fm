...
try {
		Debug.PushSubsStack("AdMatchesCurrentMinute (adscheduler) ","adscheduler",3,__ref.getField(false, "ba"),__ref,73);
...
try {
		Debug.PushSubsStack("BuildBreakForMinute (adscheduler) ","adscheduler",3,__ref.getField(false, "ba"),__ref,43);
...
try {
		Debug.PushSubsStack("CreateAdQueueItem (adscheduler) ","adscheduler",3,__ref.getField(false, "ba"),__ref,100);
...
try {
		Debug.PushSubsStack("FormatIsoDate (adscheduler) ","adscheduler",3,__ref.getField(false, "ba"),__ref,129);
...
try {
		Debug.PushSubsStack("HasBreakScheduledAt (adscheduler) ","adscheduler",3,__ref.getField(false, "ba"),__ref,112);
...
try {
		Debug.PushSubsStack("IsoWeekdayFromTimestamp (adscheduler) ","adscheduler",3,__ref.getField(false, "ba"),__ref,147);
...
try {
		Debug.PushSubsStack("LocalTimestampToTicks (adscheduler) ","adscheduler",3,__ref.getField(false, "ba"),__ref,176);
...
try {
		Debug.PushSubsStack("MinuteKeyFromTimestamp (adscheduler) ","adscheduler",3,__ref.getField(false, "ba"),__ref,164);
...
try {
		Debug.PushSubsStack("MinutesOfDayFromTimestamp (adscheduler) ","adscheduler",3,__ref.getField(false, "ba"),__ref,137);
...
try {
		Debug.PushSubsStack("TimeStringToMinutes (adscheduler) ","adscheduler",3,__ref.getField(false, "ba"),__ref,189);
...
try {
		Debug.PushSubsStack("TimezoneOffsetMinutes (adscheduler) ","adscheduler",3,__ref.getField(false, "ba"),__ref,180);
...
try {
		Debug.PushSubsStack("ToLongDefault (adscheduler) ","adscheduler",3,__ref.getField(false, "ba"),__ref,204);
...
try {
		Debug.PushSubsStack("Trace (adscheduler) ","adscheduler",3,__ref.getField(false, "ba"),__ref,123);
