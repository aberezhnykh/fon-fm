...
try {
		Debug.PushSubsStack("AdMatchesCurrentMinute (adscheduler) ","adscheduler",19,__ref.getField(false, "ba"),__ref,80);
...
try {
		Debug.PushSubsStack("BuildBreakForMinute (adscheduler) ","adscheduler",19,__ref.getField(false, "ba"),__ref,49);
...
try {
		Debug.PushSubsStack("CreateAdQueueItem (adscheduler) ","adscheduler",19,__ref.getField(false, "ba"),__ref,107);
...
try {
		Debug.PushSubsStack("FormatIsoDate (adscheduler) ","adscheduler",19,__ref.getField(false, "ba"),__ref,136);
...
try {
		Debug.PushSubsStack("HasBreakScheduledAt (adscheduler) ","adscheduler",19,__ref.getField(false, "ba"),__ref,119);
...
try {
		Debug.PushSubsStack("Initialize (adscheduler) ","adscheduler",19,__ref.getField(false, "ba"),__ref,13);
...
try {
		Debug.PushSubsStack("IsoWeekdayFromTimestamp (adscheduler) ","adscheduler",19,__ref.getField(false, "ba"),__ref,154);
...
try {
		Debug.PushSubsStack("LocalTimestampToTicks (adscheduler) ","adscheduler",19,__ref.getField(false, "ba"),__ref,183);
...
try {
		Debug.PushSubsStack("MinuteKeyFromTimestamp (adscheduler) ","adscheduler",19,__ref.getField(false, "ba"),__ref,171);
...
try {
		Debug.PushSubsStack("MinutesOfDayFromTimestamp (adscheduler) ","adscheduler",19,__ref.getField(false, "ba"),__ref,144);
...
try {
		Debug.PushSubsStack("Reset (adscheduler) ","adscheduler",19,__ref.getField(false, "ba"),__ref,20);
...
try {
		Debug.PushSubsStack("ScanTargetMinute (adscheduler) ","adscheduler",19,__ref.getField(false, "ba"),__ref,26);
...
try {
		Debug.PushSubsStack("TimeStringToMinutes (adscheduler) ","adscheduler",19,__ref.getField(false, "ba"),__ref,196);
...
try {
		Debug.PushSubsStack("TimezoneOffsetMinutes (adscheduler) ","adscheduler",19,__ref.getField(false, "ba"),__ref,187);
...
try {
		Debug.PushSubsStack("ToLongDefault (adscheduler) ","adscheduler",19,__ref.getField(false, "ba"),__ref,211);
...
try {
		Debug.PushSubsStack("Trace (adscheduler) ","adscheduler",19,__ref.getField(false, "ba"),__ref,130);
