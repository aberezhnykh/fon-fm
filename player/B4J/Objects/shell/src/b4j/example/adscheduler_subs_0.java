...
try {
		Debug.PushSubsStack("AdMatchesCurrentMinute (adscheduler) ","adscheduler",10,__ref.getField(false, "ba"),__ref,88);
...
try {
		Debug.PushSubsStack("BuildBreakForMinute (adscheduler) ","adscheduler",10,__ref.getField(false, "ba"),__ref,55);
...
try {
		Debug.PushSubsStack("CreateAdQueueItem (adscheduler) ","adscheduler",10,__ref.getField(false, "ba"),__ref,115);
...
try {
		Debug.PushSubsStack("FormatIsoDate (adscheduler) ","adscheduler",10,__ref.getField(false, "ba"),__ref,144);
...
try {
		Debug.PushSubsStack("HasBreakScheduledAt (adscheduler) ","adscheduler",10,__ref.getField(false, "ba"),__ref,127);
...
try {
		Debug.PushSubsStack("Initialize (adscheduler) ","adscheduler",10,__ref.getField(false, "ba"),__ref,17);
...
try {
		Debug.PushSubsStack("IsoWeekdayFromTimestamp (adscheduler) ","adscheduler",10,__ref.getField(false, "ba"),__ref,162);
...
try {
		Debug.PushSubsStack("LocalTimestampToTicks (adscheduler) ","adscheduler",10,__ref.getField(false, "ba"),__ref,191);
...
try {
		Debug.PushSubsStack("MinuteKeyFromTimestamp (adscheduler) ","adscheduler",10,__ref.getField(false, "ba"),__ref,179);
...
try {
		Debug.PushSubsStack("MinutesOfDayFromTimestamp (adscheduler) ","adscheduler",10,__ref.getField(false, "ba"),__ref,152);
...
try {
		Debug.PushSubsStack("Reset (adscheduler) ","adscheduler",10,__ref.getField(false, "ba"),__ref,24);
...
try {
		Debug.PushSubsStack("ScanTargetMinute (adscheduler) ","adscheduler",10,__ref.getField(false, "ba"),__ref,31);
...
try {
		Debug.PushSubsStack("TimeStringToMinutes (adscheduler) ","adscheduler",10,__ref.getField(false, "ba"),__ref,204);
...
try {
		Debug.PushSubsStack("TimezoneOffsetMinutes (adscheduler) ","adscheduler",10,__ref.getField(false, "ba"),__ref,195);
...
try {
		Debug.PushSubsStack("ToLongDefault (adscheduler) ","adscheduler",10,__ref.getField(false, "ba"),__ref,219);
...
try {
		Debug.PushSubsStack("Trace (adscheduler) ","adscheduler",10,__ref.getField(false, "ba"),__ref,138);
