...
try {
		Debug.PushSubsStack("Initialize (offlineplaybackengine) ","offlineplaybackengine",5,__ref.getField(false, "ba"),__ref,8);
...
try {
		Debug.PushSubsStack("ResolveAdvanceDecision (offlineplaybackengine) ","offlineplaybackengine",5,__ref.getField(false, "ba"),__ref,11);
...
try {
		Debug.PushSubsStack("ResolveNextMusicItem (offlineplaybackengine) ","offlineplaybackengine",5,__ref.getField(false, "ba"),__ref,35);
