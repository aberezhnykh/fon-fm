...
try {
		Debug.PushSubsStack("AppendHistoryRecord (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2117);
...
Debug.locals.put("record", _record);
 BA.debugLineNum = 2117;BA.debugLine="Private Sub AppendHistoryRecord(recordDate As Stri";
Debug.ShouldStop(16);
 BA.debugLineNum = 2118;BA.debugLine="If recordDate = \"\" Then Return";
Debug.ShouldStop(32);
if (RemoteObject.solveBoolean("=",_recorddate,BA.ObjectToString(""))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 2119;BA.debugLine="EnsureDirectory(GetHistoryDir)";
Debug.ShouldStop(64);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_ensuredirectory" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (b4j.example.b4xmainpage.class, "_gethistorydir" /*RemoteObject*/ )));
 BA.debugLineNum = 2120;BA.debugLine="Dim generator As JSONGenerator";
...
_generator = RemoteObject.createNew ("anywheresoftware.b4j.objects.collections.JSONParser.JSONGenerator");Debug.locals.put("generator", _generator);
 BA.debugLineNum = 2121;BA.debugLine="generator.Initialize(record)";
Debug.ShouldStop(256);
_generator.runVoidMethod ("Initialize",(Object)(_record));
 BA.debugLineNum = 2122;BA.debugLine="Dim outStream As OutputStream = File.OpenOutput(G";
...
_outstream = b4xmainpage.__c.getField(false,"File").runMethod(false,"OpenOutput",(Object)(__ref.runClassMethod (b4j.example.b4xmainpage.class, "_gethistorydir" /*RemoteObject*/ )),(Object)(__ref.runClassMethod (b4j.example.b4xmainpage.class, "_historyfilename" /*RemoteObject*/ ,(Object)(_recorddate))),(Object)(b4xmainpage.__c.getField(true,"True")));Debug.locals.put("outStream", _outstream);Debug.locals.put("outStream", _outstream);
 BA.debugLineNum = 2123;BA.debugLine="Dim writer As TextWriter";
...
_writer = RemoteObject.createNew ("anywheresoftware.b4a.objects.streams.File.TextWriterWrapper");Debug.locals.put("writer", _writer);
 BA.debugLineNum = 2124;BA.debugLine="writer.Initialize2(outStream, \"UTF8\")";
Debug.ShouldStop(2048);
_writer.runVoidMethod ("Initialize2",(Object)((_outstream.getObject())),(Object)(RemoteObject.createImmutable("UTF8")));
 BA.debugLineNum = 2125;BA.debugLine="writer.WriteLine(generator.ToString)";
Debug.ShouldStop(4096);
_writer.runVoidMethod ("WriteLine",(Object)(_generator.runMethod(true,"ToString")));
 BA.debugLineNum = 2126;BA.debugLine="writer.Close";
Debug.ShouldStop(8192);
_writer.runVoidMethod ("Close");
 BA.debugLineNum = 2127;BA.debugLine="storage.Put(\"pending_history_count\", storage.GetD";
Debug.ShouldStop(16384);
...
try {
		Debug.PushSubsStack("ApplyMaterialIconFont (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3142);
...
Debug.locals.put("fontSize", _fontsize);
 BA.debugLineNum = 3142;BA.debugLine="Private Sub ApplyMaterialIconFont(view As B4XView,";
Debug.ShouldStop(32);
 BA.debugLineNum = 3143;BA.debugLine="UiStyle.ApplyMaterialIconFont(xui, view, fontSize";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("ApplyOrbitFrame (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2540);
...
Debug.locals.put("stepIndex", _stepindex);
 BA.debugLineNum = 2540;BA.debugLine="Private Sub ApplyOrbitFrame(stepIndex As Int)";
Debug.ShouldStop(2048);
 BA.debugLineNum = 2541;BA.debugLine="Dim opacity As Double";
Debug.ShouldStop(4096);
_opacity = RemoteObject.createImmutable(0);Debug.locals.put("opacity", _opacity);
 BA.debugLineNum = 2542;BA.debugLine="If orbitFadeValue <= 0 Then";
Debug.ShouldStop(8192);
if (RemoteObject.solveBoolean("k",__ref.getField(true,"_orbitfadevalue" /*RemoteObject*/ ),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 2543;BA.debugLine="opacity = 0";
Debug.ShouldStop(16384);
_opacity = BA.numberCast(double.class, 0);Debug.locals.put("opacity", _opacity);
 }else {
 BA.debugLineNum = 2545;BA.debugLine="Dim basePhase As Double = stepIndex / 24";
Debug.ShouldStop(65536);
_basephase = RemoteObject.solve(new RemoteObject[] {_stepindex,RemoteObject.createImmutable(24)}, "/",0, 0);Debug.locals.put("basePhase", _basephase);Debug.locals.put("basePhase", _basephase);
 BA.debugLineNum = 2546;BA.debugLine="Dim wave As Double = (Sin(basePhase * cPI * 2) +";
Debug.ShouldStop(131072);
_wave = RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {b4xmainpage.__c.runMethod(true,"Sin",(Object)(RemoteObject.solve(new RemoteObject[] {_basephase,b4xmainpage.__c.getField(true,"cPI"),RemoteObject.createImmutable(2)}, "**",0, 0))),RemoteObject.createImmutable(1)}, "+",1, 0)),RemoteObject.createImmutable(2)}, "/",0, 0);Debug.locals.put("wave", _wave);Debug.locals.put("wave", _wave);
 BA.debugLineNum = 2547;BA.debugLine="opacity = (0.38 + wave * 0.28) * orbitFadeValue";
Debug.ShouldStop(262144);
_opacity = RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {RemoteObject.createImmutable(0.38),_wave,RemoteObject.createImmutable(0.28)}, "+*",1, 0)),__ref.getField(true,"_orbitfadevalue" /*RemoteObject*/ )}, "*",0, 0);Debug.locals.put("opacity", _opacity);
 ...
 BA.debugLineNum = 2549;BA.debugLine="ApplyOrbitState(opacity)";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("ApplyOrbitState (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2552);
...
Debug.locals.put("opacity", _opacity);
 BA.debugLineNum = 2552;BA.debugLine="Private Sub ApplyOrbitState(opacity As Double)";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 2553;BA.debugLine="Dim jo As JavaObject = orbitPane";
Debug.ShouldStop(16777216);
...
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), __ref.getField(false,"_orbitpane" /*RemoteObject*/ ).getObject());Debug.locals.put("jo", _jo);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 2554;BA.debugLine="jo.RunMethod(\"setOpacity\", Array As Object(opacit";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("ApplyStoppedState (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2621);
if (RapidSub.canDelegate("applystoppedstate")) { return __ref.runUserSub(false, "b4xmainpage","applystoppedstate", __ref);}
 BA.debugLineNum = 2621;BA.debugLine="Private Sub ApplyStoppedState";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 2622;BA.debugLine="ShowStream(MessageValue(\"idle_stream\"))";
Debug.ShouldStop(536870912);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_showstream" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (b4j.example.b4xmainpage.class, "_messagevalue" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("idle_stream")))));
 BA.debugLineNum = 2623;BA.debugLine="SetStatusText(\"\")";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("AudioPrimary_Complete (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2316);
if (RapidSub.canDelegate("audioprimary_complete")) { return __ref.runUserSub(false, "b4xmainpage","audioprimary_complete", __ref);}
 BA.debugLineNum = 2316;BA.debugLine="Private Sub AudioPrimary_Complete";
Debug.ShouldStop(2048);
 BA.debugLineNum = 2317;BA.debugLine="HandleAudioComplete(\"primary\")";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("AudioPrimary_Error (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2308);
...
Debug.locals.put("message", _message);
 BA.debugLineNum = 2308;BA.debugLine="Private Sub AudioPrimary_Error(message As String)";
Debug.ShouldStop(8);
 BA.debugLineNum = 2309;BA.debugLine="HandleAudioError(\"primary\", message)";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("AudioPrimary_Ready (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2300);
if (RapidSub.canDelegate("audioprimary_ready")) { return __ref.runUserSub(false, "b4xmainpage","audioprimary_ready", __ref);}
 BA.debugLineNum = 2300;BA.debugLine="Private Sub AudioPrimary_Ready";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 2301;BA.debugLine="HandleAudioReady(\"primary\")";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("AudioPrimary_Timeupdate (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2324);
if (RapidSub.canDelegate("audioprimary_timeupdate")) { return __ref.runUserSub(false, "b4xmainpage","audioprimary_timeupdate", __ref);}
 BA.debugLineNum = 2324;BA.debugLine="Private Sub AudioPrimary_Timeupdate";
Debug.ShouldStop(524288);
 BA.debugLineNum = 2325;BA.debugLine="HandleAudioTimeupdate(\"primary\")";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("AudioSecondary_Complete (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2320);
if (RapidSub.canDelegate("audiosecondary_complete")) { return __ref.runUserSub(false, "b4xmainpage","audiosecondary_complete", __ref);}
 BA.debugLineNum = 2320;BA.debugLine="Private Sub AudioSecondary_Complete";
Debug.ShouldStop(32768);
 BA.debugLineNum = 2321;BA.debugLine="HandleAudioComplete(\"secondary\")";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("AudioSecondary_Error (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2312);
...
Debug.locals.put("message", _message);
 BA.debugLineNum = 2312;BA.debugLine="Private Sub AudioSecondary_Error(message As String";
Debug.ShouldStop(128);
 BA.debugLineNum = 2313;BA.debugLine="HandleAudioError(\"secondary\", message)";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("AudioSecondary_Ready (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2304);
if (RapidSub.canDelegate("audiosecondary_ready")) { return __ref.runUserSub(false, "b4xmainpage","audiosecondary_ready", __ref);}
 BA.debugLineNum = 2304;BA.debugLine="Private Sub AudioSecondary_Ready";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 2305;BA.debugLine="HandleAudioReady(\"secondary\")";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("AudioSecondary_Timeupdate (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2328);
if (RapidSub.canDelegate("audiosecondary_timeupdate")) { return __ref.runUserSub(false, "b4xmainpage","audiosecondary_timeupdate", __ref);}
 BA.debugLineNum = 2328;BA.debugLine="Private Sub AudioSecondary_Timeupdate";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 2329;BA.debugLine="HandleAudioTimeupdate(\"secondary\")";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("BreakTimer_Tick (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,1951);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1952;BA.debugLine="breakTimer.Enabled = False";
Debug.ShouldStop(-2147483648);
__ref.getField(false,"_breaktimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",parent.__c.getField(true,"False"));
 BA.debugLineNum = 1953;BA.debugLine="If isStarted = False Or isStoppedByUser Then Retu";
Debug.ShouldStop(1);
if (true) break;
...
this.state = 7;
;
 BA.debugLineNum = 1954;BA.debugLine="If ShouldTriggerBreakNow = False Then Return";
Debug.ShouldStop(2);
if (true) break;
...
this.state = -1;
;
 BA.debugLineNum = 1955;BA.debugLine="TraceLog(\"Сработал таймер exact-break.\")";
Debug.ShouldStop(4);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("Сработал таймер exact-break.")));
 BA.debugLineNum = 1956;BA.debugLine="Wait For (FadeOutAndContinue) Complete (unused As";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("BringToFront (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2616);
if (RapidSub.canDelegate("bringtofront")) { return __ref.runUserSub(false, "b4xmainpage","bringtofront", __ref, _view);}
RemoteObject _jo = RemoteObject.declareNull("anywheresoftware.b4j.object.JavaObject");
Debug.locals.put("view", _view);
 BA.debugLineNum = 2616;BA.debugLine="Private Sub BringToFront(view As B4XView)";
Debug.ShouldStop(8388608);
 BA.debugLineNum = 2617;BA.debugLine="Dim jo As JavaObject = view";
Debug.ShouldStop(16777216);
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _view.getObject());Debug.locals.put("jo", _jo);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 2618;BA.debugLine="jo.RunMethod(\"toFront\", Null)";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("BuildParams (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2834);
...
Debug.locals.put("params", _params);
 BA.debugLineNum = 2834;BA.debugLine="Private Sub BuildParams(params As Map) As String";
Debug.ShouldStop(131072);
 BA.debugLineNum = 2835;BA.debugLine="Dim sb As StringBuilder";
Debug.ShouldStop(262144);
_sb = RemoteObject.createNew ("anywheresoftware.b4a.keywords.StringBuilderWrapper");Debug.locals.put("sb", _sb);
 BA.debugLineNum = 2836;BA.debugLine="sb.Initialize";
Debug.ShouldStop(524288);
_sb.runVoidMethod ("Initialize");
 BA.debugLineNum = 2837;BA.debugLine="For Each key As String In params.Keys";
Debug.ShouldStop(1048576);
{
...
Debug.locals.put("key", _key);
 BA.debugLineNum = 2838;BA.debugLine="If sb.Length > 0 Then sb.Append(\"&\")";
Debug.ShouldStop(2097152);
...
_sb.runVoidMethod ("Append",(Object)(RemoteObject.createImmutable("&")));};
 BA.debugLineNum = 2839;BA.debugLine="sb.Append(UrlEncode(key)).Append(\"=\").Append(Url";
Debug.ShouldStop(4194304);
...
;
 BA.debugLineNum = 2841;BA.debugLine="Return sb.ToString";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("ClearExactBreakState (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,1959);
if (RapidSub.canDelegate("clearexactbreakstate")) { return __ref.runUserSub(false, "b4xmainpage","clearexactbreakstate", __ref);}
 BA.debugLineNum = 1959;BA.debugLine="Private Sub ClearExactBreakState";
Debug.ShouldStop(64);
 BA.debugLineNum = 1960;BA.debugLine="scheduledBreakAt = -1";
Debug.ShouldStop(128);
__ref.setField ("_scheduledbreakat" /*RemoteObject*/ ,BA.numberCast(long.class, -(double) (0 + 1)));
 BA.debugLineNum = 1961;BA.debugLine="breakTimer.Enabled = False";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("ClearHistoryLogTimer (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2096);
if (RapidSub.canDelegate("clearhistorylogtimer")) { return __ref.runUserSub(false, "b4xmainpage","clearhistorylogtimer", __ref);}
 BA.debugLineNum = 2096;BA.debugLine="Private Sub ClearHistoryLogTimer";
Debug.ShouldStop(32768);
 BA.debugLineNum = 2097;BA.debugLine="historyItem.Initialize";
Debug.ShouldStop(65536);
__ref.getField(false,"_historyitem" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 2098;BA.debugLine="historyStartedAtTicks = 0";
Debug.ShouldStop(131072);
...
try {
		Debug.PushSubsStack("ClearPlaybackState (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2271);
if (RapidSub.canDelegate("clearplaybackstate")) { return __ref.runUserSub(false, "b4xmainpage","clearplaybackstate", __ref);}
 BA.debugLineNum = 2271;BA.debugLine="Private Sub ClearPlaybackState";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 2272;BA.debugLine="TraceLog(\"ClearPlaybackState\")";
Debug.ShouldStop(-2147483648);
...
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clearpreparedstate" /*RemoteObject*/ ,(Object)(b4xmainpage.__c.getField(true,"False")));
 BA.debugLineNum = 2283;BA.debugLine="playQueue.Clear";
Debug.ShouldStop(1024);
__ref.getField(false,"_playqueue" /*RemoteObject*/ ).runVoidMethod ("Clear");
 BA.debugLineNum = 2284;BA.debugLine="prefetchDone = False";
Debug.ShouldStop(2048);
__ref.setField ("_prefetchdone" /*RemoteObject*/ ,b4xmainpage.__c.getField(true,"False"));
 BA.debugLineNum = 2285;BA.debugLine="isCrossfadeTriggered = False";
Debug.ShouldStop(4096);
__ref.setField ("_iscrossfadetriggered" /*RemoteObject*/ ,b4xmainpage.__c.getField(true,"False"));
 BA.debugLineNum = 2286;BA.debugLine="initialStartFadePending = False";
Debug.ShouldStop(8192);
__ref.setField ("_initialstartfadepending" /*RemoteObject*/ ,b4xmainpage.__c.getField(true,"False"));
 BA.debugLineNum = 2287;BA.debugLine="ClearRetryTimer";
Debug.ShouldStop(16384);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clearretrytimer" /*RemoteObject*/ );
 BA.debugLineNum = 2288;BA.debugLine="ClearExactBreakState";
Debug.ShouldStop(32768);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clearexactbreakstate" /*RemoteObject*/ );
 BA.debugLineNum = 2289;BA.debugLine="ClearHistoryLogTimer";
Debug.ShouldStop(65536);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clearhistorylogtimer" /*RemoteObject*/ );
 BA.debugLineNum = 2290;BA.debugLine="SetStatusText(\"\")";
Debug.ShouldStop(131072);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setstatustext" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("")));
...
try {
		Debug.PushSubsStack("ClearRetryTimer (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,1920);
if (RapidSub.canDelegate("clearretrytimer")) { return __ref.runUserSub(false, "b4xmainpage","clearretrytimer", __ref);}
 BA.debugLineNum = 1920;BA.debugLine="Private Sub ClearRetryTimer";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 1921;BA.debugLine="retryTimer.Enabled = False";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("ColorToCss (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3162);
if (RapidSub.canDelegate("colortocss")) { return __ref.runUserSub(false, "b4xmainpage","colortocss", __ref, _color);}
Debug.locals.put("color", _color);
 BA.debugLineNum = 3162;BA.debugLine="Private Sub ColorToCss(color As Int) As String";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 3163;BA.debugLine="Return UiStyle.ColorToCss(color)";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("ConfirmPendingHistoryItem (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2014);
...
Debug.locals.put("reason", _reason);
 BA.debugLineNum = 2014;BA.debugLine="Private Sub ConfirmPendingHistoryItem(reason As St";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 2015;BA.debugLine="If historyItem.IsInitialized = False Then Return";
Debug.ShouldStop(1073741824);
...
if (true) return b4xmainpage.__c.getField(true,"False");};
 BA.debugLineNum = 2016;BA.debugLine="If historyItem.GetDefault(\"id\", \"\") = \"\" Then Ret";
Debug.ShouldStop(-2147483648);
...
if (true) return b4xmainpage.__c.getField(true,"False");};
 BA.debugLineNum = 2017;BA.debugLine="TraceLog(\"История подтверждена. reason=\" & reason";
Debug.ShouldStop(1);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("История подтверждена. reason="),_reason,RemoteObject.createImmutable(", item="),__ref.runClassMethod (b4j.example.b4xmainpage.class, "_describeitem" /*RemoteObject*/ ,(Object)((__ref.getField(false,"_historyitem" /*RemoteObject*/ ).getObject()))))));
 BA.debugLineNum = 2018;BA.debugLine="QueueHistoryRecordAt(historyItem, historyStartedA";
Debug.ShouldStop(2);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_queuehistoryrecordat" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_historyitem" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_historystartedatticks" /*RemoteObject*/ )));
 BA.debugLineNum = 2019;BA.debugLine="ClearHistoryLogTimer";
Debug.ShouldStop(4);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clearhistorylogtimer" /*RemoteObject*/ );
 BA.debugLineNum = 2020;BA.debugLine="Return True";
Debug.ShouldStop(8);
if (true) return b4xmainpage.__c.getField(true,"True");
...
try {
		Debug.PushSubsStack("CountAllPendingHistoryRecords (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2145);
...
RemoteObject _filename = RemoteObject.createImmutable("");
 BA.debugLineNum = 2145;BA.debugLine="Private Sub CountAllPendingHistoryRecords As Int";
Debug.ShouldStop(1);
 BA.debugLineNum = 2146;BA.debugLine="If File.Exists(GetHistoryDir, \"\") = False Then Re";
Debug.ShouldStop(2);
...
if (true) return BA.numberCast(int.class, 0);};
 BA.debugLineNum = 2147;BA.debugLine="Dim listedFiles As List = File.ListFiles(GetHisto";
Debug.ShouldStop(4);
...
_listedfiles = b4xmainpage.__c.getField(false,"File").runMethod(false,"ListFiles",(Object)(__ref.runClassMethod (b4j.example.b4xmainpage.class, "_gethistorydir" /*RemoteObject*/ )));Debug.locals.put("listedFiles", _listedfiles);Debug.locals.put("listedFiles", _listedfiles);
 BA.debugLineNum = 2148;BA.debugLine="If listedFiles.IsInitialized = False Then Return";
Debug.ShouldStop(8);
if (RemoteObject.solveBoolean("=",_listedfiles.runMethod(true,"IsInitialized"),b4xmainpage.__c.getField(true,"False"))) { 
if (true) return BA.numberCast(int.class, 0);};
 BA.debugLineNum = 2149;BA.debugLine="Dim total As Int = 0";
Debug.ShouldStop(16);
_total = BA.numberCast(int.class, 0);Debug.locals.put("total", _total);Debug.locals.put("total", _total);
 BA.debugLineNum = 2150;BA.debugLine="For Each fileName As String In listedFiles";
Debug.ShouldStop(32);
{
...
Debug.locals.put("fileName", _filename);
 BA.debugLineNum = 2151;BA.debugLine="If IsHistoryFileName(fileName) = False Then Cont";
Debug.ShouldStop(64);
...
if (true) continue;};
 BA.debugLineNum = 2152;BA.debugLine="Try";
Debug.ShouldStop(128);
try { BA.debugLineNum = 2153;BA.debugLine="total = total + CountNdjsonRecords(File.ReadStr";
Debug.ShouldStop(256);
_total = RemoteObject.solve(new RemoteObject[] {_total,__ref.runClassMethod (b4j.example.b4xmainpage.class, "_countndjsonrecords" /*RemoteObject*/ ,(Object)(b4xmainpage.__c.getField(false,"File").runMethod(true,"ReadString",(Object)(__ref.runClassMethod (b4j.example.b4xmainpage.class, "_gethistorydir" /*RemoteObject*/ )),(Object)(_filename))))}, "+",1, 1);Debug.locals.put("total", _total);
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e10.toString()); BA.debugLineNum = 2155;BA.debugLine="Log(LastException.Message)";
Debug.ShouldStop(1024);
b4xmainpage.__c.runVoidMethod ("LogImpl","642336266",b4xmainpage.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage"),0);
 };
 }
}Debug.locals.put("fileName", _filename);
;
 BA.debugLineNum = 2158;BA.debugLine="Return total";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("CountNdjsonRecords (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2161);
...
Debug.locals.put("payload", _payload);
 BA.debugLineNum = 2161;BA.debugLine="Private Sub CountNdjsonRecords(payload As String)";
Debug.ShouldStop(65536);
 BA.debugLineNum = 2162;BA.debugLine="Dim normalized As String = NormalizeNdjsonPayload";
Debug.ShouldStop(131072);
_normalized = __ref.runClassMethod (b4j.example.b4xmainpage.class, "_normalizendjsonpayload" /*RemoteObject*/ ,(Object)(_payload));Debug.locals.put("normalized", _normalized);Debug.locals.put("normalized", _normalized);
 BA.debugLineNum = 2163;BA.debugLine="If normalized = \"\" Then Return 0";
Debug.ShouldStop(262144);
if (RemoteObject.solveBoolean("=",_normalized,BA.ObjectToString(""))) { 
if (true) return BA.numberCast(int.class, 0);};
 BA.debugLineNum = 2164;BA.debugLine="Dim rows() As String = Regex.Split(CRLF, normaliz";
Debug.ShouldStop(524288);
_rows = b4xmainpage.__c.getField(false,"Regex").runMethod(false,"Split",(Object)(b4xmainpage.__c.getField(true,"CRLF")),(Object)(_normalized));Debug.locals.put("rows", _rows);Debug.locals.put("rows", _rows);
 BA.debugLineNum = 2165;BA.debugLine="Dim count As Int = 0";
Debug.ShouldStop(1048576);
_count = BA.numberCast(int.class, 0);Debug.locals.put("count", _count);Debug.locals.put("count", _count);
 BA.debugLineNum = 2166;BA.debugLine="For Each row As String In rows";
Debug.ShouldStop(2097152);
{
...
Debug.locals.put("row", _row);
 BA.debugLineNum = 2167;BA.debugLine="If row.Trim <> \"\" Then count = count + 1";
Debug.ShouldStop(4194304);
...
;
 BA.debugLineNum = 2169;BA.debugLine="Return count";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("CreateClaimParams (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2815);
...
_params.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("tz"))),(Object)((__ref.runClassMethod (b4j.example.b4xmainpage.class, "_timezoneoffsetminutes" /*RemoteObject*/ ))));
 BA.debugLineNum = 2821;BA.debugLine="Return params";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("CreateDataParams (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2824);
if (RapidSub.canDelegate("createdataparams")) { return __ref.runUserSub(false, "b4xmainpage","createdataparams", __ref);}
RemoteObject _params = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 2824;BA.debugLine="Private Sub CreateDataParams As Map";
Debug.ShouldStop(128);
 BA.debugLineNum = 2825;BA.debugLine="Dim params As Map";
Debug.ShouldStop(256);
_params = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("params", _params);
 BA.debugLineNum = 2826;BA.debugLine="params.Initialize";
Debug.ShouldStop(512);
_params.runVoidMethod ("Initialize");
 BA.debugLineNum = 2827;BA.debugLine="params.Put(\"player\", playerCode)";
Debug.ShouldStop(1024);
_params.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("player"))),(Object)((__ref.getField(true,"_playercode" /*RemoteObject*/ ))));
 BA.debugLineNum = 2828;BA.debugLine="params.Put(\"device\", deviceId)";
Debug.ShouldStop(2048);
_params.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("device"))),(Object)((__ref.getField(true,"_deviceid" /*RemoteObject*/ ))));
 BA.debugLineNum = 2829;BA.debugLine="params.Put(\"tz\", TimezoneOffsetMinutes)";
Debug.ShouldStop(4096);
_params.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("tz"))),(Object)((__ref.runClassMethod (b4j.example.b4xmainpage.class, "_timezoneoffsetminutes" /*RemoteObject*/ ))));
 BA.debugLineNum = 2830;BA.debugLine="params.Put(\"version\", APP_VERSION)";
Debug.ShouldStop(8192);
_params.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("version"))),(Object)((__ref.getField(true,"_app_version" /*RemoteObject*/ ))));
 BA.debugLineNum = 2831;BA.debugLine="Return params";
Debug.ShouldStop(16384);
if (true) return _params;
...
try {
		Debug.PushSubsStack("CreateInitializedList (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3037);
...
RemoteObject _items = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
 BA.debugLineNum = 3037;BA.debugLine="Private Sub CreateInitializedList As List";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 3038;BA.debugLine="Dim items As List";
Debug.ShouldStop(536870912);
_items = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("items", _items);
 BA.debugLineNum = 3039;BA.debugLine="items.Initialize";
Debug.ShouldStop(1073741824);
_items.runVoidMethod ("Initialize");
 BA.debugLineNum = 3040;BA.debugLine="Return items";
Debug.ShouldStop(-2147483648);
...
try {
		Debug.PushSubsStack("CreateInitializedMap (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3031);
...
RemoteObject _m = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 3031;BA.debugLine="Private Sub CreateInitializedMap As Map";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 3032;BA.debugLine="Dim m As Map";
Debug.ShouldStop(8388608);
_m = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("m", _m);
 BA.debugLineNum = 3033;BA.debugLine="m.Initialize";
Debug.ShouldStop(16777216);
_m.runVoidMethod ("Initialize");
 BA.debugLineNum = 3034;BA.debugLine="Return m";
Debug.ShouldStop(33554432);
if (true) return _m;
...
try {
		Debug.PushSubsStack("CreateLabel (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3129);
...
Debug.locals.put("wrapText", _wraptext);
 BA.debugLineNum = 3129;BA.debugLine="Private Sub CreateLabel(text As String, fontSize A";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 3130;BA.debugLine="Return UiStyle.CreateLabel(xui, text, fontSize, t";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("CreateMetaParams (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2795);
if (RapidSub.canDelegate("createmetaparams")) { return __ref.runUserSub(false, "b4xmainpage","createmetaparams", __ref);}
RemoteObject _params = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 2795;BA.debugLine="Private Sub CreateMetaParams As Map";
Debug.ShouldStop(1024);
 BA.debugLineNum = 2796;BA.debugLine="Dim params As Map";
Debug.ShouldStop(2048);
_params = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("params", _params);
 BA.debugLineNum = 2797;BA.debugLine="params.Initialize";
Debug.ShouldStop(4096);
_params.runVoidMethod ("Initialize");
 BA.debugLineNum = 2798;BA.debugLine="params.Put(\"player\", playerCode)";
Debug.ShouldStop(8192);
_params.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("player"))),(Object)((__ref.getField(true,"_playercode" /*RemoteObject*/ ))));
 BA.debugLineNum = 2799;BA.debugLine="params.Put(\"tz\", TimezoneOffsetMinutes)";
Debug.ShouldStop(16384);
_params.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("tz"))),(Object)((__ref.runClassMethod (b4j.example.b4xmainpage.class, "_timezoneoffsetminutes" /*RemoteObject*/ ))));
 BA.debugLineNum = 2800;BA.debugLine="Return params";
Debug.ShouldStop(32768);
if (true) return _params;
...
try {
		Debug.PushSubsStack("CreateNextParams (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2803);
if (RapidSub.canDelegate("createnextparams")) { return __ref.runUserSub(false, "b4xmainpage","createnextparams", __ref);}
RemoteObject _params = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 2803;BA.debugLine="Private Sub CreateNextParams As Map";
Debug.ShouldStop(262144);
 BA.debugLineNum = 2804;BA.debugLine="Dim params As Map";
Debug.ShouldStop(524288);
_params = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("params", _params);
 BA.debugLineNum = 2805;BA.debugLine="params.Initialize";
Debug.ShouldStop(1048576);
_params.runVoidMethod ("Initialize");
 BA.debugLineNum = 2806;BA.debugLine="params.Put(\"player\", playerCode)";
Debug.ShouldStop(2097152);
_params.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("player"))),(Object)((__ref.getField(true,"_playercode" /*RemoteObject*/ ))));
 BA.debugLineNum = 2807;BA.debugLine="params.Put(\"device\", deviceId)";
Debug.ShouldStop(4194304);
_params.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("device"))),(Object)((__ref.getField(true,"_deviceid" /*RemoteObject*/ ))));
 BA.debugLineNum = 2808;BA.debugLine="params.Put(\"tz\", TimezoneOffsetMinutes)";
Debug.ShouldStop(8388608);
_params.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("tz"))),(Object)((__ref.runClassMethod (b4j.example.b4xmainpage.class, "_timezoneoffsetminutes" /*RemoteObject*/ ))));
 BA.debugLineNum = 2809;BA.debugLine="params.Put(\"version\", APP_VERSION)";
Debug.ShouldStop(16777216);
_params.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("version"))),(Object)((__ref.getField(true,"_app_version" /*RemoteObject*/ ))));
 BA.debugLineNum = 2810;BA.debugLine="If nextStartMode = \"manual\" Or nextStartMode = \"a";
Debug.ShouldStop(33554432);
...
_params.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("start"))),(Object)((__ref.getField(true,"_nextstartmode" /*RemoteObject*/ ))));};
 BA.debugLineNum = 2811;BA.debugLine="If playlistIndex >= 0 Then params.Put(\"playlist\",";
Debug.ShouldStop(67108864);
...
_params.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("playlist"))),(Object)((__ref.getField(true,"_playlistindex" /*RemoteObject*/ ))));};
 BA.debugLineNum = 2812;BA.debugLine="Return params";
Debug.ShouldStop(134217728);
if (true) return _params;
...
try {
		Debug.PushSubsStack("CreateRandomDeviceId (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2874);
...
RemoteObject _uuid = RemoteObject.declareNull("anywheresoftware.b4j.object.JavaObject");
 BA.debugLineNum = 2874;BA.debugLine="Private Sub CreateRandomDeviceId As String";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 2875;BA.debugLine="Dim jo As JavaObject";
Debug.ShouldStop(67108864);
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");Debug.locals.put("jo", _jo);
 BA.debugLineNum = 2876;BA.debugLine="jo.InitializeStatic(\"java.util.UUID\")";
Debug.ShouldStop(134217728);
_jo.runVoidMethod ("InitializeStatic",(Object)(RemoteObject.createImmutable("java.util.UUID")));
 BA.debugLineNum = 2877;BA.debugLine="Dim uuid As JavaObject = jo.RunMethod(\"randomUUID";
Debug.ShouldStop(268435456);
...
_uuid = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _jo.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("randomUUID")),(Object)((b4xmainpage.__c.getField(false,"Null")))));Debug.locals.put("uuid", _uuid);Debug.locals.put("uuid", _uuid);
 BA.debugLineNum = 2878;BA.debugLine="Return uuid.RunMethod(\"toString\", Null)";
Debug.ShouldStop(536870912);
...
try {
		Debug.PushSubsStack("CreateTextButton (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3133);
...
Debug.locals.put("eventName", _eventname);
 BA.debugLineNum = 3133;BA.debugLine="Private Sub CreateTextButton(text As String, event";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 3134;BA.debugLine="Dim btn As Button";
Debug.ShouldStop(536870912);
_btn = RemoteObject.createNew ("anywheresoftware.b4j.objects.ButtonWrapper");Debug.locals.put("btn", _btn);
 BA.debugLineNum = 3135;BA.debugLine="btn.Initialize(eventName)";
Debug.ShouldStop(1073741824);
_btn.runVoidMethod ("Initialize",__ref.getField(false, "ba"),(Object)(_eventname));
 BA.debugLineNum = 3136;BA.debugLine="Dim xbtn As B4XView = btn";
Debug.ShouldStop(-2147483648);
...
_xbtn = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _btn.getObject());Debug.locals.put("xbtn", _xbtn);Debug.locals.put("xbtn", _xbtn);
 BA.debugLineNum = 3137;BA.debugLine="xbtn.Text = text.ToUpperCase";
Debug.ShouldStop(1);
_xbtn.runMethod(true,"setText",_text.runMethod(true,"toUpperCase"));
 BA.debugLineNum = 3138;BA.debugLine="UpdateTextButtonAppearance(xbtn, False)";
Debug.ShouldStop(2);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_updatetextbuttonappearance" /*RemoteObject*/ ,(Object)(_xbtn),(Object)(b4xmainpage.__c.getField(true,"False")));
 BA.debugLineNum = 3139;BA.debugLine="Return xbtn";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("CurrentSecondOfMinute (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2967);
...
RemoteObject _value = RemoteObject.createImmutable(0);
 BA.debugLineNum = 2967;BA.debugLine="Private Sub CurrentSecondOfMinute As Int";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 2968;BA.debugLine="Dim previousTimeFormat As String = DateTime.TimeF";
Debug.ShouldStop(8388608);
_previoustimeformat = b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"getTimeFormat");Debug.locals.put("previousTimeFormat", _previoustimeformat);Debug.locals.put("previousTimeFormat", _previoustimeformat);
 BA.debugLineNum = 2969;BA.debugLine="DateTime.TimeFormat = \"ss\"";
Debug.ShouldStop(16777216);
b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"setTimeFormat",BA.ObjectToString("ss"));
 BA.debugLineNum = 2970;BA.debugLine="Dim value As Int = DateTime.Time(DateTime.Now)";
Debug.ShouldStop(33554432);
_value = BA.numberCast(int.class, b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"Time",(Object)(b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"getNow"))));Debug.locals.put("value", _value);Debug.locals.put("value", _value);
 BA.debugLineNum = 2971;BA.debugLine="DateTime.TimeFormat = previousTimeFormat";
Debug.ShouldStop(67108864);
b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"setTimeFormat",_previoustimeformat);
 BA.debugLineNum = 2972;BA.debugLine="Return value";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("CurrentVolume (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2730);
if (RapidSub.canDelegate("currentvolume")) { return __ref.runUserSub(false, "b4xmainpage","currentvolume", __ref, _item);}
Debug.locals.put("item", _item);
 BA.debugLineNum = 2730;BA.debugLine="Private Sub CurrentVolume(item As Map) As Double";
Debug.ShouldStop(512);
 BA.debugLineNum = 2731;BA.debugLine="Return ResolveItemVolume(item)";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("DbToFactor (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2962);
if (RapidSub.canDelegate("dbtofactor")) { return __ref.runUserSub(false, "b4xmainpage","dbtofactor", __ref, _db);}
Debug.locals.put("db", _db);
 BA.debugLineNum = 2962;BA.debugLine="Private Sub DbToFactor(db As Double) As Double";
Debug.ShouldStop(131072);
 BA.debugLineNum = 2963;BA.debugLine="If db >= 0 Then Return 1";
Debug.ShouldStop(262144);
if (RemoteObject.solveBoolean("g",_db,BA.numberCast(double.class, 0))) { 
if (true) return BA.numberCast(double.class, 1);};
 BA.debugLineNum = 2964;BA.debugLine="Return Power(10, db / 20)";
Debug.ShouldStop(524288);
...
try {
		Debug.PushSubsStack("DeleteHistoryFile (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2225);
if (RapidSub.canDelegate("deletehistoryfile")) { return __ref.runUserSub(false, "b4xmainpage","deletehistoryfile", __ref, _filename);}
Debug.locals.put("fileName", _filename);
 BA.debugLineNum = 2225;BA.debugLine="Private Sub DeleteHistoryFile(fileName As String)";
Debug.ShouldStop(65536);
 BA.debugLineNum = 2226;BA.debugLine="If fileName = \"\" Then Return";
Debug.ShouldStop(131072);
if (RemoteObject.solveBoolean("=",_filename,BA.ObjectToString(""))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 2227;BA.debugLine="If File.Exists(GetHistoryDir, fileName) Then File";
Debug.ShouldStop(262144);
...
try {
		Debug.PushSubsStack("DescribeItem (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2446);
...
Debug.locals.put("itemObj", _itemobj);
 BA.debugLineNum = 2446;BA.debugLine="Private Sub DescribeItem(itemObj As Object) As Str";
Debug.ShouldStop(8192);
 BA.debugLineNum = 2447;BA.debugLine="If itemObj Is Map Then";
Debug.ShouldStop(16384);
if (RemoteObject.solveBoolean("i",_itemobj, RemoteObject.createImmutable("java.util.Map"))) { 
 }else {
 BA.debugLineNum = 2449;BA.debugLine="Return \"<empty>\"";
Debug.ShouldStop(65536);
if (true) return BA.ObjectToString("<empty>");
 };
 BA.debugLineNum = 2451;BA.debugLine="Dim item As Map = itemObj";
Debug.ShouldStop(262144);
...
_item = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _itemobj);Debug.locals.put("item", _item);Debug.locals.put("item", _item);
 BA.debugLineNum = 2452;BA.debugLine="If item.IsInitialized = False Then Return \"<empty";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean("=",_item.runMethod(true,"IsInitialized"),b4xmainpage.__c.getField(true,"False"))) { 
if (true) return BA.ObjectToString("<empty>");};
 BA.debugLineNum = 2453;BA.debugLine="Dim parts As List";
Debug.ShouldStop(1048576);
_parts = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("parts", _parts);
 BA.debugLineNum = 2454;BA.debugLine="parts.Initialize";
Debug.ShouldStop(2097152);
_parts.runVoidMethod ("Initialize");
 BA.debugLineNum = 2455;BA.debugLine="parts.Add(\"тип=\" & item.GetDefault(\"type\", \"\"))";
Debug.ShouldStop(4194304);
_parts.runVoidMethod ("Add",(Object)((RemoteObject.concat(RemoteObject.createImmutable("тип="),_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("type"))),(Object)((RemoteObject.createImmutable(""))))))));
 BA.debugLineNum = 2456;BA.debugLine="If item.GetDefault(\"id\", \"\") <> \"\" Then parts.Add";
Debug.ShouldStop(8388608);
...
_parts.runVoidMethod ("Add",(Object)((RemoteObject.concat(RemoteObject.createImmutable("id="),_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("id"))),(Object)((RemoteObject.createImmutable(""))))))));};
 BA.debugLineNum = 2457;BA.debugLine="If item.GetDefault(\"title\", \"\") <> \"\" Then parts.";
Debug.ShouldStop(16777216);
...
_parts.runVoidMethod ("Add",(Object)((RemoteObject.concat(RemoteObject.createImmutable("название="),_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("title"))),(Object)((RemoteObject.createImmutable(""))))))));};
 BA.debugLineNum = 2458;BA.debugLine="If item.GetDefault(\"stream\", \"\") <> \"\" Then parts";
Debug.ShouldStop(33554432);
...
_parts.runVoidMethod ("Add",(Object)((RemoteObject.concat(RemoteObject.createImmutable("поток="),_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("stream"))),(Object)((RemoteObject.createImmutable(""))))))));};
 BA.debugLineNum = 2459;BA.debugLine="If item.GetDefault(\"set\", \"\") <> \"\" Then parts.Ad";
Debug.ShouldStop(67108864);
...
_parts.runVoidMethod ("Add",(Object)((RemoteObject.concat(RemoteObject.createImmutable("сет="),_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("set"))),(Object)((RemoteObject.createImmutable(""))))))));};
 BA.debugLineNum = 2460;BA.debugLine="If item.GetDefault(\"code\", \"\") <> \"\" Then parts.A";
Debug.ShouldStop(134217728);
...
_parts.runVoidMethod ("Add",(Object)((RemoteObject.concat(RemoteObject.createImmutable("код="),_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("code"))),(Object)((RemoteObject.createImmutable(""))))))));};
 BA.debugLineNum = 2461;BA.debugLine="Return JoinList(parts, \", \")";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("DownloadOfflinePlaylistMetadata (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3010);
...
Debug.locals.put("cachedPlaylistIndex", _cachedplaylistindex);
 BA.debugLineNum = 3011;BA.debugLine="Dim playlistId As String = descriptor.GetDefault(";
Debug.ShouldStop(4);
_playlistid = BA.ObjectToString(_descriptor.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("id"))),(Object)((RemoteObject.createImmutable("")))));Debug.locals.put("playlistId", _playlistid);Debug.locals.put("playlistId", _playlistid);
 BA.debugLineNum = 3012;BA.debugLine="If playlistId = \"\" Then Return False";
Debug.ShouldStop(8);
if (true) break;
...
this.state = 7;
;
 BA.debugLineNum = 3013;BA.debugLine="Dim playlistUrl As String = offlineStoreService.P";
Debug.ShouldStop(16);
_playlisturl = __ref.getField(false,"_offlinestoreservice" /*RemoteObject*/ ).runClassMethod (b4j.example.offlinestore.class, "_playlistmetadataurl" /*RemoteObject*/ ,(Object)(_playlistid));Debug.locals.put("playlistUrl", _playlisturl);Debug.locals.put("playlistUrl", _playlisturl);
 BA.debugLineNum = 3014;BA.debugLine="TraceLog(\"Загрузка playlist metadata. id=\" & play";
Debug.ShouldStop(32);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Загрузка playlist metadata. id="),_playlistid,RemoteObject.createImmutable(", url="),_playlisturl)));
 BA.debugLineNum = 3015;BA.debugLine="Wait For (FetchJsonWithTimeout(playlistUrl, FETCH";
Debug.ShouldStop(64);
...
;
 BA.debugLineNum = 3016;BA.debugLine="If result.GetDefault(\"Success\", False) = False Th";
Debug.ShouldStop(128);
if (true) break;
...
//C
this.state = 10;
 BA.debugLineNum = 3017;BA.debugLine="TraceLog(\"Не удалось загрузить playlist metadata";
Debug.ShouldStop(256);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Не удалось загрузить playlist metadata. id="),_playlistid,RemoteObject.createImmutable(", message="),_result.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("ErrorMessage"))),(Object)((RemoteObject.createImmutable("")))))));
 BA.debugLineNum = 3018;BA.debugLine="Return False";
Debug.ShouldStop(512);
if (true) {
parent.__c.runVoidMethod ("ReturnFromResumableSub",this.remoteResumableSub,(parent.__c.getField(true,"False")));return;};
 if (true) break;
...
this.state = 11;
;
 BA.debugLineNum = 3020;BA.debugLine="Dim resultData As Object = result.Get(\"Data\")";
Debug.ShouldStop(2048);
_resultdata = _result.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Data"))));Debug.locals.put("resultData", _resultdata);Debug.locals.put("resultData", _resultdata);
 BA.debugLineNum = 3021;BA.debugLine="If resultData Is Map Then";
Debug.ShouldStop(4096);
if (true) break;
...
//C
this.state = 16;
 BA.debugLineNum = 3023;BA.debugLine="TraceLog(\"Playlist metadata не является Map. id=";
Debug.ShouldStop(16384);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Playlist metadata не является Map. id="),_playlistid)));
 BA.debugLineNum = 3024;BA.debugLine="Return False";
Debug.ShouldStop(32768);
if (true) {
parent.__c.runVoidMethod ("ReturnFromResumableSub",this.remoteResumableSub,(parent.__c.getField(true,"False")));return;};
 if (true) break;
...
this.state = -1;
;
 BA.debugLineNum = 3026;BA.debugLine="Dim playlistData As Map = resultData";
Debug.ShouldStop(131072);
_playlistdata = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_playlistdata = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _resultdata);Debug.locals.put("playlistData", _playlistdata);Debug.locals.put("playlistData", _playlistdata);
 BA.debugLineNum = 3027;BA.debugLine="offlineStoreService.SavePlaylistMetadata(descript";
Debug.ShouldStop(262144);
__ref.getField(false,"_offlinestoreservice" /*RemoteObject*/ ).runClassMethod (b4j.example.offlinestore.class, "_saveplaylistmetadata" /*RemoteObject*/ ,(Object)(_descriptor),(Object)(_playlistdata),(Object)(_cachedplaylistindex));
 BA.debugLineNum = 3028;BA.debugLine="Return True";
Debug.ShouldStop(524288);
if (true) {
...
try {
		Debug.PushSubsStack("EffectiveTrackRemainMs (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,1973);
...
RemoteObject _breakremain = RemoteObject.createImmutable(0L);
 BA.debugLineNum = 1973;BA.debugLine="Private Sub EffectiveTrackRemainMs As Long";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 1974;BA.debugLine="Dim trackRemain As Long = 0";
Debug.ShouldStop(2097152);
_trackremain = BA.numberCast(long.class, 0);Debug.locals.put("trackRemain", _trackremain);Debug.locals.put("trackRemain", _trackremain);
 BA.debugLineNum = 1975;BA.debugLine="If activeAudioKey <> \"\" Then";
Debug.ShouldStop(4194304);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_activeaudiokey" /*RemoteObject*/ ),BA.ObjectToString(""))) { 
 BA.debugLineNum = 1976;BA.debugLine="Dim activeAudio As AudioPlayer = GetAudioByKey(a";
Debug.ShouldStop(8388608);
_activeaudio = __ref.runClassMethod (b4j.example.b4xmainpage.class, "_getaudiobykey" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_activeaudiokey" /*RemoteObject*/ )));Debug.locals.put("activeAudio", _activeaudio);Debug.locals.put("activeAudio", _activeaudio);
 BA.debugLineNum = 1977;BA.debugLine="If activeAudio.Duration > 0 Then trackRemain = a";
Debug.ShouldStop(16777216);
...
_trackremain = RemoteObject.solve(new RemoteObject[] {_activeaudio.runClassMethod (b4j.example.audioplayer.class, "_duration" /*RemoteObject*/ ),_activeaudio.runClassMethod (b4j.example.audioplayer.class, "_position" /*RemoteObject*/ )}, "-",1, 2);Debug.locals.put("trackRemain", _trackremain);};
 ...
 BA.debugLineNum = 1979;BA.debugLine="If scheduledBreakAt <= 0 Then Return trackRemain";
Debug.ShouldStop(67108864);
...
if (true) return _trackremain;};
 BA.debugLineNum = 1980;BA.debugLine="Dim breakRemain As Long = (scheduledBreakAt - Loc";
Debug.ShouldStop(134217728);
_breakremain = RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_scheduledbreakat" /*RemoteObject*/ ),__ref.runClassMethod (b4j.example.b4xmainpage.class, "_localnowtimestamp" /*RemoteObject*/ )}, "-",1, 2)),RemoteObject.createImmutable(1000)}, "*",0, 2);Debug.locals.put("breakRemain", _breakremain);Debug.locals.put("breakRemain", _breakremain);
 BA.debugLineNum = 1981;BA.debugLine="If trackRemain <= 0 Then Return breakRemain";
Debug.ShouldStop(268435456);
if (RemoteObject.solveBoolean("k",_trackremain,BA.numberCast(long.class, 0))) { 
if (true) return _breakremain;};
 BA.debugLineNum = 1982;BA.debugLine="Return Min(trackRemain, breakRemain)";
Debug.ShouldStop(536870912);
...
try {
		Debug.PushSubsStack("EnsureSinglePlaylistMetadata (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2937);
...
Debug.locals.put("_ref", __ref);
Debug.locals.put("descriptor", _descriptor);
 BA.debugLineNum = 2938;BA.debugLine="Dim cachedPlaylistIndex As Map = offlineStoreServ";
Debug.ShouldStop(33554432);
...
_cachedplaylistindex = __ref.getField(false,"_offlinestoreservice" /*RemoteObject*/ ).runClassMethod (b4j.example.offlinestore.class, "_getcachedplaylistindex" /*RemoteObject*/ );Debug.locals.put("cachedPlaylistIndex", _cachedplaylistindex);Debug.locals.put("cachedPlaylistIndex", _cachedplaylistindex);
 BA.debugLineNum = 2939;BA.debugLine="Wait For (DownloadOfflinePlaylistMetadata(descrip";
Debug.ShouldStop(67108864);
...
_downloaded = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("downloaded", _downloaded);
;
 BA.debugLineNum = 2940;BA.debugLine="If downloaded Then offlineStoreService.SaveCached";
Debug.ShouldStop(134217728);
if (true) break;
...
this.state = -1;
;
 BA.debugLineNum = 2941;BA.debugLine="Return downloaded";
Debug.ShouldStop(268435456);
if (true) {
...
try {
		Debug.PushSubsStack("FadeOutAndContinue (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,1985);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1986;BA.debugLine="If isQueueTransitioning Then Return False";
Debug.ShouldStop(2);
if (true) break;
...
this.state = 7;
;
 BA.debugLineNum = 1987;BA.debugLine="isQueueTransitioning = True";
Debug.ShouldStop(4);
__ref.setField ("_isqueuetransitioning" /*RemoteObject*/ ,parent.__c.getField(true,"True"));
 BA.debugLineNum = 1988;BA.debugLine="ClearExactBreakState";
Debug.ShouldStop(8);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clearexactbreakstate" /*RemoteObject*/ );
 BA.debugLineNum = 1989;BA.debugLine="Dim fadeMs As Int";
Debug.ShouldStop(16);
_fadems = RemoteObject.createImmutable(0);Debug.locals.put("fadeMs", _fadems);
 BA.debugLineNum = 1990;BA.debugLine="If currentMediaType = \"track\" Then";
Debug.ShouldStop(32);
if (true) break;
...
//C
this.state = 12;
 BA.debugLineNum = 1991;BA.debugLine="fadeMs = STOP_FADE_MS";
Debug.ShouldStop(64);
...
//C
this.state = 12;
 BA.debugLineNum = 1993;BA.debugLine="fadeMs = 0";
Debug.ShouldStop(256);
...
this.state = 13;
;
 BA.debugLineNum = 1995;BA.debugLine="TraceLog(\"Переход через fade-out. currentType=\" &";
Debug.ShouldStop(1024);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Переход через fade-out. currentType="),__ref.getField(true,"_currentmediatype" /*RemoteObject*/ ),RemoteObject.createImmutable(", fadeMs="),_fadems)));
 BA.debugLineNum = 1996;BA.debugLine="If activeAudioKey <> \"\" Then GetAudioByKey(active";
Debug.ShouldStop(2048);
if (true) break;
...
this.state = -1;
;
 BA.debugLineNum = 1997;BA.debugLine="ClearPreparedState(False)";
Debug.ShouldStop(4096);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clearpreparedstate" /*RemoteObject*/ ,(Object)(parent.__c.getField(true,"False")));
 BA.debugLineNum = 1998;BA.debugLine="Wait For (PlayPreparedOrLoadNext) Complete (unuse";
Debug.ShouldStop(8192);
...
_unused = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("unused", _unused);
;
 BA.debugLineNum = 1999;BA.debugLine="isQueueTransitioning = False";
Debug.ShouldStop(16384);
__ref.setField ("_isqueuetransitioning" /*RemoteObject*/ ,parent.__c.getField(true,"False"));
 BA.debugLineNum = 2000;BA.debugLine="Return True";
Debug.ShouldStop(32768);
if (true) {
parent.__c.runVoidMethod ("ReturnFromResumableSub",this.remoteResumableSub,(parent.__c.getField(true,"True")));return;};
...
try {
		Debug.PushSubsStack("FilterPlayerCode (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2856);
...
Debug.locals.put("value", _value);
 BA.debugLineNum = 2856;BA.debugLine="Private Sub FilterPlayerCode(value As String) As S";
Debug.ShouldStop(128);
 BA.debugLineNum = 2857;BA.debugLine="Dim filtered As String = Regex.Replace(\"[^A-Za-z0";
Debug.ShouldStop(256);
_filtered = b4xmainpage.__c.getField(false,"Regex").runMethod(true,"Replace",(Object)(BA.ObjectToString("[^A-Za-z0-9]")),(Object)(_value),(Object)(RemoteObject.createImmutable("")));Debug.locals.put("filtered", _filtered);Debug.locals.put("filtered", _filtered);
 BA.debugLineNum = 2858;BA.debugLine="If filtered.Length > 5 Then filtered = filtered.S";
Debug.ShouldStop(512);
...
_filtered = _filtered.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 5)));Debug.locals.put("filtered", _filtered);};
 BA.debugLineNum = 2859;BA.debugLine="Return filtered.ToUpperCase";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("FlushHistoryBuffer (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2042);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 2043;BA.debugLine="If isHistoryFlushInProgress Then Return False";
Debug.ShouldStop(67108864);
if (true) break;
...
this.state = 7;
;
 BA.debugLineNum = 2044;BA.debugLine="If playerCode = \"\" Or deviceId = \"\" Then Return F";
Debug.ShouldStop(134217728);
if (true) break;
...
this.state = 13;
;
 BA.debugLineNum = 2045;BA.debugLine="Dim pendingHistoryFileName As String = GetOldestP";
Debug.ShouldStop(268435456);
_pendinghistoryfilename = __ref.runClassMethod (b4j.example.b4xmainpage.class, "_getoldestpendinghistoryfilename" /*RemoteObject*/ );Debug.locals.put("pendingHistoryFileName", _pendinghistoryfilename);Debug.locals.put("pendingHistoryFileName", _pendinghistoryfilename);
 BA.debugLineNum = 2046;BA.debugLine="If pendingHistoryFileName = \"\" Then Return True";
Debug.ShouldStop(536870912);
if (true) break;
...
this.state = 19;
;
 BA.debugLineNum = 2047;BA.debugLine="isHistoryFlushInProgress = True";
Debug.ShouldStop(1073741824);
__ref.setField ("_ishistoryflushinprogress" /*RemoteObject*/ ,parent.__c.getField(true,"True"));
 BA.debugLineNum = 2048;BA.debugLine="Dim batchDate As String = HistoryFileNameToDate(p";
Debug.ShouldStop(-2147483648);
_batchdate = __ref.runClassMethod (b4j.example.b4xmainpage.class, "_historyfilenametodate" /*RemoteObject*/ ,(Object)(_pendinghistoryfilename));Debug.locals.put("batchDate", _batchdate);Debug.locals.put("batchDate", _batchdate);
 BA.debugLineNum = 2049;BA.debugLine="Dim payload As String = \"\"";
Debug.ShouldStop(1);
...
this.state = 24;
this.catchState = 23;
 BA.debugLineNum = 2051;BA.debugLine="payload = File.ReadString(GetHistoryDir, pending";
Debug.ShouldStop(4);
...
this.state = 24;
this.catchState = 0;
 BA.debugLineNum = 2053;BA.debugLine="TraceLog(\"Не удалось прочитать history file. fil";
Debug.ShouldStop(16);
...
this.catchState = 0;
;
 BA.debugLineNum = 2055;BA.debugLine="payload = NormalizeNdjsonPayload(payload)";
Debug.ShouldStop(64);
_payload = __ref.runClassMethod (b4j.example.b4xmainpage.class, "_normalizendjsonpayload" /*RemoteObject*/ ,(Object)(_payload));Debug.locals.put("payload", _payload);
 BA.debugLineNum = 2056;BA.debugLine="If payload = \"\" Or batchDate = \"\" Then";
Debug.ShouldStop(128);
if (true) break;
...
this.state = 29;
;
 BA.debugLineNum = 2062;BA.debugLine="Dim recordCount As Int = CountNdjsonRecords(paylo";
Debug.ShouldStop(8192);
_recordcount = __ref.runClassMethod (b4j.example.b4xmainpage.class, "_countndjsonrecords" /*RemoteObject*/ ,(Object)(_payload));Debug.locals.put("recordCount", _recordcount);Debug.locals.put("recordCount", _recordcount);
 BA.debugLineNum = 2063;BA.debugLine="TraceLog(\"SendHistory batch. date=\" & batchDate &";
Debug.ShouldStop(16384);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("SendHistory batch. date="),_batchdate,RemoteObject.createImmutable(", records="),_recordcount,RemoteObject.createImmutable(", file="),_pendinghistoryfilename)));
 BA.debugLineNum = 2064;BA.debugLine="Dim queryParams As Map";
Debug.ShouldStop(32768);
_queryparams = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("queryParams", _queryparams);
 BA.debugLineNum = 2065;BA.debugLine="queryParams.Initialize";
Debug.ShouldStop(65536);
_queryparams.runVoidMethod ("Initialize");
 BA.debugLineNum = 2066;BA.debugLine="queryParams.Put(\"player\", playerCode)";
Debug.ShouldStop(131072);
_queryparams.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("player"))),(Object)((__ref.getField(true,"_playercode" /*RemoteObject*/ ))));
 BA.debugLineNum = 2067;BA.debugLine="queryParams.Put(\"device\", deviceId)";
Debug.ShouldStop(262144);
_queryparams.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("device"))),(Object)((__ref.getField(true,"_deviceid" /*RemoteObject*/ ))));
 BA.debugLineNum = 2068;BA.debugLine="queryParams.Put(\"date\", batchDate)";
Debug.ShouldStop(524288);
_queryparams.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("date"))),(Object)((_batchdate)));
 BA.debugLineNum = 2069;BA.debugLine="Dim requestUrl As String = HISTORY_BASE_URL & \"?\"";
Debug.ShouldStop(1048576);
_requesturl = RemoteObject.concat(__ref.getField(true,"_history_base_url" /*RemoteObject*/ ),RemoteObject.createImmutable("?"),__ref.runClassMethod (b4j.example.b4xmainpage.class, "_buildparams" /*RemoteObject*/ ,(Object)(_queryparams)));Debug.locals.put("requestUrl", _requesturl);Debug.locals.put("requestUrl", _requesturl);
 BA.debugLineNum = 2070;BA.debugLine="TraceLog(\"SendHistory payload. player=\" & playerC";
Debug.ShouldStop(2097152);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("SendHistory payload. player="),__ref.getField(true,"_playercode" /*RemoteObject*/ ),RemoteObject.createImmutable(", device="),__ref.getField(true,"_deviceid" /*RemoteObject*/ ),RemoteObject.createImmutable(", date="),_batchdate,RemoteObject.createImmutable(", records="),_recordcount)));
 BA.debugLineNum = 2071;BA.debugLine="Dim j As HttpJob";
Debug.ShouldStop(4194304);
_j = RemoteObject.createNew ("b4j.example.httpjob");Debug.locals.put("j", _j);
 BA.debugLineNum = 2072;BA.debugLine="j.Initialize(\"\", Me)";
Debug.ShouldStop(8388608);
_j.runClassMethod (b4j.example.httpjob.class, "_initialize" /*RemoteObject*/ ,__ref.getField(false, "ba"),(Object)(BA.ObjectToString("")),(Object)(__ref));
 BA.debugLineNum = 2073;BA.debugLine="j.PostString(requestUrl, payload)";
Debug.ShouldStop(16777216);
_j.runClassMethod (b4j.example.httpjob.class, "_poststring" /*RemoteObject*/ ,(Object)(_requesturl),(Object)(_payload));
 BA.debugLineNum = 2074;BA.debugLine="j.GetRequest.Timeout = 5000";
Debug.ShouldStop(33554432);
_j.runClassMethod (b4j.example.httpjob.class, "_getrequest" /*RemoteObject*/ ).runMethod(true,"setTimeout",BA.numberCast(int.class, 5000));
 BA.debugLineNum = 2075;BA.debugLine="j.GetRequest.SetContentType(\"text/plain; charset=";
Debug.ShouldStop(67108864);
...
_j = (RemoteObject) result.getArrayElement(false,RemoteObject.createImmutable(1));Debug.locals.put("j", _j);
;
 BA.debugLineNum = 2077;BA.debugLine="Dim success As Boolean = False";
Debug.ShouldStop(268435456);
_success = parent.__c.getField(true,"False");Debug.locals.put("success", _success);Debug.locals.put("success", _success);
 BA.debugLineNum = 2078;BA.debugLine="If j.Success Then";
Debug.ShouldStop(536870912);
if (true) break;
...
//C
this.state = 34;
 BA.debugLineNum = 2079;BA.debugLine="Dim responseText As String = j.GetString";
Debug.ShouldStop(1073741824);
_responsetext = _j.runClassMethod (b4j.example.httpjob.class, "_getstring" /*RemoteObject*/ );Debug.locals.put("responseText", _responsetext);Debug.locals.put("responseText", _responsetext);
 BA.debugLineNum = 2080;BA.debugLine="SaveServerSnapshot(\"POST\", requestUrl, True, res";
Debug.ShouldStop(-2147483648);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_saveserversnapshot" /*RemoteObject*/ ,(Object)(BA.ObjectToString("POST")),(Object)(_requesturl),(Object)(parent.__c.getField(true,"True")),(Object)(_responsetext),(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 2081;BA.debugLine="success = IsHistoryBatchAccepted(responseText)";
Debug.ShouldStop(1);
...
//C
this.state = 34;
 BA.debugLineNum = 2083;BA.debugLine="SaveServerSnapshot(\"POST\", requestUrl, False, \"\"";
Debug.ShouldStop(4);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_saveserversnapshot" /*RemoteObject*/ ,(Object)(BA.ObjectToString("POST")),(Object)(_requesturl),(Object)(parent.__c.getField(true,"False")),(Object)(BA.ObjectToString("")),(Object)(_j.getField(true,"_errormessage" /*RemoteObject*/ )));
 if (true) break;
;
 BA.debugLineNum = 2085;BA.debugLine="If success Then";
Debug.ShouldStop(16);
...
//C
this.state = 37;
 BA.debugLineNum = 2086;BA.debugLine="DeleteHistoryFile(pendingHistoryFileName)";
Debug.ShouldStop(32);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_deletehistoryfile" /*RemoteObject*/ ,(Object)(_pendinghistoryfilename));
 BA.debugLineNum = 2087;BA.debugLine="RefreshPendingHistoryState";
Debug.ShouldStop(64);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_refreshpendinghistorystate" /*RemoteObject*/ );
 BA.debugLineNum = 2088;BA.debugLine="TraceLog(\"Локальный буфер истории обновлен. remo";
Debug.ShouldStop(128);
...
this.state = -1;
;
 BA.debugLineNum = 2090;BA.debugLine="TraceLog(\"SendHistory complete. success=\" & succe";
Debug.ShouldStop(512);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("SendHistory complete. success="),_success)));
 BA.debugLineNum = 2091;BA.debugLine="j.Release";
Debug.ShouldStop(1024);
_j.runClassMethod (b4j.example.httpjob.class, "_release" /*RemoteObject*/ );
 BA.debugLineNum = 2092;BA.debugLine="isHistoryFlushInProgress = False";
Debug.ShouldStop(2048);
__ref.setField ("_ishistoryflushinprogress" /*RemoteObject*/ ,parent.__c.getField(true,"False"));
 BA.debugLineNum = 2093;BA.debugLine="Return success";
Debug.ShouldStop(4096);
if (true) {
...
try {
		Debug.PushSubsStack("FormatHistoryDate (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2101);
...
Debug.locals.put("ticks", _ticks);
 BA.debugLineNum = 2101;BA.debugLine="Private Sub FormatHistoryDate(ticks As Long) As St";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 2102;BA.debugLine="Dim previousDateFormat As String = DateTime.DateF";
Debug.ShouldStop(2097152);
_previousdateformat = b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"getDateFormat");Debug.locals.put("previousDateFormat", _previousdateformat);Debug.locals.put("previousDateFormat", _previousdateformat);
 BA.debugLineNum = 2103;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd\"";
Debug.ShouldStop(4194304);
b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("yyyy-MM-dd"));
 BA.debugLineNum = 2104;BA.debugLine="Dim value As String = DateTime.Date(ticks)";
Debug.ShouldStop(8388608);
_value = b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"Date",(Object)(_ticks));Debug.locals.put("value", _value);Debug.locals.put("value", _value);
 BA.debugLineNum = 2105;BA.debugLine="DateTime.DateFormat = previousDateFormat";
Debug.ShouldStop(16777216);
b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",_previousdateformat);
 BA.debugLineNum = 2106;BA.debugLine="Return value";
Debug.ShouldStop(33554432);
if (true) return _value;
...
try {
		Debug.PushSubsStack("FormatHistoryTime (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2109);
if (RapidSub.canDelegate("formathistorytime")) { return __ref.runUserSub(false, "b4xmainpage","formathistorytime", __ref, _ticks);}
RemoteObject _previoustimeformat = RemoteObject.createImmutable("");
RemoteObject _value = RemoteObject.createImmutable("");
Debug.locals.put("ticks", _ticks);
 BA.debugLineNum = 2109;BA.debugLine="Private Sub FormatHistoryTime(ticks As Long) As St";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 2110;BA.debugLine="Dim previousTimeFormat As String = DateTime.TimeF";
Debug.ShouldStop(536870912);
_previoustimeformat = b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"getTimeFormat");Debug.locals.put("previousTimeFormat", _previoustimeformat);Debug.locals.put("previousTimeFormat", _previoustimeformat);
 BA.debugLineNum = 2111;BA.debugLine="DateTime.TimeFormat = \"HH:mm:ss\"";
Debug.ShouldStop(1073741824);
b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"setTimeFormat",BA.ObjectToString("HH:mm:ss"));
 BA.debugLineNum = 2112;BA.debugLine="Dim value As String = DateTime.Time(ticks)";
Debug.ShouldStop(-2147483648);
_value = b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"Time",(Object)(_ticks));Debug.locals.put("value", _value);Debug.locals.put("value", _value);
 BA.debugLineNum = 2113;BA.debugLine="DateTime.TimeFormat = previousTimeFormat";
Debug.ShouldStop(1);
b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"setTimeFormat",_previoustimeformat);
 BA.debugLineNum = 2114;BA.debugLine="Return value";
Debug.ShouldStop(2);
if (true) return _value;
...
try {
		Debug.PushSubsStack("FormatPlayerCodeForDisplay (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2862);
...
Debug.locals.put("value", _value);
 BA.debugLineNum = 2862;BA.debugLine="Private Sub FormatPlayerCodeForDisplay(value As St";
Debug.ShouldStop(8192);
 BA.debugLineNum = 2863;BA.debugLine="Return value.Trim.ToUpperCase";
Debug.ShouldStop(16384);
...
try {
		Debug.PushSubsStack("GetHistoryDir (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2230);
if (RapidSub.canDelegate("gethistorydir")) { return __ref.runUserSub(false, "b4xmainpage","gethistorydir", __ref);}
 BA.debugLineNum = 2230;BA.debugLine="Private Sub GetHistoryDir As String";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 2231;BA.debugLine="Return File.Combine(storageDir, historyDirName)";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("GetOldestPendingHistoryFileName (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2196);
...
RemoteObject _filename = RemoteObject.createImmutable("");
 BA.debugLineNum = 2196;BA.debugLine="Private Sub GetOldestPendingHistoryFileName As Str";
Debug.ShouldStop(524288);
 BA.debugLineNum = 2197;BA.debugLine="If File.Exists(GetHistoryDir, \"\") = False Then Re";
Debug.ShouldStop(1048576);
if (RemoteObject.solveBoolean("=",b4xmainpage.__c.getField(false,"File").runMethod(true,"Exists",(Object)(__ref.runClassMethod (b4j.example.b4xmainpage.class, "_gethistorydir" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable(""))),b4xmainpage.__c.getField(true,"False"))) { 
if (true) return BA.ObjectToString("");};
 BA.debugLineNum = 2198;BA.debugLine="Dim listedFiles As List = File.ListFiles(GetHisto";
Debug.ShouldStop(2097152);
_listedfiles = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_listedfiles = b4xmainpage.__c.getField(false,"File").runMethod(false,"ListFiles",(Object)(__ref.runClassMethod (b4j.example.b4xmainpage.class, "_gethistorydir" /*RemoteObject*/ )));Debug.locals.put("listedFiles", _listedfiles);Debug.locals.put("listedFiles", _listedfiles);
 BA.debugLineNum = 2199;BA.debugLine="If listedFiles.IsInitialized = False Or listedFil";
Debug.ShouldStop(4194304);
...
if (true) return BA.ObjectToString("");};
 BA.debugLineNum = 2200;BA.debugLine="Dim historyFiles As List";
Debug.ShouldStop(8388608);
_historyfiles = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("historyFiles", _historyfiles);
 BA.debugLineNum = 2201;BA.debugLine="historyFiles.Initialize";
Debug.ShouldStop(16777216);
_historyfiles.runVoidMethod ("Initialize");
 BA.debugLineNum = 2202;BA.debugLine="For Each fileName As String In listedFiles";
Debug.ShouldStop(33554432);
{
...
Debug.locals.put("fileName", _filename);
 BA.debugLineNum = 2203;BA.debugLine="If IsHistoryFileName(fileName) Then historyFiles";
Debug.ShouldStop(67108864);
...
;
 BA.debugLineNum = 2205;BA.debugLine="If historyFiles.Size = 0 Then Return \"\"";
Debug.ShouldStop(268435456);
if (RemoteObject.solveBoolean("=",_historyfiles.runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
if (true) return BA.ObjectToString("");};
 BA.debugLineNum = 2206;BA.debugLine="historyFiles.Sort(True)";
Debug.ShouldStop(536870912);
_historyfiles.runVoidMethod ("Sort",(Object)(b4xmainpage.__c.getField(true,"True")));
 BA.debugLineNum = 2207;BA.debugLine="Return historyFiles.Get(0)";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("GetOrCreateDeviceId (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2866);
if (RapidSub.canDelegate("getorcreatedeviceid")) { return __ref.runUserSub(false, "b4xmainpage","getorcreatedeviceid", __ref);}
RemoteObject _id = RemoteObject.createImmutable("");
 BA.debugLineNum = 2866;BA.debugLine="Private Sub GetOrCreateDeviceId As String";
Debug.ShouldStop(131072);
 BA.debugLineNum = 2867;BA.debugLine="Dim id As String = storage.GetDefault(\"device_id\"";
Debug.ShouldStop(262144);
...
try {
		Debug.PushSubsStack("GetPendingHistoryFileCount (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2134);
...
RemoteObject _count = RemoteObject.createImmutable(0);
RemoteObject _filename = RemoteObject.createImmutable("");
 BA.debugLineNum = 2134;BA.debugLine="Private Sub GetPendingHistoryFileCount As Int";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 2135;BA.debugLine="If File.Exists(GetHistoryDir, \"\") = False Then Re";
Debug.ShouldStop(4194304);
if (RemoteObject.solveBoolean("=",b4xmainpage.__c.getField(false,"File").runMethod(true,"Exists",(Object)(__ref.runClassMethod (b4j.example.b4xmainpage.class, "_gethistorydir" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable(""))),b4xmainpage.__c.getField(true,"False"))) { 
if (true) return BA.numberCast(int.class, 0);};
 BA.debugLineNum = 2136;BA.debugLine="Dim listedFiles As List = File.ListFiles(GetHisto";
Debug.ShouldStop(8388608);
_listedfiles = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_listedfiles = b4xmainpage.__c.getField(false,"File").runMethod(false,"ListFiles",(Object)(__ref.runClassMethod (b4j.example.b4xmainpage.class, "_gethistorydir" /*RemoteObject*/ )));Debug.locals.put("listedFiles", _listedfiles);Debug.locals.put("listedFiles", _listedfiles);
 BA.debugLineNum = 2137;BA.debugLine="If listedFiles.IsInitialized = False Then Return";
Debug.ShouldStop(16777216);
if (RemoteObject.solveBoolean("=",_listedfiles.runMethod(true,"IsInitialized"),b4xmainpage.__c.getField(true,"False"))) { 
if (true) return BA.numberCast(int.class, 0);};
 BA.debugLineNum = 2138;BA.debugLine="Dim count As Int = 0";
Debug.ShouldStop(33554432);
_count = BA.numberCast(int.class, 0);Debug.locals.put("count", _count);Debug.locals.put("count", _count);
 BA.debugLineNum = 2139;BA.debugLine="For Each fileName As String In listedFiles";
Debug.ShouldStop(67108864);
{
final RemoteObject group5 = _listedfiles;
final int groupLen5 = group5.runMethod(true,"getSize").<Integer>get()
...
_filename = BA.ObjectToString(group5.runMethod(false,"Get",index5));Debug.locals.put("fileName", _filename);
Debug.locals.put("fileName", _filename);
 BA.debugLineNum = 2140;BA.debugLine="If IsHistoryFileName(fileName) Then count = coun";
Debug.ShouldStop(134217728);
if (__ref.runClassMethod (b4j.example.b4xmainpage.class, "_ishistoryfilename" /*RemoteObject*/ ,(Object)(_filename)).<Boolean>get().booleanValue()) { 
_count = RemoteObject.solve(new RemoteObject[] {_count,RemoteObject.createImmutable(1)}, "+",1, 1);Debug.locals.put("count", _count);};
 }
...
;
 BA.debugLineNum = 2142;BA.debugLine="Return count";
Debug.ShouldStop(536870912);
if (true) return _count;
...
try {
		Debug.PushSubsStack("GetServerTraceList (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2438);
if (RapidSub.canDelegate("getservertracelist")) { return __ref.runUserSub(false, "b4xmainpage","getservertracelist", __ref);}
 BA.debugLineNum = 2438;BA.debugLine="Public Sub GetServerTraceList As List";
Debug.ShouldStop(32);
 BA.debugLineNum = 2439;BA.debugLine="Return appTraceService.GetServerTraceList";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("GetServerTraceText (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2434);
if (RapidSub.canDelegate("getservertracetext")) { return __ref.runUserSub(false, "b4xmainpage","getservertracetext", __ref);}
 BA.debugLineNum = 2434;BA.debugLine="Public Sub GetServerTraceText As String";
Debug.ShouldStop(2);
 BA.debugLineNum = 2435;BA.debugLine="Return appTraceService.GetServerTraceText";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("GetTraceLogList (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2430);
if (RapidSub.canDelegate("gettraceloglist")) { return __ref.runUserSub(false, "b4xmainpage","gettraceloglist", __ref);}
 BA.debugLineNum = 2430;BA.debugLine="Public Sub GetTraceLogList As List";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 2431;BA.debugLine="Return appTraceService.GetTraceList";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("GetTraceLogText (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2426);
if (RapidSub.canDelegate("gettracelogtext")) { return __ref.runUserSub(false, "b4xmainpage","gettracelogtext", __ref);}
 BA.debugLineNum = 2426;BA.debugLine="Public Sub GetTraceLogText As String";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 2427;BA.debugLine="Return appTraceService.GetTraceText";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("HandleAudioComplete (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2372);
...
Debug.locals.put("_ref", __ref);
Debug.locals.put("audioKey", _audiokey);
 BA.debugLineNum = 2373;BA.debugLine="If isStoppedByUser Then Return False";
Debug.ShouldStop(16);
if (true) break;
...
this.state = 7;
;
 BA.debugLineNum = 2374;BA.debugLine="If audioKey <> activeAudioKey Then Return False";
Debug.ShouldStop(32);
if (true) break;
...
this.state = 13;
;
 BA.debugLineNum = 2375;BA.debugLine="TraceLog(\"Аудио завершилось. audio=\" & audioKey &";
Debug.ShouldStop(64);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Аудио завершилось. audio="),_audiokey,RemoteObject.createImmutable(", элемент="),__ref.runClassMethod (b4j.example.b4xmainpage.class, "_describeitem" /*RemoteObject*/ ,(Object)((__ref.getField(false,"_activeitem" /*RemoteObject*/ ).getObject()))))));
 BA.debugLineNum = 2376;BA.debugLine="If activeItem.GetDefault(\"type\", \"\") = \"ad\" Then";
Debug.ShouldStop(128);
if (true) break;
...
//C
this.state = 16;
 BA.debugLineNum = 2377;BA.debugLine="TraceLog(\"История подтверждена. reason=ad_comple";
Debug.ShouldStop(256);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("История подтверждена. reason=ad_complete, item="),__ref.runClassMethod (b4j.example.b4xmainpage.class, "_describeitem" /*RemoteObject*/ ,(Object)((__ref.getField(false,"_activeitem" /*RemoteObject*/ ).getObject()))))));
 BA.debugLineNum = 2378;BA.debugLine="QueueHistoryRecordAt(activeItem, historyStartedA";
Debug.ShouldStop(512);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_queuehistoryrecordat" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_activeitem" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_historystartedatticks" /*RemoteObject*/ )));
 BA.debugLineNum = 2379;BA.debugLine="ClearHistoryLogTimer";
Debug.ShouldStop(1024);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clearhistorylogtimer" /*RemoteObject*/ );
 if (true) break;
;
 BA.debugLineNum = 2381;BA.debugLine="If PromotePreparedPlayer(0, 0) Then Return True";
Debug.ShouldStop(4096);
...
this.state = -1;
;
 BA.debugLineNum = 2382;BA.debugLine="Wait For (PlayPreparedOrLoadNext) Complete (unuse";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("HandleAudioError (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2354);
...
Debug.locals.put("audioKey", _audiokey);
Debug.locals.put("message", _message);
 BA.debugLineNum = 2355;BA.debugLine="TraceLog(\"Ошибка аудио. audio=\" & audioKey & \", m";
Debug.ShouldStop(262144);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Ошибка аудио. audio="),_audiokey,RemoteObject.createImmutable(", message="),_message)));
 BA.debugLineNum = 2356;BA.debugLine="If pendingPlayAudioKey = audioKey Then";
Debug.ShouldStop(524288);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 2357;BA.debugLine="ClearPendingPlayState";
Debug.ShouldStop(1048576);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clearpendingplaystate" /*RemoteObject*/ );
 BA.debugLineNum = 2358;BA.debugLine="CallSubDelayed2(Me, \"PlaybackStartDone\", CreateM";
Debug.ShouldStop(2097152);
parent.__c.runVoidMethod ("CallSubDelayed2",__ref.getField(false, "ba"),(Object)(__ref),(Object)(BA.ObjectToString("PlaybackStartDone")),(Object)((parent.__c.runMethod(false, "createMap", (Object)(new RemoteObject[] {RemoteObject.createImmutable(("Success")),(parent.__c.getField(true,"False")),RemoteObject.createImmutable(("Message")),(_message)})))));
 BA.debugLineNum = 2359;BA.debugLine="Return True";
Debug.ShouldStop(4194304);
if (true) {
parent.__c.runVoidMethod ("ReturnFromResumableSub",this.remoteResumableSub,(parent.__c.getField(true,"True")));return;};
 if (true) break;
;
 BA.debugLineNum = 2361;BA.debugLine="If pendingPrepareAudioKey = audioKey Then";
Debug.ShouldStop(16777216);
...
//C
this.state = 7;
 BA.debugLineNum = 2362;BA.debugLine="ClearPreparedState(False)";
Debug.ShouldStop(33554432);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clearpreparedstate" /*RemoteObject*/ ,(Object)(parent.__c.getField(true,"False")));
 BA.debugLineNum = 2363;BA.debugLine="CallSubDelayed2(Me, \"PreloadDone\", CreateMap(\"Su";
Debug.ShouldStop(67108864);
parent.__c.runVoidMethod ("CallSubDelayed2",__ref.getField(false, "ba"),(Object)(__ref),(Object)(BA.ObjectToString("PreloadDone")),(Object)((parent.__c.runMethod(false, "createMap", (Object)(new RemoteObject[] {RemoteObject.createImmutable(("Success")),(parent.__c.getField(true,"False")),RemoteObject.createImmutable(("Message")),(_message)})))));
 BA.debugLineNum = 2364;BA.debugLine="Return True";
Debug.ShouldStop(134217728);
if (true) {
parent.__c.runVoidMethod ("ReturnFromResumableSub",this.remoteResumableSub,(parent.__c.getField(true,"True")));return;};
 if (true) break;
;
 BA.debugLineNum = 2366;BA.debugLine="If audioKey <> activeAudioKey Then Return False";
Debug.ShouldStop(536870912);
...
this.state = 13;
;
 BA.debugLineNum = 2367;BA.debugLine="If isStoppedByUser Or isStopping Then Return Fals";
Debug.ShouldStop(1073741824);
if (true) break;
...
this.state = -1;
;
 BA.debugLineNum = 2368;BA.debugLine="Wait For (HandleMediaError) Complete (unused As B";
Debug.ShouldStop(-2147483648);
...
_unused = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("unused", _unused);
;
 BA.debugLineNum = 2369;BA.debugLine="Return True";
Debug.ShouldStop(1);
if (true) {
parent.__c.runVoidMethod ("ReturnFromResumableSub",this.remoteResumableSub,(parent.__c.getField(true,"True")));return;};
...
try {
		Debug.PushSubsStack("HandleAudioReady (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2332);
if (RapidSub.canDelegate("handleaudioready")) { return __ref.runUserSub(false, "b4xmainpage","handleaudioready", __ref, _audiokey);}
Debug.locals.put("audioKey", _audiokey);
 BA.debugLineNum = 2332;BA.debugLine="Private Sub HandleAudioReady(audioKey As String)";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 2333;BA.debugLine="TraceLog(\"Аудио готово. audio=\" & audioKey)";
Debug.ShouldStop(268435456);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Аудио готово. audio="),_audiokey)));
 BA.debugLineNum = 2334;BA.debugLine="If isOfflinePlaybackMode Then";
Debug.ShouldStop(536870912);
if (__ref.getField(true,"_isofflineplaybackmode" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 2335;BA.debugLine="UpdateConnectionIndicator(\"offline\")";
Debug.ShouldStop(1073741824);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_updateconnectionindicator" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("offline")));
 }else {
 BA.debugLineNum = 2337;BA.debugLine="UpdateConnectionIndicator(\"online\")";
Debug.ShouldStop(1);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_updateconnectionindicator" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("online")));
 };
 BA.debugLineNum = 2339;BA.debugLine="If pendingPlayAudioKey = audioKey Then";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_pendingplayaudiokey" /*RemoteObject*/ ),_audiokey)) { 
 BA.debugLineNum = 2340;BA.debugLine="ActivateLoadedItem(audioKey, pendingPlayItem, pe";
Debug.ShouldStop(8);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_activateloadeditem" /*RemoteObject*/ ,(Object)(_audiokey),(Object)(__ref.getField(false,"_pendingplayitem" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_pendingplayfadeinms" /*RemoteObject*/ )));
 BA.debugLineNum = 2341;BA.debugLine="ClearPendingPlayState";
Debug.ShouldStop(16);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clearpendingplaystate" /*RemoteObject*/ );
 BA.debugLineNum = 2342;BA.debugLine="CallSubDelayed2(Me, \"PlaybackStartDone\", CreateM";
Debug.ShouldStop(32);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 2345;BA.debugLine="If pendingPrepareAudioKey = audioKey Then";
Debug.ShouldStop(256);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_pendingprepareaudiokey" /*RemoteObject*/ ),_audiokey)) { 
 BA.debugLineNum = 2346;BA.debugLine="preparedAudioKey = audioKey";
Debug.ShouldStop(512);
__ref.setField ("_preparedaudiokey" /*RemoteObject*/ ,_audiokey);
 BA.debugLineNum = 2347;BA.debugLine="preparedItem = CloneMap(pendingPrepareItem)";
Debug.ShouldStop(1024);
__ref.setField ("_prepareditem" /*RemoteObject*/ ,__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clonemap" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_pendingprepareitem" /*RemoteObject*/ ))));
 BA.debugLineNum = 2348;BA.debugLine="pendingPrepareAudioKey = \"\"";
Debug.ShouldStop(2048);
__ref.setField ("_pendingprepareaudiokey" /*RemoteObject*/ ,BA.ObjectToString(""));
 BA.debugLineNum = 2349;BA.debugLine="pendingPrepareItem.Initialize";
Debug.ShouldStop(4096);
__ref.getField(false,"_pendingprepareitem" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 2350;BA.debugLine="CallSubDelayed2(Me, \"PreloadDone\", CreateMap(\"Su";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("HandleAudioTimeupdate (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2386);
...
Debug.locals.put("_ref", __ref);
Debug.locals.put("audioKey", _audiokey);
 BA.debugLineNum = 2387;BA.debugLine="If audioKey <> activeAudioKey Then Return False";
Debug.ShouldStop(262144);
if (true) break;
...
this.state = 7;
;
 BA.debugLineNum = 2388;BA.debugLine="If isStarted = False Or isStoppedByUser Then Retu";
Debug.ShouldStop(524288);
if (true) break;
...
this.state = 13;
;
 BA.debugLineNum = 2389;BA.debugLine="If historyItem.IsInitialized Then";
Debug.ShouldStop(1048576);
if (true) break;
...
//C
this.state = 16;
 BA.debugLineNum = 2390;BA.debugLine="If currentTrackUrl <> \"\" And historyItem.GetDefa";
Debug.ShouldStop(2097152);
if (true) break;
...
//C
this.state = 19;
 BA.debugLineNum = 2391;BA.debugLine="ConfirmPendingHistoryItem(\"timeupdate\")";
Debug.ShouldStop(4194304);
...
;
 if (true) break;
;
 BA.debugLineNum = 2394;BA.debugLine="If ShouldTriggerBreakNow Then";
Debug.ShouldStop(33554432);
...
//C
this.state = 23;
 BA.debugLineNum = 2395;BA.debugLine="TraceLog(\"Достигнута точка exact-break.\")";
Debug.ShouldStop(67108864);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("Достигнута точка exact-break.")));
 BA.debugLineNum = 2396;BA.debugLine="Wait For (FadeOutAndContinue) Complete (unused A";
Debug.ShouldStop(134217728);
...
_unused = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("unused", _unused);
;
 BA.debugLineNum = 2397;BA.debugLine="Return True";
Debug.ShouldStop(268435456);
if (true) {
parent.__c.runVoidMethod ("ReturnFromResumableSub",this.remoteResumableSub,(parent.__c.getField(true,"True")));return;};
 if (true) break;
...
this.state = 24;
;
 BA.debugLineNum = 2399;BA.debugLine="Dim remain As Long = EffectiveTrackRemainMs";
Debug.ShouldStop(1073741824);
_remain = __ref.runClassMethod (b4j.example.b4xmainpage.class, "_effectivetrackremainms" /*RemoteObject*/ );Debug.locals.put("remain", _remain);Debug.locals.put("remain", _remain);
 BA.debugLineNum = 2400;BA.debugLine="If CanCrossfadePreparedItem And remain > 0 And re";
Debug.ShouldStop(-2147483648);
if (true) break;
...
//C
this.state = 27;
 BA.debugLineNum = 2401;BA.debugLine="isCrossfadeTriggered = True";
Debug.ShouldStop(1);
__ref.setField ("_iscrossfadetriggered" /*RemoteObject*/ ,parent.__c.getField(true,"True"));
 BA.debugLineNum = 2402;BA.debugLine="TraceLog(\"Запуск overlap треков. remainMs=\" & re";
Debug.ShouldStop(2);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Запуск overlap треков. remainMs="),_remain,RemoteObject.createImmutable(", next="),__ref.runClassMethod (b4j.example.b4xmainpage.class, "_describeitem" /*RemoteObject*/ ,(Object)((__ref.getField(false,"_prepareditem" /*RemoteObject*/ ).getObject()))))));
 BA.debugLineNum = 2403;BA.debugLine="PromotePreparedPlayer(PreparedFadeInMs, Prepared";
Debug.ShouldStop(4);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_promotepreparedplayer" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (b4j.example.b4xmainpage.class, "_preparedfadeinms" /*RemoteObject*/ )),(Object)(__ref.runClassMethod (b4j.example.b4xmainpage.class, "_preparedfadeoutms" /*RemoteObject*/ )));
 BA.debugLineNum = 2404;BA.debugLine="Return True";
Debug.ShouldStop(8);
if (true) {
parent.__c.runVoidMethod ("ReturnFromResumableSub",this.remoteResumableSub,(parent.__c.getField(true,"True")));return;};
 if (true) break;
;
 BA.debugLineNum = 2406;BA.debugLine="If CanStartPreparedOnTrackTail And remain > 0 And";
Debug.ShouldStop(32);
...
//C
this.state = 30;
 BA.debugLineNum = 2407;BA.debugLine="isCrossfadeTriggered = True";
Debug.ShouldStop(64);
__ref.setField ("_iscrossfadetriggered" /*RemoteObject*/ ,parent.__c.getField(true,"True"));
 BA.debugLineNum = 2408;BA.debugLine="TraceLog(\"Запуск ролика на хвосте трека. remainM";
Debug.ShouldStop(128);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Запуск ролика на хвосте трека. remainMs="),_remain,RemoteObject.createImmutable(", next="),__ref.runClassMethod (b4j.example.b4xmainpage.class, "_describeitem" /*RemoteObject*/ ,(Object)((__ref.getField(false,"_prepareditem" /*RemoteObject*/ ).getObject()))))));
 BA.debugLineNum = 2409;BA.debugLine="PromotePreparedPlayer(PreparedFadeInMs, Prepared";
Debug.ShouldStop(256);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_promotepreparedplayer" /*RemoteObject*/ ,(Object)(__ref.runClassMethod (b4j.example.b4xmainpage.class, "_preparedfadeinms" /*RemoteObject*/ )),(Object)(__ref.runClassMethod (b4j.example.b4xmainpage.class, "_preparedfadeoutms" /*RemoteObject*/ )));
 BA.debugLineNum = 2410;BA.debugLine="Return True";
Debug.ShouldStop(512);
if (true) {
parent.__c.runVoidMethod ("ReturnFromResumableSub",this.remoteResumableSub,(parent.__c.getField(true,"True")));return;};
 if (true) break;
;
 BA.debugLineNum = 2412;BA.debugLine="If prefetchDone Then Return False";
Debug.ShouldStop(2048);
...
this.state = 36;
;
 BA.debugLineNum = 2413;BA.debugLine="If remain <= 0 Then Return False";
Debug.ShouldStop(4096);
if (true) break;
...
this.state = 42;
;
 BA.debugLineNum = 2414;BA.debugLine="If remain <= PREFETCH_SECONDS * 1000 Then";
Debug.ShouldStop(8192);
if (true) break;
...
//C
this.state = 45;
 BA.debugLineNum = 2415;BA.debugLine="prefetchDone = True";
Debug.ShouldStop(16384);
__ref.setField ("_prefetchdone" /*RemoteObject*/ ,parent.__c.getField(true,"True"));
 BA.debugLineNum = 2416;BA.debugLine="TraceLog(\"Запуск предзагрузки следующего элемент";
Debug.ShouldStop(32768);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Запуск предзагрузки следующего элемента. remainMs="),_remain)));
 BA.debugLineNum = 2417;BA.debugLine="Wait For (PrefetchNext) Complete (unused2 As Boo";
Debug.ShouldStop(65536);
...
this.state = -1;
;
 BA.debugLineNum = 2419;BA.debugLine="Return True";
Debug.ShouldStop(262144);
if (true) {
parent.__c.runVoidMethod ("ReturnFromResumableSub",this.remoteResumableSub,(parent.__c.getField(true,"True")));return;};
...
try {
		Debug.PushSubsStack("HasPendingExactBreak (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,1964);
if (RapidSub.canDelegate("haspendingexactbreak")) { return __ref.runUserSub(false, "b4xmainpage","haspendingexactbreak", __ref);}
 BA.debugLineNum = 1964;BA.debugLine="Private Sub HasPendingExactBreak As Boolean";
Debug.ShouldStop(2048);
 BA.debugLineNum = 1965;BA.debugLine="Return scheduledBreakAt > LocalNowTimestamp";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("HideContentBlocks (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2626);
if (RapidSub.canDelegate("hidecontentblocks")) { return __ref.runUserSub(false, "b4xmainpage","hidecontentblocks", __ref);}
 BA.debugLineNum = 2626;BA.debugLine="Private Sub HideContentBlocks";
Debug.ShouldStop(2);
 BA.debugLineNum = 2627;BA.debugLine="HidePin";
Debug.ShouldStop(4);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_hidepin" /*RemoteObject*/ );
 BA.debugLineNum = 2628;BA.debugLine="SetStreamText(\"\")";
Debug.ShouldStop(8);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setstreamtext" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 2629;BA.debugLine="SetStatusText(\"\")";
Debug.ShouldStop(16);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setstatustext" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 2630;BA.debugLine="btnConfirmYes.Enabled = True";
Debug.ShouldStop(32);
__ref.getField(false,"_btnconfirmyes" /*RemoteObject*/ ).runMethod(true,"setEnabled",b4xmainpage.__c.getField(true,"True"));
 BA.debugLineNum = 2631;BA.debugLine="btnConfirmNo.Enabled = True";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("HidePin (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2653);
if (RapidSub.canDelegate("hidepin")) { return __ref.runUserSub(false, "b4xmainpage","hidepin", __ref);}
 BA.debugLineNum = 2653;BA.debugLine="Private Sub HidePin";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 2654;BA.debugLine="confirmPane.Visible = False";
Debug.ShouldStop(536870912);
__ref.getField(false,"_confirmpane" /*RemoteObject*/ ).runMethod(true,"setVisible",b4xmainpage.__c.getField(true,"False"));
 BA.debugLineNum = 2655;BA.debugLine="btnConfirmYes.Enabled = True";
Debug.ShouldStop(1073741824);
__ref.getField(false,"_btnconfirmyes" /*RemoteObject*/ ).runMethod(true,"setEnabled",b4xmainpage.__c.getField(true,"True"));
 BA.debugLineNum = 2656;BA.debugLine="btnConfirmNo.Enabled = True";
Debug.ShouldStop(-2147483648);
__ref.getField(false,"_btnconfirmno" /*RemoteObject*/ ).runMethod(true,"setEnabled",b4xmainpage.__c.getField(true,"True"));
...
try {
		Debug.PushSubsStack("HistoryFileName (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2216);
if (RapidSub.canDelegate("historyfilename")) { return __ref.runUserSub(false, "b4xmainpage","historyfilename", __ref, _recorddate);}
Debug.locals.put("recordDate", _recorddate);
 BA.debugLineNum = 2216;BA.debugLine="Private Sub HistoryFileName(recordDate As String)";
Debug.ShouldStop(128);
 BA.debugLineNum = 2217;BA.debugLine="Return recordDate & \".ndjson\"";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("HistoryFileNameToDate (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2220);
...
Debug.locals.put("fileName", _filename);
 BA.debugLineNum = 2220;BA.debugLine="Private Sub HistoryFileNameToDate(fileName As Stri";
Debug.ShouldStop(2048);
 BA.debugLineNum = 2221;BA.debugLine="If IsHistoryFileName(fileName) = False Then Retur";
Debug.ShouldStop(4096);
if (RemoteObject.solveBoolean("=",__ref.runClassMethod (b4j.example.b4xmainpage.class, "_ishistoryfilename" /*RemoteObject*/ ,(Object)(_filename)),b4xmainpage.__c.getField(true,"False"))) { 
if (true) return BA.ObjectToString("");};
 BA.debugLineNum = 2222;BA.debugLine="Return fileName.SubString2(0, fileName.Length - 7";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("IsHistoryBatchAccepted (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2172);
...
Debug.locals.put("responseText", _responsetext);
 BA.debugLineNum = 2172;BA.debugLine="Private Sub IsHistoryBatchAccepted(responseText As";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 2173;BA.debugLine="Try";
Debug.ShouldStop(268435456);
try { BA.debugLineNum = 2174;BA.debugLine="Dim parser As JSONParser";
Debug.ShouldStop(536870912);
_parser = RemoteObject.createNew ("anywheresoftware.b4j.objects.collections.JSONParser");Debug.locals.put("parser", _parser);
 BA.debugLineNum = 2175;BA.debugLine="parser.Initialize(responseText)";
Debug.ShouldStop(1073741824);
_parser.runVoidMethod ("Initialize",(Object)(_responsetext));
 BA.debugLineNum = 2176;BA.debugLine="Dim response As Map = parser.NextObject";
Debug.ShouldStop(-2147483648);
...
_response = _parser.runMethod(false,"NextObject");Debug.locals.put("response", _response);Debug.locals.put("response", _response);
 BA.debugLineNum = 2177;BA.debugLine="Return response.GetDefault(\"ok\", False) = True";
Debug.ShouldStop(1);
Debug.CheckDeviceExceptions();if (true) return BA.ObjectToBoolean(RemoteObject.solveBoolean("=",_response.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("ok"))),(Object)((b4xmainpage.__c.getField(true,"False")))),(b4xmainpage.__c.getField(true,"True"))));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e7.toString()); BA.debugLineNum = 2179;BA.debugLine="TraceLog(\"История: не удалось разобрать ответ се";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("IsHistoryFileName (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2210);
if (RapidSub.canDelegate("ishistoryfilename")) { return __ref.runUserSub(false, "b4xmainpage","ishistoryfilename", __ref, _filename);}
Debug.locals.put("fileName", _filename);
 BA.debugLineNum = 2210;BA.debugLine="Private Sub IsHistoryFileName(fileName As String)";
Debug.ShouldStop(2);
 BA.debugLineNum = 2211;BA.debugLine="If fileName = \"\" Then Return False";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("=",_filename,BA.ObjectToString(""))) { 
if (true) return b4xmainpage.__c.getField(true,"False");};
 BA.debugLineNum = 2212;BA.debugLine="If fileName.EndsWith(\".ndjson\") = False Then Retu";
Debug.ShouldStop(8);
...
if (true) return b4xmainpage.__c.getField(true,"False");};
 BA.debugLineNum = 2213;BA.debugLine="Return Regex.IsMatch(\"^\\d{4}-\\d{2}-\\d{2}\\.ndjson$";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("JoinList (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3115);
...
Debug.locals.put("separator", _separator);
 BA.debugLineNum = 3115;BA.debugLine="Private Sub JoinList(items As List, separator As S";
Debug.ShouldStop(1024);
 BA.debugLineNum = 3116;BA.debugLine="Dim sb As StringBuilder";
Debug.ShouldStop(2048);
_sb = RemoteObject.createNew ("anywheresoftware.b4a.keywords.StringBuilderWrapper");Debug.locals.put("sb", _sb);
 BA.debugLineNum = 3117;BA.debugLine="sb.Initialize";
Debug.ShouldStop(4096);
_sb.runVoidMethod ("Initialize");
 BA.debugLineNum = 3118;BA.debugLine="For i = 0 To items.Size - 1";
Debug.ShouldStop(8192);
{
final int step3 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 3119;BA.debugLine="If i > 0 Then sb.Append(separator)";
Debug.ShouldStop(16384);
if (RemoteObject.solveBoolean(">",RemoteObject.createImmutable(_i),BA.numberCast(double.class, 0))) { 
_sb.runVoidMethod ("Append",(Object)(_separator));};
 BA.debugLineNum = 3120;BA.debugLine="sb.Append(items.Get(i))";
Debug.ShouldStop(32768);
_sb.runVoidMethod ("Append",(Object)(BA.ObjectToString(_items.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))))));
 }
}Debug.locals.put("i", _i);
;
 BA.debugLineNum = 3122;BA.debugLine="Return sb.ToString";
Debug.ShouldStop(131072);
if (true) return _sb.runMethod(true,"ToString");
...
try {
		Debug.PushSubsStack("LocalNowTimestamp (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3098);
if (RapidSub.canDelegate("localnowtimestamp")) { return __ref.runUserSub(false, "b4xmainpage","localnowtimestamp", __ref);}
 BA.debugLineNum = 3098;BA.debugLine="Private Sub LocalNowTimestamp As Long";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 3099;BA.debugLine="Return Floor(DateTime.Now / 1000) - (TimezoneOffs";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("MachineGuidShell_ProcessCompleted (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2891);
...
Debug.locals.put("stdErr", _stderr);
 BA.debugLineNum = 2891;BA.debugLine="Private Sub MachineGuidShell_ProcessCompleted (suc";
Debug.ShouldStop(1024);
 BA.debugLineNum = 2892;BA.debugLine="If success And exitCode = 0 Then";
Debug.ShouldStop(2048);
if (RemoteObject.solveBoolean(".",_success) && RemoteObject.solveBoolean("=",_exitcode,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 2893;BA.debugLine="Dim matcher As Matcher = Regex.Matcher(\"MachineG";
Debug.ShouldStop(4096);
...
_matcher = b4xmainpage.__c.getField(false,"Regex").runMethod(false,"Matcher",(Object)(BA.ObjectToString("MachineGuid\\s+REG_\\w+\\s+([^\\r\\n]+)")),(Object)(_stdout));Debug.locals.put("matcher", _matcher);Debug.locals.put("matcher", _matcher);
 BA.debugLineNum = 2894;BA.debugLine="If matcher.Find Then";
Debug.ShouldStop(8192);
if (_matcher.runMethod(true,"Find").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 2895;BA.debugLine="Dim machineGuid As String = matcher.Group(1).Tr";
Debug.ShouldStop(16384);
_machineguid = _matcher.runMethod(true,"Group",(Object)(BA.numberCast(int.class, 1))).runMethod(true,"trim").runMethod(true,"toLowerCase");Debug.locals.put("machineGuid", _machineguid);Debug.locals.put("machineGuid", _machineguid);
 BA.debugLineNum = 2896;BA.debugLine="If machineGuid = \"\" Then";
Debug.ShouldStop(32768);
if (RemoteObject.solveBoolean("=",_machineguid,BA.ObjectToString(""))) { 
 BA.debugLineNum = 2897;BA.debugLine="TraceLog(\"MachineGuid получен пустым.\")";
Debug.ShouldStop(65536);
...
if (true) return RemoteObject.createImmutable("");
 ...
 BA.debugLineNum = 2900;BA.debugLine="If deviceId <> machineGuid Then";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_deviceid" /*RemoteObject*/ ),_machineguid)) { 
 BA.debugLineNum = 2901;BA.debugLine="deviceId = machineGuid";
Debug.ShouldStop(1048576);
__ref.setField ("_deviceid" /*RemoteObject*/ ,_machineguid);
 BA.debugLineNum = 2902;BA.debugLine="SaveValue(\"device_id\", deviceId)";
Debug.ShouldStop(2097152);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_savevalue" /*RemoteObject*/ ,(Object)(BA.ObjectToString("device_id")),(Object)((__ref.getField(true,"_deviceid" /*RemoteObject*/ ))));
 BA.debugLineNum = 2903;BA.debugLine="TraceLog(\"deviceId обновлен из MachineGuid: \"";
Debug.ShouldStop(4194304);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("deviceId обновлен из MachineGuid: "),__ref.getField(true,"_deviceid" /*RemoteObject*/ ))));
 ...
 BA.debugLineNum = 2905;BA.debugLine="TraceLog(\"MachineGuid совпадает с текущим devi";
Debug.ShouldStop(16777216);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("MachineGuid совпадает с текущим deviceId.")));
 ...
 BA.debugLineNum = 2908;BA.debugLine="TraceLog(\"MachineGuid не найден в выводе reg.\")";
Debug.ShouldStop(134217728);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("MachineGuid не найден в выводе reg.")));
 ...
 BA.debugLineNum = 2911;BA.debugLine="TraceLog(\"Ошибка чтения MachineGuid. success=\" &";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("MediaUrl (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2714);
...
Debug.locals.put("item", _item);
 BA.debugLineNum = 2714;BA.debugLine="Private Sub MediaUrl(item As Map) As String";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 2715;BA.debugLine="Dim id As String = item.GetDefault(\"id\", \"\")";
Debug.ShouldStop(67108864);
_id = BA.ObjectToString(_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("id"))),(Object)((RemoteObject.createImmutable("")))));Debug.locals.put("id", _id);Debug.locals.put("id", _id);
 BA.debugLineNum = 2716;BA.debugLine="If id = \"\" Then Return \"\"";
Debug.ShouldStop(134217728);
if (RemoteObject.solveBoolean("=",_id,BA.ObjectToString(""))) { 
if (true) return BA.ObjectToString("");};
 BA.debugLineNum = 2717;BA.debugLine="Dim localUri As String = mediaCacheService.Resolv";
Debug.ShouldStop(268435456);
_localuri = __ref.getField(false,"_mediacacheservice" /*RemoteObject*/ ).runClassMethod (b4j.example.mediacache.class, "_resolvelocalmediauri" /*RemoteObject*/ ,(Object)(_item));Debug.locals.put("localUri", _localuri);Debug.locals.put("localUri", _localuri);
 BA.debugLineNum = 2718;BA.debugLine="If localUri <> \"\" Then Return localUri";
Debug.ShouldStop(536870912);
if (RemoteObject.solveBoolean("!",_localuri,BA.ObjectToString(""))) { 
if (true) return _localuri;};
 BA.debugLineNum = 2719;BA.debugLine="If isOfflinePlaybackMode Then Return \"\"";
Debug.ShouldStop(1073741824);
if (__ref.getField(true,"_isofflineplaybackmode" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
if (true) return BA.ObjectToString("");};
 BA.debugLineNum = 2720;BA.debugLine="Dim first As String = id.SubString2(0, 1)";
Debug.ShouldStop(-2147483648);
_first = _id.runMethod(true,"substring",(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 1)));Debug.locals.put("first", _first);Debug.locals.put("first", _first);
 BA.debugLineNum = 2721;BA.debugLine="Dim folder As String";
Debug.ShouldStop(1);
_folder = RemoteObject.createImmutable("");Debug.locals.put("folder", _folder);
 BA.debugLineNum = 2722;BA.debugLine="If item.GetDefault(\"type\", \"\") = \"ad\" Then";
Debug.ShouldStop(2);
if (RemoteObject.solveBoolean("=",_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("type"))),(Object)((RemoteObject.createImmutable("")))),RemoteObject.createImmutable(("ad")))) { 
 BA.debugLineNum = 2723;BA.debugLine="folder = \"ads\"";
Debug.ShouldStop(4);
_folder = BA.ObjectToString("ads");Debug.locals.put("folder", _folder);
 }else {
 BA.debugLineNum = 2725;BA.debugLine="folder = \"tracks\"";
Debug.ShouldStop(16);
_folder = BA.ObjectToString("tracks");Debug.locals.put("folder", _folder);
 };
 BA.debugLineNum = 2727;BA.debugLine="Return \"https://cdn.fon.fm/media/\" & folder & \"/\"";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("MessageValue (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3125);
if (RapidSub.canDelegate("messagevalue")) { return __ref.runUserSub(false, "b4xmainpage","messagevalue", __ref, _key);}
Debug.locals.put("key", _key);
 BA.debugLineNum = 3125;BA.debugLine="Private Sub MessageValue(key As String) As String";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 3126;BA.debugLine="Return messages.GetDefault(key, \"\")";
Debug.ShouldStop(2097152);
...
try {
		Debug.PushSubsStack("MigrateLegacyStorageIfNeeded (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2919);
...
RemoteObject _key = RemoteObject.createImmutable("");
 BA.debugLineNum = 2919;BA.debugLine="Private Sub MigrateLegacyStorageIfNeeded";
Debug.ShouldStop(64);
 BA.debugLineNum = 2920;BA.debugLine="If File.Exists(storageDir, storageFile) = False T";
Debug.ShouldStop(128);
...
Debug.ShouldStop(256);
try { BA.debugLineNum = 2922;BA.debugLine="Dim parser As JSONParser";
Debug.ShouldStop(512);
_parser = RemoteObject.createNew ("anywheresoftware.b4j.objects.collections.JSONParser");Debug.locals.put("parser", _parser);
 BA.debugLineNum = 2923;BA.debugLine="parser.Initialize(File.ReadString(storageDir, st";
Debug.ShouldStop(1024);
_parser.runVoidMethod ("Initialize",(Object)(b4xmainpage.__c.getField(false,"File").runMethod(true,"ReadString",(Object)(__ref.getField(true,"_storagedir" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_storagefile" /*RemoteObject*/ )))));
 BA.debugLineNum = 2924;BA.debugLine="Dim legacy As Map = parser.NextObject";
Debug.ShouldStop(2048);
...
_legacy = _parser.runMethod(false,"NextObject");Debug.locals.put("legacy", _legacy);Debug.locals.put("legacy", _legacy);
 BA.debugLineNum = 2925;BA.debugLine="If legacy.IsInitialized Then";
Debug.ShouldStop(4096);
if (_legacy.runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 2926;BA.debugLine="For Each key As String In legacy.Keys";
Debug.ShouldStop(8192);
{
...
Debug.locals.put("key", _key);
 BA.debugLineNum = 2927;BA.debugLine="storage.Put(key, legacy.Get(key))";
Debug.ShouldStop(16384);
...
;
 BA.debugLineNum = 2929;BA.debugLine="TraceLog(\"Данные перенесены из legacy JSON в KV";
Debug.ShouldStop(65536);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("Данные перенесены из legacy JSON в KVS.")));
 BA.debugLineNum = 2930;BA.debugLine="File.Delete(storageDir, storageFile)";
Debug.ShouldStop(131072);
b4xmainpage.__c.getField(false,"File").runVoidMethod ("Delete",(Object)(__ref.getField(true,"_storagedir" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_storagefile" /*RemoteObject*/ )));
 ...
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e14.toString()); BA.debugLineNum = 2933;BA.debugLine="TraceLog(\"Не удалось перенести legacy JSON в KVS";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("NormalizeDbValue (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2950);
...
Debug.locals.put("fallbackValue", _fallbackvalue);
 BA.debugLineNum = 2950;BA.debugLine="Private Sub NormalizeDbValue(value As Object, fall";
Debug.ShouldStop(32);
 BA.debugLineNum = 2951;BA.debugLine="Dim db As Double = fallbackValue";
Debug.ShouldStop(64);
_db = _fallbackvalue;Debug.locals.put("db", _db);Debug.locals.put("db", _db);
 BA.debugLineNum = 2952;BA.debugLine="Try";
Debug.ShouldStop(128);
try { BA.debugLineNum = 2953;BA.debugLine="db = value";
Debug.ShouldStop(256);
_db = BA.numberCast(double.class, _value);Debug.locals.put("db", _db);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e5) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e5.toString()); BA.debugLineNum = 2955;BA.debugLine="db = fallbackValue";
Debug.ShouldStop(1024);
_db = _fallbackvalue;Debug.locals.put("db", _db);
 };
 BA.debugLineNum = 2957;BA.debugLine="If db > 0 Then db = 0";
Debug.ShouldStop(4096);
if (RemoteObject.solveBoolean(">",_db,BA.numberCast(double.class, 0))) { 
_db = BA.numberCast(double.class, 0);Debug.locals.put("db", _db);};
 BA.debugLineNum = 2958;BA.debugLine="If db < -24 Then db = -24";
Debug.ShouldStop(8192);
...
_db = BA.numberCast(double.class, -(double) (0 + 24));Debug.locals.put("db", _db);};
 BA.debugLineNum = 2959;BA.debugLine="Return db";
Debug.ShouldStop(16384);
if (true) return _db;
...
try {
		Debug.PushSubsStack("NormalizeNdjsonPayload (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2184);
...
RemoteObject _normalized = RemoteObject.createImmutable("");
Debug.locals.put("payload", _payload);
 BA.debugLineNum = 2184;BA.debugLine="Private Sub NormalizeNdjsonPayload(payload As Stri";
Debug.ShouldStop(128);
 BA.debugLineNum = 2185;BA.debugLine="If payload = Null Then Return \"\"";
Debug.ShouldStop(256);
if (RemoteObject.solveBoolean("n",_payload)) { 
if (true) return BA.ObjectToString("");};
 BA.debugLineNum = 2186;BA.debugLine="Dim lineFeed As String = Chr(10)";
Debug.ShouldStop(512);
_linefeed = BA.ObjectToString(b4xmainpage.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 10))));Debug.locals.put("lineFeed", _linefeed);Debug.locals.put("lineFeed", _linefeed);
 BA.debugLineNum = 2187;BA.debugLine="Dim normalized As String = payload.Replace(CRLF,";
Debug.ShouldStop(1024);
_normalized = _payload.runMethod(true,"replace",(Object)(b4xmainpage.__c.getField(true,"CRLF")),(Object)(_linefeed)).runMethod(true,"replace",(Object)(BA.ObjectToString(b4xmainpage.__c.runMethod(true,"Chr",(Object)(BA.numberCast(int.class, 13))))),(Object)(_linefeed));Debug.locals.put("normalized", _normalized);Debug.locals.put("normalized", _normalized);
 BA.debugLineNum = 2188;BA.debugLine="Do While normalized.Contains(lineFeed & lineFeed)";
Debug.ShouldStop(2048);
while (_normalized.runMethod(true,"contains",(Object)(RemoteObject.concat(_linefeed,_linefeed))).<Boolean>get().booleanValue()) {
 BA.debugLineNum = 2189;BA.debugLine="normalized = normalized.Replace(lineFeed & lineF";
Debug.ShouldStop(4096);
...
;
 BA.debugLineNum = 2191;BA.debugLine="normalized = normalized.Trim";
Debug.ShouldStop(16384);
_normalized = _normalized.runMethod(true,"trim");Debug.locals.put("normalized", _normalized);
 BA.debugLineNum = 2192;BA.debugLine="If normalized = \"\" Then Return \"\"";
Debug.ShouldStop(32768);
if (RemoteObject.solveBoolean("=",_normalized,BA.ObjectToString(""))) { 
if (true) return BA.ObjectToString("");};
 BA.debugLineNum = 2193;BA.debugLine="Return normalized.Replace(lineFeed, CRLF)";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("NormalizePlayerCode (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2850);
...
Debug.locals.put("value", _value);
 BA.debugLineNum = 2850;BA.debugLine="Private Sub NormalizePlayerCode(value As String) A";
Debug.ShouldStop(2);
 BA.debugLineNum = 2851;BA.debugLine="Dim code As String = value.Trim.ToLowerCase";
Debug.ShouldStop(4);
_code = _value.runMethod(true,"trim").runMethod(true,"toLowerCase");Debug.locals.put("code", _code);Debug.locals.put("code", _code);
 BA.debugLineNum = 2852;BA.debugLine="If Regex.IsMatch(\"^[a-z0-9]{5}$\", code) Then Retu";
Debug.ShouldStop(8);
...
if (true) return _code;};
 BA.debugLineNum = 2853;BA.debugLine="Return \"\"";
Debug.ShouldStop(16);
if (true) return BA.ObjectToString("");
...
try {
		Debug.PushSubsStack("NormalizeQueueResponse (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2749);
...
Debug.locals.put("data", _data);
 BA.debugLineNum = 2749;BA.debugLine="Private Sub NormalizeQueueResponse(data As Object)";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 2750;BA.debugLine="If data Is Map Then";
Debug.ShouldStop(536870912);
if (RemoteObject.solveBoolean("i",_data, RemoteObject.createImmutable("java.util.Map"))) { 
 BA.debugLineNum = 2751;BA.debugLine="Dim m As Map = data";
Debug.ShouldStop(1073741824);
...
_m = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _data);Debug.locals.put("m", _m);Debug.locals.put("m", _m);
 BA.debugLineNum = 2752;BA.debugLine="Dim items As List = m.GetDefault(\"queue\", Null)";
Debug.ShouldStop(-2147483648);
_items = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");
_items = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _m.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("queue"))),(Object)(b4xmainpage.__c.getField(false,"Null"))));Debug.locals.put("items", _items);Debug.locals.put("items", _items);
 BA.debugLineNum = 2753;BA.debugLine="If items.IsInitialized = False Then Return Null";
Debug.ShouldStop(1);
...
if (true) return RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), b4xmainpage.__c.getField(false,"Null"));};
 BA.debugLineNum = 2754;BA.debugLine="Dim normalized As List";
Debug.ShouldStop(2);
_normalized = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("normalized", _normalized);
 BA.debugLineNum = 2755;BA.debugLine="normalized.Initialize";
Debug.ShouldStop(4);
_normalized.runVoidMethod ("Initialize");
 BA.debugLineNum = 2756;BA.debugLine="For Each item As Object In items";
Debug.ShouldStop(8);
{
...
Debug.locals.put("item", _item);
 BA.debugLineNum = 2757;BA.debugLine="If item Is Map Then normalized.Add(item)";
Debug.ShouldStop(16);
...
;
 BA.debugLineNum = 2759;BA.debugLine="Return normalized";
Debug.ShouldStop(64);
if (true) return _normalized;
 };
 BA.debugLineNum = 2761;BA.debugLine="Return Null";
Debug.ShouldStop(256);
if (true) return RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), b4xmainpage.__c.getField(false,"Null"));
...
try {
		Debug.PushSubsStack("NormalizeRetryAfter (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2764);
if (RapidSub.canDelegate("normalizeretryafter")) { return __ref.runUserSub(false, "b4xmainpage","normalizeretryafter", __ref, _data);}
RemoteObject _m = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
RemoteObject _value = RemoteObject.createImmutable(0);
Debug.locals.put("data", _data);
 BA.debugLineNum = 2764;BA.debugLine="Private Sub NormalizeRetryAfter(data As Object) As";
Debug.ShouldStop(2048);
 BA.debugLineNum = 2765;BA.debugLine="If data Is Map Then";
Debug.ShouldStop(4096);
if (RemoteObject.solveBoolean("i",_data, RemoteObject.createImmutable("java.util.Map"))) { 
 BA.debugLineNum = 2766;BA.debugLine="Dim m As Map = data";
Debug.ShouldStop(8192);
_m = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_m = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _data);Debug.locals.put("m", _m);Debug.locals.put("m", _m);
 BA.debugLineNum = 2767;BA.debugLine="If m.ContainsKey(\"retry_after\") = False Then Ret";
Debug.ShouldStop(16384);
...
if (true) return BA.numberCast(int.class, 0);};
 BA.debugLineNum = 2768;BA.debugLine="Dim value As Int = m.Get(\"retry_after\")";
Debug.ShouldStop(32768);
_value = BA.numberCast(int.class, _m.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("retry_after")))));Debug.locals.put("value", _value);Debug.locals.put("value", _value);
 BA.debugLineNum = 2769;BA.debugLine="If value <= 0 Then Return 0";
Debug.ShouldStop(65536);
if (RemoteObject.solveBoolean("k",_value,BA.numberCast(double.class, 0))) { 
if (true) return BA.numberCast(int.class, 0);};
 BA.debugLineNum = 2770;BA.debugLine="Return value";
Debug.ShouldStop(131072);
if (true) return _value;
 };
 BA.debugLineNum = 2772;BA.debugLine="Return 0";
Debug.ShouldStop(524288);
if (true) return BA.numberCast(int.class, 0);
...
try {
		Debug.PushSubsStack("OrbitTimer_Tick (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2528);
...
RemoteObject _fadestep = RemoteObject.createImmutable(0);
 BA.debugLineNum = 2528;BA.debugLine="Private Sub OrbitTimer_Tick";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 2529;BA.debugLine="orbitPulseStep = (orbitPulseStep + 1) Mod 24";
Debug.ShouldStop(1);
__ref.setField ("_orbitpulsestep" /*RemoteObject*/ ,RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_orbitpulsestep" /*RemoteObject*/ ),RemoteObject.createImmutable(1)}, "+",1, 1)),RemoteObject.createImmutable(24)}, "%",0, 1));
 BA.debugLineNum = 2530;BA.debugLine="Dim fadeStep As Double = orbitTimer.Interval / OR";
Debug.ShouldStop(2);
_fadestep = RemoteObject.solve(new RemoteObject[] {__ref.getField(false,"_orbittimer" /*RemoteObject*/ ).runMethod(true,"getInterval"),__ref.getField(true,"_orbit_fade_ms" /*RemoteObject*/ )}, "/",0, 0);Debug.locals.put("fadeStep", _fadestep);Debug.locals.put("fadeStep", _fadestep);
 BA.debugLineNum = 2531;BA.debugLine="If orbitFadeValue < orbitFadeTarget Then";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("<",__ref.getField(true,"_orbitfadevalue" /*RemoteObject*/ ),__ref.getField(true,"_orbitfadetarget" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 2532;BA.debugLine="orbitFadeValue = Min(orbitFadeTarget, orbitFadeV";
Debug.ShouldStop(8);
...
{ BA.debugLineNum = 2533;BA.debugLine="Else If orbitFadeValue > orbitFadeTarget Then";
Debug.ShouldStop(16);
if (RemoteObject.solveBoolean(">",__ref.getField(true,"_orbitfadevalue" /*RemoteObject*/ ),__ref.getField(true,"_orbitfadetarget" /*RemoteObject*/ ))) { 
 BA.debugLineNum = 2534;BA.debugLine="orbitFadeValue = Max(orbitFadeTarget, orbitFadeV";
Debug.ShouldStop(32);
...
;
 BA.debugLineNum = 2536;BA.debugLine="ApplyOrbitFrame(orbitPulseStep)";
Debug.ShouldStop(128);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_applyorbitframe" /*RemoteObject*/ ,(Object)(__ref.getField(true,"_orbitpulsestep" /*RemoteObject*/ )));
 BA.debugLineNum = 2537;BA.debugLine="If orbitFadeValue = 0 And orbitFadeTarget = 0 The";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("ParseDateOnlyEndTimestamp (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,1860);
...
Debug.locals.put("textValue", _textvalue);
 BA.debugLineNum = 1860;BA.debugLine="Private Sub ParseDateOnlyEndTimestamp(textValue As";
Debug.ShouldStop(8);
 BA.debugLineNum = 1861;BA.debugLine="Try";
Debug.ShouldStop(16);
try { BA.debugLineNum = 1862;BA.debugLine="Dim previousDateFormat As String = DateTime.Date";
Debug.ShouldStop(32);
_previousdateformat = b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"getDateFormat");Debug.locals.put("previousDateFormat", _previousdateformat);Debug.locals.put("previousDateFormat", _previousdateformat);
 BA.debugLineNum = 1863;BA.debugLine="DateTime.DateFormat = \"yyyy-MM-dd\"";
Debug.ShouldStop(64);
b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",BA.ObjectToString("yyyy-MM-dd"));
 BA.debugLineNum = 1864;BA.debugLine="Dim dayStartTicks As Long = DateTime.DateParse(t";
Debug.ShouldStop(128);
_daystartticks = b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"DateParse",(Object)(_textvalue));Debug.locals.put("dayStartTicks", _daystartticks);Debug.locals.put("dayStartTicks", _daystartticks);
 BA.debugLineNum = 1865;BA.debugLine="DateTime.DateFormat = previousDateFormat";
Debug.ShouldStop(256);
b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"setDateFormat",_previousdateformat);
 BA.debugLineNum = 1866;BA.debugLine="Return Floor((dayStartTicks + DateTime.TicksPerD";
Debug.ShouldStop(512);
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(long.class, b4xmainpage.__c.runMethod(true,"Floor",(Object)(RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {_daystartticks,b4xmainpage.__c.getField(false,"DateTime").getField(true,"TicksPerDay")}, "+",1, 2)),RemoteObject.createImmutable(1000)}, "/",0, 0))));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e8.toString()); BA.debugLineNum = 1868;BA.debugLine="Log(LastException.Message)";
Debug.ShouldStop(2048);
b4xmainpage.__c.runVoidMethod ("LogImpl","642926088",b4xmainpage.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage"),0);
 BA.debugLineNum = 1869;BA.debugLine="Return 0";
Debug.ShouldStop(4096);
...
Debug.ShouldStop(64);
b4xmainpage.__c.runVoidMethod ("LogImpl","642074118",b4xmainpage.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage"),0);
 };
...
if (true) return BA.numberCast(long.class, b4xmainpage.__c.runMethod(true,"Floor",(Object)(BA.numberCast(double.class, _textvalue))));};
 BA.debugLineNum = 1836;BA.debugLine="If Regex.IsMatch(\"^\\d{4}-\\d{2}-\\d{2}$\", textValue";
Debug.ShouldStop(2048);
if (b4xmainpage.__c.getField(false,"Regex").runMethod(true,"IsMatch",(Object)(BA.ObjectToString("^\\d{4}-\\d{2}-\\d{2}$")),(Object)(_textvalue)).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 1837;BA.debugLine="Return ParseDateOnlyEndTimestamp(textValue)";
Debug.ShouldStop(4096);
...
Debug.ShouldStop(16384);
try { BA.debugLineNum = 1840;BA.debugLine="Dim instantClass As JavaObject";
Debug.ShouldStop(32768);
_instantclass = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");Debug.locals.put("instantClass", _instantclass);
 BA.debugLineNum = 1841;BA.debugLine="instantClass.InitializeStatic(\"java.time.Instant";
Debug.ShouldStop(65536);
_instantclass.runVoidMethod ("InitializeStatic",(Object)(RemoteObject.createImmutable("java.time.Instant")));
 BA.debugLineNum = 1842;BA.debugLine="Dim instant As JavaObject = instantClass.RunMeth";
Debug.ShouldStop(131072);
...
_instant = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _instantclass.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("parse")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(_textvalue)}))));Debug.locals.put("instant", _instant);Debug.locals.put("instant", _instant);
 BA.debugLineNum = 1843;BA.debugLine="Return instant.RunMethod(\"getEpochSecond\", Null)";
Debug.ShouldStop(262144);
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(long.class, _instant.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getEpochSecond")),(Object)((b4xmainpage.__c.getField(false,"Null")))));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e20.toString()); BA.debugLineNum = 1845;BA.debugLine="Log(LastException.Message)";
Debug.ShouldStop(1048576);
b4xmainpage.__c.runVoidMethod ("LogImpl","642074132",b4xmainpage.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage"),0);
 };
 BA.debugLineNum = 1847;BA.debugLine="Try";
Debug.ShouldStop(4194304);
try { BA.debugLineNum = 1848;BA.debugLine="Dim offsetDateTimeClass As JavaObject";
Debug.ShouldStop(8388608);
_offsetdatetimeclass = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");Debug.locals.put("offsetDateTimeClass", _offsetdatetimeclass);
 BA.debugLineNum = 1849;BA.debugLine="offsetDateTimeClass.InitializeStatic(\"java.time.";
Debug.ShouldStop(16777216);
_offsetdatetimeclass.runVoidMethod ("InitializeStatic",(Object)(RemoteObject.createImmutable("java.time.OffsetDateTime")));
 BA.debugLineNum = 1850;BA.debugLine="Dim offsetDateTime As JavaObject = offsetDateTim";
Debug.ShouldStop(33554432);
...
_offsetdatetime = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _offsetdatetimeclass.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("parse")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(_textvalue)}))));Debug.locals.put("offsetDateTime", _offsetdatetime);Debug.locals.put("offsetDateTime", _offsetdatetime);
 BA.debugLineNum = 1851;BA.debugLine="Dim instant As JavaObject = offsetDateTime.RunMe";
Debug.ShouldStop(67108864);
_instant = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_instant = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _offsetdatetime.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("toInstant")),(Object)((b4xmainpage.__c.getField(false,"Null")))));Debug.locals.put("instant", _instant);Debug.locals.put("instant", _instant);
 BA.debugLineNum = 1852;BA.debugLine="Return instant.RunMethod(\"getEpochSecond\", Null)";
Debug.ShouldStop(134217728);
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(long.class, _instant.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getEpochSecond")),(Object)((b4xmainpage.__c.getField(false,"Null")))));
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e29) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e29.toString()); BA.debugLineNum = 1854;BA.debugLine="Log(LastException.Message)";
Debug.ShouldStop(536870912);
b4xmainpage.__c.runVoidMethod ("LogImpl","642074141",b4xmainpage.__c.runMethod(false,"LastException",__ref.getField(false, "ba")).runMethod(true,"getMessage"),0);
 };
 BA.debugLineNum = 1856;BA.debugLine="TraceLog(\"Не удалось разобрать player.end: \" & te";
Debug.ShouldStop(-2147483648);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Не удалось разобрать player.end: "),_textvalue)));
 BA.debugLineNum = 1857;BA.debugLine="Return 0";
Debug.ShouldStop(1);
if (true) return BA.numberCast(long.class, 0);
...
try {
		Debug.PushSubsStack("PlayerLevelToFactor (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2944);
...
Debug.locals.put("levelValue", _levelvalue);
 BA.debugLineNum = 2944;BA.debugLine="Private Sub PlayerLevelToFactor(levelValue As Doub";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 2945;BA.debugLine="Dim normalized As Double = Max(0, Min(1, levelVal";
Debug.ShouldStop(1);
_normalized = b4xmainpage.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 0)),(Object)(b4xmainpage.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, 1)),(Object)(RemoteObject.solve(new RemoteObject[] {_levelvalue,RemoteObject.createImmutable(100)}, "/",0, 0)))));Debug.locals.put("normalized", _normalized);Debug.locals.put("normalized", _normalized);
 BA.debugLineNum = 2946;BA.debugLine="If normalized <= 0 Then Return 0";
Debug.ShouldStop(2);
if (RemoteObject.solveBoolean("k",_normalized,BA.numberCast(double.class, 0))) { 
if (true) return BA.numberCast(double.class, 0);};
 BA.debugLineNum = 2947;BA.debugLine="Return Power(normalized, 0.7)";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("PlaylistHasCachedTrack (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,1873);
...
Debug.locals.put("playlistData", _playlistdata);
 BA.debugLineNum = 1873;BA.debugLine="Private Sub PlaylistHasCachedTrack(playlistData As";
Debug.ShouldStop(65536);
 BA.debugLineNum = 1874;BA.debugLine="If playlistData.IsInitialized = False Or playlist";
Debug.ShouldStop(131072);
...
if (true) return b4xmainpage.__c.getField(true,"False");};
 BA.debugLineNum = 1875;BA.debugLine="Dim tracks As List = playlistData.GetDefault(\"tra";
Debug.ShouldStop(262144);
...
_tracks = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.List"), _playlistdata.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("tracks"))),(Object)(b4xmainpage.__c.getField(false,"Null"))));Debug.locals.put("tracks", _tracks);Debug.locals.put("tracks", _tracks);
 BA.debugLineNum = 1876;BA.debugLine="If tracks.IsInitialized = False Or tracks.Size =";
Debug.ShouldStop(524288);
...
if (true) return b4xmainpage.__c.getField(true,"False");};
 BA.debugLineNum = 1877;BA.debugLine="For Each trackObject As Object In tracks";
Debug.ShouldStop(1048576);
{
...
Debug.locals.put("trackObject", _trackobject);
 BA.debugLineNum = 1878;BA.debugLine="If trackObject Is Map Then";
Debug.ShouldStop(2097152);
if (RemoteObject.solveBoolean("i",_trackobject, RemoteObject.createImmutable("java.util.Map"))) { 
 BA.debugLineNum = 1879;BA.debugLine="Dim track As Map = trackObject";
Debug.ShouldStop(4194304);
...
_track = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _trackobject);Debug.locals.put("track", _track);Debug.locals.put("track", _track);
 BA.debugLineNum = 1880;BA.debugLine="Dim trackId As String = track.GetDefault(\"id\",";
Debug.ShouldStop(8388608);
_trackid = BA.ObjectToString(_track.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("id"))),(Object)((RemoteObject.createImmutable("")))));Debug.locals.put("trackId", _trackid);Debug.locals.put("trackId", _trackid);
 BA.debugLineNum = 1881;BA.debugLine="If trackId <> \"\" And mediaCacheService.IsTrackC";
Debug.ShouldStop(16777216);
...
;
 BA.debugLineNum = 1884;BA.debugLine="Return False";
Debug.ShouldStop(134217728);
if (true) return b4xmainpage.__c.getField(true,"False");
...
try {
		Debug.PushSubsStack("QueueHistoryRecordAt (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2023);
...
Debug.locals.put("startedAtValue", _startedatvalue);
 BA.debugLineNum = 2023;BA.debugLine="Private Sub QueueHistoryRecordAt(item As Map, star";
Debug.ShouldStop(64);
 BA.debugLineNum = 2024;BA.debugLine="If item.IsInitialized = False Then Return";
Debug.ShouldStop(128);
if (RemoteObject.solveBoolean("=",_item.runMethod(true,"IsInitialized"),b4xmainpage.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 2025;BA.debugLine="If item.GetDefault(\"id\", \"\") = \"\" Then Return";
Debug.ShouldStop(256);
if (RemoteObject.solveBoolean("=",_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("id"))),(Object)((RemoteObject.createImmutable("")))),RemoteObject.createImmutable(("")))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 2026;BA.debugLine="Dim startedAt As Long = startedAtValue";
Debug.ShouldStop(512);
_startedat = _startedatvalue;Debug.locals.put("startedAt", _startedat);Debug.locals.put("startedAt", _startedat);
 BA.debugLineNum = 2027;BA.debugLine="If startedAt <= 0 Then startedAt = DateTime.Now";
Debug.ShouldStop(1024);
...
_startedat = b4xmainpage.__c.getField(false,"DateTime").runMethod(true,"getNow");Debug.locals.put("startedAt", _startedat);};
 BA.debugLineNum = 2028;BA.debugLine="Dim record As Map";
Debug.ShouldStop(2048);
_record = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");Debug.locals.put("record", _record);
 BA.debugLineNum = 2029;BA.debugLine="record.Initialize";
Debug.ShouldStop(4096);
_record.runVoidMethod ("Initialize");
 BA.debugLineNum = 2030;BA.debugLine="Dim recordDate As String = FormatHistoryDate(star";
Debug.ShouldStop(8192);
_recorddate = __ref.runClassMethod (b4j.example.b4xmainpage.class, "_formathistorydate" /*RemoteObject*/ ,(Object)(_startedat));Debug.locals.put("recordDate", _recorddate);Debug.locals.put("recordDate", _recorddate);
 BA.debugLineNum = 2031;BA.debugLine="record.Put(\"date\", recordDate)";
Debug.ShouldStop(16384);
_record.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("date"))),(Object)((_recorddate)));
 BA.debugLineNum = 2032;BA.debugLine="record.Put(\"time\", FormatHistoryTime(startedAt))";
Debug.ShouldStop(32768);
_record.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("time"))),(Object)((__ref.runClassMethod (b4j.example.b4xmainpage.class, "_formathistorytime" /*RemoteObject*/ ,(Object)(_startedat)))));
 BA.debugLineNum = 2033;BA.debugLine="record.Put(\"type\", item.GetDefault(\"type\", \"\"))";
Debug.ShouldStop(65536);
_record.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("type"))),(Object)(_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("type"))),(Object)((RemoteObject.createImmutable(""))))));
 BA.debugLineNum = 2034;BA.debugLine="record.Put(\"id\", item.GetDefault(\"id\", \"\"))";
Debug.ShouldStop(131072);
_record.runVoidMethod ("Put",(Object)(RemoteObject.createImmutable(("id"))),(Object)(_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("id"))),(Object)((RemoteObject.createImmutable(""))))));
 BA.debugLineNum = 2035;BA.debugLine="AppendHistoryRecord(recordDate, record)";
Debug.ShouldStop(262144);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_appendhistoryrecord" /*RemoteObject*/ ,(Object)(_recorddate),(Object)(_record));
 BA.debugLineNum = 2036;BA.debugLine="TraceLog(\"История добавлена в локальный буфер. da";
Debug.ShouldStop(524288);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("История добавлена в локальный буфер. date="),_record.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("date")))),RemoteObject.createImmutable(", time="),_record.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("time")))),RemoteObject.createImmutable(", type="),_record.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("type")))),RemoteObject.createImmutable(", id="),_record.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("id")))),RemoteObject.createImmutable(", pendingFiles="),__ref.runClassMethod (b4j.example.b4xmainpage.class, "_getpendinghistoryfilecount" /*RemoteObject*/ ))));
 BA.debugLineNum = 2037;BA.debugLine="If isHistoryFlushInProgress = False And playerCod";
Debug.ShouldStop(1048576);
if (RemoteObject.solveBoolean("=",__ref.getField(true,"_ishistoryflushinprogress" /*RemoteObject*/ ),b4xmainpage.__c.getField(true,"False")) && RemoteObject.solveBoolean("!",__ref.getField(true,"_playercode" /*RemoteObject*/ ),BA.ObjectToString("")) && RemoteObject.solveBoolean("!",__ref.getField(true,"_deviceid" /*RemoteObject*/ ),BA.ObjectToString(""))) { 
 BA.debugLineNum = 2038;BA.debugLine="CallSubDelayed(Me, \"FlushHistoryBufferAsync\")";
Debug.ShouldStop(2097152);
b4xmainpage.__c.runVoidMethod ("CallSubDelayed",__ref.getField(false, "ba"),(Object)(__ref),(Object)(RemoteObject.createImmutable("FlushHistoryBufferAsync")));
 };
...
try {
		Debug.PushSubsStack("RefreshPendingHistoryState (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2130);
if (RapidSub.canDelegate("refreshpendinghistorystate")) { return __ref.runUserSub(false, "b4xmainpage","refreshpendinghistorystate", __ref);}
 BA.debugLineNum = 2130;BA.debugLine="Private Sub RefreshPendingHistoryState";
Debug.ShouldStop(131072);
 BA.debugLineNum = 2131;BA.debugLine="storage.Put(\"pending_history_count\", CountAllPend";
Debug.ShouldStop(262144);
...
try {
		Debug.PushSubsStack("RenderPlayerHead (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2705);
...
Debug.locals.put("title", _title);
 BA.debugLineNum = 2705;BA.debugLine="Private Sub RenderPlayerHead(code As String, title";
Debug.ShouldStop(65536);
 BA.debugLineNum = 2706;BA.debugLine="Dim safeCode As String = FormatPlayerCodeForDispl";
Debug.ShouldStop(131072);
_safecode = __ref.runClassMethod (b4j.example.b4xmainpage.class, "_formatplayercodefordisplay" /*RemoteObject*/ ,(Object)(_code));Debug.locals.put("safeCode", _safecode);Debug.locals.put("safeCode", _safecode);
 BA.debugLineNum = 2707;BA.debugLine="If title <> \"\" Then";
Debug.ShouldStop(262144);
if (RemoteObject.solveBoolean("!",_title,BA.ObjectToString(""))) { 
 BA.debugLineNum = 2708;BA.debugLine="lblHeader.Text = safeCode & \" • \" & title.ToUppe";
Debug.ShouldStop(524288);
__ref.getField(false,"_lblheader" /*RemoteObject*/ ).runMethod(true,"setText",RemoteObject.concat(_safecode,RemoteObject.createImmutable(" • "),_title.runMethod(true,"toUpperCase")));
 ...
 BA.debugLineNum = 2710;BA.debugLine="lblHeader.Text = safeCode";
Debug.ShouldStop(2097152);
...
try {
		Debug.PushSubsStack("ResetRetryDelay (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,1915);
if (RapidSub.canDelegate("resetretrydelay")) { return __ref.runUserSub(false, "b4xmainpage","resetretrydelay", __ref);}
 BA.debugLineNum = 1915;BA.debugLine="Private Sub ResetRetryDelay";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 1916;BA.debugLine="offlineRetryDelay = OFFLINE_RETRY_DELAY_INITIAL";
Debug.ShouldStop(134217728);
__ref.setField ("_offlineretrydelay" /*RemoteObject*/ ,__ref.getField(true,"_offline_retry_delay_initial" /*RemoteObject*/ ));
 BA.debugLineNum = 1917;BA.debugLine="serverRetryDelay = SERVER_RETRY_DELAY_INITIAL";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("ResolveErrorMessage (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2782);
...
Debug.locals.put("fallback", _fallback);
 BA.debugLineNum = 2782;BA.debugLine="Private Sub ResolveErrorMessage(result As Map, fal";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 2783;BA.debugLine="If result.GetDefault(\"Success\", False) Then";
Debug.ShouldStop(1073741824);
if (BA.ObjectToBoolean(_result.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("Success"))),(Object)((b4xmainpage.__c.getField(true,"False"))))).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 2784;BA.debugLine="Dim resultData As Object = result.Get(\"Data\")";
Debug.ShouldStop(-2147483648);
_resultdata = _result.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("Data"))));Debug.locals.put("resultData", _resultdata);Debug.locals.put("resultData", _resultdata);
 BA.debugLineNum = 2785;BA.debugLine="If resultData Is Map Then";
Debug.ShouldStop(1);
if (RemoteObject.solveBoolean("i",_resultdata, RemoteObject.createImmutable("java.util.Map"))) { 
 BA.debugLineNum = 2786;BA.debugLine="Dim m As Map = resultData";
Debug.ShouldStop(2);
_m = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_m = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _resultdata);Debug.locals.put("m", _m);Debug.locals.put("m", _m);
 BA.debugLineNum = 2787;BA.debugLine="If m.GetDefault(\"message\", \"\") <> \"\" Then Retur";
Debug.ShouldStop(4);
...
if (true) return BA.ObjectToString(_m.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("message")))));};
 ...
 BA.debugLineNum = 2790;BA.debugLine="Dim errorMessage As String = result.GetDefault(\"E";
Debug.ShouldStop(32);
_errormessage = BA.ObjectToString(_result.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("ErrorMessage"))),(Object)((RemoteObject.createImmutable("")))));Debug.locals.put("errorMessage", _errormessage);Debug.locals.put("errorMessage", _errormessage);
 BA.debugLineNum = 2791;BA.debugLine="If errorMessage <> \"\" Then Return errorMessage";
Debug.ShouldStop(64);
if (RemoteObject.solveBoolean("!",_errormessage,BA.ObjectToString(""))) { 
if (true) return _errormessage;};
 BA.debugLineNum = 2792;BA.debugLine="Return fallback";
Debug.ShouldStop(128);
...
try {
		Debug.PushSubsStack("ResolveItemVolume (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2734);
...
Debug.locals.put("item", _item);
 BA.debugLineNum = 2734;BA.debugLine="Private Sub ResolveItemVolume(item As Map) As Doub";
Debug.ShouldStop(8192);
 BA.debugLineNum = 2735;BA.debugLine="If item.IsInitialized = False Then Return 0.7";
Debug.ShouldStop(16384);
if (RemoteObject.solveBoolean("=",_item.runMethod(true,"IsInitialized"),b4xmainpage.__c.getField(true,"False"))) { 
if (true) return BA.numberCast(double.class, 0.7);};
 BA.debugLineNum = 2736;BA.debugLine="Dim itemType As String = item.GetDefault(\"type\",";
Debug.ShouldStop(32768);
_itemtype = BA.ObjectToString(_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("type"))),(Object)((RemoteObject.createImmutable("")))));Debug.locals.put("itemType", _itemtype);Debug.locals.put("itemType", _itemtype);
 BA.debugLineNum = 2737;BA.debugLine="Dim gainDb As Double = NormalizeDbValue(item.GetD";
Debug.ShouldStop(65536);
_gaindb = __ref.runClassMethod (b4j.example.b4xmainpage.class, "_normalizedbvalue" /*RemoteObject*/ ,(Object)(_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("gain"))),(Object)(RemoteObject.createImmutable((-(double) (0 + 3)))))),(Object)(BA.numberCast(double.class, -(double) (0 + 3))));Debug.locals.put("gainDb", _gaindb);Debug.locals.put("gainDb", _gaindb);
 BA.debugLineNum = 2738;BA.debugLine="Dim baseFactor As Double = 1";
Debug.ShouldStop(131072);
_basefactor = BA.numberCast(double.class, 1);Debug.locals.put("baseFactor", _basefactor);Debug.locals.put("baseFactor", _basefactor);
 BA.debugLineNum = 2739;BA.debugLine="If itemType = \"track\" Then baseFactor = ResolvePl";
Debug.ShouldStop(262144);
...
_basefactor = __ref.runClassMethod (b4j.example.b4xmainpage.class, "_resolveplayerlevelfactor" /*RemoteObject*/ );Debug.locals.put("baseFactor", _basefactor);};
 BA.debugLineNum = 2740;BA.debugLine="Return Max(0, Min(1, baseFactor * DbToFactor(gain";
Debug.ShouldStop(524288);
...
try {
		Debug.PushSubsStack("ResolveMachineGuidAsync (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2881);
if (RapidSub.canDelegate("resolvemachineguidasync")) { return __ref.runUserSub(false, "b4xmainpage","resolvemachineguidasync", __ref);}
 BA.debugLineNum = 2881;BA.debugLine="Private Sub ResolveMachineGuidAsync";
Debug.ShouldStop(1);
 BA.debugLineNum = 2882;BA.debugLine="Try";
Debug.ShouldStop(2);
try { BA.debugLineNum = 2883;BA.debugLine="machineGuidShell.Initialize(\"MachineGuidShell\",";
Debug.ShouldStop(4);
__ref.getField(false,"_machineguidshell" /*RemoteObject*/ ).runVoidMethod ("Initialize",(Object)(BA.ObjectToString("MachineGuidShell")),(Object)(BA.ObjectToString("reg")),(Object)(b4xmainpage.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("String",new int[] {4},new Object[] {BA.ObjectToString("query"),BA.ObjectToString("HKLM\\SOFTWARE\\Microsoft\\Cryptography"),BA.ObjectToString("/v"),RemoteObject.createImmutable("MachineGuid")})))));
 BA.debugLineNum = 2884;BA.debugLine="machineGuidShell.Run(-1)";
Debug.ShouldStop(8);
__ref.getField(false,"_machineguidshell" /*RemoteObject*/ ).runVoidMethod ("Run",__ref.getField(false, "ba"),(Object)(BA.numberCast(long.class, -(double) (0 + 1))));
 BA.debugLineNum = 2885;BA.debugLine="TraceLog(\"Запущено чтение MachineGuid из реестра";
Debug.ShouldStop(16);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("Запущено чтение MachineGuid из реестра.")));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e6.toString()); BA.debugLineNum = 2887;BA.debugLine="TraceLog(\"Не удалось запустить чтение MachineGui";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("ResolvePlayerLevelFactor (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2743);
...
RemoteObject _playerlevel = RemoteObject.createImmutable(0);
 BA.debugLineNum = 2743;BA.debugLine="Private Sub ResolvePlayerLevelFactor As Double";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 2744;BA.debugLine="Dim playerData As Map = offlineData.GetDefault(\"p";
Debug.ShouldStop(8388608);
_playerdata = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_playerdata = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), __ref.getField(false,"_offlinedata" /*RemoteObject*/ ).runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("player"))),(Object)((__ref.runClassMethod (b4j.example.b4xmainpage.class, "_createinitializedmap" /*RemoteObject*/ ).getObject()))));Debug.locals.put("playerData", _playerdata);Debug.locals.put("playerData", _playerdata);
 BA.debugLineNum = 2745;BA.debugLine="Dim playerLevel As Double = playerData.GetDefault";
Debug.ShouldStop(16777216);
_playerlevel = BA.numberCast(double.class, _playerdata.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("level"))),(Object)(RemoteObject.createImmutable((100)))));Debug.locals.put("playerLevel", _playerlevel);Debug.locals.put("playerLevel", _playerlevel);
 BA.debugLineNum = 2746;BA.debugLine="Return PlayerLevelToFactor(playerLevel)";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("ResolveRetryDelay (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,1887);
...
Debug.locals.put("delayMs", _delayms);
 BA.debugLineNum = 1887;BA.debugLine="Private Sub ResolveRetryDelay(mode As String, dela";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 1888;BA.debugLine="If delayMs > 0 Then Return delayMs";
Debug.ShouldStop(-2147483648);
if (RemoteObject.solveBoolean(">",_delayms,BA.numberCast(double.class, 0))) { 
if (true) return _delayms;};
 BA.debugLineNum = 1889;BA.debugLine="If mode = \"offline\" Then";
Debug.ShouldStop(1);
if (RemoteObject.solveBoolean("=",_mode,BA.ObjectToString("offline"))) { 
 BA.debugLineNum = 1890;BA.debugLine="Dim delay As Int = offlineRetryDelay";
Debug.ShouldStop(2);
_delay = __ref.getField(true,"_offlineretrydelay" /*RemoteObject*/ );Debug.locals.put("delay", _delay);Debug.locals.put("delay", _delay);
 BA.debugLineNum = 1891;BA.debugLine="offlineRetryDelay = Min(offlineRetryDelay * 2, O";
Debug.ShouldStop(4);
__ref.setField ("_offlineretrydelay" /*RemoteObject*/ ,BA.numberCast(int.class, b4xmainpage.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_offlineretrydelay" /*RemoteObject*/ ),RemoteObject.createImmutable(2)}, "*",0, 1))),(Object)(BA.numberCast(double.class, __ref.getField(true,"_offline_retry_delay_max" /*RemoteObject*/ ))))));
 BA.debugLineNum = 1892;BA.debugLine="Return delay";
Debug.ShouldStop(8);
if (true) return _delay;
 };
 BA.debugLineNum = 1894;BA.debugLine="If mode = \"blocked\" Then Return BLOCKED_RETRY_DEL";
Debug.ShouldStop(32);
...
if (true) return __ref.getField(true,"_blocked_retry_delay" /*RemoteObject*/ );};
 BA.debugLineNum = 1895;BA.debugLine="Dim serverDelay As Int = serverRetryDelay";
Debug.ShouldStop(64);
_serverdelay = __ref.getField(true,"_serverretrydelay" /*RemoteObject*/ );Debug.locals.put("serverDelay", _serverdelay);Debug.locals.put("serverDelay", _serverdelay);
 BA.debugLineNum = 1896;BA.debugLine="serverRetryDelay = Min(serverRetryDelay * 2, SERV";
Debug.ShouldStop(128);
__ref.setField ("_serverretrydelay" /*RemoteObject*/ ,BA.numberCast(int.class, b4xmainpage.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_serverretrydelay" /*RemoteObject*/ ),RemoteObject.createImmutable(2)}, "*",0, 1))),(Object)(BA.numberCast(double.class, __ref.getField(true,"_server_retry_delay_max" /*RemoteObject*/ ))))));
 BA.debugLineNum = 1897;BA.debugLine="Return serverDelay";
Debug.ShouldStop(256);
...
try {
		Debug.PushSubsStack("ResolveScheduledBreakAt (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,1924);
...
RemoteObject _item = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.Map");
 BA.debugLineNum = 1924;BA.debugLine="Private Sub ResolveScheduledBreakAt";
Debug.ShouldStop(8);
 BA.debugLineNum = 1925;BA.debugLine="scheduledBreakAt = -1";
Debug.ShouldStop(16);
__ref.setField ("_scheduledbreakat" /*RemoteObject*/ ,BA.numberCast(long.class, -(double) (0 + 1)));
 BA.debugLineNum = 1926;BA.debugLine="For Each itemObj As Object In playQueue";
Debug.ShouldStop(32);
{
...
Debug.locals.put("itemObj", _itemobj);
 BA.debugLineNum = 1927;BA.debugLine="If itemObj Is Map Then";
Debug.ShouldStop(64);
if (RemoteObject.solveBoolean("i",_itemobj, RemoteObject.createImmutable("java.util.Map"))) { 
 BA.debugLineNum = 1928;BA.debugLine="Dim item As Map = itemObj";
Debug.ShouldStop(128);
_item = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_item = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _itemobj);Debug.locals.put("item", _item);Debug.locals.put("item", _item);
 BA.debugLineNum = 1929;BA.debugLine="If item.GetDefault(\"type\", \"\") = \"break\" And it";
Debug.ShouldStop(256);
if (RemoteObject.solveBoolean("=",_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("type"))),(Object)((RemoteObject.createImmutable("")))),RemoteObject.createImmutable(("break"))) && RemoteObject.solveBoolean("=",_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("exactly"))),(Object)((b4xmainpage.__c.getField(true,"False")))),(b4xmainpage.__c.getField(true,"True"))) && RemoteObject.solveBoolean(".",_item.runMethod(true,"ContainsKey",(Object)((RemoteObject.createImmutable("at")))))) { 
 BA.debugLineNum = 1930;BA.debugLine="scheduledBreakAt = ToLongDefault(item.Get(\"at\"";
Debug.ShouldStop(512);
__ref.setField ("_scheduledbreakat" /*RemoteObject*/ ,__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tolongdefault" /*RemoteObject*/ ,(Object)(_item.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("at"))))),(Object)(BA.numberCast(long.class, -(double) (0 + 1)))));
 BA.debugLineNum = 1931;BA.debugLine="Exit";
Debug.ShouldStop(1024);
if (true) break;
 };
 };
...
;
 BA.debugLineNum = 1935;BA.debugLine="TraceLog(\"Определена точка exact-break. value=\" &";
Debug.ShouldStop(16384);
...
try {
		Debug.PushSubsStack("ResolveStartFadeInMs (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2293);
if (RapidSub.canDelegate("resolvestartfadeinms")) { return __ref.runUserSub(false, "b4xmainpage","resolvestartfadeinms", __ref);}
 BA.debugLineNum = 2293;BA.debugLine="Private Sub ResolveStartFadeInMs As Int";
Debug.ShouldStop(1048576);
 BA.debugLineNum = 2294;BA.debugLine="If initialStartFadePending = False Then Return 0";
Debug.ShouldStop(2097152);
...
if (true) return BA.numberCast(int.class, 0);};
 BA.debugLineNum = 2295;BA.debugLine="If activeAudioKey <> \"\" Then Return 0";
Debug.ShouldStop(4194304);
if (RemoteObject.solveBoolean("!",__ref.getField(true,"_activeaudiokey" /*RemoteObject*/ ),BA.ObjectToString(""))) { 
if (true) return BA.numberCast(int.class, 0);};
 BA.debugLineNum = 2296;BA.debugLine="initialStartFadePending = False";
Debug.ShouldStop(8388608);
__ref.setField ("_initialstartfadepending" /*RemoteObject*/ ,b4xmainpage.__c.getField(true,"False"));
 BA.debugLineNum = 2297;BA.debugLine="Return START_FADE_MS";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("RestoreWindowState (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3062);
...
RemoteObject _maxheight = RemoteObject.createImmutable(0);
 BA.debugLineNum = 3062;BA.debugLine="Private Sub RestoreWindowState";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 3064;BA.debugLine="Try";
Debug.ShouldStop(8388608);
try { BA.debugLineNum = 3065;BA.debugLine="Dim form As Form = B4XPages.GetNativeParent(Me)";
Debug.ShouldStop(16777216);
_form = b4xmainpage._b4xpages.runMethod(false,"_getnativeparent" /*RemoteObject*/ ,(Object)(__ref));Debug.locals.put("form", _form);Debug.locals.put("form", _form);
 BA.debugLineNum = 3066;BA.debugLine="If form.IsInitialized = False Then Return";
Debug.ShouldStop(33554432);
if (RemoteObject.solveBoolean("=",_form.runMethod(true,"IsInitialized"),b4xmainpage.__c.getField(true,"False"))) { 
Debug.CheckDeviceExceptions();if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 3067;BA.debugLine="Dim fx As JFX";
Debug.ShouldStop(67108864);
_fx = RemoteObject.createNew ("anywheresoftware.b4j.objects.JFX");Debug.locals.put("fx", _fx);
 BA.debugLineNum = 3068;BA.debugLine="Dim windowTop As Double = storage.GetDefault(\"Wi";
Debug.ShouldStop(134217728);
_windowtop = BA.numberCast(double.class, __ref.getField(false,"_storage" /*RemoteObject*/ ).runClassMethod (b4j.example.keyvaluestore.class, "_getdefault" /*RemoteObject*/ ,(Object)(BA.ObjectToString("WindowTop")),(Object)(RemoteObject.createImmutable((-(double) (0 + 1))))));Debug.locals.put("windowTop", _windowtop);Debug.locals.put("windowTop", _windowtop);
 BA.debugLineNum = 3069;BA.debugLine="Dim windowLeft As Double = storage.GetDefault(\"W";
Debug.ShouldStop(268435456);
_windowleft = BA.numberCast(double.class, __ref.getField(false,"_storage" /*RemoteObject*/ ).runClassMethod (b4j.example.keyvaluestore.class, "_getdefault" /*RemoteObject*/ ,(Object)(BA.ObjectToString("WindowLeft")),(Object)(RemoteObject.createImmutable((-(double) (0 + 1))))));Debug.locals.put("windowLeft", _windowleft);Debug.locals.put("windowLeft", _windowleft);
 BA.debugLineNum = 3070;BA.debugLine="Dim windowWidth As Double = storage.GetDefault(\"";
Debug.ShouldStop(536870912);
_windowwidth = BA.numberCast(double.class, __ref.getField(false,"_storage" /*RemoteObject*/ ).runClassMethod (b4j.example.keyvaluestore.class, "_getdefault" /*RemoteObject*/ ,(Object)(BA.ObjectToString("WindowWidth")),(Object)(RemoteObject.createImmutable((-(double) (0 + 1))))));Debug.locals.put("windowWidth", _windowwidth);Debug.locals.put("windowWidth", _windowwidth);
 BA.debugLineNum = 3071;BA.debugLine="Dim windowHeight As Double = storage.GetDefault(";
Debug.ShouldStop(1073741824);
_windowheight = BA.numberCast(double.class, __ref.getField(false,"_storage" /*RemoteObject*/ ).runClassMethod (b4j.example.keyvaluestore.class, "_getdefault" /*RemoteObject*/ ,(Object)(BA.ObjectToString("WindowHeight")),(Object)(RemoteObject.createImmutable((-(double) (0 + 1))))));Debug.locals.put("windowHeight", _windowheight);Debug.locals.put("windowHeight", _windowheight);
 BA.debugLineNum = 3072;BA.debugLine="Dim maxWidth As Double = fx.PrimaryScreen.MaxX -";
Debug.ShouldStop(-2147483648);
_maxwidth = RemoteObject.solve(new RemoteObject[] {_fx.runMethod(false,"getPrimaryScreen").runMethod(true,"getMaxX"),_fx.runMethod(false,"getPrimaryScreen").runMethod(true,"getMinX")}, "-",1, 0);Debug.locals.put("maxWidth", _maxwidth);Debug.locals.put("maxWidth", _maxwidth);
 BA.debugLineNum = 3073;BA.debugLine="Dim maxHeight As Double = fx.PrimaryScreen.MaxY";
Debug.ShouldStop(1);
_maxheight = RemoteObject.solve(new RemoteObject[] {_fx.runMethod(false,"getPrimaryScreen").runMethod(true,"getMaxY"),_fx.runMethod(false,"getPrimaryScreen").runMethod(true,"getMinY")}, "-",1, 0);Debug.locals.put("maxHeight", _maxheight);Debug.locals.put("maxHeight", _maxheight);
 BA.debugLineNum = 3074;BA.debugLine="If windowTop > -1 Then form.WindowTop = windowTo";
Debug.ShouldStop(2);
...
_form.runMethod(true,"setWindowTop",_windowtop);};
 BA.debugLineNum = 3075;BA.debugLine="If windowLeft > -1 Then form.WindowLeft = window";
Debug.ShouldStop(4);
...
_form.runMethod(true,"setWindowLeft",_windowleft);};
 BA.debugLineNum = 3076;BA.debugLine="If windowWidth > -1 Then form.WindowWidth = Min(";
Debug.ShouldStop(8);
...
_form.runMethod(true,"setWindowWidth",b4xmainpage.__c.runMethod(true,"Min",(Object)(_maxwidth),(Object)(b4xmainpage.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 520)),(Object)(_windowwidth)))));};
 BA.debugLineNum = 3077;BA.debugLine="If windowHeight > -1 Then";
Debug.ShouldStop(16);
if (RemoteObject.solveBoolean(">",_windowheight,BA.numberCast(double.class, -(double) (0 + 1)))) { 
 BA.debugLineNum = 3078;BA.debugLine="form.WindowHeight = Min(maxHeight, Max(640, win";
Debug.ShouldStop(32);
...
{ BA.debugLineNum = 3079;BA.debugLine="Else If maxHeight < 640 Then";
Debug.ShouldStop(64);
if (RemoteObject.solveBoolean("<",_maxheight,BA.numberCast(double.class, 640))) { 
 BA.debugLineNum = 3080;BA.debugLine="form.WindowHeight = maxHeight";
Debug.ShouldStop(128);
_form.runMethod(true,"setWindowHeight",_maxheight);
 }}
;
 BA.debugLineNum = 3082;BA.debugLine="TraceLog(\"Положение окна восстановлено. left=\" &";
Debug.ShouldStop(512);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Положение окна восстановлено. left="),_form.runMethod(true,"getWindowLeft"),RemoteObject.createImmutable(", top="),_form.runMethod(true,"getWindowTop"),RemoteObject.createImmutable(", width="),_form.runMethod(true,"getWindowWidth"),RemoteObject.createImmutable(", height="),_form.runMethod(true,"getWindowHeight"))));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e21.toString()); BA.debugLineNum = 3084;BA.debugLine="TraceLog(\"Не удалось восстановить положение окна";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("RetryTimer_Tick (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,1907);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 1908;BA.debugLine="retryTimer.Enabled = False";
Debug.ShouldStop(524288);
__ref.getField(false,"_retrytimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",parent.__c.getField(true,"False"));
 BA.debugLineNum = 1909;BA.debugLine="If isStarted = False Or isStoppedByUser Then Retu";
Debug.ShouldStop(1048576);
if (true) break;
...
this.state = 7;
;
 BA.debugLineNum = 1910;BA.debugLine="If isPlaybackPausedByPolicy Then Return";
Debug.ShouldStop(2097152);
if (true) break;
...
this.state = -1;
;
 BA.debugLineNum = 1911;BA.debugLine="TraceLog(\"RetryTimer_Tick. reloading next queue c";
Debug.ShouldStop(4194304);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("RetryTimer_Tick. reloading next queue chunk.")));
 BA.debugLineNum = 1912;BA.debugLine="Wait For (LoadNextAndPlay) Complete (unused As Bo";
Debug.ShouldStop(8388608);
...
try {
		Debug.PushSubsStack("SaveServerSnapshot (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2442);
...
Debug.locals.put("errorMessage", _errormessage);
 BA.debugLineNum = 2442;BA.debugLine="Private Sub SaveServerSnapshot(method As String, u";
Debug.ShouldStop(512);
 BA.debugLineNum = 2443;BA.debugLine="appTraceService.SaveServerSnapshot(method, url, s";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("SaveValue (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2915);
if (RapidSub.canDelegate("savevalue")) { return __ref.runUserSub(false, "b4xmainpage","savevalue", __ref, _key, _value);}
Debug.locals.put("key", _key);
Debug.locals.put("value", _value);
 BA.debugLineNum = 2915;BA.debugLine="Private Sub SaveValue(key As String, value As Obje";
Debug.ShouldStop(4);
 BA.debugLineNum = 2916;BA.debugLine="storage.Put(key, value)";
Debug.ShouldStop(8);
...
try {
		Debug.PushSubsStack("SaveWindowState (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3043);
if (RapidSub.canDelegate("savewindowstate")) { return __ref.runUserSub(false, "b4xmainpage","savewindowstate", __ref);}
RemoteObject _form = RemoteObject.declareNull("anywheresoftware.b4j.objects.Form");
RemoteObject _fx = RemoteObject.declareNull("anywheresoftware.b4j.objects.JFX");
 BA.debugLineNum = 3043;BA.debugLine="Public Sub SaveWindowState";
Debug.ShouldStop(4);
 BA.debugLineNum = 3045;BA.debugLine="Try";
Debug.ShouldStop(16);
try { BA.debugLineNum = 3046;BA.debugLine="Dim form As Form = B4XPages.GetNativeParent(Me)";
Debug.ShouldStop(32);
_form = b4xmainpage._b4xpages.runMethod(false,"_getnativeparent" /*RemoteObject*/ ,(Object)(__ref));Debug.locals.put("form", _form);Debug.locals.put("form", _form);
 BA.debugLineNum = 3047;BA.debugLine="Dim fx As JFX";
Debug.ShouldStop(64);
_fx = RemoteObject.createNew ("anywheresoftware.b4j.objects.JFX");Debug.locals.put("fx", _fx);
 BA.debugLineNum = 3048;BA.debugLine="If form.IsInitialized = False Then Return";
Debug.ShouldStop(128);
if (RemoteObject.solveBoolean("=",_form.runMethod(true,"IsInitialized"),b4xmainpage.__c.getField(true,"False"))) { 
Debug.CheckDeviceExceptions();if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 3049;BA.debugLine="If fx.PrimaryScreen.MaxX > form.Width Then";
Debug.ShouldStop(256);
if (RemoteObject.solveBoolean(">",_fx.runMethod(false,"getPrimaryScreen").runMethod(true,"getMaxX"),_form.runMethod(true,"getWidth"))) { 
 BA.debugLineNum = 3050;BA.debugLine="storage.Put(\"WindowTop\", form.WindowTop)";
Debug.ShouldStop(512);
__ref.getField(false,"_storage" /*RemoteObject*/ ).runClassMethod (b4j.example.keyvaluestore.class, "_put" /*RemoteObject*/ ,(Object)(BA.ObjectToString("WindowTop")),(Object)((_form.runMethod(true,"getWindowTop"))));
 BA.debugLineNum = 3051;BA.debugLine="storage.Put(\"WindowLeft\", form.WindowLeft)";
Debug.ShouldStop(1024);
__ref.getField(false,"_storage" /*RemoteObject*/ ).runClassMethod (b4j.example.keyvaluestore.class, "_put" /*RemoteObject*/ ,(Object)(BA.ObjectToString("WindowLeft")),(Object)((_form.runMethod(true,"getWindowLeft"))));
 BA.debugLineNum = 3052;BA.debugLine="storage.Put(\"WindowWidth\", form.WindowWidth)";
Debug.ShouldStop(2048);
__ref.getField(false,"_storage" /*RemoteObject*/ ).runClassMethod (b4j.example.keyvaluestore.class, "_put" /*RemoteObject*/ ,(Object)(BA.ObjectToString("WindowWidth")),(Object)((_form.runMethod(true,"getWindowWidth"))));
 BA.debugLineNum = 3053;BA.debugLine="storage.Put(\"WindowHeight\", form.WindowHeight)";
Debug.ShouldStop(4096);
__ref.getField(false,"_storage" /*RemoteObject*/ ).runClassMethod (b4j.example.keyvaluestore.class, "_put" /*RemoteObject*/ ,(Object)(BA.ObjectToString("WindowHeight")),(Object)((_form.runMethod(true,"getWindowHeight"))));
 BA.debugLineNum = 3054;BA.debugLine="TraceLog(\"Положение окна сохранено. left=\" & fo";
Debug.ShouldStop(8192);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Положение окна сохранено. left="),_form.runMethod(true,"getWindowLeft"),RemoteObject.createImmutable(", top="),_form.runMethod(true,"getWindowTop"),RemoteObject.createImmutable(", width="),_form.runMethod(true,"getWindowWidth"),RemoteObject.createImmutable(", height="),_form.runMethod(true,"getWindowHeight"))));
 ...
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e13.toString()); BA.debugLineNum = 3057;BA.debugLine="TraceLog(\"Не удалось сохранить положение окна. \"";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("ScaleValue (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3158);
...
Debug.locals.put("largeValue", _largevalue);
 BA.debugLineNum = 3158;BA.debugLine="Private Sub ScaleValue(availableWidth As Int, smal";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 3159;BA.debugLine="Return UiStyle.ScaleValue(availableWidth, smallVa";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("ScheduleBreakWatch (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,1943);
...
RemoteObject _delay = RemoteObject.createImmutable(0L);
 BA.debugLineNum = 1943;BA.debugLine="Private Sub ScheduleBreakWatch";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 1944;BA.debugLine="breakTimer.Enabled = False";
Debug.ShouldStop(8388608);
__ref.getField(false,"_breaktimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",b4xmainpage.__c.getField(true,"False"));
 BA.debugLineNum = 1945;BA.debugLine="If HasPendingExactBreak = False Then Return";
Debug.ShouldStop(16777216);
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 1946;BA.debugLine="Dim delay As Long = Max(1, ((scheduledBreakAt - L";
Debug.ShouldStop(33554432);
_delay = BA.numberCast(long.class, b4xmainpage.__c.runMethod(true,"Max",(Object)(BA.numberCast(double.class, 1)),(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_scheduledbreakat" /*RemoteObject*/ ),__ref.runClassMethod (b4j.example.b4xmainpage.class, "_localnowtimestamp" /*RemoteObject*/ )}, "-",1, 2)),RemoteObject.createImmutable(1000)}, "*",0, 2)),RemoteObject.createImmutable(250)}, "-",1, 2)))));Debug.locals.put("delay", _delay);Debug.locals.put("delay", _delay);
 BA.debugLineNum = 1947;BA.debugLine="breakTimer.Interval = delay";
Debug.ShouldStop(67108864);
__ref.getField(false,"_breaktimer" /*RemoteObject*/ ).runMethod(true,"setInterval",_delay);
 BA.debugLineNum = 1948;BA.debugLine="breakTimer.Enabled = True";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("ScheduleHistoryLog (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2003);
if (RapidSub.canDelegate("schedulehistorylog")) { return __ref.runUserSub(false, "b4xmainpage","schedulehistorylog", __ref, _item);}
RemoteObject _itemtype = RemoteObject.createImmutable("");
Debug.locals.put("item", _item);
 BA.debugLineNum = 2003;BA.debugLine="Private Sub ScheduleHistoryLog(item As Map)";
Debug.ShouldStop(262144);
 BA.debugLineNum = 2004;BA.debugLine="If item.IsInitialized = False Then Return";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean("=",_item.runMethod(true,"IsInitialized"),b4xmainpage.__c.getField(true,"False"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 2005;BA.debugLine="Dim itemType As String = item.GetDefault(\"type\",";
Debug.ShouldStop(1048576);
_itemtype = BA.ObjectToString(_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("type"))),(Object)((RemoteObject.createImmutable("")))));Debug.locals.put("itemType", _itemtype);Debug.locals.put("itemType", _itemtype);
 BA.debugLineNum = 2006;BA.debugLine="If itemType <> \"track\" And itemType <> \"ad\" Then";
Debug.ShouldStop(2097152);
if (RemoteObject.solveBoolean("!",_itemtype,BA.ObjectToString("track")) && RemoteObject.solveBoolean("!",_itemtype,BA.ObjectToString("ad"))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 2007;BA.debugLine="If item.GetDefault(\"id\", \"\") = \"\" Then Return";
Debug.ShouldStop(4194304);
if (RemoteObject.solveBoolean("=",_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("id"))),(Object)((RemoteObject.createImmutable("")))),RemoteObject.createImmutable(("")))) { 
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 2008;BA.debugLine="TraceLog(\"ScheduleHistoryLog. item=\" & DescribeIt";
Debug.ShouldStop(8388608);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("ScheduleHistoryLog. item="),__ref.runClassMethod (b4j.example.b4xmainpage.class, "_describeitem" /*RemoteObject*/ ,(Object)((_item.getObject()))),RemoteObject.createImmutable(", mode=first_timeupdate"))));
 BA.debugLineNum = 2009;BA.debugLine="ClearHistoryLogTimer";
Debug.ShouldStop(16777216);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clearhistorylogtimer" /*RemoteObject*/ );
 BA.debugLineNum = 2010;BA.debugLine="historyItem = item";
Debug.ShouldStop(33554432);
__ref.setField ("_historyitem" /*RemoteObject*/ ,_item);
 BA.debugLineNum = 2011;BA.debugLine="historyStartedAtTicks = DateTime.Now";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("ScheduleRetry (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,1900);
if (RapidSub.canDelegate("scheduleretry")) { return __ref.runUserSub(false, "b4xmainpage","scheduleretry", __ref, _mode, _delayms);}
Debug.locals.put("mode", _mode);
Debug.locals.put("delayMs", _delayms);
 BA.debugLineNum = 1900;BA.debugLine="Private Sub ScheduleRetry(mode As String, delayMs";
Debug.ShouldStop(2048);
 BA.debugLineNum = 1901;BA.debugLine="ClearRetryTimer";
Debug.ShouldStop(4096);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clearretrytimer" /*RemoteObject*/ );
 BA.debugLineNum = 1902;BA.debugLine="retryTimer.Interval = ResolveRetryDelay(mode, del";
Debug.ShouldStop(8192);
__ref.getField(false,"_retrytimer" /*RemoteObject*/ ).runMethod(true,"setInterval",BA.numberCast(long.class, __ref.runClassMethod (b4j.example.b4xmainpage.class, "_resolveretrydelay" /*RemoteObject*/ ,(Object)(_mode),(Object)(_delayms))));
 BA.debugLineNum = 1903;BA.debugLine="TraceLog(\"ScheduleRetry. mode=\" & mode & \", delay";
Debug.ShouldStop(16384);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("ScheduleRetry. mode="),_mode,RemoteObject.createImmutable(", delayMs="),__ref.getField(false,"_retrytimer" /*RemoteObject*/ ).runMethod(true,"getInterval"))));
 BA.debugLineNum = 1904;BA.debugLine="retryTimer.Enabled = True";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("SetLabelStyle (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3150);
...
Debug.locals.put("style", _style);
 BA.debugLineNum = 3150;BA.debugLine="Private Sub SetLabelStyle(view As B4XView, style A";
Debug.ShouldStop(8192);
 BA.debugLineNum = 3151;BA.debugLine="UiStyle.SetLabelStyle(view, style)";
Debug.ShouldStop(16384);
...
try {
		Debug.PushSubsStack("SetPaneStyle (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3146);
if (RapidSub.canDelegate("setpanestyle")) { return __ref.runUserSub(false, "b4xmainpage","setpanestyle", __ref, _view, _style);}
Debug.locals.put("view", _view);
Debug.locals.put("style", _style);
 BA.debugLineNum = 3146;BA.debugLine="Private Sub SetPaneStyle(view As B4XView, style As";
Debug.ShouldStop(512);
 BA.debugLineNum = 3147;BA.debugLine="UiStyle.SetPaneStyle(view, style)";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("SetPickOnBounds (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3154);
if (RapidSub.canDelegate("setpickonbounds")) { return __ref.runUserSub(false, "b4xmainpage","setpickonbounds", __ref, _view, _value);}
Debug.locals.put("view", _view);
Debug.locals.put("value", _value);
 BA.debugLineNum = 3154;BA.debugLine="Private Sub SetPickOnBounds(view As B4XView, value";
Debug.ShouldStop(131072);
 BA.debugLineNum = 3155;BA.debugLine="UiStyle.SetPickOnBounds(view, value)";
Debug.ShouldStop(262144);
...
try {
		Debug.PushSubsStack("SetPlayIcon (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2464);
if (RapidSub.canDelegate("setplayicon")) { return __ref.runUserSub(false, "b4xmainpage","setplayicon", __ref);}
 BA.debugLineNum = 2464;BA.debugLine="Private Sub SetPlayIcon";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 2465;BA.debugLine="SetLabelStyle(lblPlayIcon, \"-fx-alignment: center";
Debug.ShouldStop(1);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setlabelstyle" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblplayicon" /*RemoteObject*/ )),(Object)(RemoteObject.concat(RemoteObject.createImmutable("-fx-alignment: center; -fx-text-fill: "),__ref.runClassMethod (b4j.example.b4xmainpage.class, "_colortocss" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, ((int)0xffd0ff71)))),RemoteObject.createImmutable("; -fx-padding: 0;"))));
 BA.debugLineNum = 2466;BA.debugLine="lblPlayIcon.Text = ICON_PLAY";
Debug.ShouldStop(2);
__ref.getField(false,"_lblplayicon" /*RemoteObject*/ ).runMethod(true,"setText",__ref.getField(true,"_icon_play" /*RemoteObject*/ ));
 BA.debugLineNum = 2467;BA.debugLine="ApplyMaterialIconFont(lblPlayIcon, playIconBaseSi";
Debug.ShouldStop(4);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_applymaterialiconfont" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblplayicon" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_playiconbasesize" /*RemoteObject*/ )));
 BA.debugLineNum = 2468;BA.debugLine="orbitPane.SetColorAndBorder(xui.Color_Transparent";
Debug.ShouldStop(8);
__ref.getField(false,"_orbitpane" /*RemoteObject*/ ).runVoidMethod ("SetColorAndBorder",(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent")),(Object)(BA.numberCast(double.class, b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2))))),(Object)(BA.numberCast(int.class, ((int)0x00d0ff71))),(Object)(BA.numberCast(double.class, b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 999))))));
 BA.debugLineNum = 2469;BA.debugLine="StopOrbitAnimation";
Debug.ShouldStop(16);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_stoporbitanimation" /*RemoteObject*/ );
 BA.debugLineNum = 2470;BA.debugLine="UpdatePlayButtonAppearance(False)";
Debug.ShouldStop(32);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_updateplaybuttonappearance" /*RemoteObject*/ ,(Object)(b4xmainpage.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("SetStatusText (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2675);
if (RapidSub.canDelegate("setstatustext")) { return __ref.runUserSub(false, "b4xmainpage","setstatustext", __ref, _text);}
Debug.locals.put("text", _text);
 BA.debugLineNum = 2675;BA.debugLine="Private Sub SetStatusText(text As String)";
Debug.ShouldStop(262144);
 BA.debugLineNum = 2676;BA.debugLine="lblInfo.Text = text";
Debug.ShouldStop(524288);
...
try {
		Debug.PushSubsStack("SetStopIcon (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2473);
if (RapidSub.canDelegate("setstopicon")) { return __ref.runUserSub(false, "b4xmainpage","setstopicon", __ref);}
 BA.debugLineNum = 2473;BA.debugLine="Private Sub SetStopIcon";
Debug.ShouldStop(256);
 BA.debugLineNum = 2474;BA.debugLine="SetLabelStyle(lblPlayIcon, \"-fx-alignment: center";
Debug.ShouldStop(512);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setlabelstyle" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblplayicon" /*RemoteObject*/ )),(Object)(RemoteObject.concat(RemoteObject.createImmutable("-fx-alignment: center; -fx-text-fill: "),__ref.runClassMethod (b4j.example.b4xmainpage.class, "_colortocss" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, ((int)0xffd0ff71)))),RemoteObject.createImmutable("; -fx-padding: 0;"))));
 BA.debugLineNum = 2475;BA.debugLine="lblPlayIcon.Text = ICON_STOP";
Debug.ShouldStop(1024);
__ref.getField(false,"_lblplayicon" /*RemoteObject*/ ).runMethod(true,"setText",__ref.getField(true,"_icon_stop" /*RemoteObject*/ ));
 BA.debugLineNum = 2476;BA.debugLine="ApplyMaterialIconFont(lblPlayIcon, stopIconBaseSi";
Debug.ShouldStop(2048);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_applymaterialiconfont" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblplayicon" /*RemoteObject*/ )),(Object)(__ref.getField(true,"_stopiconbasesize" /*RemoteObject*/ )));
 BA.debugLineNum = 2477;BA.debugLine="orbitPane.SetColorAndBorder(xui.Color_Transparent";
Debug.ShouldStop(4096);
__ref.getField(false,"_orbitpane" /*RemoteObject*/ ).runVoidMethod ("SetColorAndBorder",(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent")),(Object)(BA.numberCast(double.class, b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2))))),(Object)(BA.numberCast(int.class, ((int)0x66d0ff71))),(Object)(BA.numberCast(double.class, b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 999))))));
 BA.debugLineNum = 2478;BA.debugLine="StartOrbitAnimation";
Debug.ShouldStop(8192);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_startorbitanimation" /*RemoteObject*/ );
 BA.debugLineNum = 2479;BA.debugLine="UpdatePlayButtonAppearance(False)";
Debug.ShouldStop(16384);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_updateplaybuttonappearance" /*RemoteObject*/ ,(Object)(b4xmainpage.__c.getField(true,"False")));
...
try {
		Debug.PushSubsStack("SetStreamText (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2671);
if (RapidSub.canDelegate("setstreamtext")) { return __ref.runUserSub(false, "b4xmainpage","setstreamtext", __ref, _text);}
Debug.locals.put("text", _text);
 BA.debugLineNum = 2671;BA.debugLine="Private Sub SetStreamText(text As String)";
Debug.ShouldStop(16384);
 BA.debugLineNum = 2672;BA.debugLine="lblStream.Text = text";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("ShiftQueueItem (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2775);
if (RapidSub.canDelegate("shiftqueueitem")) { return __ref.runUserSub(false, "b4xmainpage","shiftqueueitem", __ref);}
RemoteObject _item = RemoteObject.declareNull("Object");
 BA.debugLineNum = 2775;BA.debugLine="Private Sub ShiftQueueItem As Object";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 2776;BA.debugLine="If playQueue.Size = 0 Then Return Null";
Debug.ShouldStop(8388608);
if (RemoteObject.solveBoolean("=",__ref.getField(false,"_playqueue" /*RemoteObject*/ ).runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
if (true) return b4xmainpage.__c.getField(false,"Null");};
 BA.debugLineNum = 2777;BA.debugLine="Dim item As Object = playQueue.Get(0)";
Debug.ShouldStop(16777216);
_item = __ref.getField(false,"_playqueue" /*RemoteObject*/ ).runMethod(false,"Get",(Object)(BA.numberCast(int.class, 0)));Debug.locals.put("item", _item);Debug.locals.put("item", _item);
 BA.debugLineNum = 2778;BA.debugLine="playQueue.RemoveAt(0)";
Debug.ShouldStop(33554432);
__ref.getField(false,"_playqueue" /*RemoteObject*/ ).runVoidMethod ("RemoveAt",(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 2779;BA.debugLine="Return item";
Debug.ShouldStop(67108864);
...
try {
		Debug.PushSubsStack("ShouldTriggerBreakNow (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,1968);
if (RapidSub.canDelegate("shouldtriggerbreaknow")) { return __ref.runUserSub(false, "b4xmainpage","shouldtriggerbreaknow", __ref);}
 BA.debugLineNum = 1968;BA.debugLine="Private Sub ShouldTriggerBreakNow As Boolean";
Debug.ShouldStop(32768);
 BA.debugLineNum = 1969;BA.debugLine="If scheduledBreakAt <= 0 Then Return False";
Debug.ShouldStop(65536);
if (RemoteObject.solveBoolean("k",__ref.getField(true,"_scheduledbreakat" /*RemoteObject*/ ),BA.numberCast(long.class, 0))) { 
if (true) return b4xmainpage.__c.getField(true,"False");};
 BA.debugLineNum = 1970;BA.debugLine="Return LocalNowTimestamp >= scheduledBreakAt";
Debug.ShouldStop(131072);
...
try {
		Debug.PushSubsStack("ShowAdMeta (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2667);
if (RapidSub.canDelegate("showadmeta")) { return __ref.runUserSub(false, "b4xmainpage","showadmeta", __ref, _item);}
Debug.locals.put("item", _item);
 BA.debugLineNum = 2667;BA.debugLine="Private Sub ShowAdMeta(item As Map)";
Debug.ShouldStop(1024);
 BA.debugLineNum = 2668;BA.debugLine="SetStatusText(item.GetDefault(\"title\", \"\"))";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("ShowClaimPrompt (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2643);
if (RapidSub.canDelegate("showclaimprompt")) { return __ref.runUserSub(false, "b4xmainpage","showclaimprompt", __ref, _text);}
Debug.locals.put("text", _text);
 BA.debugLineNum = 2643;BA.debugLine="Private Sub ShowClaimPrompt(text As String)";
Debug.ShouldStop(262144);
 BA.debugLineNum = 2644;BA.debugLine="HideContentBlocks";
Debug.ShouldStop(524288);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_hidecontentblocks" /*RemoteObject*/ );
 BA.debugLineNum = 2645;BA.debugLine="isStarted = False";
Debug.ShouldStop(1048576);
__ref.setField ("_isstarted" /*RemoteObject*/ ,b4xmainpage.__c.getField(true,"False"));
 BA.debugLineNum = 2646;BA.debugLine="isStoppedByUser = True";
Debug.ShouldStop(2097152);
__ref.setField ("_isstoppedbyuser" /*RemoteObject*/ ,b4xmainpage.__c.getField(true,"True"));
 BA.debugLineNum = 2647;BA.debugLine="SetPlayIcon";
Debug.ShouldStop(4194304);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setplayicon" /*RemoteObject*/ );
 BA.debugLineNum = 2648;BA.debugLine="SetStatusText(text)";
Debug.ShouldStop(8388608);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setstatustext" /*RemoteObject*/ ,(Object)(_text));
 BA.debugLineNum = 2649;BA.debugLine="confirmPane.Visible = True";
Debug.ShouldStop(16777216);
__ref.getField(false,"_confirmpane" /*RemoteObject*/ ).runMethod(true,"setVisible",b4xmainpage.__c.getField(true,"True"));
 BA.debugLineNum = 2650;BA.debugLine="LayoutUi(rootView.Width, rootView.Height)";
Debug.ShouldStop(33554432);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_layoutui" /*RemoteObject*/ ,(Object)(BA.numberCast(int.class, __ref.getField(false,"_rootview" /*RemoteObject*/ ).runMethod(true,"getWidth"))),(Object)(BA.numberCast(int.class, __ref.getField(false,"_rootview" /*RemoteObject*/ ).runMethod(true,"getHeight"))));
...
try {
		Debug.PushSubsStack("ShowMessage (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2638);
if (RapidSub.canDelegate("showmessage")) { return __ref.runUserSub(false, "b4xmainpage","showmessage", __ref, _text);}
Debug.locals.put("text", _text);
 BA.debugLineNum = 2638;BA.debugLine="Private Sub ShowMessage(text As String)";
Debug.ShouldStop(8192);
 BA.debugLineNum = 2639;BA.debugLine="HideContentBlocks";
Debug.ShouldStop(16384);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_hidecontentblocks" /*RemoteObject*/ );
 BA.debugLineNum = 2640;BA.debugLine="SetStatusText(text)";
Debug.ShouldStop(32768);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setstatustext" /*RemoteObject*/ ,(Object)(_text));
...
try {
		Debug.PushSubsStack("ShowStream (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2634);
if (RapidSub.canDelegate("showstream")) { return __ref.runUserSub(false, "b4xmainpage","showstream", __ref, _text);}
Debug.locals.put("text", _text);
 BA.debugLineNum = 2634;BA.debugLine="Private Sub ShowStream(text As String)";
Debug.ShouldStop(512);
 BA.debugLineNum = 2635;BA.debugLine="SetStreamText(text)";
Debug.ShouldStop(1024);
...
try {
		Debug.PushSubsStack("ShowTrackMeta (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2659);
if (RapidSub.canDelegate("showtrackmeta")) { return __ref.runUserSub(false, "b4xmainpage","showtrackmeta", __ref, _item);}
RemoteObject _parts = RemoteObject.declareNull("anywheresoftware.b4a.objects.collections.List");
Debug.locals.put("item", _item);
 BA.debugLineNum = 2659;BA.debugLine="Private Sub ShowTrackMeta(item As Map)";
Debug.ShouldStop(4);
 BA.debugLineNum = 2660;BA.debugLine="Dim parts As List";
Debug.ShouldStop(8);
_parts = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("parts", _parts);
 BA.debugLineNum = 2661;BA.debugLine="parts.Initialize";
Debug.ShouldStop(16);
_parts.runVoidMethod ("Initialize");
 BA.debugLineNum = 2662;BA.debugLine="If item.GetDefault(\"set\", \"\") <> \"\" Then parts.Ad";
Debug.ShouldStop(32);
if (RemoteObject.solveBoolean("!",_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("set"))),(Object)((RemoteObject.createImmutable("")))),RemoteObject.createImmutable(("")))) { 
_parts.runVoidMethod ("Add",(Object)(_item.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("set"))))));};
 BA.debugLineNum = 2663;BA.debugLine="If item.GetDefault(\"code\", \"\") <> \"\" Then parts.A";
Debug.ShouldStop(64);
if (RemoteObject.solveBoolean("!",_item.runMethod(false,"GetDefault",(Object)(RemoteObject.createImmutable(("code"))),(Object)((RemoteObject.createImmutable("")))),RemoteObject.createImmutable(("")))) { 
_parts.runVoidMethod ("Add",(Object)(_item.runMethod(false,"Get",(Object)((RemoteObject.createImmutable("code"))))));};
 BA.debugLineNum = 2664;BA.debugLine="SetStatusText(JoinList(parts, \" • \"))";
Debug.ShouldStop(128);
...
try {
		Debug.PushSubsStack("StartOrbitAnimation (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2512);
if (RapidSub.canDelegate("startorbitanimation")) { return __ref.runUserSub(false, "b4xmainpage","startorbitanimation", __ref);}
 BA.debugLineNum = 2512;BA.debugLine="Private Sub StartOrbitAnimation";
Debug.ShouldStop(32768);
 BA.debugLineNum = 2513;BA.debugLine="orbitPulseStep = 0";
Debug.ShouldStop(65536);
__ref.setField ("_orbitpulsestep" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 2514;BA.debugLine="orbitFadeTarget = 1";
Debug.ShouldStop(131072);
__ref.setField ("_orbitfadetarget" /*RemoteObject*/ ,BA.numberCast(double.class, 1));
 BA.debugLineNum = 2515;BA.debugLine="orbitTimer.Enabled = True";
Debug.ShouldStop(262144);
...
try {
		Debug.PushSubsStack("StopOrbitAnimation (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2518);
if (RapidSub.canDelegate("stoporbitanimation")) { return __ref.runUserSub(false, "b4xmainpage","stoporbitanimation", __ref);}
 BA.debugLineNum = 2518;BA.debugLine="Private Sub StopOrbitAnimation";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 2519;BA.debugLine="orbitFadeTarget = 0";
Debug.ShouldStop(4194304);
__ref.setField ("_orbitfadetarget" /*RemoteObject*/ ,BA.numberCast(double.class, 0));
 BA.debugLineNum = 2520;BA.debugLine="If orbitFadeValue > 0 Then";
Debug.ShouldStop(8388608);
if (RemoteObject.solveBoolean(">",__ref.getField(true,"_orbitfadevalue" /*RemoteObject*/ ),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 2521;BA.debugLine="orbitTimer.Enabled = True";
Debug.ShouldStop(16777216);
__ref.getField(false,"_orbittimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",b4xmainpage.__c.getField(true,"True"));
 }else {
 BA.debugLineNum = 2523;BA.debugLine="orbitTimer.Enabled = False";
Debug.ShouldStop(67108864);
__ref.getField(false,"_orbittimer" /*RemoteObject*/ ).runMethod(true,"setEnabled",b4xmainpage.__c.getField(true,"False"));
 BA.debugLineNum = 2524;BA.debugLine="ApplyOrbitFrame(0)";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("StopPlayer (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2234);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 2235;BA.debugLine="If isStopping Then Return False";
Debug.ShouldStop(67108864);
if (true) break;
...
this.state = 7;
;
 BA.debugLineNum = 2236;BA.debugLine="isStopping = True";
Debug.ShouldStop(134217728);
__ref.setField ("_isstopping" /*RemoteObject*/ ,parent.__c.getField(true,"True"));
 BA.debugLineNum = 2237;BA.debugLine="TraceLog(\"StopPlayer requested. currentType=\" & c";
Debug.ShouldStop(268435456);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("StopPlayer requested. currentType="),__ref.getField(true,"_currentmediatype" /*RemoteObject*/ ),RemoteObject.createImmutable(", activeAudio="),__ref.getField(true,"_activeaudiokey" /*RemoteObject*/ ),RemoteObject.createImmutable(", preparedAudio="),__ref.getField(true,"_preparedaudiokey" /*RemoteObject*/ ))));
 BA.debugLineNum = 2238;BA.debugLine="isStarted = False";
Debug.ShouldStop(536870912);
__ref.setField ("_isstarted" /*RemoteObject*/ ,parent.__c.getField(true,"False"));
 BA.debugLineNum = 2239;BA.debugLine="isStoppedByUser = True";
Debug.ShouldStop(1073741824);
__ref.setField ("_isstoppedbyuser" /*RemoteObject*/ ,parent.__c.getField(true,"True"));
 BA.debugLineNum = 2240;BA.debugLine="isPlaybackPausedByPolicy = False";
Debug.ShouldStop(-2147483648);
__ref.setField ("_isplaybackpausedbypolicy" /*RemoteObject*/ ,parent.__c.getField(true,"False"));
 BA.debugLineNum = 2241;BA.debugLine="ClearRetryTimer";
Debug.ShouldStop(1);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clearretrytimer" /*RemoteObject*/ );
 BA.debugLineNum = 2242;BA.debugLine="ClearExactBreakState";
Debug.ShouldStop(2);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clearexactbreakstate" /*RemoteObject*/ );
 BA.debugLineNum = 2243;BA.debugLine="ClearHistoryLogTimer";
Debug.ShouldStop(4);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_clearhistorylogtimer" /*RemoteObject*/ );
 BA.debugLineNum = 2244;BA.debugLine="ResetRetryDelay";
Debug.ShouldStop(8);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_resetretrydelay" /*RemoteObject*/ );
 BA.debugLineNum = 2245;BA.debugLine="If activeAudioKey <> \"\" Then";
Debug.ShouldStop(16);
if (true) break;
...
//C
this.state = 10;
 BA.debugLineNum = 2246;BA.debugLine="If currentMediaType = \"track\" Then";
Debug.ShouldStop(32);
if (true) break;
...
//C
this.state = 15;
 BA.debugLineNum = 2247;BA.debugLine="GetAudioByKey(activeAudioKey).Stop(STOP_FADE_MS";
Debug.ShouldStop(64);
...
//C
this.state = 15;
 BA.debugLineNum = 2249;BA.debugLine="GetAudioByKey(activeAudioKey).Stop(0)";
Debug.ShouldStop(256);
...
;
 if (true) break;
;
 BA.debugLineNum = 2252;BA.debugLine="If preparedAudioKey <> \"\" Then GetAudioByKey(prep";
Debug.ShouldStop(2048);
...
this.state = -1;
;
 BA.debugLineNum = 2253;BA.debugLine="currentTrackUrl = \"\"";
Debug.ShouldStop(4096);
__ref.setField ("_currenttrackurl" /*RemoteObject*/ ,BA.ObjectToString(""));
 BA.debugLineNum = 2254;BA.debugLine="currentMediaType = \"\"";
Debug.ShouldStop(8192);
__ref.setField ("_currentmediatype" /*RemoteObject*/ ,BA.ObjectToString(""));
 BA.debugLineNum = 2255;BA.debugLine="activeAudioKey = \"\"";
Debug.ShouldStop(16384);
__ref.setField ("_activeaudiokey" /*RemoteObject*/ ,BA.ObjectToString(""));
 BA.debugLineNum = 2256;BA.debugLine="preparedAudioKey = \"\"";
Debug.ShouldStop(32768);
__ref.setField ("_preparedaudiokey" /*RemoteObject*/ ,BA.ObjectToString(""));
 BA.debugLineNum = 2257;BA.debugLine="activeItem.Initialize";
Debug.ShouldStop(65536);
__ref.getField(false,"_activeitem" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 2258;BA.debugLine="preparedItem.Initialize";
Debug.ShouldStop(131072);
__ref.getField(false,"_prepareditem" /*RemoteObject*/ ).runVoidMethod ("Initialize");
 BA.debugLineNum = 2259;BA.debugLine="playlistIndex = -1";
Debug.ShouldStop(262144);
__ref.setField ("_playlistindex" /*RemoteObject*/ ,BA.numberCast(int.class, -(double) (0 + 1)));
 BA.debugLineNum = 2260;BA.debugLine="playQueue.Clear";
Debug.ShouldStop(524288);
__ref.getField(false,"_playqueue" /*RemoteObject*/ ).runVoidMethod ("Clear");
 BA.debugLineNum = 2261;BA.debugLine="prefetchDone = False";
Debug.ShouldStop(1048576);
__ref.setField ("_prefetchdone" /*RemoteObject*/ ,parent.__c.getField(true,"False"));
 BA.debugLineNum = 2262;BA.debugLine="isCrossfadeTriggered = False";
Debug.ShouldStop(2097152);
__ref.setField ("_iscrossfadetriggered" /*RemoteObject*/ ,parent.__c.getField(true,"False"));
 BA.debugLineNum = 2263;BA.debugLine="SetStatusText(\"\")";
Debug.ShouldStop(4194304);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setstatustext" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 2264;BA.debugLine="HidePin";
Debug.ShouldStop(8388608);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_hidepin" /*RemoteObject*/ );
 BA.debugLineNum = 2265;BA.debugLine="SetPlayIcon";
Debug.ShouldStop(16777216);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setplayicon" /*RemoteObject*/ );
 BA.debugLineNum = 2266;BA.debugLine="ApplyStoppedState";
Debug.ShouldStop(33554432);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_applystoppedstate" /*RemoteObject*/ );
 BA.debugLineNum = 2267;BA.debugLine="isStopping = False";
Debug.ShouldStop(67108864);
__ref.setField ("_isstopping" /*RemoteObject*/ ,parent.__c.getField(true,"False"));
 BA.debugLineNum = 2268;BA.debugLine="Return True";
Debug.ShouldStop(134217728);
if (true) {
parent.__c.runVoidMethod ("ReturnFromResumableSub",this.remoteResumableSub,(parent.__c.getField(true,"True")));return;};
...
try {
		Debug.PushSubsStack("SyncExactBreakState (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,1938);
if (RapidSub.canDelegate("syncexactbreakstate")) { return __ref.runUserSub(false, "b4xmainpage","syncexactbreakstate", __ref);}
 BA.debugLineNum = 1938;BA.debugLine="Private Sub SyncExactBreakState";
Debug.ShouldStop(131072);
 BA.debugLineNum = 1939;BA.debugLine="ResolveScheduledBreakAt";
Debug.ShouldStop(262144);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_resolvescheduledbreakat" /*RemoteObject*/ );
 BA.debugLineNum = 1940;BA.debugLine="ScheduleBreakWatch";
Debug.ShouldStop(524288);
...
try {
		Debug.PushSubsStack("SyncOfflinePlaylistMetadata (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2975);
...
this.state = 1;
Debug.locals.put("_ref", __ref);
 BA.debugLineNum = 2976;BA.debugLine="Dim playlistDescriptors As List = offlineStoreSer";
Debug.ShouldStop(-2147483648);
...
_playlistdescriptors = __ref.getField(false,"_offlinestoreservice" /*RemoteObject*/ ).runClassMethod (b4j.example.offlinestore.class, "_getstoredplaylistdescriptors" /*RemoteObject*/ );Debug.locals.put("playlistDescriptors", _playlistdescriptors);Debug.locals.put("playlistDescriptors", _playlistdescriptors);
 BA.debugLineNum = 2977;BA.debugLine="If playlistDescriptors.IsInitialized = False Or p";
Debug.ShouldStop(1);
if (true) break;
...
//C
this.state = 4;
 BA.debugLineNum = 2978;BA.debugLine="TraceLog(\"Для синхронизации playlist metadata ни";
Debug.ShouldStop(2);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.createImmutable("Для синхронизации playlist metadata ничего не найдено.")));
 BA.debugLineNum = 2979;BA.debugLine="Return False";
Debug.ShouldStop(4);
if (true) {
parent.__c.runVoidMethod ("ReturnFromResumableSub",this.remoteResumableSub,(parent.__c.getField(true,"False")));return;};
 if (true) break;
...
this.state = 5;
;
 BA.debugLineNum = 2981;BA.debugLine="EnsureDirectory(offlineStoreService.GetOfflinePla";
Debug.ShouldStop(16);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_ensuredirectory" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_offlinestoreservice" /*RemoteObject*/ ).runClassMethod (b4j.example.offlinestore.class, "_getofflineplaylistsdir" /*RemoteObject*/ )));
 BA.debugLineNum = 2982;BA.debugLine="Dim cachedPlaylistIndex As Map = offlineStoreServ";
Debug.ShouldStop(32);
_cachedplaylistindex = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.Map");
_cachedplaylistindex = __ref.getField(false,"_offlinestoreservice" /*RemoteObject*/ ).runClassMethod (b4j.example.offlinestore.class, "_getcachedplaylistindex" /*RemoteObject*/ );Debug.locals.put("cachedPlaylistIndex", _cachedplaylistindex);Debug.locals.put("cachedPlaylistIndex", _cachedplaylistindex);
 BA.debugLineNum = 2983;BA.debugLine="Dim downloadedCount As Int = 0";
Debug.ShouldStop(64);
_downloadedcount = BA.numberCast(int.class, 0);Debug.locals.put("downloadedCount", _downloadedcount);Debug.locals.put("downloadedCount", _downloadedcount);
 BA.debugLineNum = 2984;BA.debugLine="Dim updatedCount As Int = 0";
Debug.ShouldStop(128);
_updatedcount = BA.numberCast(int.class, 0);Debug.locals.put("updatedCount", _updatedcount);Debug.locals.put("updatedCount", _updatedcount);
 BA.debugLineNum = 2985;BA.debugLine="Dim failedCount As Int = 0";
Debug.ShouldStop(256);
_failedcount = BA.numberCast(int.class, 0);Debug.locals.put("failedCount", _failedcount);Debug.locals.put("failedCount", _failedcount);
 BA.debugLineNum = 2986;BA.debugLine="For Each descriptorObject As Object In playlistDe";
Debug.ShouldStop(512);
if (true) break;
...
//C
this.state = 8;
 BA.debugLineNum = 2987;BA.debugLine="If descriptorObject Is Map Then";
Debug.ShouldStop(1024);
if (true) break;
...
//C
this.state = 11;
 BA.debugLineNum = 2988;BA.debugLine="Dim descriptor As Map = descriptorObject";
Debug.ShouldStop(2048);
...
_descriptor = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.collections.Map"), _descriptorobject);Debug.locals.put("descriptor", _descriptor);Debug.locals.put("descriptor", _descriptor);
 BA.debugLineNum = 2989;BA.debugLine="Dim syncAction As String = offlineStoreService.";
Debug.ShouldStop(4096);
_syncaction = __ref.getField(false,"_offlinestoreservice" /*RemoteObject*/ ).runClassMethod (b4j.example.offlinestore.class, "_resolveplaylistsyncaction" /*RemoteObject*/ ,(Object)(_descriptor),(Object)(_cachedplaylistindex));Debug.locals.put("syncAction", _syncaction);Debug.locals.put("syncAction", _syncaction);
 BA.debugLineNum = 2990;BA.debugLine="If syncAction = \"skip\" Then Continue";
Debug.ShouldStop(8192);
if (true) break;
...
this.state = 17;
;
 BA.debugLineNum = 2991;BA.debugLine="Wait For (DownloadOfflinePlaylistMetadata(descr";
Debug.ShouldStop(16384);
...
_downloaded = (RemoteObject) result.getArrayElement(true,RemoteObject.createImmutable(1));Debug.locals.put("downloaded", _downloaded);
;
 BA.debugLineNum = 2992;BA.debugLine="If downloaded Then";
Debug.ShouldStop(32768);
if (true) break;
...
//C
this.state = 20;
 BA.debugLineNum = 2993;BA.debugLine="If syncAction = \"missing\" Then";
Debug.ShouldStop(65536);
if (true) break;
...
//C
this.state = 25;
 BA.debugLineNum = 2994;BA.debugLine="downloadedCount = downloadedCount + 1";
Debug.ShouldStop(131072);
...
//C
this.state = 25;
 BA.debugLineNum = 2996;BA.debugLine="updatedCount = updatedCount + 1";
Debug.ShouldStop(524288);
...
//C
this.state = 28;
 BA.debugLineNum = 2999;BA.debugLine="failedCount = failedCount + 1";
Debug.ShouldStop(4194304);
...
Debug.locals.put("descriptorObject", _descriptorobject);
;
 BA.debugLineNum = 3003;BA.debugLine="offlineStoreService.SaveCachedPlaylistIndex(cache";
Debug.ShouldStop(67108864);
__ref.getField(false,"_offlinestoreservice" /*RemoteObject*/ ).runClassMethod (b4j.example.offlinestore.class, "_savecachedplaylistindex" /*RemoteObject*/ ,(Object)(_cachedplaylistindex));
 BA.debugLineNum = 3004;BA.debugLine="offlineStoreService.RefreshPlaylistCacheStatus(pl";
Debug.ShouldStop(134217728);
__ref.getField(false,"_offlinestoreservice" /*RemoteObject*/ ).runClassMethod (b4j.example.offlinestore.class, "_refreshplaylistcachestatus" /*RemoteObject*/ ,(Object)(_playlistdescriptors));
 BA.debugLineNum = 3005;BA.debugLine="Dim actualCount As Int = storage.GetDefault(\"offl";
Debug.ShouldStop(268435456);
_actualcount = BA.numberCast(int.class, __ref.getField(false,"_storage" /*RemoteObject*/ ).runClassMethod (b4j.example.keyvaluestore.class, "_getdefault" /*RemoteObject*/ ,(Object)(BA.ObjectToString("offline_playlist_actual_count")),(Object)(RemoteObject.createImmutable((0)))));Debug.locals.put("actualCount", _actualcount);Debug.locals.put("actualCount", _actualcount);
 BA.debugLineNum = 3006;BA.debugLine="TraceLog(\"Синхронизация playlist metadata заверше";
Debug.ShouldStop(536870912);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_tracelog" /*RemoteObject*/ ,(Object)(RemoteObject.concat(RemoteObject.createImmutable("Синхронизация playlist metadata завершена. downloaded="),_downloadedcount,RemoteObject.createImmutable(", updated="),_updatedcount,RemoteObject.createImmutable(", failed="),_failedcount,RemoteObject.createImmutable(", actual="),_actualcount)));
 BA.debugLineNum = 3007;BA.debugLine="Return failedCount = 0";
Debug.ShouldStop(1073741824);
if (true) {
...
try {
		Debug.PushSubsStack("TimezoneOffsetMinutes (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3089);
...
RemoteObject _totalseconds = RemoteObject.createImmutable(0);
 BA.debugLineNum = 3089;BA.debugLine="Private Sub TimezoneOffsetMinutes As Int";
Debug.ShouldStop(65536);
 BA.debugLineNum = 3090;BA.debugLine="Dim jo As JavaObject";
Debug.ShouldStop(131072);
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");Debug.locals.put("jo", _jo);
 BA.debugLineNum = 3091;BA.debugLine="jo.InitializeStatic(\"java.time.OffsetDateTime\")";
Debug.ShouldStop(262144);
_jo.runVoidMethod ("InitializeStatic",(Object)(RemoteObject.createImmutable("java.time.OffsetDateTime")));
 BA.debugLineNum = 3092;BA.debugLine="Dim nowOffset As JavaObject = jo.RunMethod(\"now\",";
Debug.ShouldStop(524288);
...
_nowoffset = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _jo.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("now")),(Object)((b4xmainpage.__c.getField(false,"Null")))));Debug.locals.put("nowOffset", _nowoffset);Debug.locals.put("nowOffset", _nowoffset);
 BA.debugLineNum = 3093;BA.debugLine="Dim zoneOffset As JavaObject = nowOffset.RunMetho";
Debug.ShouldStop(1048576);
...
_zoneoffset = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _nowoffset.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getOffset")),(Object)((b4xmainpage.__c.getField(false,"Null")))));Debug.locals.put("zoneOffset", _zoneoffset);Debug.locals.put("zoneOffset", _zoneoffset);
 BA.debugLineNum = 3094;BA.debugLine="Dim totalSeconds As Int = zoneOffset.RunMethod(\"g";
Debug.ShouldStop(2097152);
_totalseconds = BA.numberCast(int.class, _zoneoffset.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getTotalSeconds")),(Object)((b4xmainpage.__c.getField(false,"Null")))));Debug.locals.put("totalSeconds", _totalseconds);Debug.locals.put("totalSeconds", _totalseconds);
 BA.debugLineNum = 3095;BA.debugLine="Return -Round(totalSeconds / 60)";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("ToLongDefault (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,3102);
...
Debug.locals.put("defaultValue", _defaultvalue);
 BA.debugLineNum = 3102;BA.debugLine="Private Sub ToLongDefault(value As Object, default";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 3103;BA.debugLine="Try";
Debug.ShouldStop(1073741824);
try { BA.debugLineNum = 3104;BA.debugLine="If value = Null Then Return defaultValue";
Debug.ShouldStop(-2147483648);
if (RemoteObject.solveBoolean("n",_value)) { 
Debug.CheckDeviceExceptions();if (true) return _defaultvalue;};
 BA.debugLineNum = 3105;BA.debugLine="Return value";
Debug.ShouldStop(1);
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(long.class, _value);
 Debug.CheckDeviceExceptions();
} 
       catch (Exception e5) {
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e5.toString()); BA.debugLineNum = 3107;BA.debugLine="Try";
Debug.ShouldStop(4);
try { BA.debugLineNum = 3108;BA.debugLine="Return Floor((\"\" & value).Trim)";
Debug.ShouldStop(8);
Debug.CheckDeviceExceptions();if (true) return BA.numberCast(long.class, b4xmainpage.__c.runMethod(true,"Floor",(Object)(BA.numberCast(double.class, (RemoteObject.concat(RemoteObject.createImmutable(""),_value)).runMethod(true,"trim")))));
 Debug.CheckDeviceExceptions();
			...
			BA.rdebugUtils.runVoidMethod("setLastException",__ref.getField(false, "ba"), e8.toString()); BA.debugLineNum = 3110;BA.debugLine="Return defaultValue";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("TraceLog (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2422);
if (RapidSub.canDelegate("tracelog")) { return __ref.runUserSub(false, "b4xmainpage","tracelog", __ref, _message);}
Debug.locals.put("message", _message);
 BA.debugLineNum = 2422;BA.debugLine="Public Sub TraceLog(message As String)";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 2423;BA.debugLine="appTraceService.Trace(message)";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("UpdateCodeInputAppearance (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2594);
...
__ref.getField(false,"_accesscirclepane" /*RemoteObject*/ ).runVoidMethod ("SetColorAndBorder",(Object)(_fillcolor),(Object)(BA.numberCast(double.class, b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 4))))),(Object)(_bordercolor),(Object)(BA.numberCast(double.class, b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 999))))));
 BA.debugLineNum = 2608;BA.debugLine="accessCorePane.SetColorAndBorder(xui.Color_Transp";
Debug.ShouldStop(32768);
__ref.getField(false,"_accesscorepane" /*RemoteObject*/ ).runVoidMethod ("SetColorAndBorder",(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent")),(Object)(BA.numberCast(double.class, b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2))))),(Object)(_orbitbordercolor),(Object)(BA.numberCast(double.class, b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 999))))));
 BA.debugLineNum = 2609;BA.debugLine="accessInputPane.SetColorAndBorder(xui.Color_Trans";
Debug.ShouldStop(65536);
__ref.getField(false,"_accessinputpane" /*RemoteObject*/ ).runVoidMethod ("SetColorAndBorder",(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent")),(Object)(BA.numberCast(double.class, 0)),(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent")),(Object)(BA.numberCast(double.class, 0)));
 BA.debugLineNum = 2610;BA.debugLine="SetPaneStyle(accessCirclePane, \"-fx-background-ra";
Debug.ShouldStop(131072);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setpanestyle" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_accesscirclepane" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("-fx-background-radius: 999; -fx-border-radius: 999;")));
 BA.debugLineNum = 2611;BA.debugLine="SetPaneStyle(accessCorePane, \"-fx-background-radi";
Debug.ShouldStop(262144);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setpanestyle" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_accesscorepane" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("-fx-background-radius: 999; -fx-border-radius: 999;")));
 BA.debugLineNum = 2612;BA.debugLine="SetPaneStyle(accessInputPane, \"-fx-background-col";
Debug.ShouldStop(524288);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setpanestyle" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_accessinputpane" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("-fx-background-color: transparent; -fx-background-radius: 0; -fx-border-width: 0; -fx-border-radius: 0;")));
 BA.debugLineNum = 2613;BA.debugLine="SetPaneStyle(txtPlayerCodeView, \"-fx-background-c";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("UpdateConnectionIndicator (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2679);
...
Debug.locals.put("mode", _mode);
 BA.debugLineNum = 2679;BA.debugLine="Private Sub UpdateConnectionIndicator(mode As Stri";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 2680;BA.debugLine="If lblConnectionIcon.IsInitialized = False Then R";
Debug.ShouldStop(8388608);
...
if (true) return RemoteObject.createImmutable("");};
 BA.debugLineNum = 2681;BA.debugLine="Dim iconText As String = ICON_CLOUD_OK";
Debug.ShouldStop(16777216);
_icontext = __ref.getField(true,"_icon_cloud_ok" /*RemoteObject*/ );Debug.locals.put("iconText", _icontext);Debug.locals.put("iconText", _icontext);
 BA.debugLineNum = 2682;BA.debugLine="Dim iconColor As Int = 0xFF747B86";
Debug.ShouldStop(33554432);
_iconcolor = BA.numberCast(int.class, ((int)0xff747b86));Debug.locals.put("iconColor", _iconcolor);Debug.locals.put("iconColor", _iconcolor);
 BA.debugLineNum = 2683;BA.debugLine="Select mode";
Debug.ShouldStop(67108864);
...
case 0: {
 BA.debugLineNum = 2685;BA.debugLine="iconText = ICON_CLOUD_OK";
Debug.ShouldStop(268435456);
_icontext = __ref.getField(true,"_icon_cloud_ok" /*RemoteObject*/ );Debug.locals.put("iconText", _icontext);
 BA.debugLineNum = 2686;BA.debugLine="iconColor = 0xFFD0FF71";
Debug.ShouldStop(536870912);
_iconcolor = BA.numberCast(int.class, ((int)0xffd0ff71));Debug.locals.put("iconColor", _iconcolor);
 break; }
case 1: {
 BA.debugLineNum = 2688;BA.debugLine="iconText = ICON_CLOUD_OFF";
Debug.ShouldStop(-2147483648);
_icontext = __ref.getField(true,"_icon_cloud_off" /*RemoteObject*/ );Debug.locals.put("iconText", _icontext);
 BA.debugLineNum = 2689;BA.debugLine="iconColor = 0xFFFF6B6B";
Debug.ShouldStop(1);
_iconcolor = BA.numberCast(int.class, ((int)0xffff6b6b));Debug.locals.put("iconColor", _iconcolor);
 break; }
case 2: {
 BA.debugLineNum = 2691;BA.debugLine="iconText = ICON_CLOUD_OFF";
Debug.ShouldStop(4);
_icontext = __ref.getField(true,"_icon_cloud_off" /*RemoteObject*/ );Debug.locals.put("iconText", _icontext);
 BA.debugLineNum = 2692;BA.debugLine="iconColor = 0xFFFF6B6B";
Debug.ShouldStop(8);
_iconcolor = BA.numberCast(int.class, ((int)0xffff6b6b));Debug.locals.put("iconColor", _iconcolor);
 break; }
case 3: {
 BA.debugLineNum = 2694;BA.debugLine="iconText = ICON_CLOUD_OK";
Debug.ShouldStop(32);
_icontext = __ref.getField(true,"_icon_cloud_ok" /*RemoteObject*/ );Debug.locals.put("iconText", _icontext);
 BA.debugLineNum = 2695;BA.debugLine="iconColor = 0xFF8E97A3";
Debug.ShouldStop(64);
_iconcolor = BA.numberCast(int.class, ((int)0xff8e97a3));Debug.locals.put("iconColor", _iconcolor);
 break; }
default: {
 BA.debugLineNum = 2697;BA.debugLine="iconText = ICON_CLOUD_OK";
Debug.ShouldStop(256);
_icontext = __ref.getField(true,"_icon_cloud_ok" /*RemoteObject*/ );Debug.locals.put("iconText", _icontext);
 BA.debugLineNum = 2698;BA.debugLine="iconColor = 0xFF747B86";
Debug.ShouldStop(512);
_iconcolor = BA.numberCast(int.class, ((int)0xff747b86));Debug.locals.put("iconColor", _iconcolor);
 break; }
}
;
 BA.debugLineNum = 2700;BA.debugLine="lblConnectionIcon.Text = iconText";
Debug.ShouldStop(2048);
__ref.getField(false,"_lblconnectionicon" /*RemoteObject*/ ).runMethod(true,"setText",_icontext);
 BA.debugLineNum = 2701;BA.debugLine="SetLabelStyle(lblConnectionIcon, \"-fx-alignment:";
Debug.ShouldStop(4096);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setlabelstyle" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblconnectionicon" /*RemoteObject*/ )),(Object)(RemoteObject.concat(RemoteObject.createImmutable("-fx-alignment: center; -fx-text-fill: "),__ref.runClassMethod (b4j.example.b4xmainpage.class, "_colortocss" /*RemoteObject*/ ,(Object)(_iconcolor)),RemoteObject.createImmutable(";"))));
 BA.debugLineNum = 2702;BA.debugLine="ApplyMaterialIconFont(lblConnectionIcon, 16)";
Debug.ShouldStop(8192);
...
try {
		Debug.PushSubsStack("UpdateHeaderActionAppearance (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2557);
...
Debug.locals.put("isHovered", _ishovered);
 BA.debugLineNum = 2557;BA.debugLine="Private Sub UpdateHeaderActionAppearance(isHovered";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 2558;BA.debugLine="Dim fillColor As Int";
Debug.ShouldStop(536870912);
_fillcolor = RemoteObject.createImmutable(0);Debug.locals.put("fillColor", _fillcolor);
 BA.debugLineNum = 2559;BA.debugLine="Dim borderColor As Int";
Debug.ShouldStop(1073741824);
_bordercolor = RemoteObject.createImmutable(0);Debug.locals.put("borderColor", _bordercolor);
 BA.debugLineNum = 2560;BA.debugLine="Dim textColor As Int";
Debug.ShouldStop(-2147483648);
_textcolor = RemoteObject.createImmutable(0);Debug.locals.put("textColor", _textcolor);
 BA.debugLineNum = 2561;BA.debugLine="If isHovered Then";
Debug.ShouldStop(1);
if (_ishovered.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 2562;BA.debugLine="fillColor = 0x14FFFFFF";
Debug.ShouldStop(2);
_fillcolor = BA.numberCast(int.class, ((int)0x14ffffff));Debug.locals.put("fillColor", _fillcolor);
 BA.debugLineNum = 2563;BA.debugLine="borderColor = 0x30FFFFFF";
Debug.ShouldStop(4);
_bordercolor = BA.numberCast(int.class, ((int)0x30ffffff));Debug.locals.put("borderColor", _bordercolor);
 BA.debugLineNum = 2564;BA.debugLine="textColor = 0xFFDDE6EF";
Debug.ShouldStop(8);
_textcolor = BA.numberCast(int.class, ((int)0xffdde6ef));Debug.locals.put("textColor", _textcolor);
 }else {
 BA.debugLineNum = 2566;BA.debugLine="fillColor = 0x08FFFFFF";
Debug.ShouldStop(32);
_fillcolor = BA.numberCast(int.class, ((int)0x08ffffff));Debug.locals.put("fillColor", _fillcolor);
 BA.debugLineNum = 2567;BA.debugLine="borderColor = 0x18FFFFFF";
Debug.ShouldStop(64);
_bordercolor = BA.numberCast(int.class, ((int)0x18ffffff));Debug.locals.put("borderColor", _bordercolor);
 BA.debugLineNum = 2568;BA.debugLine="textColor = 0xFFB9C0C9";
Debug.ShouldStop(128);
_textcolor = BA.numberCast(int.class, ((int)0xffb9c0c9));Debug.locals.put("textColor", _textcolor);
 };
 BA.debugLineNum = 2570;BA.debugLine="headerActionPane.SetColorAndBorder(fillColor, 1di";
Debug.ShouldStop(512);
__ref.getField(false,"_headeractionpane" /*RemoteObject*/ ).runVoidMethod ("SetColorAndBorder",(Object)(_fillcolor),(Object)(BA.numberCast(double.class, b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 1))))),(Object)(_bordercolor),(Object)(BA.numberCast(double.class, b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 999))))));
 BA.debugLineNum = 2571;BA.debugLine="SetPaneStyle(headerActionPane, \"-fx-cursor: hand;";
Debug.ShouldStop(1024);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setpanestyle" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_headeractionpane" /*RemoteObject*/ )),(Object)(RemoteObject.createImmutable("-fx-cursor: hand; -fx-background-radius: 999; -fx-border-radius: 999;")));
 BA.debugLineNum = 2572;BA.debugLine="SetLabelStyle(lblHeaderAction, \"-fx-alignment: ce";
Debug.ShouldStop(2048);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setlabelstyle" /*RemoteObject*/ ,(Object)(__ref.getField(false,"_lblheaderaction" /*RemoteObject*/ )),(Object)(RemoteObject.concat(RemoteObject.createImmutable("-fx-alignment: center; -fx-text-fill: "),__ref.runClassMethod (b4j.example.b4xmainpage.class, "_colortocss" /*RemoteObject*/ ,(Object)(_textcolor)),RemoteObject.createImmutable(";"))));
 BA.debugLineNum = 2573;BA.debugLine="ApplyMaterialIconFont(lblHeaderAction, headerActi";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("UpdatePlayButtonAppearance (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2482);
...
RemoteObject _orbitbordercolor = RemoteObject.createImmutable(0);
Debug.locals.put("isHovered", _ishovered);
 BA.debugLineNum = 2482;BA.debugLine="Private Sub UpdatePlayButtonAppearance(isHovered A";
Debug.ShouldStop(131072);
 BA.debugLineNum = 2483;BA.debugLine="Dim backgroundColor As Int";
Debug.ShouldStop(262144);
_backgroundcolor = RemoteObject.createImmutable(0);Debug.locals.put("backgroundColor", _backgroundcolor);
 BA.debugLineNum = 2484;BA.debugLine="Dim borderColor As Int";
Debug.ShouldStop(524288);
_bordercolor = RemoteObject.createImmutable(0);Debug.locals.put("borderColor", _bordercolor);
 BA.debugLineNum = 2485;BA.debugLine="Dim orbitBorderColor As Int";
Debug.ShouldStop(1048576);
_orbitbordercolor = RemoteObject.createImmutable(0);Debug.locals.put("orbitBorderColor", _orbitbordercolor);
 BA.debugLineNum = 2486;BA.debugLine="If isStarted Then";
Debug.ShouldStop(2097152);
if (__ref.getField(true,"_isstarted" /*RemoteObject*/ ).<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 2487;BA.debugLine="If isHovered Then";
Debug.ShouldStop(4194304);
if (_ishovered.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 2488;BA.debugLine="backgroundColor = 0x12FFFFFF";
Debug.ShouldStop(8388608);
_backgroundcolor = BA.numberCast(int.class, ((int)0x12ffffff));Debug.locals.put("backgroundColor", _backgroundcolor);
 BA.debugLineNum = 2489;BA.debugLine="borderColor = 0x77FFFFFF";
Debug.ShouldStop(16777216);
_bordercolor = BA.numberCast(int.class, ((int)0x77ffffff));Debug.locals.put("borderColor", _bordercolor);
 }else {
 BA.debugLineNum = 2491;BA.debugLine="backgroundColor = 0x08FFFFFF";
Debug.ShouldStop(67108864);
_backgroundcolor = BA.numberCast(int.class, ((int)0x08ffffff));Debug.locals.put("backgroundColor", _backgroundcolor);
 BA.debugLineNum = 2492;BA.debugLine="borderColor = 0x55FFFFFF";
Debug.ShouldStop(134217728);
_bordercolor = BA.numberCast(int.class, ((int)0x55ffffff));Debug.locals.put("borderColor", _bordercolor);
 };
 }else {
 BA.debugLineNum = 2495;BA.debugLine="If isHovered Then";
Debug.ShouldStop(1073741824);
if (_ishovered.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 2496;BA.debugLine="backgroundColor = 0x12FFFFFF";
Debug.ShouldStop(-2147483648);
_backgroundcolor = BA.numberCast(int.class, ((int)0x12ffffff));Debug.locals.put("backgroundColor", _backgroundcolor);
 BA.debugLineNum = 2497;BA.debugLine="borderColor = 0x55D0FF71";
Debug.ShouldStop(1);
_bordercolor = BA.numberCast(int.class, ((int)0x55d0ff71));Debug.locals.put("borderColor", _bordercolor);
 }else {
 BA.debugLineNum = 2499;BA.debugLine="backgroundColor = 0x07FFFFFF";
Debug.ShouldStop(4);
_backgroundcolor = BA.numberCast(int.class, ((int)0x07ffffff));Debug.locals.put("backgroundColor", _backgroundcolor);
 BA.debugLineNum = 2500;BA.debugLine="borderColor = 0x40FFFFFF";
Debug.ShouldStop(8);
_bordercolor = BA.numberCast(int.class, ((int)0x40ffffff));Debug.locals.put("borderColor", _bordercolor);
 };
 };
 BA.debugLineNum = 2503;BA.debugLine="If isStarted Or isHovered Then";
Debug.ShouldStop(64);
if (RemoteObject.solveBoolean(".",__ref.getField(true,"_isstarted" /*RemoteObject*/ )) || RemoteObject.solveBoolean(".",_ishovered)) { 
 BA.debugLineNum = 2504;BA.debugLine="orbitBorderColor = 0x66D0FF71";
Debug.ShouldStop(128);
_orbitbordercolor = BA.numberCast(int.class, ((int)0x66d0ff71));Debug.locals.put("orbitBorderColor", _orbitbordercolor);
 }else {
 BA.debugLineNum = 2506;BA.debugLine="orbitBorderColor = 0x22D0FF71";
Debug.ShouldStop(512);
_orbitbordercolor = BA.numberCast(int.class, ((int)0x22d0ff71));Debug.locals.put("orbitBorderColor", _orbitbordercolor);
 };
 BA.debugLineNum = 2508;BA.debugLine="playButtonPane.SetColorAndBorder(backgroundColor,";
Debug.ShouldStop(2048);
__ref.getField(false,"_playbuttonpane" /*RemoteObject*/ ).runVoidMethod ("SetColorAndBorder",(Object)(_backgroundcolor),(Object)(BA.numberCast(double.class, b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 4))))),(Object)(_bordercolor),(Object)(BA.numberCast(double.class, b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 999))))));
 BA.debugLineNum = 2509;BA.debugLine="orbitPane.SetColorAndBorder(xui.Color_Transparent";
Debug.ShouldStop(4096);
__ref.getField(false,"_orbitpane" /*RemoteObject*/ ).runVoidMethod ("SetColorAndBorder",(Object)(__ref.getField(false,"_xui" /*RemoteObject*/ ).getField(true,"Color_Transparent")),(Object)(BA.numberCast(double.class, b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 2))))),(Object)(_orbitbordercolor),(Object)(BA.numberCast(double.class, b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 999))))));
...
try {
		Debug.PushSubsStack("UpdateTextButtonAppearance (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2576);
...
Debug.locals.put("isHovered", _ishovered);
 BA.debugLineNum = 2576;BA.debugLine="Private Sub UpdateTextButtonAppearance(buttonView";
Debug.ShouldStop(32768);
 BA.debugLineNum = 2577;BA.debugLine="Dim fillColor As Int";
Debug.ShouldStop(65536);
_fillcolor = RemoteObject.createImmutable(0);Debug.locals.put("fillColor", _fillcolor);
 BA.debugLineNum = 2578;BA.debugLine="Dim borderColor As Int";
Debug.ShouldStop(131072);
_bordercolor = RemoteObject.createImmutable(0);Debug.locals.put("borderColor", _bordercolor);
 BA.debugLineNum = 2579;BA.debugLine="Dim textColor As Int";
Debug.ShouldStop(262144);
_textcolor = RemoteObject.createImmutable(0);Debug.locals.put("textColor", _textcolor);
 BA.debugLineNum = 2580;BA.debugLine="If isHovered Then";
Debug.ShouldStop(524288);
if (_ishovered.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 2581;BA.debugLine="fillColor = 0x12FFFFFF";
Debug.ShouldStop(1048576);
_fillcolor = BA.numberCast(int.class, ((int)0x12ffffff));Debug.locals.put("fillColor", _fillcolor);
 BA.debugLineNum = 2582;BA.debugLine="borderColor = 0x34FFFFFF";
Debug.ShouldStop(2097152);
_bordercolor = BA.numberCast(int.class, ((int)0x34ffffff));Debug.locals.put("borderColor", _bordercolor);
 BA.debugLineNum = 2583;BA.debugLine="textColor = 0xFFF2F7FB";
Debug.ShouldStop(4194304);
_textcolor = BA.numberCast(int.class, ((int)0xfff2f7fb));Debug.locals.put("textColor", _textcolor);
 }else {
 BA.debugLineNum = 2585;BA.debugLine="fillColor = 0x06FFFFFF";
Debug.ShouldStop(16777216);
_fillcolor = BA.numberCast(int.class, ((int)0x06ffffff));Debug.locals.put("fillColor", _fillcolor);
 BA.debugLineNum = 2586;BA.debugLine="borderColor = 0x1EFFFFFF";
Debug.ShouldStop(33554432);
_bordercolor = BA.numberCast(int.class, ((int)0x1effffff));Debug.locals.put("borderColor", _bordercolor);
 BA.debugLineNum = 2587;BA.debugLine="textColor = 0xFFE0E4EA";
Debug.ShouldStop(67108864);
_textcolor = BA.numberCast(int.class, ((int)0xffe0e4ea));Debug.locals.put("textColor", _textcolor);
 };
 BA.debugLineNum = 2589;BA.debugLine="buttonView.SetColorAndBorder(fillColor, 1dip, bor";
Debug.ShouldStop(268435456);
_buttonview.runVoidMethod ("SetColorAndBorder",(Object)(_fillcolor),(Object)(BA.numberCast(double.class, b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 1))))),(Object)(_bordercolor),(Object)(BA.numberCast(double.class, b4xmainpage.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 12))))));
 BA.debugLineNum = 2590;BA.debugLine="SetPaneStyle(buttonView, \"-fx-cursor: hand; -fx-b";
Debug.ShouldStop(536870912);
__ref.runClassMethod (b4j.example.b4xmainpage.class, "_setpanestyle" /*RemoteObject*/ ,(Object)(_buttonview),(Object)(RemoteObject.concat(RemoteObject.createImmutable("-fx-cursor: hand; -fx-border-radius: 12; -fx-background-radius: 12; -fx-text-fill: "),__ref.runClassMethod (b4j.example.b4xmainpage.class, "_colortocss" /*RemoteObject*/ ,(Object)(_textcolor)),RemoteObject.createImmutable(";"))));
 BA.debugLineNum = 2591;BA.debugLine="buttonView.Font = xui.CreateDefaultBoldFont(13)";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("UrlEncode (b4xmainpage) ","b4xmainpage",1,__ref.getField(false, "ba"),__ref,2844);
if (RapidSub.canDelegate("urlencode")) { return __ref.runUserSub(false, "b4xmainpage","urlencode", __ref, _value);}
RemoteObject _jo = RemoteObject.declareNull("anywheresoftware.b4j.object.JavaObject");
Debug.locals.put("value", _value);
 BA.debugLineNum = 2844;BA.debugLine="Private Sub UrlEncode(value As Object) As String";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 2845;BA.debugLine="Dim jo As JavaObject";
Debug.ShouldStop(268435456);
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");Debug.locals.put("jo", _jo);
 BA.debugLineNum = 2846;BA.debugLine="jo.InitializeStatic(\"java.net.URLEncoder\")";
Debug.ShouldStop(536870912);
_jo.runVoidMethod ("InitializeStatic",(Object)(RemoteObject.createImmutable("java.net.URLEncoder")));
 BA.debugLineNum = 2847;BA.debugLine="Return jo.RunMethod(\"encode\", Array As Object(\"\"";
Debug.ShouldStop(1073741824);
