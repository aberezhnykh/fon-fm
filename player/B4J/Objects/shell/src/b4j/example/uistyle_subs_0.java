...
try {
		Debug.PushSubsStack("ApplyMaterialIconFont (uistyle) ","uistyle",23,uistyle.ba,uistyle.mostCurrent,26);
...
try {
		Debug.PushSubsStack("ColorToCss (uistyle) ","uistyle",23,uistyle.ba,uistyle.mostCurrent,56);
...
try {
		Debug.PushSubsStack("CreateLabel (uistyle) ","uistyle",23,uistyle.ba,uistyle.mostCurrent,9);
...
try {
		Debug.PushSubsStack("MergeNodeStyle (uistyle) ","uistyle",23,uistyle.ba,uistyle.mostCurrent,63);
...
try {
		Debug.PushSubsStack("ScaleValue (uistyle) ","uistyle",23,uistyle.ba,uistyle.mostCurrent,50);
...
try {
		Debug.PushSubsStack("SetLabelStyle (uistyle) ","uistyle",23,uistyle.ba,uistyle.mostCurrent,35);
...
try {
		Debug.PushSubsStack("SetMouseTransparent (uistyle) ","uistyle",23,uistyle.ba,uistyle.mostCurrent,40);
...
try {
		Debug.PushSubsStack("SetPaneStyle (uistyle) ","uistyle",23,uistyle.ba,uistyle.mostCurrent,30);
...
try {
		Debug.PushSubsStack("SetPickOnBounds (uistyle) ","uistyle",23,uistyle.ba,uistyle.mostCurrent,45);
