...
try {
		Debug.PushSubsStack("ApplyMaterialIconFont (uistyle) ","uistyle",3,uistyle.ba,uistyle.mostCurrent,28);
...
Debug.locals.put("fontSize", _fontsize);
 BA.debugLineNum = 28;BA.debugLine="Public Sub ApplyMaterialIconFont(xui As XUI, view";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 29;BA.debugLine="view.Font = xui.CreateMaterialIcons(fontSize)";
...
try {
		Debug.PushSubsStack("ColorToCss (uistyle) ","uistyle",3,uistyle.ba,uistyle.mostCurrent,58);
...
Debug.locals.put("color", _color);
 BA.debugLineNum = 58;BA.debugLine="Public Sub ColorToCss(color As Int) As String";
Debug.ShouldStop(33554432);
 BA.debugLineNum = 59;BA.debugLine="Dim unsignedColor As Long = Bit.And(0xFFFFFFFF, c";
...
_unsignedcolor = BA.numberCast(long.class, uistyle.__c.getField(false,"Bit").runMethod(true,"And",(Object)(BA.numberCast(int.class, ((int)0xffffffff))),(Object)(_color)));Debug.locals.put("unsignedColor", _unsignedcolor);Debug.locals.put("unsignedColor", _unsignedcolor);
 BA.debugLineNum = 60;BA.debugLine="Dim rgb As Int = Bit.And(unsignedColor, 0xFFFFFF)";
Debug.ShouldStop(134217728);
_rgb = uistyle.__c.getField(false,"Bit").runMethod(true,"And",(Object)(BA.numberCast(int.class, _unsignedcolor)),(Object)(BA.numberCast(int.class, ((int)0xffffff))));Debug.locals.put("rgb", _rgb);Debug.locals.put("rgb", _rgb);
 BA.debugLineNum = 61;BA.debugLine="Return \"#\" & Bit.ToHexString(rgb)";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("CreateLabel (uistyle) ","uistyle",3,uistyle.ba,uistyle.mostCurrent,11);
...
Debug.locals.put("wrapText", _wraptext);
 BA.debugLineNum = 11;BA.debugLine="Public Sub CreateLabel(xui As XUI, text As String,";
Debug.ShouldStop(1024);
 BA.debugLineNum = 12;BA.debugLine="Dim lbl As Label";
Debug.ShouldStop(2048);
_lbl = RemoteObject.createNew ("anywheresoftware.b4j.objects.LabelWrapper");Debug.locals.put("lbl", _lbl);
 BA.debugLineNum = 13;BA.debugLine="lbl.Initialize(\"\")";
Debug.ShouldStop(4096);
_lbl.runVoidMethod ("Initialize",uistyle.ba,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 14;BA.debugLine="lbl.Text = text";
Debug.ShouldStop(8192);
_lbl.runMethod(true,"setText",_text);
 BA.debugLineNum = 15;BA.debugLine="lbl.WrapText = wrapText";
Debug.ShouldStop(16384);
_lbl.runMethod(true,"setWrapText",_wraptext);
 BA.debugLineNum = 16;BA.debugLine="Dim xlbl As B4XView = lbl";
...
_xlbl = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), _lbl.getObject());Debug.locals.put("xlbl", _xlbl);Debug.locals.put("xlbl", _xlbl);
 BA.debugLineNum = 17;BA.debugLine="If bold Then";
Debug.ShouldStop(65536);
if (_bold.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 18;BA.debugLine="xlbl.Font = xui.CreateDefaultBoldFont(fontSize)";
Debug.ShouldStop(131072);
_xlbl.runMethod(false,"setFont",_xui.runMethod(false,"CreateDefaultBoldFont",(Object)(_fontsize)));
 }else {
 BA.debugLineNum = 20;BA.debugLine="xlbl.Font = xui.CreateDefaultFont(fontSize)";
Debug.ShouldStop(524288);
_xlbl.runMethod(false,"setFont",_xui.runMethod(false,"CreateDefaultFont",(Object)(_fontsize)));
 };
 BA.debugLineNum = 22;BA.debugLine="xlbl.SetTextAlignment(\"CENTER\", \"CENTER\")";
Debug.ShouldStop(2097152);
_xlbl.runVoidMethod ("SetTextAlignment",(Object)(BA.ObjectToString("CENTER")),(Object)(RemoteObject.createImmutable("CENTER")));
 BA.debugLineNum = 23;BA.debugLine="SetLabelStyle(xlbl, \"-fx-alignment: center; -fx-t";
...
_setlabelstyle(_xlbl,RemoteObject.concat(RemoteObject.createImmutable("-fx-alignment: center; -fx-text-fill: "),_colortocss(_textcolor),RemoteObject.createImmutable(";")));
 BA.debugLineNum = 24;BA.debugLine="SetMouseTransparent(xlbl, True)";
Debug.ShouldStop(8388608);
_setmousetransparent(_xlbl,uistyle.__c.getField(true,"True"));
 BA.debugLineNum = 25;BA.debugLine="Return xlbl";
...
try {
		Debug.PushSubsStack("MergeNodeStyle (uistyle) ","uistyle",3,uistyle.ba,uistyle.mostCurrent,65);
...
Debug.locals.put("extraStyle", _extrastyle);
 BA.debugLineNum = 65;BA.debugLine="Private Sub MergeNodeStyle(currentStyle As String,";
Debug.ShouldStop(1);
 BA.debugLineNum = 66;BA.debugLine="If currentStyle = Null Or currentStyle.Trim = \"\"";
Debug.ShouldStop(2);
...
if (true) return _extrastyle;};
 BA.debugLineNum = 67;BA.debugLine="If extraStyle = Null Or extraStyle.Trim = \"\" Then";
Debug.ShouldStop(4);
...
if (true) return _currentstyle;};
 BA.debugLineNum = 68;BA.debugLine="If currentStyle.EndsWith(\";\") Then";
Debug.ShouldStop(8);
...
if (true) return RemoteObject.concat(_currentstyle,RemoteObject.createImmutable(" "),_extrastyle);
 ...
 BA.debugLineNum = 71;BA.debugLine="Return currentStyle & \"; \" & extraStyle";
Debug.ShouldStop(64);
if (true) return RemoteObject.concat(_currentstyle,RemoteObject.createImmutable("; "),_extrastyle);
 };
...
try {
		Debug.PushSubsStack("ScaleValue (uistyle) ","uistyle",3,uistyle.ba,uistyle.mostCurrent,52);
...
Debug.locals.put("largeValue", _largevalue);
 BA.debugLineNum = 52;BA.debugLine="Public Sub ScaleValue(availableWidth As Int, small";
Debug.ShouldStop(524288);
 BA.debugLineNum = 53;BA.debugLine="If availableWidth <= 420dip Then Return smallValu";
...
if (true) return _smallvalue;};
 BA.debugLineNum = 54;BA.debugLine="If availableWidth <= 720dip Then Return mediumVal";
Debug.ShouldStop(2097152);
...
if (true) return _mediumvalue;};
 BA.debugLineNum = 55;BA.debugLine="Return largeValue";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("SetLabelStyle (uistyle) ","uistyle",3,uistyle.ba,uistyle.mostCurrent,37);
...
Debug.locals.put("style", _style);
 BA.debugLineNum = 37;BA.debugLine="Public Sub SetLabelStyle(view As B4XView, style As";
Debug.ShouldStop(16);
 BA.debugLineNum = 38;BA.debugLine="Dim jo As JavaObject = view";
Debug.ShouldStop(32);
...
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _view.getObject());Debug.locals.put("jo", _jo);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 39;BA.debugLine="jo.RunMethod(\"setStyle\", Array(MergeNodeStyle(jo.";
Debug.ShouldStop(64);
...
try {
		Debug.PushSubsStack("SetMouseTransparent (uistyle) ","uistyle",3,uistyle.ba,uistyle.mostCurrent,42);
...
Debug.locals.put("value", _value);
 BA.debugLineNum = 42;BA.debugLine="Public Sub SetMouseTransparent(view As B4XView, va";
Debug.ShouldStop(512);
 BA.debugLineNum = 43;BA.debugLine="Dim jo As JavaObject = view";
Debug.ShouldStop(1024);
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _view.getObject());Debug.locals.put("jo", _jo);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 44;BA.debugLine="jo.RunMethod(\"setMouseTransparent\", Array(value))";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("SetPaneStyle (uistyle) ","uistyle",3,uistyle.ba,uistyle.mostCurrent,32);
...
Debug.locals.put("view", _view);
Debug.locals.put("style", _style);
 BA.debugLineNum = 32;BA.debugLine="Public Sub SetPaneStyle(view As B4XView, style As";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 33;BA.debugLine="Dim jo As JavaObject = view";
Debug.ShouldStop(1);
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _view.getObject());Debug.locals.put("jo", _jo);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 34;BA.debugLine="jo.RunMethod(\"setStyle\", Array(MergeNodeStyle(jo.";
Debug.ShouldStop(2);
_jo.runVoidMethod ("RunMethod",(Object)(BA.ObjectToString("setStyle")),(Object)(RemoteObject.createNewArray("Object",new int[] {1},new Object[] {(_mergenodestyle(BA.ObjectToString(_jo.runMethod(false,"RunMethod",(Object)(BA.ObjectToString("getStyle")),(Object)((uistyle.__c.getField(false,"Null"))))),_style))})));
...
try {
		Debug.PushSubsStack("SetPickOnBounds (uistyle) ","uistyle",3,uistyle.ba,uistyle.mostCurrent,47);
...
Debug.locals.put("view", _view);
Debug.locals.put("value", _value);
 BA.debugLineNum = 47;BA.debugLine="Public Sub SetPickOnBounds(view As B4XView, value";
Debug.ShouldStop(16384);
 BA.debugLineNum = 48;BA.debugLine="Dim jo As JavaObject = view";
Debug.ShouldStop(32768);
_jo = RemoteObject.createNew ("anywheresoftware.b4j.object.JavaObject");
_jo = RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4j.object.JavaObject"), _view.getObject());Debug.locals.put("jo", _jo);Debug.locals.put("jo", _jo);
 BA.debugLineNum = 49;BA.debugLine="jo.RunMethod(\"setPickOnBounds\", Array(value))";
Debug.ShouldStop(65536);
