...
public static RemoteObject  _class_globals(RemoteObject __ref) throws Exception{
 ...
 //BA.debugLineNum = 6;BA.debugLine="Public LocalRetryDelay As Int";
playbackretryfallbackstate._localretrydelay = RemoteObject.createImmutable(0);__ref.setField("_localretrydelay",playbackretryfallbackstate._localretrydelay);
 //BA.debugLineNum = 7;BA.debugLine="Public ServerRetryDelay As Int";
playbackretryfallbackstate._serverretrydelay = RemoteObject.createImmutable(0);__ref.setField("_serverretrydelay",playbackretryfallbackstate._serverretrydelay);
 //BA.debugLineNum = 8;BA.debugLine="Public DispatchRetryAfter As Int";
playbackretryfallbackstate._dispatchretryafter = RemoteObject.createImmutable(0);__ref.setField("_dispatchretryafter",playbackretryfallbackstate._dispatchretryafter);
 //BA.debugLineNum = 9;BA.debugLine="Public IsMediaPathDegraded As Boolean";
...
try {
		Debug.PushSubsStack("ClearDispatchRetryAfter (playbackretryfallbackstate) ","playbackretryfallbackstate",18,__ref.getField(false, "ba"),__ref,43);
if (RapidSub.canDelegate("cleardispatchretryafter")) { return __ref.runUserSub(false, "playbackretryfallbackstate","cleardispatchretryafter", __ref);}
 BA.debugLineNum = 43;BA.debugLine="Public Sub ClearDispatchRetryAfter";
Debug.ShouldStop(1024);
 BA.debugLineNum = 44;BA.debugLine="DispatchRetryAfter = 0";
...
try {
		Debug.PushSubsStack("ConsumeDispatchRetryAfter (playbackretryfallbackstate) ","playbackretryfallbackstate",18,__ref.getField(false, "ba"),__ref,51);
...
RemoteObject _value = RemoteObject.createImmutable(0);
 BA.debugLineNum = 51;BA.debugLine="Public Sub ConsumeDispatchRetryAfter As Int";
Debug.ShouldStop(262144);
 BA.debugLineNum = 52;BA.debugLine="Dim value As Int = DispatchRetryAfter";
...
_value = __ref.getField(true,"_dispatchretryafter" /*RemoteObject*/ );Debug.locals.put("value", _value);Debug.locals.put("value", _value);
 BA.debugLineNum = 53;BA.debugLine="DispatchRetryAfter = 0";
Debug.ShouldStop(1048576);
__ref.setField ("_dispatchretryafter" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 54;BA.debugLine="Return value";
...
try {
		Debug.PushSubsStack("Initialize (playbackretryfallbackstate) ","playbackretryfallbackstate",18,__ref.getField(false, "ba"),__ref,12);
...
Debug.locals.put("serverRetryInitial", _serverretryinitial);
 BA.debugLineNum = 12;BA.debugLine="Public Sub Initialize(localRetryInitial As Int, se";
Debug.ShouldStop(2048);
 BA.debugLineNum = 13;BA.debugLine="Reset(localRetryInitial, serverRetryInitial)";
Debug.ShouldStop(4096);
...
try {
		Debug.PushSubsStack("Reset (playbackretryfallbackstate) ","playbackretryfallbackstate",18,__ref.getField(false, "ba"),__ref,17);
...
Debug.locals.put("localRetryInitial", _localretryinitial);
Debug.locals.put("serverRetryInitial", _serverretryinitial);
 BA.debugLineNum = 17;BA.debugLine="Public Sub Reset(localRetryInitial As Int, serverR";
Debug.ShouldStop(65536);
 BA.debugLineNum = 18;BA.debugLine="LocalRetryDelay = localRetryInitial";
Debug.ShouldStop(131072);
__ref.setField ("_localretrydelay" /*RemoteObject*/ ,_localretryinitial);
 BA.debugLineNum = 19;BA.debugLine="ServerRetryDelay = serverRetryInitial";
Debug.ShouldStop(262144);
__ref.setField ("_serverretrydelay" /*RemoteObject*/ ,_serverretryinitial);
 BA.debugLineNum = 20;BA.debugLine="DispatchRetryAfter = 0";
Debug.ShouldStop(524288);
__ref.setField ("_dispatchretryafter" /*RemoteObject*/ ,BA.numberCast(int.class, 0));
 BA.debugLineNum = 21;BA.debugLine="IsMediaPathDegraded = False";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("ResetRetryDelays (playbackretryfallbackstate) ","playbackretryfallbackstate",18,__ref.getField(false, "ba"),__ref,38);
...
Debug.locals.put("localRetryInitial", _localretryinitial);
Debug.locals.put("serverRetryInitial", _serverretryinitial);
 BA.debugLineNum = 38;BA.debugLine="Public Sub ResetRetryDelays(localRetryInitial As I";
Debug.ShouldStop(32);
 BA.debugLineNum = 39;BA.debugLine="LocalRetryDelay = localRetryInitial";
Debug.ShouldStop(64);
__ref.setField ("_localretrydelay" /*RemoteObject*/ ,_localretryinitial);
 BA.debugLineNum = 40;BA.debugLine="ServerRetryDelay = serverRetryInitial";
...
try {
		Debug.PushSubsStack("ResolveRetryDelay (playbackretryfallbackstate) ","playbackretryfallbackstate",18,__ref.getField(false, "ba"),__ref,25);
...
Debug.locals.put("blockedRetryDelay", _blockedretrydelay);
 BA.debugLineNum = 25;BA.debugLine="Public Sub ResolveRetryDelay(mode As String, delay";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 26;BA.debugLine="If delayMs > 0 Then Return delayMs";
Debug.ShouldStop(33554432);
if (RemoteObject.solveBoolean(">",_delayms,BA.numberCast(double.class, 0))) { 
if (true) return _delayms;};
 BA.debugLineNum = 27;BA.debugLine="If mode = \"offline\" Then";
Debug.ShouldStop(67108864);
if (RemoteObject.solveBoolean("=",_mode,BA.ObjectToString("offline"))) { 
 BA.debugLineNum = 28;BA.debugLine="Dim delay As Int = LocalRetryDelay";
...
_delay = __ref.getField(true,"_localretrydelay" /*RemoteObject*/ );Debug.locals.put("delay", _delay);Debug.locals.put("delay", _delay);
 BA.debugLineNum = 29;BA.debugLine="LocalRetryDelay = Min(LocalRetryDelay * 2, local";
...
__ref.setField ("_localretrydelay" /*RemoteObject*/ ,BA.numberCast(int.class, playbackretryfallbackstate.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_localretrydelay" /*RemoteObject*/ ),RemoteObject.createImmutable(2)}, "*",0, 1))),(Object)(BA.numberCast(double.class, _localretrymax)))));
 BA.debugLineNum = 30;BA.debugLine="Return delay";
Debug.ShouldStop(536870912);
if (true) return _delay;
 };
 BA.debugLineNum = 32;BA.debugLine="If mode = \"blocked\" Then Return blockedRetryDelay";
Debug.ShouldStop(-2147483648);
if (RemoteObject.solveBoolean("=",_mode,BA.ObjectToString("blocked"))) { 
if (true) return _blockedretrydelay;};
 BA.debugLineNum = 33;BA.debugLine="Dim delayServer As Int = ServerRetryDelay";
Debug.ShouldStop(1);
_delayserver = __ref.getField(true,"_serverretrydelay" /*RemoteObject*/ );Debug.locals.put("delayServer", _delayserver);Debug.locals.put("delayServer", _delayserver);
 BA.debugLineNum = 34;BA.debugLine="ServerRetryDelay = Min(ServerRetryDelay * 2, serv";
Debug.ShouldStop(2);
__ref.setField ("_serverretrydelay" /*RemoteObject*/ ,BA.numberCast(int.class, playbackretryfallbackstate.__c.runMethod(true,"Min",(Object)(BA.numberCast(double.class, RemoteObject.solve(new RemoteObject[] {__ref.getField(true,"_serverretrydelay" /*RemoteObject*/ ),RemoteObject.createImmutable(2)}, "*",0, 1))),(Object)(BA.numberCast(double.class, _serverretrymax)))));
 BA.debugLineNum = 35;BA.debugLine="Return delayServer";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("SetDispatchRetryAfter (playbackretryfallbackstate) ","playbackretryfallbackstate",18,__ref.getField(false, "ba"),__ref,47);
...
Debug.locals.put("value", _value);
 BA.debugLineNum = 47;BA.debugLine="Public Sub SetDispatchRetryAfter(value As Int)";
Debug.ShouldStop(16384);
 BA.debugLineNum = 48;BA.debugLine="DispatchRetryAfter = Max(0, value)";
...
try {
		Debug.PushSubsStack("SetMediaPathDegraded (playbackretryfallbackstate) ","playbackretryfallbackstate",18,__ref.getField(false, "ba"),__ref,57);
...
Debug.locals.put("value", _value);
 BA.debugLineNum = 57;BA.debugLine="Public Sub SetMediaPathDegraded(value As Boolean)";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 58;BA.debugLine="IsMediaPathDegraded = value";
Debug.ShouldStop(33554432);
...
try {
		Debug.PushSubsStack("UpdateMediaPathDegradedFromCacheSync (playbackretryfallbackstate) ","playbackretryfallbackstate",18,__ref.getField(false, "ba"),__ref,62);
...
Debug.locals.put("networkFailure", _networkfailure);
 BA.debugLineNum = 62;BA.debugLine="Public Sub UpdateMediaPathDegradedFromCacheSync(do";
Debug.ShouldStop(536870912);
 BA.debugLineNum = 63;BA.debugLine="Dim previous As Boolean = IsMediaPathDegraded";
...
_previous = __ref.getField(true,"_ismediapathdegraded" /*RemoteObject*/ );Debug.locals.put("previous", _previous);Debug.locals.put("previous", _previous);
 BA.debugLineNum = 64;BA.debugLine="If downloaded Then";
Debug.ShouldStop(-2147483648);
if (_downloaded.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 65;BA.debugLine="IsMediaPathDegraded = False";
Debug.ShouldStop(1);
__ref.setField ("_ismediapathdegraded" /*RemoteObject*/ ,playbackretryfallbackstate.__c.getField(true,"False"));
 }else 
{ BA.debugLineNum = 66;BA.debugLine="Else If networkFailure Then";
Debug.ShouldStop(2);
if (_networkfailure.<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 67;BA.debugLine="IsMediaPathDegraded = True";
Debug.ShouldStop(4);
__ref.setField ("_ismediapathdegraded" /*RemoteObject*/ ,playbackretryfallbackstate.__c.getField(true,"True"));
 }}
;
 BA.debugLineNum = 69;BA.debugLine="If previous = False And IsMediaPathDegraded Then";
Debug.ShouldStop(16);
...
if (true) return BA.ObjectToString("entered");};
 BA.debugLineNum = 70;BA.debugLine="If previous = True And IsMediaPathDegraded = Fals";
Debug.ShouldStop(32);
