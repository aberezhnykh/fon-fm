...
RDebugUtils.currentLine=33292289;
 //BA.debugLineNum = 33292289;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=33357825;
 //BA.debugLineNum = 33357825;BA.debugLine="End Sub";
return "";
}
...
RDebugUtils.currentLine=33554432;
 //BA.debugLineNum = 33554432;BA.debugLine="Private Sub Partition(Data As List, StartIndex As";
RDebugUtils.currentLine=33554433;
 //BA.debugLineNum = 33554433;BA.debugLine="Dim PivotValue As Object = Data.Get(StartIndex +";
_pivotvalue = _data.Get((int) (_startindex+_pivotindex));
RDebugUtils.currentLine=33554434;
 //BA.debugLineNum = 33554434;BA.debugLine="Swap(Data, StartIndex, PivotIndex, Length - 1)";
__ref._swap /*String*/ (null,_data,_startindex,_pivotindex,(int) (_length-1));
RDebugUtils.currentLine=33554435;
 //BA.debugLineNum = 33554435;BA.debugLine="Dim L As Int = 0";
_l = (int) (0);
RDebugUtils.currentLine=33554436;
 //BA.debugLineNum = 33554436;BA.debugLine="For i = 0 To Length - 2";
{
final int step4 = 1;
...
RDebugUtils.currentLine=33554437;
 //BA.debugLineNum = 33554437;BA.debugLine="If CallSub3(Comparator, \"Compare\", Data.Get(Star";
...
RDebugUtils.currentLine=33554438;
 //BA.debugLineNum = 33554438;BA.debugLine="L = L + 1";
_l = (int) (_l+1);
RDebugUtils.currentLine=33554439;
 //BA.debugLineNum = 33554439;BA.debugLine="Swap(Data, StartIndex, L - 1, i)";
__ref._swap /*String*/ (null,_data,_startindex,(int) (_l-1),_i);
 };
 }
};
RDebugUtils.currentLine=33554442;
 //BA.debugLineNum = 33554442;BA.debugLine="Swap(Data, StartIndex, Length - 1, L)";
__ref._swap /*String*/ (null,_data,_startindex,(int) (_length-1),_l);
RDebugUtils.currentLine=33554443;
 //BA.debugLineNum = 33554443;BA.debugLine="Return L";
if (true) return _l;
RDebugUtils.currentLine=33554444;
 //BA.debugLineNum = 33554444;BA.debugLine="End Sub";
return 0;
}
...
RDebugUtils.currentLine=33619968;
 //BA.debugLineNum = 33619968;BA.debugLine="Private Sub Swap (Data As List, StartIndex As Int,";
RDebugUtils.currentLine=33619969;
 //BA.debugLineNum = 33619969;BA.debugLine="Dim o As Object = Data.Get(StartIndex + i1)";
_o = _data.Get((int) (_startindex+_i1));
RDebugUtils.currentLine=33619970;
 //BA.debugLineNum = 33619970;BA.debugLine="Data.Set(StartIndex + i1, Data.Get(StartIndex + i";
_data.Set((int) (_startindex+_i1),_data.Get((int) (_startindex+_i2)));
RDebugUtils.currentLine=33619971;
 //BA.debugLineNum = 33619971;BA.debugLine="Data.Set(StartIndex + i2, o)";
...
RDebugUtils.currentLine=33488896;
 //BA.debugLineNum = 33488896;BA.debugLine="Private Sub QuickSort (Data As List, StartIndex As";
RDebugUtils.currentLine=33488897;
 //BA.debugLineNum = 33488897;BA.debugLine="If Length > 1 Then";
if (_length>1) { 
RDebugUtils.currentLine=33488898;
 //BA.debugLineNum = 33488898;BA.debugLine="Dim PivotIndex As Int = Rnd(0, Length)";
_pivotindex = __c.Rnd((int) (0),_length);
RDebugUtils.currentLine=33488899;
 //BA.debugLineNum = 33488899;BA.debugLine="Dim r As Int = Partition(Data, StartIndex, Lengt";
_r = __ref._partition /*int*/ (null,_data,_startindex,_length,_pivotindex,_comparator);
RDebugUtils.currentLine=33488900;
 //BA.debugLineNum = 33488900;BA.debugLine="QuickSort(Data, StartIndex, r, Comparator)";
__ref._quicksort /*String*/ (null,_data,_startindex,_r,_comparator);
RDebugUtils.currentLine=33488901;
 //BA.debugLineNum = 33488901;BA.debugLine="QuickSort(Data, StartIndex + r + 1, Length - r -";
...
RDebugUtils.currentLine=33423360;
 //BA.debugLineNum = 33423360;BA.debugLine="Public Sub Sort (Data As List, Comparator As Objec";
RDebugUtils.currentLine=33423362;
 //BA.debugLineNum = 33423362;BA.debugLine="QuickSort(Data, 0, Data.Size, Comparator)";
